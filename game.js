  ...
  function _tutStep_game() {
    _tutGameSteps = [
      ...
      () => {
        ...
        _tutPopup('main-card',
          '◄► <strong>Ora fai una scelta!</strong> Premi uno dei pulsanti in basso o <em>swipa la carta</em>.<br><span style="color:#fbbf24">Il tutorial continuerà dopo la tua scelta.</span>',
          'down', null, null);
