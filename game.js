...
const Game = (() => {
  ...
  // Scacchiera 4×4 per ogni campo, nebbia di guerra, cerchietti con HP
  // ══════════════════════════════════════════════════════════════════════
  function showStrategicBattle(playerForce, enemyForce, enemyLabel, onComplete, allowRetreat) {
    ...
    // ── Griglia 6×10 — ottimizzata per mobile ──
    const COLS = 6, ROWS = 10;
    const CW = 42, CH = 42;         // celle quadrate touch-friendly
    const BW = COLS * CW;           // 252px
