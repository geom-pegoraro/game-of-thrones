...
const Game = (() => {
  ...
  const CHARACTERS = [
    ...
    },
    {
      ...
      objective: 'Il Re Mendicante: accumula 3 alleanze, Potere >70 e sopravvivi al turno 40 — riconquista il rispetto.',
      objectiveCheck: (s) => s.king === 'viserys' || (s.turn >= 40 && countAllies(s) >= 3 && s.resources.power > 70),
    ...
    },
    {
      ...
      objective: "Mano del Re: Potere >75, Popolo >55 e almeno 2 alleanze — o siedi tu stesso sul Trono.",
      objectiveCheck: (s) => s.king === 'tyrion' || (s.resources.power > 75 && s.resources.people > 55 && countAllies(s) >= 2),
    ...
    },
    {
      ...
      objective: 'Redenzione: raggiungi Potere >60, 2 alleanze e Esercito >40 al turno 45.',
      objectiveCheck: (s) => s.turn >= 45 && s.resources.power > 60 && countAllies(s) >= 2 && s.resources.army > 40,
    ...
    },
    {
      ...
      objective: "Il Mercenario d'Oro: Tesoro >75 e Esercito >55 entro il turno 50.",
      objectiveCheck: (s) => s.turn >= 50 && s.resources.gold > 75 && s.resources.army > 55,
      startAllies: [], startEnemies: [],
    ...
    },
    {
      ...
      objective: 'Il Bastardo Spietato: vinci 2 guerre e mantieni Esercito >55 e Potere >50 — oppure siedi sul Trono di Spade.',
      objectiveCheck: (s) => s.king === 'ramsay' || (s.decisionHistory.filter(d => d.tags?.includes('war_victory')).length >= 2 && s.resources.army > 55 && s.resources.power > 50),
    ...
    },
    {
      ...
      objective: 'Figlia del Vento: mantieni almeno 2 alleanze e Popolo >60 al turno 40.',
      objectiveCheck: (s) => s.turn >= 40 && countAllies(s) >= 2 && s.resources.people > 60,
    ...
    },
    {
      ...
      objective: 'Cavaliere Esiliato: ottieni 3 alleanze e Potere >60 — redenzione attraverso la lealtà.',
      objectiveCheck: (s) => countAllies(s) >= 3 && s.resources.power > 60,
      startAllies: [], startEnemies: [],
    ...
    },
    {
      ...
      objective: 'Sopravvissuto: raggiungi il turno 50 con Esercito >55 e Tesoro >45 — niente eroismi, solo sopravvivenza.',
      objectiveCheck: (s) => s.turn >= 50 && s.resources.army > 55 && s.resources.gold > 45,
      startAllies: [], startEnemies: [],
    ...
    },
    {
      ...
      objective: "Il Cavaliere della Cipolla: Popolo >70, Fede >60 e almeno 3 alleanze al turno 40.",
      objectiveCheck: (s) => s.turn >= 40 && s.resources.people > 70 && s.resources.faith > 60 && countAllies(s) >= 3,
      startAllies: ['Baratheon'], startEnemies: [],
    ...
    },
    {
      ...
      objective: 'La Mano del Re: Potere >75, Fede >65 e Tesoro >60 al turno 50 — o siedi sul Trono di Spade.',
      objectiveCheck: (s) => s.king === 'otto' || (s.turn >= 50 && s.resources.power > 75 && s.resources.faith > 65 && s.resources.gold > 60),
  ...
  const HOUSES_DEF = [
    ...
    { id: 'Lannister', name: 'Lannister',icon: '🦁', region: 'Castel Granito',     baseArmy: 95,
    ...
    { id: 'Bolton',    name: 'Bolton',    icon: '🩸', region: 'Il Nord (Forte Terrore)',  baseArmy: 85,
    ...
    { id: 'Targaryen', name: 'Targaryen', icon: '🐉', region: 'Dragonstone / Esilio',       baseArmy: 95,
    ...
    { id: 'Hightower', name: 'Hightower', icon: '🕯️', region: 'Vecchia Città (Oldtown)',    baseArmy: 85,
  ...
  const EVENTS = [
    ...
    },
    {
      ...
      rightText: 'Paga e rinegozia', rightEffects: { gold: -10, power: +10 },
      minTurn: 10,
    },
    {
      ...
      rightText: 'Schiaccia la ribellione', rightEffects: { army: -10, power: +10, people: -8 },
      minTurn: 5,
    },
    {
      ...
      leftText: 'Rifiuta — i nobili approvano', leftEffects: { power: +6, faith: +5 },
    ...
    },
    {
      ...
      leftText: 'Giustizia pubblica', leftEffects: { power: +6, faith: +6 },
    ...
    },
    {
      ...
      rightText: "Commissiona l'assassinio", rightEffects: { gold: -10, power: +10 },
    ...
    },
    {
      ...
      rightText: 'Accetta le nozze', rightEffects: { power: +10, people: +8, gold: -6 },
    ...
    },
    {
      ...
      rightText: 'Finanzia la rete', rightEffects: { gold: -10, power: +8 },
      minTurn: 6,
      onRightChoose: () => {
    ...
    },
    {
      ...
      rightText: 'Offri compensazione', rightEffects: { gold: -10, power: +9 },
    ...
    },
    {
      ...
      rightText: 'Organizza il banchetto', rightEffects: { gold: -10, people: +10, power: +8, faith: +4 },
    ...
    },
    {
      ...
      rightText: "Segui il destino", rightEffects: { faith: +10, army: -8, power: +4 },
      minTurn: 9,
    },
    ...
    },
    {
      ...
      rightText: 'Indici il torneo', rightEffects: { gold: -12, people: +5, power: +9 },
      minTurn: 4,
    },
    {
      ...
      rightText: 'Diffondili con la tua versione dei fatti', rightEffects: { power: +9, people: +6, faith: -10 },
      minTurn: 5,
    },
    {
    ...
    },
    {
      ...
      rightText: 'Usa il segreto', rightEffects: { power: +10, gold: +6, faith: -10 },
    ...
    },
    {
      ...
      rightText: 'Accoglienza sfarzosa', rightEffects: { power: +9, gold: -12, people: -5 },
      minTurn: 6,
    },
    {
    ...
    },
    {
      ...
      rightText: 'Ricostruisci con fondi pubblici', rightEffects: { gold: -12, people: +10, power: +4 },
      minTurn: 4,
    },
    {
    ...
    },
    {
      ...
      leftText: 'Contro-embargo', leftEffects: { gold: -8, power: +6, people: -6 },
    ...
    },
    {
      ...
      rightText: 'Accetta il sostegno', rightEffects: { power: +9, gold: +6 },
      ...
      onRightChoose: () => {
        ...
        state.eventQueue.push({
          ...
          leftText: 'Paga il debito', leftEffects: { gold: -12, army: -8 },
    ...
    },
    {
      ...
      rightText: "Sfrutta l'omen divino", rightEffects: { faith: +10, power: +6, people: -8 },
      minTurn: 5,
    },
    {
      ...
      leftText: "Vendi la concessione in segreto", leftEffects: { gold: +10, power: +6, faith: -6 },
    ...
    },
    {
      ...
      rightText: 'Agisci prima che sia tardi', rightEffects: { army: -8, power: +9, people: -6 },
      minTurn: 10,
    },
    {
      ...
      rightText: 'Rappresaglia immediata', rightEffects: { army: -10, power: +8, people: -5 },
      minTurn: 4,
    },
    {
    ...
    },
    {
      ...
      leftText: 'Consegnalo alla Cittadella', leftEffects: { faith: +8, power: +4 },
    ...
    },
    {
      ...
      rightText: "Usalo a vostro vantaggio", rightEffects: { power: +9, army: +5 },
      minTurn: 6,
    },
    {
    ...
    },
    {
      ...
      rightText: 'Accetta il duello', rightEffects: { power: +10, people: +8, army: -8 },
      minTurn: 5,
    },
    {
      ...
      rightText: "Concedi l'esenzione", rightEffects: { gold: -8, power: +9 },
      minTurn: 6,
    },
    {
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Alimenta la voce con discrezione', rightEffects: { power: +10, people: -8, faith: -8 },
    ...
    },
    {
      ...
      leftText: 'Mantieni le distanze con grazia', leftEffects: { faith: +8, power: +5 },
      rightText: 'Coltiva questa frequentazione', rightEffects: { gold: +10, power: +8, people: +5, faith: -10 },
      minTurn: 3,
    },
    {
      ...
      rightText: 'Conserva l\'informazione con cura', rightEffects: { power: +10, gold: +6, faith: -8 },
    ...
    },
    {
      ...
      rightText: 'Favorisci chi ti offre di più', rightEffects: { gold: +12, power: +8, people: -8 },
    ...
    },
    {
      ...
      leftText: 'Lascia perdere — fatti tuoi', leftEffects: { faith: +8, power: +5 },
      rightText: 'Fai indagare in silenzio', rightEffects: { power: +10, gold: +8, people: -6, faith: -6 },
      minTurn: 5, rightTags: ['poison_intrigue'],
    },

    {
      ...
      leftText: 'Giustizialo pubblicamente', leftEffects: { power: +10, faith: +8, people: -8 },
      rightText: 'Fallo sparire in silenzio', rightEffects: { power: +8, gold: -8, faith: -6 },
    ...
    },
    {
      ...
      rightText: 'Aspetta — forse i segnali sono falsi', rightEffects: { gold: +10, power: +5, people: -8 },
      minTurn: 8,
    },
    {
      ...
      leftText: 'Sostieni il pretendente più debole', leftEffects: { power: +9, people: +8, gold: -8 },
      rightText: 'Rimani neutrale e media', rightEffects: { faith: +10, power: +5, people: +5 },
      minTurn: 7,
    },
    {
    ...
    },
    {
      ...
      leftText: 'Accetta con clausole restrittive', leftEffects: { gold: +10, power: +6, faith: -5 },
      rightText: 'Rifiuta — Westeros basta a se stessa', rightEffects: { power: +8, faith: +8, people: +5, gold: -5 },
      minTurn: 4,
    },
    {
      ...
      rightText: 'Manda oro e vai avanti', rightEffects: { gold: -10, people: +8, power: +6 },
      minTurn: 3,
    },
    {
      ...
      leftText: 'Rappresaglia immediata — mostra i muscoli', leftEffects: { army: -8, power: +9, people: -6 },
      rightText: 'Indaga prima di agire', rightEffects: { power: +6, faith: +8, gold: -5 },
      minTurn: 4,
    },
    {
      ...
      leftText: 'Paga immediatamente — chiudi il debito', leftEffects: { gold: -14, power: +10, faith: +6 },
      rightText: 'Rinegozia con fermezza', rightEffects: { gold: -6, power: +8, people: +6 },
      minTurn: 10,
    },
    ...
    },
    {
      ...
      rightText: 'Mostra la loro potenza', rightEffects: { power: +10, people: -8, army: +10 },
      minTurn: 2,
    },
    {
    ...
    },
    {
      ...
      leftText: 'Rifiuta — costruisci consenso, non terrore', leftEffects: { people: +12, faith: +8, power: +5 },
    ...
    },
    {
      ...
      rightText: 'Considera la diplomazia', rightEffects: { power: +10, army: -5 },
    ...
    },
    {
      ...
      rightText: 'Affronta il confronto', rightEffects: { power: +10, army: -5, people: +5 },
      minTurn: 4,
    },
    ...
    },
    {
      ...
      rightText: 'Salda il debito', rightEffects: { gold: -10, power: +10 },
      minTurn: 4,
    },
    ...
    },
    {
      ...
      rightText: 'Paga per le informazioni', rightEffects: { gold: -10, power: +10 },
      minTurn: 3,
    },
    {
    ...
    },
    {
      ...
      rightText: 'Tienile testa', rightEffects: { power: +10, faith: -8, army: -5 },
      minTurn: 5,
    },
    {
      ...
      leftText: 'Ringrazia e mantieni la distanza', leftEffects: { power: +6, faith: +6 },
      rightText: 'Coltiva la fonte — vale ogni denaro', rightEffects: { gold: -8, power: +12, people: +6 },
      minTurn: 3,
    },
    {
      ...
      rightText: 'Usa le prove come leva', rightEffects: { power: +12, gold: +8, faith: -10 },
      minTurn: 4, rightTags: ['poison_intrigue'],
    },
    {
      ...
      rightText: 'Accetta — il potere prima di tutto', rightEffects: { gold: +12, power: +8, people: -8 },
      minTurn: 6, rightTags: ['royal_marriage'],
    },
    {
      ...
      rightText: 'Leggilo e conservalo', rightEffects: { power: +10, gold: +6, faith: -8 },
      minTurn: 7, rightTags: ['poison_intrigue'],
    },
    ...
    // ARYA HIT LIST CARDS — one per target, triggers kill confirmation overlay
    {
      ...
      leftText: 'Non ancora — osserva e raccogli informazioni', leftEffects: { power: +8, gold: +6, faith: -5 },
      rightText: '⚔ Elimina Cersei Lannister', rightEffects: { power: +9, army: +5, faith: -8 },
    ...
    },
    {
      ...
      leftText: 'Non oggi — infiltrati prima tra i suoi', leftEffects: { power: +8, faith: +6, gold: +5 },
    ...
    },
    {
      ...
      leftText: 'Seguilo — scopri i suoi complici', leftEffects: { army: +8, power: +6, faith: +5 },
    ...
    },
    {
      ...
      leftText: 'Infiltrati nel castello prima', leftEffects: { power: +8, gold: +8, army: +5 },
      rightText: '⚔ Elimina Tywin Lannister', rightEffects: { power: +10, gold: +8, faith: -10 },
    ...
    },
    {
      ...
      leftText: 'Raccogli informazioni sull\'esercito', leftEffects: { army: +8, power: +6, people: +5 },
    ...
    },
    {
      ...
      rightText: 'Applica la legge', rightEffects: { power: +10, faith: +8, people: -5 },
      minTurn: 3,
    },
    ...
    },
    {
      ...
      rightText: 'Accetta la corona del Nord', rightEffects: { power: +10, people: +14, army: +8 },
      minTurn: 4,
    },
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Segui i consigli di nonna', rightEffects: { power: +10, people: +8 },
      minTurn: 2,
    },
    {
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Sono Theon Greyjoy', rightEffects: { power: +10, faith: +6, army: -5 },
      minTurn: 1,
    },
    {
      ...
      leftText: 'Negozia supporto da lontano', leftEffects: { army: +8, gold: +8, power: +5 },
      rightText: 'Torna e rivendica la flotta', rightEffects: { army: +14, power: +10, gold: -12 },
      minTurn: 3,
    },
    ...
    // ══════════════════════════════════════════
    {
      ...
      leftText: 'Accordo segreto con Varys', leftEffects: { power: +10, gold: -10 },
      rightText: 'Distruggi la sua reputazione', rightEffects: { power: +10, faith: -8 },
    ...
    },
    {
      ...
      rightText: 'Coltiva questa alleanza silenziosa', rightEffects: { power: +10, gold: +10, faith: -12 },
      minTurn: 3, rightTags: ['poison_intrigue'],
    },
    {
      ...
      leftText: 'Aspetta — il momento giusto vale di più', leftEffects: { power: +6, gold: +8 },
      rightText: 'Usa le informazioni adesso', rightEffects: { power: +12, people: -8, faith: -6 },
    ...
    },
    {
      ...
      leftText: 'Non ti abbassare a questo', leftEffects: { faith: +10, power: +5 },
      rightText: 'Insinuati nella sua cerchia', rightEffects: { gold: +14, power: +8, faith: -10 },
      minTurn: 5,
    },
    {
      ...
      leftText: 'Rifiuta — Cersei non si controlla', leftEffects: { power: +8, faith: +6, gold: -5 },
      rightText: 'Accetta e diventa indispensabile', rightEffects: { power: +12, gold: +10, people: -10 },
      minTurn: 6, rightTags: ['poison_intrigue'],
    },
    {
      ...
      rightText: 'Organizza la faccenda con cura', rightEffects: { gold: +14, power: +9, faith: -12, army: -5 },
    ...
    },
    {
      ...
      rightText: 'Usala come pedina diplomatica', rightEffects: { power: +10, gold: +8, people: -12 },
      minTurn: 4,
    },
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Agisci sulla visione', rightEffects: { faith: +14, power: +10, army: -8 },
      minTurn: 2,
    },
    {
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: "Accetta l'incarico", rightEffects: { power: +10, people: -8 },
      minTurn: 1,
    },
    {
      ...
      rightText: "Usa l'informazione con cautela", rightEffects: { power: +10, faith: -10 },
      minTurn: 5,
    },
    ...
    // ══════════════════════════════════════════
    {
      ...
      leftText: 'Usalo come leva diplomatica', leftEffects: { power: +10, people: -5 },
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'È il momento', rightEffects: { power: +10, faith: -14 },
    ...
    },
    {
      ...
      rightText: 'Sacrificala se necessario', rightEffects: { power: +10, people: -14 },
      minTurn: 4,
    },
    {
      ...
      leftText: 'Rifiuta — i Lannister non si fidano mai', leftEffects: { power: +8, faith: +8, gold: -5 },
      rightText: "Accetta alle tue condizioni", rightEffects: { gold: +14, power: +6, people: -8 },
      minTurn: 5,
    },
    {
      ...
      leftText: 'Ricattalo in segreto — diventa tuo debitore', leftEffects: { power: +10, gold: +10, faith: -8 },
      rightText: 'Rivelalo pubblicamente — esemplarità', rightEffects: { power: +8, people: +10, faith: +5, gold: -6 },
      minTurn: 6, rightTags: ['poison_intrigue'],
    },
    {
      ...
      leftText: 'Vendi a prezzo pieno — il profitto viene prima', leftEffects: { gold: +14, people: -8, power: +5 },
    ...
    },
    {
      ...
      leftText: 'Rifiuta — la Fede non governa qui', leftEffects: { power: +9, people: +6, faith: -8 },
    ...
    },
    {
      ...
      rightText: 'Accetta la tregua con Jon', rightEffects: { army: +10, power: +6, people: -8 },
      minTurn: 3,
    },
    {
    ...
    // ARYA — 3a carta assassination (+ repeatable via arya_shadow)
    {
      ...
      rightText: 'Colpisci adesso', rightEffects: { power: +9, army: +5, faith: -8 },
    ...
    },
    {
      ...
      rightText: 'Depenna il nome', rightEffects: { power: +10, faith: -10, people: +4 },
    ...
    // MARGAERY — carte royal_marriage aggiuntive
    {
      ...
      rightText: 'Accetta le nozze reali', rightEffects: { power: +10, people: +8, gold: +6 },
    ...
    },
    {
      ...
      rightText: 'Conquista il Re', rightEffects: { power: +10, gold: +8, people: +5 },
    ...
    // STANNIS — carte war_victory aggiuntive
    {
      ...
      rightText: 'Lancia il siege', rightEffects: { army: -14, power: +10, gold: -10 },
    ...
    },
    {
      ...
      rightText: "Attacca con il favore di R'hllor", rightEffects: { army: -12, faith: +10, power: +8 },
    ...
    // DAENERYS — carta war_victory specifica
    {
      ...
      rightText: 'Dracarys — attacca!', rightEffects: { army: -14, power: +10, people: -8 },
    ...
    // ══════════════════════════════════════════
    {
      ...
      leftText: 'Rifiuta — hai altri piani', leftEffects: { power: +5, gold: -4 },
      rightText: 'Accetta l\'ospitalità e il piano', rightEffects: { power: +9, gold: +8, army: +8, people: -8 },
      minTurn: 1,
    },
    {
      ...
      leftText: 'Il rispetto si prende, non si chiede', leftEffects: { power: +4, people: -10, army: -5 },
    ...
    },
    {
      ...
      rightText: 'È il prezzo del trono', rightEffects: { army: +14, power: +8, faith: -12, people: -6 },
      minTurn: 3,
    },
    {
      ...
      leftText: 'Fai tacere chi ti deride', leftEffects: { power: +6, people: -8, gold: -6 },
      rightText: 'Abbraccia la storia — risorgerai', rightEffects: { people: +10, faith: +8, power: +4 },
      minTurn: 4,
    },
    {
      ...
      leftText: 'Tienila segreta — è un\'arma', leftEffects: { power: +10, gold: +4 },
      rightText: 'Annuncia la profezia — raduna i fedeli', rightEffects: { faith: +12, people: +8, power: +6, army: +5 },
      minTurn: 5,
    },
    ...
    // ══════════════════════════════════════════
    {
      ...
      leftText: 'La proclamazione basta', leftEffects: { power: +6 },
      rightText: 'Rafforza la posizione con oro e diplomazia', rightEffects: { gold: -12, power: +9, people: +10 },
      minTurn: 1,
    },
    {
      ...
      leftText: 'Tieni Syrax nascosta per ora', leftEffects: { power: +5 },
      rightText: 'Vola sopra la corte — dimostrazione di forza', rightEffects: { army: +10, power: +9, people: -6 },
      minTurn: 2,
    },
    {
      ...
      leftText: 'Aspetta — lascia che si scoprano', leftEffects: { power: +5 },
      rightText: 'Smantella la fazione con diplomazia', rightEffects: { gold: -10, power: +9, people: +8, faith: +6 },
      minTurn: 3,
    },
    {
      ...
      rightText: 'Affronta la questione pubblicamente', rightEffects: { people: +12, power: +8, gold: -8 },
      minTurn: 4,
    },
    {
      ...
      leftEffects: { gold: -12, army: +10, power: +6 },
      rightText: 'Investi in diplomazia', rightEffects: { power: +9, people: +8, gold: -8 },
      minTurn: 5,
    },
    ...
    // ══════════════════════════════════════════
    {
      ...
      leftText: 'Riserva Balerion per il momento giusto', leftEffects: { army: +8, power: +5 },
      rightText: 'Scatena il Terrore Nero — fine immediata', rightEffects: { army: -8, power: +10, people: -10 },
    ...
    },
    {
      ...
      leftText: 'Fuoco e sangue — la conquista parla da sola', leftEffects: { army: +10, power: +8, people: -12 },
      rightText: 'La diplomazia costruisce ciò che il fuoco non può', rightEffects: { power: +9, people: +10, gold: -8 },
      minTurn: 2,
    },
    {
      ...
      leftText: 'Il Re non risponde alla Fede', leftEffects: { power: +8, faith: -12, people: -8 },
    ...
    },
    {
      ...
      leftText: 'Governare con pugno di ferro', leftEffects: { power: +10, army: +5, people: -8, faith: -5 },
      rightText: "Costruire un'eredità di giustizia", rightEffects: { people: +12, faith: +8, power: +6, gold: -10 },
      minTurn: 4,
    },
    {
      ...
      leftText: 'Posticipa — prima consolida il potere', leftEffects: { gold: +8, power: +4 },
      rightText: 'Costruisci il Dragonpit', rightEffects: { gold: -10, army: +8, faith: +8, power: +10 },
      minTurn: 6,
    },
    {
      ...
      rightText: 'Colpisci i Lannister', rightEffects: { army: -14, power: +10, people: -5 },
    ...
    },
    {
      ...
      rightText: 'Aiuta il cavaliere', rightEffects: { faith: +10, people: +8, gold: -12 },
    ...
    // (Ned ha già ned_cersei_secret che può portare a betray — aggiungiamo una trappola esplicita)
    {
      ...
      rightText: "Accetta il compromesso", rightEffects: { power: +10, faith: -14 },
    ...
    },
    {
      ...
      leftText: 'Lascia che le gesta parlino da sole', leftEffects: { army: +8, faith: +6, power: +5 },
    ...
    },
    {
      ...
      leftText: 'Rifiuta e tieniti le mani libere', leftEffects: { army: +8, people: +6, power: +5 },
    ...
    },
    {
      ...
      leftText: 'Ruba i piani di distribuzione', leftEffects: { gold: +10, power: +6, faith: -8 },
    ...
    },
    {
      ...
      rightText: "Accetta l'accordo in segreto", rightEffects: { power: +10, gold: +6, faith: -5 },
      minTurn: 4,
    },
    {
    ...
    },
    {
      ...
      rightText: 'Tendi la mano della pace', rightEffects: { power: +8, people: +7 },
      minTurn: 5,
    },
    {
      ...
      rightText: 'Interroga e sfrutta', rightEffects: { power: +9, army: +5, gold: -6 },
      minTurn: 4,
    },
    {
    ...
    // ══════════════════════════════════════════
    {
      ...
      leftText: 'Proteggere il Re sopra ogni cosa', leftEffects: { power: +10, faith: +6, gold: -6 },
      rightText: 'Proteggere Oldtown e i Hightower', rightEffects: { power: +9, gold: +8, people: -8 },
      minTurn: 1,
    },
    {
      ...
      leftText: 'Manovra in segreto', leftEffects: { power: +10, faith: -6 },
      rightText: 'Agisci nel Gran Consiglio', rightEffects: { power: +8, people: +8, gold: -8 },
      minTurn: 3,
    },
    {
      ...
      rightText: 'Organizza il matrimonio', rightEffects: { power: +10, faith: +8, people: -8 },
      minTurn: 4,
    },
    {
      ...
      leftText: 'Non è il momento di spendere', leftEffects: { power: +4 },
      rightText: 'Finanzia la Cittadella', rightEffects: { gold: -12, faith: +12, power: +8 },
      minTurn: 5,
    },
    {
      ...
      leftText: 'Sostieni Rhaenyra — pragmatismo', leftEffects: { power: +8, faith: +6 },
      rightText: 'Punta su Aegon II — il vero piano', rightEffects: { power: +9, gold: -8, people: -6 },
      minTurn: 6,
    },
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Con alleanze e oro', rightEffects: { power: +9, gold: -10, people: -5 },
      minTurn: 1,
    },
    {
      ...
      leftText: 'Non fidarti di Larys', leftEffects: { power: +5, faith: +6 },
      rightText: 'Usa Larys — le informazioni valgono', rightEffects: { power: +10, gold: -8, faith: -6 },
      minTurn: 2,
    },
    {
      ...
      rightText: 'Usa la Fede come arma politica', rightEffects: { faith: +12, power: +10, people: +6, gold: -8 },
      minTurn: 3,
    },
    {
      ...
      leftText: 'Rifiuta — la guerra è inevitabile', leftEffects: { power: +10, army: +5, people: -10 },
    ...
    },
    {
      ...
      rightText: 'Incoronalo subito — agisci ora', rightEffects: { power: +10, army: +8, people: -10, faith: -6 },
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Scorticatelo — il terrore è ordine', rightEffects: { power: +10, people: -14, army: +5 },
      minTurn: 1,
    },
    {
      ...
      rightText: 'Il Nord cadrà — il potere vale tutto', rightEffects: { power: +10, army: +8, faith: -14, people: -10 },
    ...
    },
    {
      ...
      leftText: 'La reputazione basta', leftEffects: { power: +8, people: -8 },
      rightText: 'Presidi in ogni villaggio', rightEffects: { gold: -12, army: -8, power: +10 },
      minTurn: 3,
    },
    {
    ...
    },
    {
      ...
      leftText: 'Il Nord non si inginocchia', leftEffects: { power: +6, army: +5, people: +5 },
      rightText: 'Accetta il titolo dalla Corona', rightEffects: { power: +10, gold: +10, army: -8 },
      minTurn: 4,
    },
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Lascia scorrere i cani', rightEffects: { army: +10, people: -14, power: +8 },
      minTurn: 1,
    },
    {
      ...
      leftText: 'Usalo come leva diplomatica', leftEffects: { power: +10, gold: +8 },
      rightText: 'Spezzalo — diventerà il tuo strumento', rightEffects: { army: +8, power: +9, faith: -10, people: -8 },
      minTurn: 2,
    },
    {
      ...
      leftText: 'Elimina chi dubita di te', leftEffects: { power: +8, people: -12, faith: -8 },
      rightText: 'Compra la legittimità legale', rightEffects: { gold: -10, power: +9, faith: +6 },
      minTurn: 3,
    },
    {
      ...
      rightText: 'Accetta il nome Bolton', rightEffects: { power: +10, people: +8, gold: +8, army: -5 },
      minTurn: 4,
    },
    {
      ...
      rightText: 'Paga e disciplina le truppe', rightEffects: { gold: -12, army: +10, people: +5 },
      minTurn: 5,
    },
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Guida l\'avanguardia', rightEffects: { army: +12, people: -8, power: +8 },
      minTurn: 1,
    },
    {
      ...
      leftText: 'Il sentimento è una debolezza', leftEffects: { power: +8, people: -6 },
      rightText: 'Il legame può essere utile', rightEffects: { power: +10, people: +10, army: -5 },
      minTurn: 2,
    },
    {
      ...
      rightText: 'La negoziazione salva vite', rightEffects: { people: +12, power: +8, army: -5 },
      minTurn: 3,
    },
    {
      ...
      rightText: 'Usa le informazioni diplomaticamente', rightEffects: { power: +9, people: +6, gold: -4 },
      minTurn: 4,
    },
    ...
    // ══════════════════════════════════════════
    {
      ...
      leftText: 'Paga per il silenzio', leftEffects: { gold: -12, power: +4 },
    ...
    },
    {
      ...
      leftText: 'Troppo rischioso per te ora', leftEffects: { power: +5 },
      rightText: 'Guida la campagna — redenzione sul campo', rightEffects: { army: +12, faith: +10, power: +8, gold: -8 },
      minTurn: 3,
    },
    {
      ...
      leftText: 'Orso Isola non fa per me ora', leftEffects: { power: +4 },
      rightText: 'Torna alla famiglia', rightEffects: { people: +12, faith: +8, power: +10, gold: +6 },
      minTurn: 5,
    },
    {
    ...
    // ══════════════════════════════════════════
    {
      ...
      leftText: 'Fallo smettere — odi il fuoco', leftEffects: { faith: -8, army: -5, power: +5 },
    ...
    },
    {
      ...
      rightEffects: { gold: +12, power: +8, faith: -10 },
      minTurn: 3,
    },
    {
      ...
      rightText: 'Sfida il mostro — è il tuo destino', rightEffects: { power: +10, army: +8, faith: +8, people: +6 },
      minTurn: 6, rightTags: ['war_victory'],
    },
    {
      ...
      leftText: 'Continua a muoverti — niente riposo', leftEffects: { army: +5, power: +5 },
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Investi in nuove vene', rightEffects: { gold: -10, power: +8, gold2: +6 },
      minTurn: 1,
    },
    {
      ...
      rightText: 'Costruisci per i posteri', rightEffects: { power: +9, people: +8, gold: -10 },
      minTurn: 3,
    },
    {
      ...
      rightText: 'La Casa Lannister viene prima dei singoli', rightEffects: { power: +10, gold: +6, people: -10 },
      minTurn: 5,
    },
    {
      ...
      rightText: 'Un Lannister paga i suoi debiti — in sangue', rightEffects: { army: +10, power: +9, faith: -14, people: -10 },
    ...
    },
    {
      ...
      rightText: 'Mantieni il pugno di ferro', rightEffects: { gold: -8, army: +12, power: +8 },
      minTurn: 2,
    },
    ...
    // ══════════════════════════════════════════
    {
      ...
      leftText: 'Il giuramento è morto con lei', leftEffects: { power: +6, faith: -10 },
    ...
    },
    {
      ...
      rightText: 'Usa il pregiudizio a tuo favore', rightEffects: { people: +12, power: +10, gold: -6 },
      minTurn: 2,
    },
    {
      ...
      leftText: 'Il debito è saldato — niente di più', leftEffects: { power: +6 },
      rightText: 'L\'alleanza con Jaime può essere potente', rightEffects: { power: +9, army: +8, faith: +6, gold: -6 },
      minTurn: 4,
    },
    {
      ...
      leftText: 'La missione viene prima', leftEffects: { power: +5, army: +3 },
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Adottare i modi nobili è necessario', rightEffects: { power: +10, gold: +6, people: -8 },
      minTurn: 1,
    },
    {
      ...
      rightText: 'Stannis ha il diritto di scegliere', rightEffects: { power: +10, army: +5, faith: -12, people: -8 },
      minTurn: 3,
    },
    {
      ...
      leftText: 'Rifiuta — hai lasciato quel mondo', leftEffects: { faith: +8, power: +4 },
    ...
    },
    {
      ...
      rightEffects: { army: +8, power: +6, faith: -12, people: -10 },
      minTurn: 5,
    },
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Scegli il pragmatismo', rightEffects: { power: +10, gold: +6, faith: -10 },
      minTurn: 5,
    },
    {
      ...
      rightText: 'Il futuro non aspetta il passato', rightEffects: { power: +8, gold: +5, faith: -6 },
      minTurn: 8,
    },
    ...
    // ══════════════════════════════════════════
    {
      ...
      leftText: 'Paga il debito — onore della casata', leftEffects: { gold: -12, power: +8, faith: +4 },
    ...
    },
    {
      ...
      leftText: 'Mantieni il segreto ad ogni costo', leftEffects: { power: +6, gold: -5 },
      rightText: 'Usa il segreto come leva politica ora', rightEffects: { power: +9, gold: +8, faith: -8 },
      minTurn: 10,
    },
    ...
    // ══════════════════════════════════════════
    {
      ...
      leftText: 'Accetta il duello personalmente', leftEffects: { army: +5, power: +10, people: +6 },
    ...
    },
    {
      ...
      rightText: 'Le tattiche vecchie non servono più', rightEffects: { power: +5, army: -3 },
      minTurn: 4,
    },
    ...
    // ══════════════════════════════════════════
    {
      ...
      leftText: 'Il passato è il passato — guarda avanti', leftEffects: { power: +6, gold: +4 },
    ...
    },
    {
      ...
      rightText: 'La gratitudine è debolezza — sfrutta l\'occasione', rightEffects: { power: +8, gold: +6, faith: -10 },
      minTurn: 8,
    },
    ...
    // ══════════════════════════════════════════
    {
      ...
      leftText: 'L\'eredità è tutto — è legittimità', leftEffects: { power: +9, faith: +6, people: -5 },
      rightText: 'L\'eredità è un peso — costruisci il futuro', rightEffects: { people: +10, power: +4, faith: -4 },
      minTurn: 5,
    },
    {
      ...
      leftText: 'La politica viene prima dei draghi', leftEffects: { power: +8, gold: +4 },
    ...
    // ══════════════════════════════════════════
    {
      ...
      leftText: 'Usali come strumenti politici', leftEffects: { power: +10, gold: -8, faith: +5 },
    ...
    },
    {
      ...
      rightText: 'Abbassa le tasse — attrai commercio', rightEffects: { gold: +6, people: +8, power: +5 },
      minTurn: 3,
    },
...

    {
      ...
      rightText: 'Ripara subito', rightEffects: { gold: -12, people: +10 },
      minTurn: 3,
    },
    {
      ...
      rightText: 'Indici il torneo', rightEffects: { gold: -12, people: +14, power: +6 },
      minTurn: 5,
    },
    {
    ...
    },
    {
      ...
      rightText: 'Assumi il maester', rightEffects: { gold: -10, power: +8, faith: +6 },
      minTurn: 6,
    },
    {
      ...
      leftText: 'Dai ragione al primo', leftEffects: { power: +8, people: -5 },
      rightText: 'Proponi una divisione equa', rightEffects: { power: +4, people: +8, gold: -6 },
      minTurn: 5,
    },
    {
    ...
    },
    {
      ...
      rightText: 'Accettalo al servizio', rightEffects: { army: +8, power: +5, gold: -4 },
      minTurn: 4,
    },
    {
      ...
      rightText: 'Invia la flotta', rightEffects: { gold: -8, army: -6, power: +10 },
      minTurn: 6,
    },
    {
      ...
      leftText: 'Tieni la profezia segreta', leftEffects: { power: +6 },
    ...
    },
    {
      ...
      rightText: 'Finanzia la rete', rightEffects: { gold: -10, power: +10 },
      minTurn: 9,
    },
    {
      ...
      rightText: 'Prepara le riserve', rightEffects: { gold: -12, people: +10, army: +3 },
      minTurn: 6,
    },
    {
      ...
      rightText: 'Accetta l\'accordo', rightEffects: { gold: +12, power: +6, faith: -5 },
      minTurn: 8,
    },
    ...
    },
    {
      ...
      leftText: 'Apri i granai — è tuo dovere', leftEffects: { gold: -12, people: +14, faith: +5 },
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Finanzia il Settone', rightEffects: { gold: -12, faith: +14, people: +8 },
    ...
    },
    {
      ...
      leftText: 'Fallo arrestare', leftEffects: { power: +6, people: -10, faith: -5 },
    ...
    },
    {
      ...
      rightText: 'Permetti loro di restare', rightEffects: { people: +10, faith: -8, power: +4 },
    ...
    },
    {
      ...
      leftText: 'Scetticismo pubblico — è superstizione', leftEffects: { faith: -6, power: +4 },
    ...
    // ══════════════════════════════════════════
    {
      ...
      leftText: 'Rifiuta — niente debiti con Braavos', leftEffects: { power: +4 },
    ...
    },
    {
      ...
      leftText: 'Troppo rischioso politicamente', leftEffects: { power: +4 },
    ...
    // ══════════════════════════════════════════
    {
      ...
      leftText: 'Usa la lettera come leva privata', leftEffects: { power: +9, gold: -6 },
      rightText: 'Rivelala pubblicamente', rightEffects: { power: +8, faith: +6, people: +5 },
      minTurn: 8,
    },
    {
      ...
      rightText: 'Abbraccia la profezia', rightEffects: { faith: -5, power: +9, people: +8 },
    ...
    },
    {
      ...
      rightText: 'Intervieni come arbitro', rightEffects: { power: +10, gold: -8, faith: +4 },
      minTurn: 6,
    },
    {
      ...
      leftText: 'Troppo rischioso', leftEffects: { power: +4 },
      rightText: 'Autorizza l\'operazione', rightEffects: { power: +9, army: +5, gold: -8 },
      minTurn: 12,
    },
    {
      ...
      rightText: 'Accetta l\'alleanza matrimoniale', rightEffects: { power: +10, people: +6, gold: +8 },
    ...
    },
    {
      ...
      leftText: 'Arrestalo subito', leftEffects: { army: -5, power: +6 },
      rightText: 'Usalo come esca', rightEffects: { power: +9, army: -3, gold: -6 },
      minTurn: 10,
    },
    ...
    },
    {
      ...
      rightText: 'Costruisci le macchine', rightEffects: { gold: -12, army: +10, power: +5 },
    ...
    },
    {
      ...
      leftText: 'Punizione esemplare', leftEffects: { army: -5, power: +8, people: -5 },
      rightText: 'Rinforza i confini', rightEffects: { army: +5, gold: -8, power: +4 },
      minTurn: 5,
    },
    {
      ...
      leftText: 'Punizione pubblica — disciplina', leftEffects: { army: -5, power: +8, people: -8 },
    ...
    // ══════════════════════════════════════════
    {
      ...
      leftText: 'Ricostruisci rapidamente', leftEffects: { gold: -10, army: +5, power: +6, people: +5 },
    ...
    },
    {
      ...
      rightText: 'Alimenta il timore — le profezie ti favoriscono', rightEffects: { power: +10, faith: -8, people: -6 },
    ...
    },
    {
      ...
      leftText: 'Presagio di gloria — il cielo vi sostiene', leftEffects: { power: +10, faith: +6, people: +4 },
    ...
    },
    {
      ...
      rightText: 'Organizza la grande caccia', rightEffects: { gold: -10, people: +8, power: +8, army: -4 },
    ...
    },
    {
      ...
      rightText: 'Finanzia i medici', rightEffects: { gold: -12, people: +8, faith: +8 },
      minTurn: 8,
    },
...

    {
      ...
      rightText: 'Investigare in segreto', rightEffects: { gold: -8, power: +10, faith: +6 },
      minTurn: 12,
      maxUses: 1,
    },
    {
      ...
      rightText: 'Acquista l\'uovo', rightEffects: { gold: -10, power: +10, faith: +5 },
      minTurn: 10,
      maxUses: 1,
    },
    {
      ...
      leftText: 'Sopprimi la notizia', leftEffects: { power: +5, faith: -5 },
    ...
    },
    {
      ...
      leftText: 'Informazione inaffidabile', leftEffects: { power: +4 },
      rightText: 'Invia una delegazione a Essos', rightEffects: { gold: -12, power: +9, army: +5 },
      minTurn: 15,
      maxUses: 1,
    },
...

    {
      ...
      rightText: 'Imponi la riscossione', rightEffects: { gold: +12, people: -12, army: -6, power: +6 },
      minTurn: 1,
      maxUses: 2,
    },
    {
      ...
      rightText: 'Designa un erede simbolico', rightEffects: { faith: +10, people: +8, power: +6, gold: -8 },
      minTurn: 1,
      maxUses: 1,
    },
    {
      ...
      rightText: 'Dai ragione al Comandante — difesa', rightEffects: { army: +10, gold: -8, power: +4 },
      minTurn: 2,
      maxUses: 3,
    },
    {
      ...
      rightText: 'Schiaccia subito la ribellione', rightEffects: { army: -10, power: +9, people: -8 },
      minTurn: 2,
      maxUses: 2,
    },
    {
      ...
      rightText: 'Accetta il matrimonio', rightEffects: { gold: +12, power: +8, people: +6, faith: +5 },
      minTurn: 3,
      maxUses: 1,
    },
    {
      ...
      leftText: 'Invia la guardia — ristabilisci l\'ordine', leftEffects: { army: -5, people: -8, power: +6, faith: -8 },
      rightText: 'Distribuisci pane e spettacolo', rightEffects: { gold: -12, people: +14, faith: +6 },
      minTurn: 2,
      maxUses: 2,
    },
    {
      ...
      rightText: 'Invia esattori con scorta armata', rightEffects: { gold: +12, army: -6, power: +4, people: -8 },
      minTurn: 3,
      maxUses: 2,
    },
    {
      ...
      leftText: 'Sciogli la Fede Militante', leftEffects: { faith: -14, army: -8, people: -6, power: +8 },
    ...
    },
    {
      ...
      leftText: 'Sorveglialo in segreto', leftEffects: { power: +8, gold: -6 },
      rightText: 'Arrestalo subito — tolleranza zero', leftEffects2: {},
      rightEffects: { power: +4, army: +5, people: -8, faith: -5 },
      minTurn: 4,
      maxUses: 1,
    },
    {
      ...
      leftText: 'La forza parla più delle parole', leftEffects: { army: +8, power: +6, people: -8 },
      rightText: 'Convoca una grande assemblea di pace', rightEffects: { gold: -12, people: +12, power: +10, faith: +6 },
      minTurn: 5,
      maxUses: 1,
    },
    {
      ...
      rightText: 'Schiera truppe di confine come deterrente', rightEffects: { army: -8, power: +10, gold: -6 },
      minTurn: 5,
      maxUses: 2,
    },
    {
      ...
      rightText: 'Indici il Grande Torneo', rightEffects: { gold: -10, people: +14, power: +10, faith: +4 },
      minTurn: 6,
      maxUses: 1,
    },
  ...
  function _showHouseSelect() {
    ...
    const HOUSE_GROUPS = [
      { id: 'Stark',     name: 'Casa Stark',       icon: '🐺', region: 'Il Nord',              chars: ['jon','sansa','arya','robb','ned'],              color: 'rgba(148,163,184,0.15)', border: 'rgba(148,163,184,0.4)' },
      { id: 'Lannister', name: 'Casa Lannister',   icon: '🦁', region: 'Castel Granito',        chars: ['cersei','tyrion','jaime','tywin'],             color: 'rgba(201,168,76,0.12)',  border: 'rgba(201,168,76,0.45)' },
      { id: 'Targaryen', name: 'Casa Targaryen',   icon: '🐉', region: 'Esilio / Dragonstone',  chars: ['daenerys','viserys','rhaenyra','aegon_t'],             color: 'rgba(220,38,38,0.12)',   border: 'rgba(220,38,38,0.45)'  },
      { id: 'Baratheon', name: 'Casa Baratheon',   icon: '🦌', region: 'Capo della Tempesta',   chars: ['stannis','melisandre','davos'],                color: 'rgba(251,191,36,0.12)',  border: 'rgba(251,191,36,0.4)'  },
      { id: 'Tyrell',    name: 'Casa Tyrell',      icon: '🌹', region: 'Altogarden',            chars: ['margaery','olenna'],                           color: 'rgba(74,222,128,0.1)',   border: 'rgba(74,222,128,0.4)'  },
      { id: 'Martell',   name: 'Casa Martell',     icon: '☀️', region: 'Dorne',                 chars: ['oberyn'],                                     color: 'rgba(251,146,60,0.12)',  border: 'rgba(251,146,60,0.4)'  },
      { id: 'Greyjoy',   name: 'Casa Greyjoy',     icon: '🐙', region: 'Isole di Ferro',        chars: ['theon'],                                      color: 'rgba(99,102,241,0.1)',   border: 'rgba(99,102,241,0.4)'  },
      { id: 'Tully',     name: 'Casa Tully',       icon: '🐟', region: 'Acque del Nera',        chars: ['catelyn'],                                    color: 'rgba(59,130,246,0.1)',   border: 'rgba(59,130,246,0.4)'  },
      { id: 'Bolton',    name: 'Casa Bolton',      icon: '🩸', region: 'Forte Terrore',         chars: ['roose','ramsay'],                             color: 'rgba(127,29,29,0.15)',   border: 'rgba(239,68,68,0.4)'   },
      { id: 'Hightower', name: 'Casa Hightower',   icon: '🕯️', region: 'Oldtown',               chars: ['otto','alicent'],                             color: 'rgba(251,191,36,0.1)',   border: 'rgba(251,191,36,0.35)' },
      { id: 'None',      name: 'Senza Casa',       icon: '🪙', region: 'Westeros',              chars: ['littlefinger','bronn','tormund','jorah','sandor','ygritte','brienne'], color: 'rgba(120,120,120,0.1)', border: 'rgba(120,120,120,0.35)'},
    ];
    ...
    HOUSE_GROUPS.forEach(group => {
      ...
      card.innerHTML = `
        <span class="char-card-icon" style="font-size:2.2rem">${group.icon}</span>
  ...
  function _showHouseCharacters(group) {
    ...
    // Update header
    const sub = document.querySelector('#screen-char-select .section-sub');
    if (sub) sub.textContent = `${group.icon} ${group.name} — Scegli il tuo personaggio`;

    // Back button
    const backWrapper = document.createElement('div');
    backWrapper.style.cssText = 'width:100%;padding:0 0.5rem;margin-bottom:0.75rem;box-sizing:border-box;';
    backWrapper.innerHTML = `
      <button onclick="Game._showHouseSelect()" style="background:transparent;border:1px solid rgba(201,168,76,0.3);border-radius:3px;padding:0.45rem 0.9rem;font-family:'Cinzel',serif;font-size:0.68rem;letter-spacing:0.1em;text-transform:uppercase;cursor:pointer;color:#9a8a6a;transition:all 0.2s">
        ◄ Torna alle Casate
      </button>`;
    ...
    chars.forEach(c => {
      const card = document.createElement('div');
      card.className = 'char-card';
      card.style.cssText = `background:${group.color};border-color:${group.border};`;
  ...
  function renderDiplomacy() {
    ...
    if (kingH) {
      ...
      sec.innerHTML = `
        ...
        <div style="background:rgba(192,132,252,0.06);border:2px solid rgba(192,132,252,0.5);border-radius:6px;padding:0.8rem;cursor:pointer;position:relative"
             onclick="Game._openHousePopup('${kingHouseId}')">
          <div style="display:flex;align-items:center;gap:0.6rem;margin-bottom:0.5rem">
            <span style="font-size:1.6rem">${kingH.icon}</span>
            <div>
              <div style="font-family:'Cinzel',serif;font-size:0.82rem;color:#c084fc;font-weight:700">Casa ${kingH.name}</div>
              <div style="font-size:0.68rem;color:#9a8a6a;font-family:'EB Garamond',serif">${state.kingName} · ⚔ ${Math.round(kingH.army)} truppe</div>
            </div>
            <span style="margin-left:auto;font-size:0.65rem;color:#c084fc;font-family:'Cinzel',serif;letter-spacing:0.05em">tocca →</span>
          </div>
          ${state.isPlayerKing
            ...
            : `<div style="font-family:'EB Garamond',serif;font-size:0.8rem;color:#9a8a6a;line-height:1.5;margin-bottom:0.5rem">
              ...
              ${canChallenge
                ...
                : state.pendingKingChallenge
                  ...
                  : `<div style="font-family:'Cinzel',serif;font-size:0.68rem;color:#6b5e4a;text-align:center">🔒 Requisiti non soddisfatti</div>`
              }`
          }
        </div>`;
    ...
    if (Math.random() < refuseChance) {
      ...
      overlay.innerHTML = `
        <div style="background:#12121a;border:2px solid rgba(239,68,68,0.5);border-radius:8px;width:92%;max-width:420px;padding:1.6rem;font-family:'Cinzel',serif;text-align:center">
          <div style="font-size:2rem;margin-bottom:0.6rem">${h.icon}</div>
  ...
  function showBattleAnimation(playerForce, kingForce, onComplete, allowRetreat) {
  ...
  function _resolveThroneAttack(won, playerForce, kingForce, survived, enemySurvived) {
    ...
    if (won) {
      ...
      // ── +100 cap just like conquering a house ──
      ...
      // ── Apply resources — cap already increased ──
      const cap = getResourceCap();
      Object.keys(state.resources).forEach(k => {
        state.resources[k] = Math.min(cap - 1, Math.max(1, state.resources[k]));
      });
      // Subtract loaned troops — they return to allies, only own survivors count
      const ownThroneSwrvived = Math.max(5, (survived ?? state.resources.army) - (state.loanedArmy || 0));
      returnLoanedArmies();
      state.resources.army  = Math.min(cap - 1, ownThroneSwrvived);
      state.resources.power = Math.min(cap - 1, state.resources.power + 25);
  ...
  const THRONE_LEGITIMACY_EVENT = {
    ...
    rightText: 'Afferma la tua legittimità', rightEffects: { gold: -10, people: +14, faith: +10, power: +10 },
    ...
    overlay.innerHTML = `
      ...
      <div class="war-log">
        ${won ? `
          ...
          ${allyNote}
          <p style="color:#c9a84c;margin-top:0.5rem">📜 Il cap delle risorse è aumentato di +100.</p>
  ...
  function triggerPactCall(hId) {
    ...
    state.eventQueue.unshift({
      ...
      rightText: `Onora il patto — invia truppe`, rightEffects: { army: -12, power: +8 },
      tags: ['pact_response'],
      pactHouseId: hId,
      onRightChoose: () => {
  ...
  function showPreBattleOverlay(houseId, playerInitiated = true) {
    ...
    // Also show warAllianceBonus contributors (from declaration phase)
    const allianceBonusRow = allianceBonus > 0
    ...
    overlay.innerHTML = `
      <div style="width:92%;max-width:460px;padding:1.75rem;background:#0d0208;border:1px solid rgba(201,168,76,0.4);border-radius:6px;">
        ...
        <div style="text-align:center;margin-bottom:1.2rem">
          ...
          <div style="display:flex;align-items:center;justify-content:center;gap:1.5rem;margin-bottom:0.8rem">
            <div style="text-align:center">
              <div style="font-size:2.8rem">${charIcon}</div>
              <div style="font-size:0.65rem;color:#4ade80;letter-spacing:0.08em;margin-top:0.2rem">${state.character?.name?.split(' ')[0] || 'Tu'}</div>
            ...
            <div style="text-align:center">
              <div style="font-size:2.8rem">${h.icon}</div>
  ...
  function _resolveHouseBattle(houseId, h, won, survived, enemySurvived, playerForce, enemyForce, desertNote, playerInitiated) {
    ...
    if (won) {
      ...
      // Player army = own survivors + conquest bonus
      state.resources.army   = Math.min(newCap, ownSurvived + bonusArmy);
      ...
      // Don't checkGameOver immediately after conquest — resources just jumped with new cap,
      // cap-overflow conditions would fire falsely. Check will run on next drawNextCard.
...
const AudioManager = (() => {
  ...
  function playMainFromWar() {
    ...
    _warActive = false;
    // Always fade out track2 if it's playing, regardless of _warActive state
