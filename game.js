...
const Game = (() => {
  ...
  const EVENTS = [
    ...
    },
    {
      ...
      rightText: 'Accetta il patto', rightEffects: { gold: +12 },
      minTurn: 3,
    },
    {
    ...
    },
    {
      ...
      portrait: '🗡️', icon: '🗡️',
      text: "Un messaggero dei Molti Volti offre l'eliminazione di un vostro nemico. Il prezzo è altissimo. Un nemico in meno vale molto — ma di chi si tratta?",
      leftText: 'Rifiuta', leftEffects: { power: -3 },
      rightText: "Commissiona l'assassinio", rightEffects: { gold: -14, power: +10 },
    ...
    },
    {
      ...
      rightText: "Invia oro e rifornimenti", rightEffects: { gold: -14 },
    ...
    },
    {
      ...
      rightText: 'Finanzia la rete', rightEffects: { gold: -14, power: +8 },
      minTurn: 6,
      onRightChoose: () => {
    ...
    },
    {
      ...
      rightText: 'Organizza il banchetto', rightEffects: { gold: -14, people: +10, power: +8, faith: +4 },
    ...
    },
    {
      ...
      rightText: 'Indici il torneo', rightEffects: { gold: -12, people: +8, power: +8 },
      minTurn: 4,
    },
    {
      ...
      leftText: 'Tienilo riservato', leftEffects: { },
      rightText: 'Diffondilo in tutto il regno', rightEffects: { power: +8, people: +5 },
      minTurn: 5,
    },
    {
    ...
    },
    {
      ...
      rightText: 'Accetta il sostegno', rightEffects: { power: +12, gold: +6 },
    ...
    },
    {
      ...
      leftText: 'Rifiuta i Dothraki', leftEffects: { },
    ...
    },
    {
      ...
      leftText: 'Troppo pericoloso', leftEffects: { },
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Accetta l\'ospitalità e il piano', rightEffects: { power: +12, gold: +8, army: +8, people: -8 },
      minTurn: 1,
    },
    {
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Rafforza la posizione con oro e diplomazia', rightEffects: { gold: -12, power: +12, people: +10 },
      minTurn: 1,
    },
    {
      ...
      rightText: 'Vola sopra la corte — dimostrazione di forza', rightEffects: { army: +10, power: +12, people: -6 },
      minTurn: 2,
    },
    {
      ...
      rightText: 'Smantella la fazione con diplomazia', rightEffects: { gold: -10, power: +12, people: +8, faith: +6 },
      minTurn: 3,
    },
    {
    ...
    },
    {
      ...
      rightText: 'Investi in diplomazia', rightEffects: { power: +12, people: +8, gold: -8 },
      minTurn: 5,
    },
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Scatena il Terrore Nero — fine immediata', rightEffects: { army: -8, power: +14, people: -10 },
    ...
    },
    {
      ...
      rightText: 'La diplomazia costruisce ciò che il fuoco non può', rightEffects: { power: +12, people: +10, gold: -8 },
      minTurn: 2,
    },
    {
    ...
    },
    {
      ...
      rightText: 'Costruisci il Dragonpit', rightEffects: { gold: -14, army: +8, faith: +8, power: +10 },
      minTurn: 6,
    },
    {
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Proteggere Oldtown e i Hightower', rightEffects: { power: +12, gold: +8, people: -8 },
      minTurn: 1,
    },
    {
    ...
    },
    {
      ...
      rightText: 'Organizza il matrimonio', rightEffects: { power: +14, faith: +8, people: -8 },
      minTurn: 4,
    },
    {
    ...
    },
    {
      ...
      rightText: 'Punta su Aegon II — il vero piano', rightEffects: { power: +12, gold: -8, people: -6 },
      minTurn: 6,
    },
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Con alleanze e oro', rightEffects: { power: +12, gold: -10, people: -5 },
      minTurn: 1,
    },
    {
      ...
      rightText: 'Usa Larys — le informazioni valgono', rightEffects: { power: +14, gold: -8, faith: -6 },
      minTurn: 2,
    },
    {
    ...
    },
    {
      ...
      rightText: 'Incoronalo subito — agisci ora', rightEffects: { power: +14, army: +8, people: -10, faith: -6 },
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Scorticatelo — il terrore è ordine', rightEffects: { power: +14, people: -14, army: +5 },
      minTurn: 1,
    },
    {
      ...
      rightText: 'Il Nord cadrà — il potere vale tutto', rightEffects: { power: +14, army: +8, faith: -14, people: -10 },
    ...
    },
    {
      ...
      rightText: 'Accetta il titolo dalla Corona', rightEffects: { power: +14, gold: +10, army: -8 },
      minTurn: 4,
    },
    ...
    },
    {
      ...
      rightText: 'Spezzalo — diventerà il tuo strumento', rightEffects: { army: +8, power: +12, faith: -10, people: -8 },
      minTurn: 2,
    },
    {
      ...
      rightText: 'Compra la legittimità legale', rightEffects: { gold: -14, power: +12, faith: +6 },
      minTurn: 3,
    },
    {
      ...
      rightText: 'Accetta il nome Bolton', rightEffects: { power: +14, people: +8, gold: +8, army: -5 },
      minTurn: 4,
    },
    {
    ...
    },
    {
      ...
      rightText: 'Usa le informazioni diplomaticamente', rightEffects: { power: +12, people: +6, gold: -4 },
      minTurn: 4,
    },
    ...
    },
    {
      ...
      rightText: 'Cura la malattia a qualunque costo', rightEffects: { gold: -14, faith: +12, army: +5 },
      minTurn: 8,
    },
    ...
    },
    {
      ...
      rightText: 'Sfida il mostro — è il tuo destino', rightEffects: { power: +14, army: +8, faith: +8, people: +6 },
      minTurn: 6, rightTags: ['war_victory'],
    },
    {
    ...
    },
    {
      ...
      rightText: 'Costruisci per i posteri', rightEffects: { power: +12, people: +8, gold: -10 },
      minTurn: 3,
    },
    {
      ...
      rightText: 'La Casa Lannister viene prima dei singoli', rightEffects: { power: +14, gold: +6, people: -10 },
      minTurn: 5,
    },
    {
      ...
      rightText: 'Un Lannister paga i suoi debiti — in sangue', rightEffects: { army: +10, power: +12, faith: -14, people: -10 },
    ...
    },
    {
      ...
      rightText: 'L\'alleanza con Jaime può essere potente', rightEffects: { power: +12, army: +8, faith: +6, gold: -6 },
      minTurn: 4,
    },
    {
    ...
    },
    {
      ...
      rightText: 'Usa il segreto come leva politica ora', rightEffects: { power: +12, gold: +8, faith: -8 },
      minTurn: 10,
    },
    ...
    // ══════════════════════════════════════════
    {
      ...
      leftText: 'L\'eredità è tutto — è legittimità', leftEffects: { power: +12, faith: +6, people: -5 },
    ...
    },
    {
      ...
      rightText: 'Compra grano d\'emergenza', rightEffects: { gold: -14, people: +8 },
      minTurn: 4,
    },
    {
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Compra scorte', rightEffects: { gold: -14, people: +10, faith: +5 },
      minTurn: 5,
    },
    {
    ...
    // ══════════════════════════════════════════
    {
      ...
      leftText: 'Usa la lettera come leva privata', leftEffects: { power: +12, gold: -6 },
    ...
    },
    {
      ...
      rightText: 'Abbraccia la profezia', rightEffects: { faith: -5, power: +12, people: +8 },
    ...
    },
    {
      ...
      rightText: 'Autorizza l\'operazione', rightEffects: { power: +12, army: +5, gold: -8 },
      minTurn: 12,
    },
    {
    ...
    },
    {
      ...
      rightText: 'Usalo come esca', rightEffects: { power: +12, army: -3, gold: -6 },
      minTurn: 10,
    },
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Ingaggia la compagnia', rightEffects: { gold: -14, army: +14 },
      minTurn: 5,
    },
    {
    ...
    // ══════════════════════════════════════════
    {
      ...
      leftText: 'Ricostruisci rapidamente', leftEffects: { gold: -14, army: +5, power: +6, people: +5 },
    ...
    },
    {
      ...
      rightText: 'Acquista l\'uovo', rightEffects: { gold: -14, power: +14, faith: +5 },
      minTurn: 10,
      maxUses: 1,
    },
    {
    ...
    },
    {
      ...
      rightText: 'Invia una delegazione a Essos', rightEffects: { gold: -12, power: +12, army: +5 },
      minTurn: 15,
      maxUses: 1,
    },
    ...
    },
    {
      ...
      rightText: 'Schiaccia subito la ribellione', rightEffects: { army: -10, power: +12, people: -8 },
      minTurn: 2,
      maxUses: 2,
    },
    {
    ...
    },
    {
      ...
      rightText: 'Indici il Grande Torneo', rightEffects: { gold: -14, people: +14, power: +10, faith: +4 },
      minTurn: 6,
      maxUses: 1,
    },
  ...
  function _openKingChallengeDiplomacy() {
    ...
    // Auto-commit home house troops (same logic as _openWarDiplomacy)
    const char = state.character;
    const homeHouses = (char?.startAllies || []).filter(id => {
      const hh = state.houses[id];
      return hh && hh.status === 'ally' && !hh.suppressed && !hh.pactBroken
          && !(state.allyLoanRefusals && state.allyLoanRefusals[id]);
    });
    homeHouses.forEach(id => {
      if (state.allyLoans && state.allyLoans[id]) return;
      const hh = state.houses[id];
      const autoAmount = Math.floor(hh.army * 0.35);
      if (!state.allyLoans) state.allyLoans = {};
      state.allyLoans[id] = { amount: autoAmount, auto: true };
      state.loanedArmy = (state.loanedArmy || 0) + autoAmount;
    });
    ...
    const allyRows = allies.length > 0
      ? allies.map(([id, hh]) => {
          ...
          const isHome       = (char?.startAllies || []).includes(id) && !hh.pactBroken;
          const refusalState = (state.allyLoanRefusals || {})[id];
          if (hasLoan && isHome) {
            return `<div style="display:flex;align-items:center;justify-content:space-between;padding:0.5rem 0.65rem;margin-bottom:0.3rem;background:rgba(201,168,76,0.1);border:1px solid rgba(201,168,76,0.35);border-radius:3px;font-family:'EB Garamond',serif;font-size:0.88rem;color:#c9a84c">
              <span>${hh.icon} Casa ${hh.name} <span style="font-size:0.68rem;font-family:'Cinzel',serif;color:#9a8a6a">— la tua casata</span></span>
              <span style="font-family:'Cinzel',serif;font-size:0.68rem;color:#c9a84c">⚔ +${state.allyLoans[id].amount} (automatici)</span>
            </div>`;
          }
          if (hasLoan) {
          ...
          if (isHome) {
            return `<button onclick="Game.requestAllyArmy('${id}');document.getElementById('war-diplo-reinf-overlay').remove();setTimeout(()=>Game._openKingChallengeDiplomacy(),200)" style="width:100%;display:flex;align-items:center;justify-content:space-between;padding:0.5rem 0.65rem;margin-bottom:0.3rem;background:rgba(201,168,76,0.07);border:1px solid rgba(201,168,76,0.35);border-radius:3px;font-family:'EB Garamond',serif;font-size:0.88rem;color:#e8dcc8;cursor:pointer;text-align:left">
              <span>${hh.icon} Casa ${hh.name} <span style="font-size:0.68rem;font-family:'Cinzel',serif;color:#9a8a6a">— riconquistata</span></span>
              <span style="color:#c9a84c;font-family:'Cinzel',serif;font-size:0.68rem">Chiedi rinforzi →</span>
            </button>`;
          }
  ...
  function _openWarDiplomacy(houseId) {
    ...
    // Auto-commit home house troops if not already done
    // Home houses = char.startAllies that are STILL ally and haven't been betrayed
    const char = state.character;
    const homeHouses = (char?.startAllies || []).filter(id => {
      const hh = state.houses[id];
      return hh && hh.status === 'ally' && !hh.suppressed && !hh.pactBroken
    ...
    homeHouses.forEach(id => {
      if (state.allyLoans && state.allyLoans[id]) return; // already committed
      const hh = state.houses[id];
      const autoAmount = Math.floor(hh.army * 0.35); // 35% auto
      if (!state.allyLoans) state.allyLoans = {};
      state.allyLoans[id] = { amount: autoAmount, auto: true };
      state.loanedArmy = (state.loanedArmy || 0) + autoAmount;
    });
    ...
    const allyRows = allies.length > 0
      ? allies.map(([id, hh]) => {
          ...
          if (hasLoan && isHome) {
            // Home house — always with you, no need to ask
            return `<div style="display:flex;align-items:center;justify-content:space-between;padding:0.5rem 0.65rem;margin-bottom:0.3rem;background:rgba(201,168,76,0.1);border:1px solid rgba(201,168,76,0.35);border-radius:3px;font-family:'EB Garamond',serif;font-size:0.88rem;color:#c9a84c">
              <span>${hh.icon} Casa ${hh.name} <span style="font-size:0.68rem;font-family:'Cinzel',serif;color:#9a8a6a">— la tua casata</span></span>
              <span style="font-family:'Cinzel',serif;font-size:0.68rem;color:#c9a84c">⚔ +${state.allyLoans[id].amount} (automatici)</span>
            </div>`;
          ...
          // Home house that was reconquered after betrayal — ask explicitly
          if (isHome) {
            return `<button onclick="Game.requestAllyArmy('${id}');document.getElementById('war-diplo-reinf-overlay').remove();setTimeout(()=>Game._openWarDiplomacy('${houseId}'),200)" style="width:100%;display:flex;align-items:center;justify-content:space-between;padding:0.5rem 0.65rem;margin-bottom:0.3rem;background:rgba(201,168,76,0.07);border:1px solid rgba(201,168,76,0.35);border-radius:3px;font-family:'EB Garamond',serif;font-size:0.88rem;color:#e8dcc8;cursor:pointer;text-align:left">
              <span>${hh.icon} Casa ${hh.name} <span style="font-size:0.68rem;font-family:'Cinzel',serif;color:#9a8a6a">— riconquistata</span></span>
              <span style="color:#c9a84c;font-family:'Cinzel',serif;font-size:0.68rem">Chiedi rinforzi →</span>
            </button>`;
          }
          return `<button onclick="Game.requestAllyArmy('${id}');document.getElementById('war-diplo-reinf-overlay').remove();setTimeout(()=>Game._openWarDiplomacy('${houseId}'),200)" style="width:100%;display:flex;align-items:center;justify-content:space-between;padding:0.5rem 0.65rem;margin-bottom:0.3rem;background:rgba(74,222,128,0.07);border:1px solid rgba(74,222,128,0.28);border-radius:3px;font-family:'EB Garamond',serif;font-size:0.88rem;color:#e8dcc8;cursor:pointer;text-align:left">
            <span>${hh.icon} Casa ${hh.name} — ⚔ ${Math.round(hh.army)}</span>
            <span style="color:#4ade80;font-family:'Cinzel',serif;font-size:0.68nm">Chiedi rinforzi →</span>
          </button>`;
        }).join('')
      : `<p style="font-family:'EB Garamond',serif;font-size:0.88rem;color:#6b5e4a;font-style:italic;margin:0">Nessuna casata alleata disponibile.</p>`;
  ...
  function showPreBattleOverlay(houseId, playerInitiated = true) {
    ...
    // Ally contributions (loaned troops)
    const allyContribs = Object.entries(state.allyLoans || {})
      .map(([id, loan]) => {
        const ah = state.houses[id];
        return ah ? `<div style="font-size:0.78rem;color:#4ade80;font-family:'EB Garamond',serif">${ah.icon} Casa ${ah.name} <strong>+${loan.amount}⚔</strong></div>` : '';
      }).join('');
    ...
    overlay.innerHTML = `
      <div style="width:92%;max-width:460px;padding:1.75rem;background:#0d0208;border:1px solid rgba(201,168,76,0.4);border-radius:6px;">
        ...
        <div style="background:rgba(74,222,128,0.06);border:1px solid rgba(74,222,128,0.2);border-radius:4px;padding:0.6rem 0.75rem;margin-bottom:0.75rem">
          <div style="font-size:0.65rem;color:#4ade80;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:0.35rem">🤝 Rinforzi alleati</div>
          ${allyContribs}
        </div>` : ''}
