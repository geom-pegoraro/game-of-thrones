...
const Game = (() => {
  ...
  const CHARACTERS = [
    ...
    },
    {
      ...
      icon: '🔥', emoji: '🌹',
      difficulty: 'hard',
      startResources: { gold: 22, faith: 78, people: 28, army: 22, power: 45 },
  ...
  function updateHUD() {
    ...
    if (garrisonCount > 0) {
      ...
      if (!capBadge) {
        ...
        // Inserisci sotto la barra obiettivo, non flottante
      ...
      capBadge.textContent = `🏰 ${garrisonCount===1?'1 territorio':'${garrisonCount} territori'}: ${garrisonNames} · -${totalCost}💰 ogni 5 turni`;
    } else if (capBadgeEl) {
      capBadgeEl.remove();
    }
  }
