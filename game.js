...
const Game = (() => {
  ...
  const CHARACTERS = [
    ...
    },
    {
      ...
      objective: 'Guardiano del Nord: conquista Casa Stark, mantieni Esercito >60 e Potere >60 fino al turno 50.',
      objectiveCheck: (s) => s.turn >= 50 && s.houses['Stark']?.status === 'suppressed' && s.resources.army > 60 && s.resources.power > 60,
    ...
    },
    {
      ...
      objective: 'Il Bastardo Spietato: vinci 3 guerre e mantieni il Popolo sopra 0 — la gente ti odia ma teme.',
      objectiveCheck: (s) => s.decisionHistory.filter(d => d.tags?.includes('war_victory')).length >= 3 && s.resources.people > 0,
    ...
    },
    {
      ...
      objective: 'Signore di Castel Granito: mantieni il dominio Lannister — Tesoro >70, Potere >70 e nessun alleato tradito, al turno 55.',
      objectiveCheck: (s) => s.turn >= 55 && s.resources.gold > 70 && s.resources.power > 70 && !s.decisionHistory.some(d => d.tags?.includes('betray_ally')),
      startAllies: ['Lannister'], startEnemies: ['Stark', 'Baratheon'],
  ...
  function tickHouseArmies() {
    ...
    const BASE_ARMIES = { Stark: 105, Lannister: 125, Tyrell: 110, Baratheon: 95, Tully: 85, Martell: 90, Greyjoy: 92, Frey: 75 };
