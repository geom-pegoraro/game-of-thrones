...
const Game = (() => {
  ...
  function _showHouseSelect() {
    ...
    const HOUSE_GROUPS = [
      ...
      { id: 'Lannister', name: 'Casa Lannister',   icon: '🦁', region: 'Castel Granito',        chars: ['cersei','tyrion','jaime'],               color: 'rgba(201,168,76,0.12)',  border: 'rgba(201,168,76,0.45)' },
      ...
      { id: 'Baratheon', name: 'Casa Baratheon',   icon: '🦌', region: 'Capo della Tempesta',   chars: ['stannis','melisandre'],                 color: 'rgba(251,191,36,0.12)',  border: 'rgba(251,191,36,0.4)'  },
      ...
      { id: 'None',      name: 'Senza Casa',       icon: '🪙', region: 'Westeros',              chars: ['littlefinger','bronn','tormund'],        color: 'rgba(120,120,120,0.1)',  border: 'rgba(120,120,120,0.35)'},
    ];

    // Custom character option
    const customWrapper = document.createElement('div');
    customWrapper.style.cssText = 'width:100%;padding:0 0.5rem;margin-bottom:0.5rem;box-sizing:border-box;';
    customWrapper.innerHTML = `
      <button onclick="Game.showCustomCharScreen()" style="width:100%;padding:0.7rem 1rem;background:rgba(192,132,252,0.1);border:1px solid rgba(192,132,252,0.4);border-radius:4px;font-family:'Cinzel',serif;font-size:0.78rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;cursor:pointer;color:#c084fc;transition:all 0.2s">
        ⚜ Crea il Tuo Destino — Personaggio Personalizzato
      </button>`;
