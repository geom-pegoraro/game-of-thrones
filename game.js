...
const Game = (() => {
  ...
  function showStrategicBattle(playerForce, enemyForce, enemyLabel, onComplete, allowRetreat) {
    ...
    const HOUSE_ROSTERS = {
      Stark:      ['guardie_stark', 'guardie_stark', 'milizia'],          // uomini del nord, fedeli
      Lannister:  ['cavalieri_lann', 'cavalieri_lann', 'compagnia_dorata'], // oro = truppe d'elite
      Tyrell:     ['arcieri_tyrell', 'arcieri_tyrell', 'milizia'],         // arcieri di Altogarden
      Baratheon:  ['cavalieri_bar', 'cavalieri_bar', 'guardie_stark'],     // cavalieri pesanti
      Tully:      ['lancieri_tully', 'milizia', 'lancieri_tully'],         // difensori dei fiumi
      Martell:    ['serpi_martell', 'serpi_martell', 'dothraki'],          // veloci e letali
      Greyjoy:    ['saccheggiatori', 'saccheggiatori', 'milizia'],         // predatori del mare
      Frey:       ['soldati_frey', 'milizia', 'soldati_frey'],             // truppe mediocri
      Bolton:     ['sguernitori', 'sguernitori', 'milizia'],               // spietati
      Targaryen:  ['immacolati', 'dothraki', 'immacolati'],                // eserciti di Essos
      Hightower:  ['cavalieri_lann', 'milizia', 'lancieri_tully'],         // guardie di Oldtown
      _king:      ['guardie_re', 'guardie_re', 'cavalieri_lann'],          // guardia reale d'elite
    };
    ...
    function drawUnit(u) {
      ...
      } else if(tt==='immacolati'||tt==='guardie_re'||tt==='cavalieri_lann'||tt==='compagnia_dorata') {
      ...
      } else if(tt==='dothraki'||tt==='saccheggiatori'||tt==='serpi_martell'||tt==='sguernitori') {
  ...
  function _buildCharGrid() {
    // Usa il sistema a due livelli (Casate → Personaggi) come showCharacterSelect
    _showHouseSelect();
  }
...
window.addEventListener('load', () => {
  ...
  // Changelog popup check — usa la versione corrente
  const seen = localStorage.getItem('ia_version_seen');
  if (seen !== '3.0.0') {
