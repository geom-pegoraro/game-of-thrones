...
const Game = (() => {
  ...
  function showPreBattleOverlay(houseId) {
    const h = state.houses[houseId];
    if (!h) return;
    ...
    overlay.innerHTML = `
      <div style="width:92%;max-width:460px;padding:1.75rem;background:#0d0208;border:1px solid rgba(201,168,76,0.4);border-radius:6px;">
        ...
        <div style="display:flex;gap:0.75rem;margin-top:0.5rem">
          <button onclick="document.getElementById('pre-battle-overlay').remove();Game._startHouseBattleFromOverlay('${houseId}')"
          ...
          <button onclick="document.getElementById('pre-battle-overlay').remove();Game._cancelFromPreBattle('${houseId}')"
        ...
        <div style="text-align:center;margin-top:0.5rem;font-family:'EB Garamond',serif;font-size:0.75rem;color:#6b5e4a;font-style:italic">
  ...
  return {
    ...
    _startHouseBattleFromOverlay: (houseId) => triggerHouseBattle(houseId, true),
