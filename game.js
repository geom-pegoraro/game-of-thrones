...
const Game = (() => {
  ...
  const CHARACTERS = [
    ...
    },
    {
      ...
      objective: '🐉 Il Re mendicante — 3 alleanze senza perdere mai l\'esercito',
      objectiveFull: 'Viserys ha venduto tutto per riacquistare il trono. Ma il drago non si compra: si guadagna. Costruisci 3 alleanze senza mai rimanere senza esercito.',
      objectiveCheck: (s) => countAllies(s) >= 3 && !s.decisionHistory.some(d => d.tags?.includes('army_zero')),
...
const LOCKED_CHARS = {
  ...
  'aegon_t':      { unlockBy: ['daenerys','viserys','rhaenyra'],
