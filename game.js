...
const Game = (() => {
  ...
  // ══════════════════════════════════════════════
  // TROOP TYPES — sistema esercito attivo
  // Ogni tipo ha: id, nome, icona, costo reclutamento,
  // costo mantenimento ogni 5 turni, forza per unità,
  // restrizioni personaggio, descrizione
  // ══════════════════════════════════════════════
  const TROOP_TYPES = [
    {
      id: 'milizia',
      name: 'Milizia',
      icon: '🪓',
      role: 'Fanteria leggera',
      desc: 'Contadini armati. Numerosi ma fragili.',
      lore: 'Chi non ha nulla da perdere combatte con la disperazione di chi ha tutto da guadagnare. La milizia è il cuore pulsante di ogni esercito — povera, fedele, sacrificabile.',
      cost: { army: 5 },
      upkeep: {},
      force: 4,
      hpMult: 0.7,
      ...
      unitIcon: '🪓',
      passives: [
        { icon: '⚔', name: 'Riserva Militare', desc: 'Costa Esercito per reclutare — attingi dalla tua riserva militare. Nessun costo di mantenimento.' },
        { icon: '🔢', name: 'Numero', desc: 'Puoi arruolarne fino a 8 unità — la più alta capienza del roster.' },
      ],
    },
    {
      id: 'sellaspe',
      ...
      icon: '⚔️',
      role: 'Mercenari',
      desc: 'Mercenari esperti. Costosi ma affidabili.',
      lore: 'Nelle Città Libere, le spade si comprano e si vendono come seta. I Sellaspe non giurano fedeltà — giurano al contratto. Finché l\'oro scorre, combattono.',
      cost: { gold: 10 },
      upkeep: { gold: 2 },
      force: 9,
      hpMult: 1.1,
      ...
      unitIcon: '⚔️',
      passives: [
        { icon: '🗡️', name: 'Infiltrazione', desc: 'All\'inizio della battaglia vengono posizionati in fondo alla metà nemica — attaccano di sorpresa alle spalle e infliggono danno x1.5 per i primi 3 attacchi.' },
        { icon: '💀', name: 'Fragili sotto fuoco', desc: 'Meno HP della media (0.85×) — la velocità è la loro armatura.' },
      ],
      battlePassive: 'infiltrato',   // spawn dietro le linee nemiche
    },
    {
      id: 'dothraki',
      name: 'Dothraki',
      icon: '🐴',
      role: 'Cavalleria leggera',
      desc: 'Cavalieri feroci di Essos. Devastanti in campo aperto.',
      lore: 'Il Dothraki non conosce muri né fortezze. Conosce la pianura, il vento e il grido di guerra. Un khalesar in carica è come un\'onda che rompe su tutto ciò che trova.',
      cost: { gold: 6, army: 4 },
      upkeep: { gold: 1 },
      force: 12,
      hpMult: 0.85,
      ...
      battleColor: '#fb923c',
      unitIcon: '🐴',
      allowedChars: ['daenerys','daemon','rhaenyra','aegon_t','jorah','theon','oberyn'],
      passives: [
        { icon: '⚡', name: 'Cavalcata', desc: 'Velocità di movimento 1.6× — i più veloci sul campo. Raggiungono il nemico prima di tutti.' },
        { icon: '🔱', name: 'Carica', desc: 'Danno x1.4 — il primo impatto è devastante.' },
        { icon: '🏹', name: 'Vulnerabili ai proiettili', desc: 'Meno HP (0.85×) — l\'armatura non è la loro forza.' },
      ],
    },
    {
      id: 'immacolati',
      name: 'Immacolati',
      icon: '🛡️',
      role: 'Fanteria d\'élite',
      desc: 'Guerrieri disciplinati e incorruttibili. I migliori fanti del mondo conosciuto.',
      lore: 'Addestrati fin da bambini a non sentire dolore, paura, o desiderio. Gli Immacolati non fuggono. Non cedono. Non tradiscono. Sono la perfezione militare resa carne.',
      cost: { gold: 12 },
      upkeep: { gold: 2 },
      force: 14,
      hpMult: 1.3,
      ...
      battleColor: '#60a5fa',
      unitIcon: '🛡️',
      allowedChars: ['daenerys','rhaenyra','daemon','aegon_t'],
      passives: [
        { icon: '🛡️', name: 'Disciplina di Ferro', desc: 'HP 1.3× — resistono molto più a lungo degli altri fanti.' },
        { icon: '🔒', name: 'Formazione', desc: 'Non si disperdono mai — tengono la posizione assegnata più a lungo durante il posizionamento.' },
        { icon: '🚫', name: 'Incorruttibili', desc: 'Immuni al tradimento alleato. Non possono essere "acquistati" dal nemico tramite carte evento.' },
      ],
    },
    {
      id: 'compagnia_dorata',
      name: 'Compagnia Dorata',
      icon: '💰',
      role: 'Mercenari d\'élite',
      desc: 'La più temuta compagnia di mercenari di Essos. Non tradiscono mai un contratto.',
      lore: 'Fondata da esuli Targaryen, la Compagnia Dorata non ha mai rotto un contratto. Diecimila spadaccini, cavalli bardati d\'oro, e una storia lunga un secolo di vittorie. Il loro prezzo è astronomico. Il loro valore, incalcolabile.',
      cost: { gold: 16 },
      upkeep: { gold: 3 },
      force: 18,
      hpMult: 1.5,
      ...
      battleColor: '#fde047',
      unitIcon: '💰',
      allowedChars: ['cersei','tywin','littlefinger','bronn','sandor','aegon_t','daemon'],
      passives: [
        { icon: '👑', name: 'Élite', desc: 'HP 1.5× e danno 1.3× — le unità più potenti del roster.' },
        { icon: '🗡️', name: 'Infiltrazione avanzata', desc: 'Come i Sellaspe, si posizionano tra le linee nemiche — ma con danno iniziale x2.0 per i primi 2 attacchi.' },
        { icon: '💰', name: 'Contratto d\'Oro', desc: 'Non tradiscono mai — immuni alla meccanica di diserzione per mancato mantenimento (per un ciclo).' },
      ],
      battlePassive: 'infiltrato_elite',
    },
    {
      id: 'drago',
      name: 'Drago',
      icon: '🐉',
      role: '★ Creatura Leggendaria',
      desc: 'Una creatura leggendaria. In battaglia scatena fuoco su tutti i nemici.',
      lore: 'Il fuoco e il sangue non sono solo parole di casa Targaryen. Sono la realtà di una creatura che non conosce pietà né paura. Un drago in battaglia non combatte — giudica.',
      cost: {},
      upkeep: { gold: 4, faith: 2 },
      force: 30,
      hpMult: 3.0,
      maxUnits: 1,
      battleColor: '#f87171',
      ...
      onlyFromCard: true,
      passives: [
        { icon: '🔥', name: 'Fuoco del Drago', desc: 'Una volta per battaglia: abilità speciale AOE che colpisce fino a 4 nemici per l\'80% dei loro HP.' },
        { icon: '😱', name: 'Terrore', desc: 'La sola presenza del drago riduce la velocità di attacco nemica del 20% per i primi 10 secondi.' },
        { icon: '💪', name: 'Corazza di Scaglie', desc: 'HP 3.0× — estremamente resistente in battaglia.' },
      ],
    },
  ];

  // Restituisce la forza totale dell'esercito del giocatore
  // (usata al posto di state.resources.army nei calcoli di battaglia)
  function getTroopForce() {
    const troops = state.troops || {};
    let force = 0;
    TROOP_TYPES.forEach(t => {
      force += (troops[t.id] || 0) * t.force;
    });
    // Se non ha truppe reclutate, usa army come milizia di default
    if (force === 0) force = state.resources.army;
    return Math.round(force);
  }

  // Restituisce il costo upkeep totale ogni 5 turni
  function getTroopUpkeep() {
    const troops = state.troops || {};
    const upkeep = { gold: 0, faith: 0, people: 0 };
    TROOP_TYPES.forEach(t => {
      const count = troops[t.id] || 0;
      if (count > 0 && t.upkeep) {
        Object.entries(t.upkeep).forEach(([res, val]) => {
          upkeep[res] = (upkeep[res] || 0) + val * count;
        });
      }
    });
    return upkeep;
  ...
  let state = {
    ...
    troops: {},          // { milizia: 2, sellaspe: 1, ... } — esercito attivo
  ...
  const CHARACTERS = [
    {
      ...
      objective: '🐉 Spezza le catene — conquista il Trono di Spade',
      objectiveFull: 'Il sangue del drago non supplica — conquista. Sconfiggi il Re Reggente e siedi sul Trono di Spade. Solo allora i draghi avranno una casa.',
      objectiveCheck: (s) => s.king === 'daenerys',
      throneObjective: true,
      secondaryObjective: '👑 Unisci i Sette Regni: ottieni la fedeltà di tutte le casate',
    ...
    {
      id: 'daemon', name: 'Daemon Targaryen', house: 'Casa Targaryen',
      icon: '🐉', emoji: '⚔️',
      difficulty: 'hard',
      startResources: { gold: 48, faith: 22, people: 35, army: 62, power: 52 },
      objective: '🐉 Il Drago Rinnegato — conquista il Trono di Spade',
      objectiveFull: "Daemon Targaryen non si è mai inginocchiato davanti a nessuno — nemmeno a suo fratello. Ora è il momento di prendere ciò che è sempre stato suo per diritto di sangue e di spada. Conquista il Trono.",
      objectiveCheck: (s) => s.king === 'daemon',
      throneObjective: true,
      secondaryObjective: '🐉 Sangue e fuoco: unifica i Sette Regni con ferro e drago',
      startAllies: ['Targaryen'], startEnemies: ['Hightower', 'Lannister'],
      flavor: 'Ho combattuto, ho ucciso, ho vissuto. Ora voglio il trono.',
      houseBonus: { res: [['army',3],['power',1]], label: '🐉 Furia del Drago Rinnegato: +3 Esercito +1 Potere ogni 5 turni' },
    },
    {
      ...
      objective: '🐉 L\'erede legittima — conquista il Trono che ti spetta',
      objectiveFull: 'Tuo padre ti ha designata erede davanti a tutti i Lord di Westeros. Il trono non si chiede: si prende. Sconfiggi il Re e siediti dove è tuo diritto.',
      objectiveCheck: (s) => s.king === 'rhaenyra',
      throneObjective: true,
      secondaryObjective: '👑 Legittima il tuo regno: fai giurare fedeltà a tutte le casate',
      startAllies: ['Targaryen'], startEnemies: ['Lannister'],
    ...
    },
    {
      ...
      objective: '🐉 La Conquista — conquista 3 casate o ottieni 5 alleanze',
      objectiveFull: 'Aegon non ha chiesto permesso ai re di Westeros: li ha bruciati o piegati. Conquista almeno 3 casate o portale tutte all\'alleanza. I Sette Regni devono diventare Uno.',
      objectiveCheck: (s) => Object.values(s.houses).filter(h => h.suppressed).length >= 3 || countAllies(s) >= 5,
    ...
    },
    {
      ...
      objective: '🐺 Per il regno — conquista il Trono di Spade',
      objectiveFull: 'Jon non vuole il trono — ma qualcuno deve prenderlo. Sconfiggi il Re Reggente e governa con onore. Il Nord non dimentica chi lo protegge.',
      objectiveCheck: (s) => s.king === 'jon',
      throneObjective: true,
      secondaryObjective: '🐺 Per il Nord: fa\' giurare fedeltà a Stark, Tully e altre 3 casate',
    ...
    },
    {
      ...
      objective: '🦁 Il trono per i miei figli — conquista il Trono di Spade',
      objectiveFull: 'Cersei non ha mai voluto il potere per sé: lo ha voluto per i suoi figli. Ma ora è sola. Conquista il trono e tienilo. Lannister paga sempre i suoi debiti.',
      objectiveCheck: (s) => s.king === 'cersei',
      throneObjective: true,
      secondaryObjective: '🦁 Nessuno tradisce un Lannister: unifica senza mai perdere un alleato',
    ...
    },
    {
      ...
      objective: '🍷 La mente batte la spada — 4 alleanze senza mai vincere una guerra',
      objectiveFull: 'Tyrion non combatte con le spade: combatte con le parole, l\'oro e la diplomazia. Costruisci 4 alleanze senza mai aver schierato truppe in guerra. La penna è più affilata della spada.',
      objectiveCheck: (s) => countAllies(s) >= 4 && !s.decisionHistory.some(d => d.tags?.includes('war_victory')),
    ...
    },
    {
      ...
      objective: '🐺 Lady di Grande Inverno — ottieni 3 alleanze senza mai tradire',
      objectiveFull: 'Sansa ha imparato dai migliori — e dai peggiori. Costruisci 3 alleanze mantenendo la lealtà di Stark e Tully. Il Nord non scorda i tradimenti.',
      objectiveCheck: (s) => s.houses['Stark']?.status === 'ally' && s.houses['Tully']?.status === 'ally' && countAllies(s) >= 3 && !s.decisionHistory.some(d => d.tags?.includes('betray_ally')),
      startAllies: ['Stark'], startEnemies: [],
    ...
    },
    {
      ...
      icon: '🗡️', emoji: '🐺',
      difficulty: 'hard',
      startResources: { gold: 30, faith: 22, people: 42, army: 36, power: 28 },
      objective: '🗡 La Lista — depenna 3 nomi dalla lista di Arya',
      objectiveFull: 'Un ragazzo non ha nome. Ma ha una lista. Ogni nome sulla lista è un debito di sangue. Depennane almeno tre.',
    ...
    },
    {
      ...
      objective: '🦌 Il diritto è il diritto — conquista il Trono di Spade',
      objectiveFull: 'Stannis non desidera il trono: è suo per diritto di successione. Non è ambizione — è la legge. Spodesta il Re e prendi ciò che ti spetta.',
      objectiveCheck: (s) => s.king === 'stannis',
      throneObjective: true,
      secondaryObjective: '🦌 La legge si applica a tutti: fa\' giurare fedeltà a ogni casata',
    ...
    },
    {
      ...
      objective: '🐺 Re del Nord — mantieni Stark+Tully alleati e vinci una guerra',
      objectiveFull: 'Il Re del Nord non è mai stato sconfitto in campo aperto. Mantieni il blocco Nord-Fiume unito, vinci almeno una guerra e mostra ai Sette Regni che il Nord non si piega.',
      objectiveCheck: (s) => s.houses['Stark']?.status === 'ally' && s.houses['Tully']?.status === 'ally' && s.decisionHistory.some(d => d.tags?.includes('war_victory')) && !s.decisionHistory.some(d => d.tags?.includes('betray_ally')),
      startAllies: ['Stark'], startEnemies: ['Lannister'],
      flavor: "Il Nord ricorda. E il Nord non perdona.",
      houseBonus: { res: [['faith',2],['people',2]], label: '🐺 Onore del Nord: +2 Fede +2 Popolo ogni 5 turni' },
    },
    {
      ...
      icon: '⚔️', emoji: '🦁',
      difficulty: 'medium',
      startResources: { gold: 58, faith: 22, people: 30, army: 55, power: 45 },
      objective: '⚔ Riscatta l\'onore — vinci 2 guerre senza mai tradire',
      objectiveFull: 'Il Sterminatore dei Re. L\'epiteto che lo perseguita. Jaime vuole ridefinire quel nome. Vinci due guerre con onore, senza mai tradire chi ti fida.',
      objectiveCheck: (s) => s.decisionHistory.filter(d => d.tags?.includes('war_victory')).length >= 2 && !s.decisionHistory.some(d => d.tags?.includes('betray_ally')),
      startAllies: ['Lannister'], startEnemies: ['Stark', 'Baratheon'],
      flavor: "Tutti mi chiamano Sterminatore di Re. Nessuno chiede perché.",
      houseBonus: { res: [['gold',3]], label: '🦁 Ricchezza Lannister: +3 Oro ogni 5 turni' },
    },
    {
      ...
      icon: '🌹', emoji: '👸',
      difficulty: 'easy',
      startResources: { gold: 62, faith: 48, people: 68, army: 35, power: 48 },
      objective: '🌹 La Rosa del potere — sposa il Re e ottieni 3 alleanze',
      objectiveFull: 'Margaery non vuole essere una regina: vuole essere la regina. Usa il matrimonio reale come strumento e costruisci una rete di alleanze solide.',
      objectiveCheck: (s) => s.decisionHistory.some(d => d.tags?.includes('royal_marriage')) && countAllies(s) >= 3,
      startAllies: ['Tyrell'], startEnemies: [],
      flavor: "Voglio essere LA regina. Non una regina.",
    ...
    },
    {
      ...
      icon: '🐙', emoji: '⚓',
      difficulty: 'medium',
      startResources: { gold: 42, faith: 25, people: 38, army: 48, power: 35 },
      objective: '🐙 Riconquista il nome — vinci una guerra e ottieni 2 alleanze',
      objectiveFull: 'Theon Greyjoy. Non Reek. Ha tradito il Nord ma il tradimento si può espiare. Vinci una guerra e trova almeno 2 alleati che credano nel nome Greyjoy.',
      objectiveCheck: (s) => s.decisionHistory.some(d => d.tags?.includes('war_victory')) && countAllies(s) >= 2,
      startAllies: ['Greyjoy'], startEnemies: ['Stark'],
      flavor: "Sono Theon Greyjoy. Non Reek. Theon Greyjoy.",
    ...
    },
    {
      ...
      icon: '🪙', emoji: '🕷',
      difficulty: 'hard',
      startResources: { gold: 72, faith: 20, people: 35, army: 18, power: 58 },
      objective: '🪙 Il caos è una scala — conquista il Trono di Spade',
      objectiveFull: 'Ditocorto ha costruito la sua fortuna sul caos altrui. Ora vuole il premio finale: non con le spade, ma con l\'oro, le bugie e la giusta alleanza al momento giusto.',
      objectiveCheck: (s) => s.king === 'littlefinger',
      throneObjective: true,
      secondaryObjective: '🪙 Il grande gioco: controlla tutte le casate tramite alleanze o conquista',
      startAllies: [], startEnemies: ['Stark'],
      flavor: "Il caos non è un abisso. Il caos è una scala.",
      houseBonus: { res: [['gold',2],['power',2]], label: '🪙 Reti di Ditocorto: +2 Oro +2 Potere ogni 5 turni' },
    },
    {
      id: 'melisandre', name: 'Melisandre', house: "R'hllor",
      icon: '🔥', emoji: '🌹',
      difficulty: 'hard',
      startResources: { gold: 28, faith: 78, people: 28, army: 30, power: 45 },
      objective: '🔥 Il Principe Promesso — mantieni la Fede alta per 15 turni',
      objectiveFull: 'Melisandre serve R\'hllor, non gli uomini. Il Signore della Luce ha mostrato nelle fiamme il volto del Principe Promesso. Mantieni la Fede sopra 75 per 15 turni consecutivi.',
      objectiveCheck: (s) => (s.faithHighTurns || 0) >= 15,
      startAllies: [], startEnemies: [],
      flavor: "Il Signore della Luce ha molti strumenti. Io sono uno di essi.",
      houseBonus: { res: [['faith',4]], label: '🔥 Fiamma di R\'hllor: +4 Fede ogni 5 turni' },
    },
    {
      id: 'oberyn', name: 'Oberyn Martell', house: 'Casa Martell',
      icon: '☀️', emoji: '🐍',
      difficulty: 'medium',
      startResources: { gold: 52, faith: 38, people: 48, army: 50, power: 42 },
      objective: '☀️ La vendetta di Dorne — vinci una guerra contro i Lannister',
      objectiveFull: 'La Montagna ha ucciso Elia Martell e i suoi figli. Oberyn non dimentica, non perdona. Sconfiggi i Lannister in battaglia: quella è la giustizia di Dorne.',
      objectiveCheck: (s) => s.decisionHistory.some(d => d.tags?.includes('war_victory') && d.target === 'Lannister'),
      startAllies: ['Martell'], startEnemies: ['Lannister'],
      flavor: "Dorne non dimentica. Dorne non perdona.",
    ...
    },
    {
      ...
      icon: '🐺', emoji: '⚖️',
      difficulty: 'medium',
      startResources: { gold: 38, faith: 65, people: 68, army: 45, power: 38 },
      objective: '🐺 L\'onore del Nord — 3 alleanze senza tradire né usare veleno',
      objectiveFull: 'Ned Stark non sa mentire. Costruisci 3 alleanze rimanendo onesto: niente tradimenti, niente avvelenamenti, niente assassini. Solo parola data e mantenuta.',
      objectiveCheck: (s) => countAllies(s) >= 3 && !s.decisionHistory.some(d => d.tags?.includes('betray_ally')) && !s.decisionHistory.some(d => d.tags?.includes('poison_intrigue')),
      startAllies: ['Stark'], startEnemies: [],
      flavor: "L'onore è tutto ciò che rimane quando si è perso tutto il resto.",
      houseBonus: { res: [['faith',2],['people',2]], label: '🐺 Onore del Nord: +2 Fede +2 Popolo ogni 5 turni' },
    },
    {
      ...
      icon: '🐟', emoji: '👩',
      difficulty: 'medium',
      startResources: { gold: 42, faith: 58, people: 62, army: 35, power: 38 },
      objective: '🐟 Per la famiglia — mantieni Stark e Tully alleati con 3 alleanze totali',
      objectiveFull: 'Catelyn ha sacrificato tutto per i figli. Il sangue di Tully scorre nelle vene degli Stark — e quella lealtà deve reggere. Mantieni entrambe le casate alleate e non tradire mai nessuno.',
      objectiveCheck: (s) => s.houses['Stark']?.status === 'ally' && s.houses['Tully']?.status === 'ally' && !s.decisionHistory.some(d => d.tags?.includes('betray_ally')) && countAllies(s) >= 3,
      startAllies: ['Tully', 'Stark'], startEnemies: [],
      flavor: "I Tully e gli Stark sono uno. Non spezzare ciò che il sangue ha unito.",
    ...
    },
    {
      ...
      icon: '🗡️', emoji: '😏',
      difficulty: 'hard',
      startResources: { gold: 55, faith: 15, people: 35, army: 50, power: 30 },
      objective: '🗡 Il prezzo giusto — vinci 2 guerre senza alleati formali',
      objectiveFull: 'Bronn non ha lealtà: ha prezzi. Vinci due guerre senza l\'aiuto di nessun alleato formale. Solo tu, la tua spada e il tuo istinto di sopravvivenza.',
      objectiveCheck: (s) => s.decisionHistory.filter(d => d.tags?.includes('war_victory')).length >= 2 && countAllies(s) === 0,
      startAllies: [], startEnemies: [],
      flavor: "Non ho mai avuto un castello. Ma sono ancora vivo.",
      houseBonus: { res: [['gold',2],['army',2]], label: '🗡 Mercenario: +2 Oro +2 Esercito ogni 5 turni' },
    },
    {
      id: 'tormund', name: 'Tormund Giantsbane', house: 'Popolo Libero',
      icon: '🪓', emoji: '❄️',
      difficulty: 'hard',
      startResources: { gold: 18, faith: 28, people: 55, army: 48, power: 22 },
      objective: '🪓 Il Popolo Libero — sopravvivi 45 turni con 3 alleanze senza tradire',
      objectiveFull: 'Tormund non sa cosa sia un re. Il Popolo Libero sopravvive oltre il Muro senza chiedere permesso. Costruisci 3 alleanze restando fedele a chi sei.',
      objectiveCheck: (s) => s.turn >= 45 && countAllies(s) >= 3 && !s.decisionHistory.some(d => d.tags?.includes('betray_ally')),
      startAllies: [], startEnemies: ['Lannister', 'Baratheon'],
      flavor: "Beviamo, combattiamo, e non ci inginocchiamo davanti a nessuno.",
      houseBonus: { res: [['army',3]], label: '🪓 Furia del Nord: +3 Esercito ogni 5 turni' },
    },
    {
      id: 'olenna', name: 'Olenna Tyrell', house: 'Casa Tyrell',
      icon: '🌹', emoji: '👵',
      difficulty: 'hard',
      startResources: { gold: 68, faith: 42, people: 55, army: 38, power: 60 },
      objective: '🌹 La Regina delle Spine — 2 avvelenamenti e 3 alleanze',
      objectiveFull: 'Olenna non usa spade: usa il veleno e le parole. Ha eliminato Joffrey con un sorriso. Usa almeno 2 intrighi di veleno e mantieni 3 alleanze.',
      objectiveCheck: (s) => s.decisionHistory.filter(d => d.tags?.includes('poison_intrigue')).length >= 2 && countAllies(s) >= 3,
      startAllies: ['Tyrell'], startEnemies: ['Lannister'],
      flavor: "Sono stata una donna vivace. Ora sono una vecchia pericolosa.",
      houseBonus: { res: [['people',2],['gold',1]], label: '🌹 Prosperità Tyrell: +2 Popolo +1 Oro ogni 5 turni' },
    },
    {
      ...
      objective: '🩸 Guardiano del Nord — conquista Casa Stark e 2 alleanze',
      objectiveFull: 'Roose Bolton ha tradito Robb Stark al Castello Gemelli. Ora vuole il controllo del Nord. Sopprimi Casa Stark e costruisci 2 alleanze.',
      objectiveCheck: (s) => s.houses['Stark']?.status === 'suppressed' && countAllies(s) >= 2,
    ...
    },
    {
      ...
      objective: '😈 Il Bastardo — conquista il Trono di Spade',
      objectiveFull: 'Ramsay non è mai abbastanza: non abbastanza nobile, non abbastanza rispettato. Il trono sarebbe la prova definitiva. Conquista ciò che nessuno crede possa raggiungere.',
      objectiveCheck: (s) => s.king === 'ramsay',
      throneObjective: true,
      secondaryObjective: '😈 Il terrore si diffonde: nessuna casata deve essere alleata, solo temuta',
    ...
    },
    {
      ...
      objective: '🏹 Figlia del Vento — sopravvivi 40 turni senza allearti con Lannister o Baratheon',
      objectiveFull: 'Ygritte è cresciuta oltre il Muro — libera. Sopravvivi 40 turni restando te stessa: mai piegarti ai nemici naturali del Popolo Libero.',
      objectiveCheck: (s) => s.turn >= 40 && s.houses['Lannister']?.status !== 'ally' && s.houses['Baratheon']?.status !== 'ally' && !s.decisionHistory.some(d => d.tags?.includes('betray_ally')),
    ...
    },
    {
      ...
      objective: '🐻 Riscatta l\'onore — 3 alleanze, 1 vittoria in guerra, mai tradire',
      objectiveFull: 'Jorah è stato esiliato per aver venduto uomini come schiavi. Costruisci 3 alleanze onorevolmente, vinci una guerra e non tradire mai. L\'onore si guadagna ogni giorno.',
      objectiveCheck: (s) => countAllies(s) >= 3 && !s.decisionHistory.some(d => d.tags?.includes('betray_ally')) && s.decisionHistory.some(d => d.tags?.includes('war_victory')),
      startAllies: [], startEnemies: [],
    ...
    },
    {
      ...
      objective: '🐕 Sopravvivi da solo — arriva al turno 50 con massimo 1 alleanza',
      objectiveFull: 'Il Mastino non si fida di nessuno. Sopravvivi 50 turni senza dipendere dagli altri. Al massimo un alleato: il Mastino non ha bisogno di branco.',
      objectiveCheck: (s) => s.turn >= 50 && countAllies(s) <= 1,
      startAllies: [], startEnemies: [],
    ...
    },
    {
      ...
      objective: '🦁 L\'eredità Lannister — conquista il Trono di Spade',
      objectiveFull: 'Tywin non vuole il trono per sé: lo vuole per il cognome Lannister. Il nome deve durare mille anni. Conquista il trono e dimostra che i Lannister sono la forza più grande di Westeros.',
      objectiveCheck: (s) => s.king === 'tywin',
      throneObjective: true,
      secondaryObjective: '🦁 L\'eredità dura mille anni: unifica tutte le casate sotto il Leone',
      startAllies: ['Lannister'], startEnemies: ['Stark', 'Baratheon'],
    ...
    },
    {
      ...
      objective: '🛡 Giuramento sacro — 2 alleanze senza mai tradire, con matrimonio reale',
      objectiveFull: 'Brienne ha giurato di proteggere la famiglia Stark. Il giuramento è tutto. Ottieni 2 alleanze, usa il matrimonio come strumento politico, e non tradire mai nessuno.',
      objectiveCheck: (s) => countAllies(s) >= 2 && !s.decisionHistory.some(d => d.tags?.includes('betray_ally')) && s.decisionHistory.some(d => d.tags?.includes('royal_marriage')),
      startAllies: [], startEnemies: [],
    ...
    },
    {
      ...
      objective: '✋ Il Cavaliere della Cipolla — 3 alleanze senza tradire né dichiarare guerra',
      objectiveFull: 'Davos non è nato nobile: è nato giusto. Non tradisce, non aggredisce, non mente. Costruisci 3 alleanze oneste senza mai essere tu a dichiarare guerra.',
      objectiveCheck: (s) => countAllies(s) >= 3 && !s.decisionHistory.some(d => d.tags?.includes('betray_ally')) && !s.decisionHistory.some(d => d.tags?.includes('war_declaration')),
    ...
    },
    {
      ...
      icon: '🕯️', emoji: '📜',
      difficulty: 'medium',
      startResources: { gold: 52, faith: 48, people: 38, army: 28, power: 58 },
      objective: '🕯 La Mano del Re — conquista il Trono di Spade',
      objectiveFull: 'Otto Hightower ha manipolato re per tutta la vita. Ora vuole il trono per il suo sangue. Conquista il potere supremo attraverso l\'intrigo e la politica.',
      objectiveCheck: (s) => s.king === 'otto',
      throneObjective: true,
      secondaryObjective: '🕯 Il potere invisibile: controlla tutte le casate senza mai perdere una guerra',
    ...
    },
    {
      ...
      objective: '🕯 La Regina Reggente — conquista il Trono di Spade',
      objectiveFull: 'Alicent ha sacrificato la giovinezza per la Corona. Ha servito il Re, protetto i figli, combattuto Rhaenyra. Ora vuole il trono — per sé, per i suoi figli, per Oldtown.',
      objectiveCheck: (s) => s.king === 'alicent',
      throneObjective: true,
      secondaryObjective: '🕯 La Fede come scudo: mantieni la Fede sopra 70 e unifica le casate',
  ...
  const HOUSES_DEF = [
    { id: 'Stark',     name: 'Stark',    icon: '🐺', crest: 'images/houses/Stark.png',     region: 'Nord',               baseArmy: 90,
      ...
      conquestIncome: { res: 'army', val: 3, label: '🐺 Guardie del Nord: +3 Esercito' },
    ...
    { id: 'Lannister', name: 'Lannister',icon: '🦁', crest: 'images/houses/Lannister.png', region: 'Castel Granito',     baseArmy: 95,
      ...
      conquestIncome: { res: 'gold', val: 4, label: '🦁 Miniere di Castel Granito: +4 Oro' },
    ...
    { id: 'Tyrell',    name: 'Tyrell',   icon: '🌹', crest: 'images/houses/Tyrell.png',    region: 'Altogarden',         baseArmy: 95,
      ...
      conquestIncome: { res: 'people', val: 3, label: '🌹 Granai di Altogarden: +3 Popolo' },
    ...
    { id: 'Baratheon', name: 'Baratheon',icon: '🦌', crest: 'images/houses/Baratheon.png', region: 'Capo della Tempesta',baseArmy: 80,
      ...
      conquestIncome: { res: 'power', val: 3, label: '🦌 Legittimità Baratheon: +3 Potere' },
    ...
    { id: 'Tully',     name: 'Tully',    icon: '🐟', crest: 'images/houses/Tully.png',    region: 'Acque del Nera',     baseArmy: 70,
      ...
      conquestIncome: { res: 'faith', val: 3, label: '🐟 Fede del Tridente: +3 Fede' },
    ...
    { id: 'Martell',   name: 'Martell',  icon: '☀️', crest: 'images/houses/Martell.png',  region: 'Dorne',              baseArmy: 75,
      allianceReq: { power: 45, army: 40 },
      conquestIncome: { res: 'power', val: 3, label: '☀️ Rete di Dorne: +3 Potere' },
    ...
    { id: 'Greyjoy',   name: 'Greyjoy',  icon: '🐙', crest: 'images/houses/Greyjoy.png',  region: 'Isole di Ferro',     baseArmy: 78,
      allianceReq: { army: 48 },
      conquestIncome: { res: 'army', val: 4, label: '🐙 Ferro e Sale: +4 Esercito' },
    ...
    { id: 'Frey',      name: 'Frey',     icon: '🌉', crest: 'images/houses/Frey.png',     region: 'Tridente',           baseArmy: 60,
      allianceReq: { gold: 45 },
      conquestIncome: { res: 'gold', val: 3, label: '🌉 Pedaggi del Tridente: +3 Oro' },
    ...
    { id: 'Bolton',    name: 'Bolton',    icon: '🩸', crest: 'images/houses/Bolton.png',   region: 'Il Nord (Forte Terrore)',  baseArmy: 85,
      ...
      conquestIncome: { res: 'army', val: 3, label: '🩸 Terrore di Forte Terrore: +3 Esercito' },
    ...
    { id: 'Targaryen', name: 'Targaryen', icon: '🐉', crest: 'images/houses/Targaryen.png', region: 'Dragonstone / Esilio',       baseArmy: 95,
      ...
      conquestIncome: { res: 'power', val: 4, label: '🐉 Eredità del Drago: +4 Potere' },
    ...
    { id: 'Hightower', name: 'Hightower', icon: '🕯️', crest: 'images/houses/Hightower.png', region: 'Vecchia Città (Oldtown)',    baseArmy: 85,
      ...
      conquestIncome: { res: 'faith', val: 3, label: '🕯️ Archivi di Oldtown: +3 Fede' },
  ...
  // ══════════════════════════════════════════════
  // SISTEMA ESERCITO — Unità reclutabili
  // army = somma forza unità. Ogni unità ha:
  //   id, name, icon, force (forza in battaglia),
  //   cost (risorse reclutamento), upkeep (ogni 5t),
  //   unitType (per la battaglia: melee/cavalry/elite),
  //   onlyChars (se presente, solo per certi personaggi)
  // ══════════════════════════════════════════════
  const ARMY_UNITS = [
    {
      id: 'milizia',
      name: 'Milizia', icon: '🪓',
      desc: 'Contadini armati. Numerosi ma fragili.',
      force: 6, unitType: 'melee',
      cost: { people: 5 },
      upkeep: {},   // gratuita da mantenere
      maxCount: 6,
    },
    {
      id: 'sellaspe',
      name: 'Sellaspe', icon: '⚔️',
      desc: 'Mercenari professionisti. Affidabili ma costosi.',
      force: 12, unitType: 'melee',
      cost: { gold: 8 },
      upkeep: { gold: 2 },
      maxCount: 4,
    },
    {
      id: 'dothraki',
      name: 'Dothraki', icon: '🐴',
      desc: 'Cavalieri selvaggi del Dothraki Sea. Devastanti in campo aperto.',
      force: 16, unitType: 'cavalry',
      cost: { gold: 6, people: 4 },
      upkeep: { people: 1 },
      maxCount: 3,
      onlyChars: ['daenerys','daemon','rhaenyra','aegon_t','drogo'],
    },
    {
      id: 'immacolati',
      name: 'Immacolati', icon: '🛡️',
      desc: 'Soldati d\'élite disciplinati. Imbattibili in formazione.',
      force: 18, unitType: 'elite',
      cost: { gold: 10 },
      upkeep: { gold: 2 },
      maxCount: 3,
      onlyChars: ['daenerys','daemon','rhaenyra','aegon_t','jorah','missandei'],
    },
    {
      id: 'comp_dorata',
      name: 'Compagnia Dorata', icon: '💰',
      desc: 'La miglior compagnia mercenaria di Essos. Non ha mai rotto un contratto.',
      force: 22, unitType: 'elite',
      cost: { gold: 14 },
      upkeep: { gold: 3 },
      maxCount: 2,
    },
    {
      id: 'guardia_notte',
      name: 'Guardia della Notte', icon: '🖤',
      desc: 'Veterani del Muro. Duri come il ghiaccio, leali come la neve.',
      force: 14, unitType: 'melee',
      cost: { faith: 6, army: 4 },
      upkeep: { faith: 1 },
      maxCount: 3,
      onlyChars: ['jon','ned','robb','catelyn','tormund','davos','brienne'],
    },
    {
      id: 'guardia_re',
      name: 'Guardia del Re', icon: '👑',
      desc: 'Sette guerrieri scelti. Proteggono il potere con la vita.',
      force: 20, unitType: 'elite',
      cost: { power: 8, gold: 6 },
      upkeep: { power: 1 },
      maxCount: 2,
      onlyChars: ['cersei','jaime','tywin','joffrey','otto','alicent','littlefinger'],
    },
    {
      id: 'arcieri',
      name: 'Arcieri di Dorne', icon: '🏹',
      desc: 'Cecchini del deserto. Colpiscono prima che il nemico li raggiunga.',
      force: 13, unitType: 'ranged',
      cost: { gold: 7, people: 3 },
      upkeep: { gold: 1 },
      maxCount: 3,
      onlyChars: ['oberyn','martell_char','doran'],
    },
  ];

  // ── Ottieni le unità disponibili per il personaggio corrente ──
  function getAvailableUnits() {
    const charId = state.character?.id || '';
    return ARMY_UNITS.filter(u =>
      !u.onlyChars || u.onlyChars.includes(charId)
    );
  }

  // ── Forza totale esercito dal composition array ──
  // Se armyUnits è vuoto usa resources.army (milizia implicita)
  function getArmyForce() {
    const units = state.armyUnits || [];
    if (units.length === 0) return state.resources.army; // fallback legacy
    const unitForce = units.reduce((sum, slot) => {
      const def = ARMY_UNITS.find(u => u.id === slot.typeId);
      return sum + (def ? def.force * slot.count : 0);
    }, 0);
    // Dragon bonus
    const dragonBonus = state.hasDragon ? 35 : 0;
    return Math.min(getResourceCap('army') + (state.conquestCapBonus?.army || 0), unitForce + dragonBonus);
  }

  // ── Costo mantenimento totale ogni 5 turni ──
  function getArmyUpkeep() {
    ...
    units.forEach(slot => {
      const def = ARMY_UNITS.find(u => u.id === slot.typeId);
      if (!def) return;
      Object.entries(def.upkeep || {}).forEach(([res, val]) => {
        totals[res] = (totals[res] || 0) + val * slot.count;
      });
    });
    if (state.hasDragon) totals.gold  = (totals.gold  || 0) + 4;
    if (state.hasDragon) totals.faith = (totals.faith || 0) + 2;
    return totals;
  }

  // ── Conta slot occupati per tipo ──
  function getUnitCount(typeId) {
    return (state.armyUnits || [])
      .filter(s => s.typeId === typeId)
      .reduce((s, slot) => s + slot.count, 0);
  }

  // ── Recluta unità ──
  function recruitUnit(typeId) {
    const def = ARMY_UNITS.find(u => u.id === typeId);
    if (!def) return;
    const available = getAvailableUnits();
    if (!available.find(u => u.id === typeId)) {
      showToast('⚠ Questa unità non è disponibile per il tuo personaggio.', 'warn');
      return;
    }
    const current = getUnitCount(typeId);
    if (current >= def.maxCount) {
      showToast(`⚠ Hai già il massimo di ${def.maxCount} ${def.name}.`, 'warn');
      return;
    }
    // Verifica risorse
    ...
    for (const [res, amt] of Object.entries(def.cost)) {
      if ((state.resources[res] || 0) < amt) {
        const labels = { gold:'💰 Oro', army:'⚔ Esercito', people:'👥 Popolo', faith:'✝ Fede', power:'👑 Potere' };
        showToast(`⚠ Risorse insufficienti: serve ${labels[res] || res} ≥${amt} (hai ${Math.round(state.resources[res] || 0)}).`, 'warn');
        return;
      }
    }
    // Paga il costo
    for (const [res, amt] of Object.entries(def.cost)) {
      state.resources[res] = Math.max(0, state.resources[res] - amt);
    }
    // Aggiungi allo slot
    const existing = state.armyUnits.find(s => s.typeId === typeId);
    if (existing) existing.count++;
    else state.armyUnits.push({ typeId, count: 1 });

    // Aggiorna resources.army per compatibilità col sistema esistente
    _syncArmyResource();
    showToast(`⚔ ${def.icon} ${def.name} reclutata! Forza esercito: ${getArmyForce()}`, 'good');
    updateHUD(); saveGame();
    showArmyPanel(); // refresh
  }

  // ── Licenzia unità ──
  function dismissUnit(typeId) {
    const slot = (state.armyUnits || []).find(s => s.typeId === typeId);
    if (!slot || slot.count <= 0) return;
    slot.count--;
    if (slot.count === 0) state.armyUnits = state.armyUnits.filter(s => s.typeId !== typeId);
    _syncArmyResource();
    const def = ARMY_UNITS.find(u => u.id === typeId);
    showToast(`${def?.icon || '⚔'} Unità congedata. Forza: ${getArmyForce()}`, 'warn');
    updateHUD(); saveGame();
    showArmyPanel();
  }

  // ── Sincronizza resources.army con la forza reale per il sistema esistente ──
  function _syncArmyResource() {
    if ((state.armyUnits || []).length > 0) {
      state.resources.army = Math.min(getResourceCap('army'), getArmyForce());
    }
  }

  // ── Mantieni l'esercito ogni 5 turni ──
  function _applyArmyUpkeep() {
    if (!state.armyUnits || state.armyUnits.length === 0) return;
    const upkeep = getArmyUpkeep();
    if (Object.keys(upkeep).length === 0) return;
    const resLabels = { gold:'💰 Oro', people:'👥 Popolo', faith:'✝ Fede', power:'👑 Potere', army:'⚔ Esercito' };
    const lines = [];
    let anyDisbanded = false;
    Object.entries(upkeep).forEach(([res, amt]) => {
      if (state.resources[res] < amt) {
        // Non riesce a pagare — licenzia l'unità più costosa di quel tipo
        const toDisband = [...state.armyUnits]
          .sort((a, b) => {
            const da = ARMY_UNITS.find(u => u.id === a.typeId);
            const db = ARMY_UNITS.find(u => u.id === b.typeId);
            return (db?.upkeep?.[res] || 0) - (da?.upkeep?.[res] || 0);
          })[0];
        if (toDisband) {
          toDisband.count--;
          if (toDisband.count <= 0) state.armyUnits = state.armyUnits.filter(s => s.typeId !== toDisband.typeId);
          const def = ARMY_UNITS.find(u => u.id === toDisband.typeId);
          lines.push(`💔 ${def?.icon} ${def?.name} si è dispersa — non potevi pagarla.`);
          anyDisbanded = true;
        }
      } else {
        state.resources[res] = Math.max(0, state.resources[res] - amt);
        lines.push(`⚔ Mantenimento: −${amt} ${resLabels[res]}`);
      }
    });
    _syncArmyResource();
    if (lines.length > 0) setTimeout(() => showToast(lines.join('\n'), anyDisbanded ? 'warn' : 'warn'), 500);
  }

  // DATA — EVENTS (continua sotto)
  ...
  const EVENTS = [
    ...
    // ══════════════════════════════════════════
    {
      id: 'daemon_ambition', tags: ['power', 'people'], forChars: ['daemon'],
    ...
    {
      id: 'daemon_fury', tags: ['people', 'power'], forChars: ['daemon'],
    ...
    {
      id: 'daemon_dragonstone', tags: ['army', 'gold'], forChars: ['daemon'],
    ...
    {
      id: 'daemon_exile', tags: ['power', 'faith'], forChars: ['daemon'],
    ...
    {
      id: 'daemon_legacy', tags: ['faith', 'power'], forChars: ['daemon'],
    ...
    // ══════════════════════════════════════════
    {
      id: 'exile_return', tags: ['power', 'people'], forChars: ['jorah','theon','jaime','daemon','daenerys'],
    ...
    // ══════════════════════════════════════════
    {
      id: 'targaryen_lineage', tags: ['power', 'faith'], forChars: ['daenerys','daemon','rhaenyra','aegon_t'],
    ...
    // ══════════════════════════════════════════
    {
      ...
      rightText: 'Accetta il prestito', rightEffects: { gold: +14, power: -6 },
      minTurn: 5, excludeChars: ['tormund', 'arya'],
    },
    {
    ...
    },
    {
      ...
      rightText: 'Acquista l\'uovo', rightEffects: { gold: -10 },
      minTurn: 10,
      maxUses: 1,
      onRightChoose: () => {
        const roll = Math.random();
        if (roll < 0.05 && !state.hasDragon) {
          state.hasDragon = true;
          if (!state.troops) state.troops = {};
          state.troops['drago'] = 1;
          state.resources.army = Math.min(getResourceCap('army') - 1, getTroopForce());
          showModal('🐉 Un Drago!',
            'L\'uovo si è schiuso nel cuore della notte. Le fiamme che ne sono uscite hanno illuminato il cielo. Un drago è nato — e si è legato a voi. Il drago è ora nel vostro esercito: in battaglia potrete usare la sua abilità speciale una volta per scontro.',
            '🔥', 'Per il Fuoco e il Sangue');
        } else {
          state.resources.power = Math.min(getResourceCap('power') - 1, state.resources.power + 2);
          state.resources.faith = Math.min(getResourceCap('faith') - 1, state.resources.faith + 5);
          showToast('🥚 Pietrificato. Non si è schiuso, ma la sua presenza ispira rispetto. +2 Potere, +5 Fede.', 'good');
        }
        updateHUD(); saveGame();
      },
    },
    ...
    // ══════════════════════════════════════════════════════════════════
    // ── NUOVE CARTE GENERICHE (v3.0) ──
    // ══════════════════════════════════════════════════════════════════

    {
      id: 'flood_riverlands', tags: ['people', 'gold'],
      speaker: 'Messo del Tridente', speakerRole: 'Notizia dai Riverlands',
      portrait: '🌊', icon: '🌊',
      text: "Le piogge torrenziali hanno fatto esondare il Tridente. Decine di villaggi sono sott'acqua, i raccolti perduti, la gente disperata. Le casse possono aprirsi — o restare chiuse.",
      leftText: 'Lascia che si arrangino', leftEffects: { people: -12, faith: -5 },
      rightText: 'Invia soccorsi immediati', rightEffects: { gold: -12, people: +14, faith: +6 },
      minTurn: 3,
    },
    {
      id: 'corrupt_steward', tags: ['gold', 'power'],
      speaker: 'Ispettore reale', speakerRole: 'Rapporto riservato',
      excludeChars: ['arya','tormund','bronn'],
      portrait: '📋', icon: '📋',
      text: "Il vostro steward ha sottratto fondi per anni. La prova è schiacciante. Processarlo pubblicamente rafforzerebbe la vostra reputazione di giustizia, ma rivelerebbe la debolezza dei vostri controlli.",
      leftText: 'Gestisci in privato', leftEffects: { gold: +8, power: -5 },
      rightText: 'Processo pubblico', rightEffects: { gold: +5, power: +3, faith: +8, people: +6 },
      minTurn: 5,
    },
    {
      id: 'wildfire_discovery', tags: ['army', 'power'],
      speaker: 'Alchimista', speakerRole: 'Gilda degli Alchimisti',
      excludeChars: ['tormund','ned','catelyn','davos','robb'],
      portrait: '🔥', icon: '🔥',
      text: "Gli alchimisti hanno trovato cache di fuoco vivo sotto la città. Potete usarlo come arma deterrente — oppure farlo distruggere prima che cada nelle mani sbagliate.",
      leftText: 'Distruggi tutto', leftEffects: { faith: +10, people: +6, power: -5 },
      rightText: 'Tienilo come deterrente', rightEffects: { army: +10, power: +5, people: -8 },
      minTurn: 8,
    },
    {
      id: 'religious_schism', tags: ['faith', 'people'],
      speaker: 'Gran Septon', speakerRole: 'Settori della Fede',
      excludeChars: ['tormund','arya'],
      portrait: '⚖️', icon: '⚖️',
      text: "Una disputa teologica sta spaccando la Fede dei Sette in due fazioni. Il clero vi chiede di prendere posizione. Il silenzio sarebbe interpretato come empietà.",
      leftText: 'Sostieni la fazione tradizionale', leftEffects: { faith: +12, people: +5, power: -5 },
      rightText: 'Sostieni i riformatori', rightEffects: { faith: +6, people: +8, gold: -5 },
      minTurn: 6,
    },
    {
      id: 'sellsword_captain_offer', tags: ['army', 'gold'],
      speaker: 'Capitano Mercenario', speakerRole: 'Compagnia delle Aquile',
      portrait: '⚔️', icon: '⚔️',
      text: "Un capitano mercenario offre tremila spade esperte. Ma i sellsword sono fedeli solo all'oro — e se l'oro finisce, finisce anche la loro lealtà.",
      leftText: 'Troppo rischio, rifiuta', leftEffects: { gold: +4 },
      rightText: 'Assoldali per tre stagioni', rightEffects: { gold: -14, army: +14 },
      minTurn: 2,
    },
    {
      id: 'border_skirmish', tags: ['army', 'power'],
      speaker: 'Capitano di confine', speakerRole: 'Rapporto militare',
      portrait: '🗡️', icon: '🗡️',
      text: "Scaramucce al confine meridionale. Una casata vicina sembra testare le vostre difese. Potete rispondere con forza immediata o ignorare e monitorare.",
      leftText: 'Ignora e monitora', leftEffects: { power: -5, army: +3 },
      rightText: 'Risposta di forza', rightEffects: { army: -8, power: +6, people: -5 },
      minTurn: 4,
    },
    {
      id: 'maester_medicine', tags: ['people', 'faith'],
      speaker: 'Maester Luwin', speakerRole: 'Consiglio medico',
      portrait: '⚕️', icon: '⚕️',
      text: "Il Maester ha sviluppato un nuovo trattamento per il flagello dei poveri. Finanziarlo costerebbe oro ma salverebbe migliaia di vite — e guadagnerebbe devozione popolare.",
      leftText: 'Non ora, ci sono priorità', leftEffects: { people: -8 },
      rightText: "Finanzia la ricerca", rightEffects: { gold: -10, people: +14, faith: +5 },
      minTurn: 5,
    },
    {
      id: 'foreign_ambassador', tags: ['gold', 'power'],
      speaker: 'Ambasciatore di Yi Ti', speakerRole: 'Delegazione orientale',
      portrait: '🗺️', icon: '🗺️',
      text: "Un ambasciatore di Yi Ti propone accordi commerciali esclusivi. I benefici economici sono enormi, ma i nobili tradizionalisti vedono il commercio con l'Est come una contaminazione.",
      leftText: 'Rifiuta per preservare le tradizioni', leftEffects: { faith: +8, power: +3, gold: -5 },
      rightText: 'Apri le rotte commerciali', rightEffects: { gold: +14, power: -8 },
      minTurn: 6,
    },
    {
      id: 'tournament_champion', tags: ['people', 'power'],
      speaker: 'Maestro delle cerimonie', speakerRole: 'Proposta reale',
      excludeChars: ['arya','tormund','melisandre'],
      portrait: '🏆', icon: '🏆',
      text: "Un grande torneo richiamerebbe cavalieri da ogni angolo del regno. La gente festeggerebbe, i nobili si mostrerebbero — ma potrebbe diventare un palcoscenico per rivalità pericolose.",
      leftText: 'Annulla — troppo rischio', leftEffects: { people: -6 },
      rightText: 'Organizza il Gran Torneo', rightEffects: { gold: -12, people: +14, power: +5 },
      minTurn: 5,
    },
    {
      id: 'winter_supply', tags: ['gold', 'people'],
      speaker: 'Steward capo', speakerRole: 'Preparativi invernali',
      portrait: '❄️', icon: '❄️',
      text: "L'inverno si avvicina. I granai devono essere riforniti. Farlo ora è costoso ma salva vite; aspettare risparmia oro ma rischia la carestia.",
      leftText: 'Aspetta prezzi migliori', leftEffects: { gold: +8, people: -8 },
      rightText: 'Acquista riserve adesso', rightEffects: { gold: -12, people: +12 },
      minTurn: 3,
    },
    {
      id: 'raven_blackmail', tags: ['power', 'gold'],
      speaker: 'Mittente anonimo', speakerRole: 'Lettera senza sigillo',
      portrait: '🦅', icon: '🦅',
      text: "Una lettera anonima minaccia di rivelare segreti compromettenti sulla vostra casata. Potete pagare per il silenzio, o sfidare il ricattatore e rischiare lo scandalo.",
      leftText: 'Paga per il silenzio', leftEffects: { gold: -12, power: +3 },
      rightText: "Sfida il ricattatore", rightEffects: { power: -8, people: -6, army: +5 },
      minTurn: 7,
    },
    {
      id: 'refugee_crisis', tags: ['people', 'gold'],
      speaker: 'Lord dei Riverlands', speakerRole: 'Richiesta urgente',
      portrait: '🏕️', icon: '🏕️',
      text: "Migliaia di profughi fuggono dalla guerra. Accoglierli costerebbe molto ma aumenterebbe la manodopera; respingerli salverebbe risorse ma seminerebbe odio.",
      leftText: 'Chiudi le frontiere', leftEffects: { gold: +6, people: -12, faith: -8 },
      rightText: 'Accoglili e reinsediali', rightEffects: { gold: -10, people: +10, army: +5 },
      minTurn: 4,
    },
    {
      id: 'secret_tunnel', tags: ['army', 'power'],
      speaker: 'Mastro muratore', speakerRole: 'Scoperta architettonica',
      portrait: '🕳️', icon: '🕳️',
      text: "Un passaggio segreto è stato scoperto sotto il castello. Potrebbe essere usato per infiltrazioni militari — o per evacuazioni in caso di assedio.",
      leftText: 'Predisponilo per evacuazioni', leftEffects: { army: +5, people: +5 },
      rightText: 'Usalo per operazioni militari', rightEffects: { army: +8, power: +5, gold: -8 },
      minTurn: 6,
    },
    {
      id: 'noble_marriage_alliance', tags: ['power', 'people'],
      speaker: 'Emissario', speakerRole: 'Proposta matrimoniale',
      excludeChars: ['arya','tormund','bronn','melisandre','jaime','ned'],
      portrait: '💍', icon: '💍',
      text: "Una casata neutrale propone un matrimonio per cementare l'alleanza. Le nozze potrebbero trasformare un vicino incerto in un alleato leale.",
      leftText: 'Troppo presto', leftEffects: { power: -5 },
      rightText: 'Accetta le nozze', rightEffects: { power: +8, people: +8, gold: -8 },
      minTurn: 6, rightTags: ['royal_marriage'],
    },
    {
      id: 'drought_trade_route', tags: ['gold', 'power'],
      speaker: 'Mercante di Penthos', speakerRole: 'Proposta commerciale',
      portrait: '🛤️', icon: '🛤️',
      text: "Un mercante propone di aprire una nuova rotta commerciale attraverso territori pericolosi. L'investimento è alto, ma potrebbe portare profitti stabili per anni.",
      leftText: 'Rifiuta il rischio', leftEffects: { gold: +4 },
      rightText: 'Investi nella rotta', rightEffects: { gold: -10, power: +3 },
      minTurn: 5,
      onRightChoose: () => {
        state.activeEffects = state.activeEffects || [];
        state.activeEffects.push({ type: 'gold_per_turn', value: 4, turns: 5 });
        showToast('🛤️ La rotta commerciale porterà +4 oro per 5 turni.', 'good');
      },
    },
    {
      id: 'prison_break', tags: ['army', 'power'],
      speaker: 'Carceriere', speakerRole: 'Rapporto dalla prigione',
      portrait: '🔓', icon: '🔓',
      text: "Prigionieri di guerra sono evasi durante la notte. Riprenderli richiede truppe; lasciarli fuggire mostra debolezza ma risparmia risorse.",
      leftText: 'Lascia che fuggano', leftEffects: { power: -8 },
      rightText: 'Invia truppe a riprenderli', rightEffects: { army: -8, power: +5 },
      minTurn: 5,
    },
    {
      id: 'harvest_poor', tags: ['people', 'faith'],
      speaker: 'Septa del villaggio', speakerRole: 'Supplica dei poveri',
      portrait: '🌾', icon: '🌾',
      text: "I contadini del villaggio più povero chiedono esenzione dalle tasse per quest'anno. Concederla vi costerà in entrate ma guadagnerete devozione.",
      leftText: 'Nessuna esenzione', leftEffects: { gold: +8, people: -8, faith: -5 },
      rightText: 'Concedi esenzione totale', rightEffects: { gold: -8, people: +12, faith: +8 },
      minTurn: 2,
    },
    {
      id: 'shipwreck_treasure', tags: ['gold', 'power'],
      speaker: 'Capitano di marina', speakerRole: 'Notizia dal mare',
      portrait: '⚓', icon: '⚓',
      text: "Un galeone affondato al largo contiene un tesoro enorme. Recuperarlo è rischioso e costoso, ma il bottino potrebbe essere enorme.",
      leftText: 'Troppo rischioso', leftEffects: {},
      rightText: 'Finanzia la spedizione', rightEffects: { gold: -8 },
      minTurn: 4,
      onRightChoose: () => {
        const roll = Math.random();
        if (roll > 0.4) {
          state.resources.gold = Math.min(state.resources.gold + 20, 100);
          showToast('⚓ La spedizione è riuscita! Trovato un tesoro enorme. +20 oro.', 'good');
        } else {
          state.resources.army = Math.max(0, state.resources.army - 8);
          showToast('⚓ La spedizione è fallita. Alcune truppe sono annegate. -8 esercito.', 'bad');
        }
        updateHUD(); saveGame();
      },
    },
    {
      id: 'night_attack_camp', tags: ['army', 'power'],
      speaker: 'Capitano delle vedette', speakerRole: 'Allarme notturno',
      portrait: '🌙', icon: '🌙',
      text: "Nemici hanno attaccato un accampamento avanzato di notte. Le perdite sono contenute, ma l'insolenza richiede risposta. Una rappresaglia immediata potrebbe espandere il conflitto.",
      leftText: 'Ritirati, evita il conflitto', leftEffects: { army: +5, power: -8 },
      rightText: 'Rappresaglia immediata', rightEffects: { army: -8, power: +8, people: -5 },
      minTurn: 6,
    },
    {
      id: 'cartographer_maps', tags: ['power', 'army'],
      speaker: 'Cartografo reale', speakerRole: 'Proposta strategica',
      portrait: '🗺️', icon: '🗺️',
      text: "Un cartografo ha mappato in dettaglio i territori nemici. Questi dati potrebbero essere decisivi in una campagna militare — ma anche venduti a chi offre di più.",
      leftText: 'Vendi le mappe al miglior offerente', leftEffects: { gold: +14, power: -6 },
      rightText: 'Usa le mappe per pianificare', rightEffects: { army: +8, power: +5 },
      minTurn: 5,
    },
    {
      id: 'cult_rises', tags: ['faith', 'people'],
      speaker: 'Septon anziano', speakerRole: 'Rapporto della Fede',
      portrait: '🕯️', icon: '🕯️',
      text: "Un culto misterioso si sta diffondendo tra il popolo. La gente è attratta dalle loro promesse di salvezza. Sopprimerli farebbe contenti i Settari ma alienare molti fedeli.",
      leftText: 'Tollera il culto', leftEffects: { faith: -8, people: +6 },
      rightText: 'Sopprimilo con forza', rightEffects: { faith: +10, people: -10, army: -5 },
      minTurn: 7,
    },
    {
      id: 'grand_maester_advice', tags: ['power', 'faith'],
      speaker: 'Gran Maester Pycelle', speakerRole: 'Consiglio della Fortezza Rossa',
      excludeChars: ['tormund','arya','bronn'],
      portrait: '📜', icon: '📜',
      text: "Il Gran Maester vi porta notizie: una crisi diplomatica si avvicina. Agire preventivamente con ambasciate costerebbe oro ma eviterebbe la guerra; attendere rischia l'escalation.",
      leftText: 'Monitora e attendi', leftEffects: { power: -3 },
      rightText: 'Invia ambascerie preventive', rightEffects: { gold: -8, power: +6, people: +5 },
      minTurn: 8,
    },
    {
      id: 'poison_scare', tags: ['power', 'faith'],
      speaker: 'Medico personale', speakerRole: 'Avviso urgente',
      portrait: '☠️', icon: '☠️',
      text: "Il vostro assaggiatore è morto durante il banchetto notturno. Forse veleno. Potete indagare pubblicamente rischiando il panico di corte, o investigare in segreto.",
      leftText: 'Indagine segreta', leftEffects: { power: +3, gold: -6 },
      rightText: 'Annuncio pubblico', rightEffects: { faith: +8, people: +5, power: -8 },
      minTurn: 6,
    },
    {
      id: 'abandoned_castle', tags: ['army', 'power'],
      speaker: 'Esploratore', speakerRole: 'Rapporto territoriale',
      portrait: '🏰', icon: '🏰',
      text: "Un castello abbandonato al confine potrebbe essere rioccupato. Farlo costerebbe risorse ma fornirebbe un avamposto strategico irrinunciabile.",
      leftText: 'Non è il momento', leftEffects: {},
      rightText: 'Rioccupa il castello', rightEffects: { gold: -10, army: -5, power: +8 },
      minTurn: 6,
    },
    {
      id: 'drought_prayer', tags: ['faith', 'people'],
      speaker: 'Septon del villaggio', speakerRole: 'Processione religiosa',
      portrait: '🙏', icon: '🙏',
      text: "La siccità continua. Un gran Septon propone una processione pubblica di preghiere per la pioggia. Partecipare mostrerebbe devozione; rifiutare sembrerebbe empio.",
      leftText: 'Non partecipo, ho altro da fare', leftEffects: { faith: -8, people: -5 },
      rightText: 'Guida la processione in persona', rightEffects: { faith: +14, people: +8 },
      minTurn: 4,
    },
    {
      id: 'mine_discovery', tags: ['gold', 'power'],
      speaker: 'Mastro minerario', speakerRole: 'Scoperta nelle colline',
      portrait: '⛏️', icon: '⛏️',
      text: "Una vena d'argento è stata scoperta. Aprire la miniera richiede investimenti — ma potrebbe portare ricchezze per generazioni. O si può vendere la concessione.",
      leftText: 'Vendi la concessione', leftEffects: { gold: +12, power: -3 },
      rightText: 'Apri la miniera del regno', rightEffects: { gold: -10, power: +5 },
      minTurn: 4,
      onRightChoose: () => {
        state.activeEffects = state.activeEffects || [];
        state.activeEffects.push({ type: 'gold_per_turn', value: 5, turns: 8 });
        showToast('⛏️ La miniera è operativa. +5 oro per 8 turni.', 'good');
      },
    },
    {
      id: 'bandit_roads', tags: ['people', 'gold'],
      speaker: 'Comandante della guardia', speakerRole: 'Rapporto sulla sicurezza',
      portrait: '🦹', icon: '🦹',
      text: "Banditi infestano le strade del regno. I mercanti si lamentano. Potete inviare pattuglie — costoso — o tassare le carovane per finanziare la sicurezza.",
      leftText: 'Tassa le carovane', leftEffects: { gold: +8, people: -8 },
      rightText: 'Finanzia le pattuglie', rightEffects: { gold: -10, people: +10, power: +3 },
      minTurn: 3,
    },
    {
      id: 'drought_sacrifice', tags: ['faith', 'army'],
      speaker: 'Sacerdote pagano', speakerRole: 'Rituale antico',
      excludeChars: ['ned','catelyn','brienne','davos','sansa','margaery'],
      portrait: '🔥', icon: '🔥',
      text: "Un antico rituale promette pioggia in cambio di sangue versato. I veterani ridono, ma il popolo è disperato. Vale la pena rischiare la credibilità?",
      leftText: 'Ridicolo, rifiuta', leftEffects: { faith: +5, people: -5 },
      rightText: 'Permetti il rituale', rightEffects: { faith: +10, army: -5, people: +8 },
      minTurn: 5,
    },
    {
      id: 'orphan_army', tags: ['army', 'people'],
      speaker: 'Comandante veterano', speakerRole: 'Proposta di reclutamento',
      portrait: '⚔️', icon: '⚔️',
      text: "Migliaia di giovani orfani di guerra potrebbero essere addestrati come soldati. Veloce e poco costoso — ma usare bambini è moralmente controverso.",
      leftText: 'Rifiuta, è disumano', leftEffects: { faith: +8, people: +6 },
      rightText: 'Addestra i giovani', rightEffects: { army: +12, faith: -10, people: -8 },
      minTurn: 6, excludeChars: ['ned','catelyn','brienne','sansa','davos'],
    },
    {
      id: 'archmaester_scroll', tags: ['faith', 'power'],
      speaker: 'Archmaester di Vecchia Valeria', speakerRole: 'Messaggio accademico',
      portrait: '📚', icon: '📚',
      text: "Un archmaester propone un accordo: in cambio del finanziamento della sua ricerca, condividerà segreti della storia antica che potrebbero legittimare il vostro potere.",
      leftText: 'Rifiuta la speculazione', leftEffects: { faith: +5 },
      rightText: 'Finanzia la ricerca', rightEffects: { gold: -10, faith: +8, power: +6 },
      minTurn: 8,
    },
    {
      id: 'coastal_raid', tags: ['army', 'gold'],
      speaker: 'Ammiraglio di flotta', speakerRole: 'Notizia dalla costa',
      portrait: '🚢', icon: '🚢',
      text: "Pirati delle Isole di Ferro hanno saccheggiato tre porti. Potete inviare la flotta a punirli o rafforzare semplicemente le difese costiere.",
      leftText: 'Rinforza le difese', leftEffects: { gold: -8, army: +5 },
      rightText: 'Invia la flotta a punirli', rightEffects: { army: -10, gold: +8, power: +6 },
      minTurn: 5,
    },
    {
      id: 'harvest_festival', tags: ['people', 'faith'],
      speaker: 'Castellano', speakerRole: 'Proposta stagionale',
      portrait: '🎉', icon: '🎉',
      text: "Il festival del raccolto è l'occasione perfetta per incontrare il popolo. Partecipare di persona — e distribuire cibo ai poveri — costerebbe ma costruirebbe lealtà.",
      leftText: 'Salta il festival', leftEffects: { people: -5 },
      rightText: 'Partecipa e distribuisci', rightEffects: { gold: -8, people: +12, faith: +6 },
      minTurn: 3,
    },
    {
      id: 'captured_spy', tags: ['power', 'army'],
      speaker: 'Capo della guardia', speakerRole: 'Detenuto di alto profilo',
      portrait: '🔍', icon: '🔍',
      text: "Una spia nemica è stata catturata con documenti sensibili. Potete torturarla per informazioni — rischiando scandalo — o usarla come pedina in uno scambio diplomatico.",
      leftText: 'Scambio diplomatico', leftEffects: { power: +5, people: +5 },
      rightText: 'Estrai informazioni con forza', rightEffects: { army: +8, power: +3, faith: -10, people: -8 },
      minTurn: 7, excludeChars: ['ned','catelyn','davos','brienne','sansa'],
    },
    {
      id: 'young_heir_education', tags: ['power', 'faith'],
      speaker: 'Maester tutore', speakerRole: 'Proposta pedagogica',
      excludeChars: ['arya','tormund','bronn','melisandre'],
      portrait: '📖', icon: '📖',
      text: "L'erede della casata alleata ha bisogno di un tutore. Accoglierlo a corte lo renderebbe ostaggi di fatto — ma anche un legame d'amicizia potente.",
      leftText: 'Rifiuta la responsabilità', leftEffects: {},
      rightText: "Accoglilo alla tua corte", rightEffects: { power: +8, gold: -5, people: +5 },
      minTurn: 5,
    },
    {
      id: 'siege_supplies', tags: ['army', 'gold'],
      speaker: 'Mastro dei rifornimenti', speakerRole: 'Pianificazione militare',
      excludeChars: ['arya','melisandre','sansa','margaery'],
      portrait: '🏹', icon: '🏹',
      text: "L'esercito ha bisogno di scorte per resistere a un assedio prolungato. Farne uno stock ora costa molto; aspettare rischia di ritrovarsi impreparati.",
      leftText: 'Aspetta tempi migliori', leftEffects: { gold: +5, army: -5 },
      rightText: 'Acquista rifornimenti ora', rightEffects: { gold: -12, army: +10 },
      minTurn: 4,
    },
    {
      id: 'plague_quarantine', tags: ['people', 'army'],
      speaker: 'Maester medico', speakerRole: 'Crisi sanitaria',
      portrait: '🤒', icon: '🤒',
      text: "Una malattia sta colpendo l'esercito nei campi. La quarantena salverebbe vite ma paralizzerebbe l'esercito per settimane. Ignorarla potrebbe diffondere il contagio in tutta la regione.",
      leftText: 'Ignora — la guerra non aspetta', leftEffects: { army: -12, people: -8 },
      rightText: 'Quarantena immediata', rightEffects: { army: -6, people: +10, faith: +5 },
      minTurn: 5,
    },
    {
      id: 'old_alliance_memory', tags: ['power', 'people'],
      speaker: 'Araldo di un vecchio alleato', speakerRole: 'Lettera dal passato',
      portrait: '📜', icon: '📜',
      text: "Una casata ricorda un vecchio patto di sangue. Onorandolo si guadagna rispetto e lealtà antica; ignorarlo è tecnicamente legale ma eticamente discutibile.",
      leftText: 'Il patto è prescritto', leftEffects: { power: -6, people: -5 },
      rightText: 'Onora il patto antico', rightEffects: { power: +8, people: +8, gold: -6 },
      minTurn: 7,
    },
    {
      id: 'catspaw_mystery', tags: ['power', 'faith'],
      speaker: 'Lord Varys', speakerRole: "Maestro degli Esploratori",
      excludeChars: ['tormund','arya','bronn','theon'],
      portrait: '🕵️', icon: '🕵️',
      text: "Varys vi informa: qualcuno ha assoldato un sicario contro uno dei vostri vassalli. L'attentato fallito ha lasciato tracce — ma seguirle potrebbe aprire un vaso di Pandora.",
      leftText: 'Lascia perdere', leftEffects: { power: -5 },
      rightText: 'Indaga fino in fondo', rightEffects: { gold: -8, power: +6 },
      minTurn: 8,
    },

    // ══════════════════════════════════════════════════════════════════
    // ── NUOVE CARTE MARGAERY ──
    // ══════════════════════════════════════════════════════════════════

    {
      id: 'margaery_smallfolk_visit', tags: ['people', 'faith'], forChars: ['margaery'],
      speaker: 'Ser Loras Tyrell', speakerRole: 'Fratello della Regina',
      portrait: '🌹', icon: '🌹',
      text: "Loras vi suggerisce di visitare i quartieri poveri con cibo e medicine. «Il popolo ama chi lo vede, sorella. E un re ama una regina amata dal popolo.»",
      leftText: 'Delega ai servitori', leftEffects: { people: +5 },
      rightText: 'Vai in persona tra la gente', rightEffects: { people: +14, faith: +8, power: +3 },
      minTurn: 2,
    },
    {
      id: 'margaery_olenna_plan', tags: ['power', 'gold'], forChars: ['margaery'],
      speaker: 'Lady Olenna Tyrell', speakerRole: 'La Regina delle Spine',
      portrait: '🌹', icon: '🌹',
      text: "Olenna vi passa una nota cifrata: «Ho un piano per eliminare un ostacolo. Non ti chiedo di sapere i dettagli. Ti chiedo solo di non essere in quella stanza quella notte.»",
      leftText: 'Rifiuta, troppo pericoloso', leftEffects: { power: -5, gold: +5 },
      rightText: 'Segui il consiglio di Olenna', rightEffects: { power: +10, gold: +8, faith: -10 },
      minTurn: 5,
    },
    {
      id: 'margaery_sept_ceremony', tags: ['faith', 'people'], forChars: ['margaery'],
      speaker: 'Gran Septon', speakerRole: 'Cerimonia religiosa reale',
      portrait: '⭐', icon: '⭐',
      text: "Il Gran Septon propone una cerimonia pubblica in cui la Regina si inginocchia davanti ai Sette. Il popolo adorerebbe l'umiltà; i nobili la leggerebbero come debolezza.",
      leftText: 'Declina elegantemente', leftEffects: { faith: -5, power: +3 },
      rightText: 'Partecipa con devozione', rightEffects: { faith: +14, people: +10, power: -5 },
      minTurn: 3,
    },
    {
      id: 'margaery_joffrey_temper', tags: ['power', 'people'], forChars: ['margaery'],
      speaker: 'Cameriera personale', speakerRole: 'Avviso riservato',
      portrait: '👑', icon: '👑',
      text: "Re Joffrey ha avuto uno scatto di rabbia in pubblico. Potete cercare di calmarlo e distrarlo — oppure distanziarvi strategicamente prima che la situazione degeneri.",
      leftText: 'Distanziati politicamente', leftEffects: { power: +3, people: -5 },
      rightText: 'Calmalo e sostieni la sua immagine', rightEffects: { power: +8, people: +5, gold: -5 },
      minTurn: 3,
    },
    {
      id: 'margaery_tyrell_gold', tags: ['gold', 'power'], forChars: ['margaery'],
      speaker: 'Mace Tyrell', speakerRole: 'Padre e Lord di Altogarden',
      portrait: '💰', icon: '💰',
      text: "Vostro padre offre di inviare un convoglio di rifornimenti da Altogarden — pane, oro, soldati. «La Corona deve sapere che Casa Tyrell è la sua colonna portante.»",
      leftText: 'Accetta con umiltà', leftEffects: { gold: +14, people: +8 },
      rightText: "Richiedi più truppe invece dell'oro", rightEffects: { army: +12, gold: +5, power: +3 },
      minTurn: 2,
    },
    {
      id: 'margaery_rumor_cersei', tags: ['power', 'faith'], forChars: ['margaery'],
      speaker: 'Lady Alerie Tyrell', speakerRole: 'Madre discreta',
      portrait: '👂', icon: '👂',
      text: "Vostra madre ha intercettato una voce: Cersei sta raccogliendo prove contro di voi presso la Fede Militante. Potete agire subito — o ignorare e rischiare.",
      leftText: 'Ignora, sono solo voci', leftEffects: { power: -8 },
      rightText: 'Agisci preventivamente', rightEffects: { gold: -10, power: +10, faith: -6 },
      minTurn: 6,
    },
    {
      id: 'margaery_prisoner_mercy', tags: ['faith', 'people'], forChars: ['margaery'],
      speaker: 'Prigioniero di guerra', speakerRole: 'Supplica dalla prigione reale',
      portrait: '🕊️', icon: '🕊️',
      text: "Un signore prigioniero chiede la vostra intercessione per la sua famiglia. Aiutarlo non vi dà nulla di tangibile — ma la sua casata ricorderà.",
      leftText: 'Non ti riguarda', leftEffects: {},
      rightText: 'Intercedi per lui', rightEffects: { faith: +10, people: +8, power: +5 },
      minTurn: 4,
    },
    {
      id: 'margaery_spy_flowers', tags: ['power', 'gold'], forChars: ['margaery'],
      speaker: 'Giardiniera fidata', speakerRole: 'Messaggio nascosto in un mazzo',
      portrait: '💐', icon: '💐',
      text: "Una delle vostre donne ha acquisito informazioni riservate su un altro nobile. Potete usarle come leva politica — oppure distruggerle per mantenere la vostra immagine pulita.",
      leftText: 'Brucia le informazioni', leftEffects: { faith: +6, people: +5 },
      rightText: 'Usale come leva', rightEffects: { power: +10, gold: +6 },
      minTurn: 5,
    },
    ...
    {
      id: 'tormund_clan_war', tags: ['army', 'power'], forChars: ['tormund'],
      speaker: 'Anziano della tribù', speakerRole: 'Riunione dei Liberi',
      portrait: '🪓', icon: '🪓',
      text: "Due clan sono sul punto di guerra per una questione di territorio. Come leader riconosciuto, potete imporre un accordo brutale — o lasciarli scontrarsi e raccogliere i superstiti.",
      leftText: 'Lasciali combattere', leftEffects: { army: -8, power: -5 },
      rightText: 'Imponi la pace con la forza', rightEffects: { army: +5, power: +10, people: +5 },
      minTurn: 3,
    },
    {
      id: 'tormund_giant_alliance', tags: ['army', 'people'], forChars: ['tormund'],
      speaker: 'Wun Wun', speakerRole: 'Ultimo dei Giganti',
      portrait: '🧊', icon: '🧊',
      text: "Wun Wun è disposto a combattere al vostro fianco. I Corvi e gli uomini del Sud sono terrorizzati dai Giganti — ma un gigante alleato vale dieci guerrieri.",
      leftText: "Troppo complicato, vai per conto tuo", leftEffects: { power: -5 },
      rightText: 'Combattiamo insieme', rightEffects: { army: +14, people: -5, faith: -8 },
      minTurn: 2,
    },
    {
      id: 'tormund_crow_tensions', tags: ['power', 'army'], forChars: ['tormund'],
      speaker: 'Ser Alliser Thorne', speakerRole: 'Comandante dei Guardiani',
      portrait: '❄️', icon: '❄️',
      text: "I Corvi non si fidano di voi — e lo fanno capire chiaramente. Potete cercare di convincerli oppure ignorarli del tutto e fare affidamento solo sui Liberi.",
      leftText: 'Chi se ne frega dei Corvi', leftEffects: { army: +5, power: -8 },
      rightText: 'Cerca un punto di incontro', rightEffects: { power: +8, people: +5, army: -5 },
      minTurn: 3,
    },
    {
      id: 'tormund_brienne_heart', tags: ['people', 'power'], forChars: ['tormund'],
      speaker: 'Voce interiore', speakerRole: 'Momento di vulnerabilità',
      portrait: '❤️', icon: '❤️',
      text: "Brienne vi guarda con quei suoi occhi grandi. I vostri guerrieri ridono dei vostri tentativi di corteggiamento. Ma voi non vi vergognate di niente.",
      leftText: 'Ignorala, ci sono battaglie da vincere', leftEffects: { army: +3 },
      rightText: 'Mostrale chi sei davvero', rightEffects: { people: +12, power: +3 },
      minTurn: 4,
    },
    {
      id: 'tormund_wildfire_cold', tags: ['army', 'faith'], forChars: ['tormund'],
      speaker: 'Sciamana del ghiaccio', speakerRole: 'Rituale di preparazione',
      portrait: '🌨️', icon: '🌨️',
      text: "Una sciamana offre un rituale per preparare i guerrieri al freddo letale. Doloroso, costoso in uomini — ma chi sopravvive diventa immune al gelo.",
      leftText: 'Non torturiamo i nostri guerrieri', leftEffects: { faith: +5 },
      rightText: 'Fai il rituale', rightEffects: { army: -5, faith: -8, people: +10 },
      minTurn: 4,
      onRightChoose: () => {
        state.resources.army = Math.min(state.resources.army + 14, 100);
        showToast('🌨️ I sopravvissuti al rituale sono diventati guerrieri del gelo. +14 esercito.', 'good');
        updateHUD(); saveGame();
      },
    },
    ...
    {
      id: 'ygritte_jon_tension', tags: ['power', 'people'], forChars: ['ygritte'],
      speaker: 'Jon Snow', speakerRole: 'Il Corvo Rinnegato',
      portrait: '❄️', icon: '❄️',
      text: "Jon vi guarda con quegli occhi da stupido del Sud. Dice che conosce poco. Ma voi sapete che ha il cuore giusto — forse anche l'utilità giusta.",
      leftText: 'Tienilo a distanza', leftEffects: { power: +3, army: +5 },
      rightText: 'Fidati di lui questa volta', rightEffects: { people: +12, power: +5 },
      minTurn: 2,
    },
    {
      id: 'ygritte_arrow_choice', tags: ['army', 'power'], forChars: ['ygritte'],
      speaker: 'Mance Rayder', speakerRole: 'Re oltre il Muro',
      portrait: '🏹', icon: '🏹',
      text: "Mance vi ordina di uccidere un Corvo disarmato per dimostrare fedeltà. Farlo rinforza la vostra posizione tra i Liberi. Rifiutare vi costerebbe tutto.",
      leftText: 'Rifiuta — non è il tuo stile', leftEffects: { power: -10, people: +8 },
      rightText: 'Obbedisci a Mance', rightEffects: { army: +8, power: +8, faith: -10 },
      minTurn: 3,
    },
    {
      id: 'ygritte_cave_secret', tags: ['faith', 'people'], forChars: ['ygritte'],
      speaker: 'Anziana sciamana', speakerRole: 'Custode dei segreti del Nord',
      portrait: '🔮', icon: '🔮',
      text: "Una vecchia sciamana vi rivela la posizione di un sito sacro dei Liberi. Condividerlo con i vostri potrebbe unire le tribù. Ma profanarlo porta sfortuna.",
      leftText: 'Tieni il segreto per te', leftEffects: { faith: +8 },
      rightText: 'Condividi la notizia', rightEffects: { people: +14, faith: -8, army: +5 },
      minTurn: 3,
    },
    {
      id: 'ygritte_raiders_lead', tags: ['army', 'gold'], forChars: ['ygritte'],
      speaker: 'Tormund Giantsbane', speakerRole: 'Compagno di razzie',
      portrait: '🪓', icon: '🪓',
      text: "Tormund propone una razia su un villaggio del Sud ricco e mal difeso. Bottino garantito — ma lascerete odio e cenere al vostro passaggio.",
      leftText: 'Lascia perdere', leftEffects: { army: +3 },
      rightText: 'Guida la razia', rightEffects: { gold: +14, army: +5, people: -10, faith: -8 },
      minTurn: 2,
    },
    {
      id: 'ygritte_defector_news', tags: ['power', 'army'], forChars: ['ygritte'],
      speaker: 'Disertore dei Corvi', speakerRole: 'Informatore',
      portrait: '🕵️', icon: '🕵️',
      text: "Un Corvo disertore porta informazioni sulle difese del Muro. Le informazioni sono preziose — ma potrebbe essere una trappola.",
      leftText: 'Non fidarti', leftEffects: { power: +3 },
      rightText: "Usa le informazioni", rightEffects: { army: +10, power: +6 },
      minTurn: 4,
      onRightChoose: () => {
        if (Math.random() > 0.35) {
          showToast('🕵️ Le informazioni erano genuine. Il Muro ha una debolezza sfruttabile.', 'good');
          state.resources.army = Math.min(state.resources.army + 6, 100);
        } else {
          showToast('🕵️ Era una trappola! Un\'imboscata dei Corvi decimò un gruppo avanzato.', 'bad');
          state.resources.army = Math.max(0, state.resources.army - 10);
        }
        updateHUD(); saveGame();
      },
    },
    ...
    {
      id: 'stannis_seaworth_loyalty', tags: ['people', 'army'], forChars: ['stannis'],
      speaker: 'Ser Davos Seaworth', speakerRole: 'Il Cavaliere della Cipolla',
      portrait: '⚓', icon: '⚓',
      text: "Davos propone di liberare dei prigionieri comuni per guadagnare il favore del popolo. «La giustizia non è solo punire, Maestà. È anche mostrare misericordia quando la si può.»",
      leftText: 'La legge non conosce sconti', leftEffects: { power: +3, faith: +5 },
      rightText: 'Libera i prigionieri', rightEffects: { people: +14, army: +3, power: -5 },
      minTurn: 3,
    },
    {
      id: 'stannis_blackwater_prep', tags: ['army', 'power'], forChars: ['stannis'],
      speaker: 'Ammiraglio Stannis', speakerRole: 'Pianificazione navale',
      portrait: '🚢', icon: '🚢',
      text: "La flotta è pronta per l'attacco ad Approdo del Re. Melisandre dice che le stelle favoriscono questa luna. Davos dice che è follia. Chi ascoltate?",
      leftText: 'Ascolta Davos, aspetta', leftEffects: { army: +5, power: -5 },
      rightText: 'Segui Melisandre, attacca ora', rightEffects: { army: -8, power: +10, faith: +8 },
      minTurn: 5,
    },
    {
      id: 'stannis_dragonstone_tax', tags: ['gold', 'power'], forChars: ['stannis'],
      speaker: 'Mastro delle Monete', speakerRole: 'Rapporto fiscale di Draconite',
      portrait: '🏰', icon: '🏰',
      text: "I signori di Draconite chiedono una riduzione delle tasse in cambio di lealtà formale. Rifiutare è nel vostro diritto. Accettare è una concessione politica.",
      leftText: 'Nessuna concessione', leftEffects: { gold: +10, power: -5, people: -5 },
      rightText: 'Accordo fiscale limitato', rightEffects: { gold: +5, power: +5, people: +5 },
      minTurn: 3,
    },
    {
      id: 'stannis_red_witch_price', tags: ['faith', 'army'], forChars: ['stannis'],
      speaker: 'Melisandre', speakerRole: 'Sacerdotessa di R\'hllor',
      portrait: '🔥', icon: '🔥',
      text: "Melisandre chiede di sacrificare un bastardo reale al Signore della Luce per garantire la vittoria. «Il re sangue fa risorgere la fiamma, Vostra Maestà.»",
      leftText: 'Rifiuto — è mio figlio', leftEffects: { faith: -10, army: +5, people: +8 },
      rightText: 'Il Signore della Luce vuole così', rightEffects: { faith: +14, army: +12, people: -14 },
      minTurn: 8,
    },
    {
      id: 'stannis_victory_terms', tags: ['power', 'people'], forChars: ['stannis'],
      speaker: 'Araldo dei vinti', speakerRole: 'Trattativa post-battaglia',
      portrait: '⚖️', icon: '⚖️',
      text: "Una casata nemica chiede la resa in cambio di termini onorevoli. Stannis non crede alle rese a metà — ma la clemenza potrebbe portare alleati inattesi.",
      leftText: 'Resa incondizionata o nulla', leftEffects: { power: +5, people: -8 },
      rightText: 'Accetta la resa con termini', rightEffects: { power: +3, people: +10, army: +5 },
      minTurn: 6,
    },
    {
      id: 'stannis_iron_will', tags: ['power', 'faith'], forChars: ['stannis'],
      speaker: 'Cortigiano di Draconite', speakerRole: 'Tensione interna',
      portrait: '⚔️', icon: '⚔️',
      text: "Un Lord alleato vi chiede di «ammorbidire» la vostra posizione su un punto legale per mantenere la coalizione unita. Cedere è contro la vostra natura.",
      leftText: 'Non cedo di un pollice', leftEffects: { power: -5, faith: +8, people: -5 },
      rightText: 'Un compromesso una volta sola', rightEffects: { power: +8, people: +8 },
      minTurn: 4,
    },

    // ══════════════════════════════════════════════════════════════════
    // ── NUOVE CARTE ROBB STARK ──
    // ══════════════════════════════════════════════════════════════════

    {
      id: 'robb_grey_wind', tags: ['army', 'people'], forChars: ['robb'],
      speaker: 'Grigio Vento', speakerRole: 'Il tuo direwolf',
      portrait: '🐺', icon: '🐺',
      text: "Grigio Vento ha ringhiato contro il nuovo consigliere. I direwolf sentono cose che gli uomini non vedono. Fidarsi dell'istinto del lupo potrebbe costarvi un alleato.",
      leftText: 'Ignora il lupo', leftEffects: { army: +5, power: +3 },
      rightText: 'Ascolta Grigio Vento', rightEffects: { army: +8, power: -5, people: +8 },
      minTurn: 3,
    },
    {
      id: 'robb_broken_oath', tags: ['power', 'faith'], forChars: ['robb'],
      speaker: 'Lord Bolton', speakerRole: 'Consigliere di guerra',
      portrait: '🩸', icon: '🩸',
      text: "Avete promesso a Walder Frey una cosa che ora non potete mantenere. Bolton vi consiglia di minimizzare e andare avanti. L'onore nordico però non si dimentica.",
      leftText: "Non puoi mantenere la promessa", leftEffects: { power: -10, faith: -8 },
      rightText: 'Onora la promessa a tutti i costi', rightEffects: { power: -5, faith: +14, people: +8 },
      minTurn: 4,
    },
    {
      id: 'robb_talisa_love', tags: ['people', 'faith'], forChars: ['robb'],
      speaker: 'Talisa Maegyr', speakerRole: 'Guaritrice dei campi di battaglia',
      portrait: '💙', icon: '💙',
      text: "Talisa è rimasta ferita curandovi i soldati. I vostri uomini la rispettano. Lei vi guarda come se sapesse già cosa sceglierete. Voi lo sapete anche voi.",
      leftText: 'Mantenete la distanza', leftEffects: { power: +3 },
      rightText: 'Segui il cuore', rightEffects: { people: +12, faith: +6, power: -8 },
      minTurn: 4,
    },
    {
      id: 'robb_north_rebellion', tags: ['army', 'power'], forChars: ['robb'],
      speaker: 'Lord Karstark', speakerRole: 'Lord di Fronte di Karhold',
      portrait: '🐻', icon: '🐻',
      text: "Lord Karstark ha ucciso due prigionieri Lannister per vendetta. La legge del Nord impone l'esecuzione. Ma perdere i Karstark indebolisce il vostro esercito del 20%.",
      leftText: 'La rabbia di Karstark è comprensibile', leftEffects: { army: +5, power: -8, faith: -8 },
      rightText: 'Applica la legge — decapita Karstark', rightEffects: { army: -10, power: +5, faith: +10 },
      minTurn: 5,
    },
    {
      id: 'robb_lannister_prisoner', tags: ['power', 'gold'], forChars: ['robb'],
      speaker: 'Catelyn Stark', speakerRole: 'Madre e consigliera',
      portrait: '🐟', icon: '🐟',
      text: "Avete in mano Jaime Lannister. Potete usarlo per un riscatto immenso, scambiarlo per le vostre sorelle, o tenerlo come pedina nelle trattative di pace.",
      leftText: 'Riscatto in oro', leftEffects: { gold: +14, power: -5 },
      rightText: 'Scambialo per le sorelle', rightEffects: { people: +10, power: -5, army: +3 },
      minTurn: 3,
    },
    {
      id: 'robb_war_council', tags: ['army', 'power'], forChars: ['robb'],
      speaker: 'Consiglio di guerra nordico', speakerRole: 'Riunione strategica',
      portrait: '⚔️', icon: '⚔️',
      text: "I vostri Lord discutono la strategia: attacco diretto ad Approdo del Re contro guerriglia prolungata nei Riverlands. Entrambe le opzioni hanno meriti e rischi.",
      leftText: 'Guerriglia lunga nei Riverlands', leftEffects: { army: +8, gold: -8, power: +3 },
      rightText: 'Attacco diretto alla capitale', rightEffects: { army: -10, power: +10, people: -5 },
      minTurn: 6,
    },

    // ══════════════════════════════════════════════════════════════════
    // ── NUOVE CARTE OBERYN MARTELL ──
    // ══════════════════════════════════════════════════════════════════

    {
      id: 'oberyn_dorne_spies', tags: ['power', 'army'], forChars: ['oberyn'],
      speaker: 'Ellaria Sand', speakerRole: 'Amante e consigliera',
      portrait: '☀️', icon: '☀️',
      text: "Ellaria vi informa: le vostre spie a Approdo del Re hanno scoperto qualcosa di prezioso su un alto Lord Lannister. Usarlo come ricatto o come prova pubblica?",
      leftText: 'Ricatto privato', leftEffects: { gold: +14, power: +5 },
      rightText: 'Denuncia pubblica', rightEffects: { power: +8, people: +8, faith: -5 },
      minTurn: 4,
    },
    {
      id: 'oberyn_sand_snakes', tags: ['army', 'power'], forChars: ['oberyn'],
      speaker: 'Obara Sand', speakerRole: 'Figlia di Oberyn',
      portrait: '🐍', icon: '🐍',
      text: "Le vostre figlie Sabbie Bastarde chiedono di agire contro i Lannister senza aspettare il permesso politico. «Elia non può aspettare ancora, padre.»",
      leftText: 'Tratteniamoci — la politica prima', leftEffects: { power: +5, army: -5 },
      rightText: 'Lasciatele agire', rightEffects: { army: +10, power: -8, people: +5 },
      minTurn: 3,
    },
    {
      id: 'oberyn_mountain_grudge', tags: ['army', 'faith'], forChars: ['oberyn'],
      speaker: 'Voce interiore', speakerRole: 'La voce di Elia',
      portrait: '⚡', icon: '⚡',
      text: "Gregor Clegane — La Montagna. Responsabile di ciò che non si dimentica. Avete un'occasione legale di sfidarlo in combattimento. I rischi sono alti. Ma l'onore di Elia grida.",
      leftText: 'Non è il momento giusto', leftEffects: { faith: -5, power: -5 },
      rightText: 'Sfida la Montagna per Elia', rightEffects: { faith: +14, people: +10, army: -5 },
      minTurn: 5,
    },
    {
      id: 'oberyn_dorne_isolation', tags: ['gold', 'power'], forChars: ['oberyn'],
      speaker: 'Doran Martell', speakerRole: 'Principe di Dorne',
      portrait: '🌴', icon: '🌴',
      text: "Doran vi ordina di mantenere la neutralità — non provocare i Lannister. «La pazienza è la nostra arma più affilata, Oberyn.» Ma la pazienza ha un costo.",
      leftText: 'Obbedisci a Doran', leftEffects: { power: +5, gold: +8 },
      rightText: 'Ignora gli ordini, agisci', rightEffects: { power: -8, army: +10, faith: +5 },
      minTurn: 4,
    },
    {
      id: 'oberyn_poison_mastery', tags: ['army', 'power'], forChars: ['oberyn'],
      speaker: 'Maester di Dorne', speakerRole: 'Laboratoria di Sunspear',
      portrait: '☠️', icon: '☠️',
      text: "Il vostro veleno più sofisticato è pronto. Potete usarlo su un nemico specifico o venderlo per un prezzo astronomico alle Città Libere.",
      leftText: 'Vendilo a Braavos', leftEffects: { gold: +14 },
      rightText: 'Usalo contro un nemico', rightEffects: { power: +10, army: +8, faith: -10 },
      minTurn: 6,
    },
    ...
    {
      id: 'cersei_golden_crown', tags: ['power', 'people'], forChars: ['cersei'],
      speaker: 'Lord Varys', speakerRole: 'Maestro degli Esploratori',
      portrait: '🕷️', icon: '🕷️',
      text: "Varys vi informa: il consenso popolare verso la Corona sta scendendo. «La gente si aspetta azioni, Vostra Maestà — generosità o forza, scegliete.»",
      leftText: 'Distribuisci pane e oro', leftEffects: { gold: -12, people: +14 },
      rightText: 'Dimostrazione di forza militare', rightEffects: { army: -5, power: +8, people: -8 },
      minTurn: 3,
    },
    {
      id: 'cersei_tywin_shadow', tags: ['power', 'faith'], forChars: ['cersei'],
      speaker: 'Fantasma di Tywin', speakerRole: 'Voce nella notte',
      portrait: '🦁', icon: '🦁',
      text: "Vi svegliate pensando a vostro padre. Lui avrebbe già eliminato ogni rivale. Ma forse l'ombra di Tywin pesa sulla vostra mente più del necessario.",
      leftText: 'Non sei Tywin — sii te stessa', leftEffects: { people: +8, faith: +5 },
      rightText: 'Agisci come agirebbe lui', rightEffects: { power: +10, army: +5, people: -8 },
      minTurn: 4,
    },
    {
      id: 'cersei_faith_militant_deal', tags: ['faith', 'army'], forChars: ['cersei'],
      speaker: 'Sumo Septon', speakerRole: 'Leader della Fede Militante',
      portrait: '✝️', icon: '✝️',
      text: "Il Sumo Septon offre supporto della Fede Militante in cambio di concessioni. «Armate la Fede e Approdo del Re sarà sicura, Maestà.» Un'offerta che potrebbe rivoltarsi.",
      leftText: 'Rifiuta — non armare fanatici', leftEffects: { faith: -8, power: +3 },
      rightText: 'Arma la Fede Militante', rightEffects: { faith: +14, army: +8, power: -10 },
      minTurn: 5,
    },
    {
      id: 'cersei_joffrey_control', tags: ['power', 'people'], forChars: ['cersei'],
      speaker: 'Consiglio ristretto', speakerRole: 'Udienza privata',
      portrait: '👑', icon: '👑',
      text: "Joffrey ha preso una decisione pubblica palesemente sbagliata. Potete sostenerlo per apparire uniti o correggerlo in privato rischiando una scenata reale.",
      leftText: 'Sostieni pubblicamente Joffrey', leftEffects: { power: +5, people: -8 },
      rightText: 'Correggilo in privato con fermezza', rightEffects: { power: +3, people: +8 },
      minTurn: 2,
    },
    {
      id: 'cersei_wine_secrets', tags: ['power', 'gold'], forChars: ['cersei'],
      speaker: 'Servitore fidato', speakerRole: 'Notte a Approdo del Re',
      portrait: '🍷', icon: '🍷',
      text: "Tra un calice e l'altro avete raccolto informazioni scottanti su un Lord del Consiglio. Potete usarle subito o custodirle per il momento più opportuno.",
      leftText: 'Custodisci per dopo', leftEffects: { power: +3 },
      rightText: 'Usa le informazioni ora', rightEffects: { power: +10, gold: +8, people: -5 },
      minTurn: 4,
    },
    {
      id: 'cersei_lannister_allies', tags: ['army', 'gold'], forChars: ['cersei'],
      speaker: 'Kevan Lannister', speakerRole: 'Zio e consigliere',
      portrait: '🦁', icon: '🦁',
      text: "Kevan propone di richiamare i signori Lannister fedeli con un compenso generoso. «Il leone ruggisce solo se ben nutrito, Cersei.»",
      leftText: 'Le casse non lo permettono', leftEffects: { army: -5 },
      rightText: 'Paga e raduna i Lannister', rightEffects: { gold: -14, army: +14, power: +5 },
      minTurn: 4,
    },

    // ══════════════════════════════════════════════════════════════════
    // ── NUOVE CARTE NED STARK ──
    // ══════════════════════════════════════════════════════════════════

    {
      id: 'ned_kings_hand', tags: ['power', 'faith'], forChars: ['ned'],
      speaker: 'Re Robert Baratheon', speakerRole: 'Il Re',
      portrait: '🐺', icon: '🐺',
      text: "Robert vi chiede di essere la sua Mano del Re. «Non c'è uomo più onesto nel regno, Ned.» È un onore — ma Approdo del Re è un posto pericoloso per gli uomini onesti.",
      leftText: "Declina l'incarico", leftEffects: { power: -5, people: +5 },
      rightText: 'Accetta per dovere verso Robert', rightEffects: { power: +10, faith: +5, people: -5 },
      minTurn: 2,
    },
    {
      id: 'ned_bastard_secret', tags: ['power', 'faith'], forChars: ['ned'],
      speaker: 'Maester Luwin', speakerRole: 'Consiglio privato',
      portrait: '📜', icon: '📜',
      text: "Avete scoperto qualcosa di devastante sulla legittimità del trono. Portarlo alla luce è la cosa giusta — ma potrebbe costare la vita a voi e alla vostra famiglia.",
      leftText: 'Taci per proteggere la famiglia', leftEffects: { power: +3, faith: -10 },
      rightText: "Rivela la verità al mondo", rightEffects: { faith: +14, power: -12, people: +8 },
      minTurn: 4,
    },
    {
      id: 'ned_wolf_pups', tags: ['people', 'army'], forChars: ['ned'],
      speaker: 'Robb Stark', speakerRole: 'Vostro figlio',
      portrait: '🐺', icon: '🐺',
      text: "I vostri figli hanno trovato dei cuccioli di lupo mannaro. Tenerli rafforza il legame dei Stark con la terra del Nord. Mandarli via è più sicuro.",
      leftText: 'Mandate i lupi via', leftEffects: { army: +3 },
      rightText: 'I lupi restano con i Stark', rightEffects: { people: +12, army: +5, faith: +5 },
      minTurn: 1,
    },
    {
      id: 'ned_northern_justice', tags: ['faith', 'power'], forChars: ['ned'],
      speaker: 'Giustizia del Nord', speakerRole: 'Esecuzione pubblica',
      portrait: '⚔️', icon: '⚔️',
      text: "Un disertore della Guardia della Notte è stato catturato. La legge del Nord è chiara. L'esecuzione va fatta — e il Lord di Grande Inverno la conduce di persona.",
      leftText: 'Delega a un tenente', leftEffects: { power: -5, faith: -5 },
      rightText: 'Alza la spada tu stesso', rightEffects: { power: +3, faith: +12, people: +5 },
      minTurn: 1,
    },
    {
      id: 'ned_catelyn_counsel', tags: ['people', 'power'], forChars: ['ned'],
      speaker: 'Catelyn Tully Stark', speakerRole: 'Vostra moglie',
      portrait: '🐟', icon: '🐟',
      text: "Catelyn vi avverte: fidarsi dei Lannister è un errore. I suoi istinti raramente sbagliano. Ma la politica richiede alleanze anche difficili.",
      leftText: 'La politica richiede pragmatismo', leftEffects: { power: +6, people: -5 },
      rightText: 'Ascolta Catelyn, diffida dei Lannister', rightEffects: { people: +10, power: -5, faith: +5 },
      minTurn: 3,
    },
    {
      id: 'ned_winter_preparations', tags: ['gold', 'people'], forChars: ['ned'],
      speaker: 'Mastro dei granai', speakerRole: 'Grande Inverno',
      portrait: '❄️', icon: '❄️',
      text: "«L'inverno sta arrivando.» Non è solo uno slogan Stark — è realtà. Preparare i magazzini di Grande Inverno richiede tutto il surplus. Ma la guerra non aspetta l'inverno.",
      leftText: 'La guerra è la priorità', leftEffects: { army: +5, people: -8 },
      rightText: 'Prepara le riserve invernali', rightEffects: { gold: -10, people: +14, faith: +5 },
      minTurn: 2,
    },
    ...
    {
      id: 'catelyn_lysa_sister', tags: ['power', 'gold'], forChars: ['catelyn'],
      speaker: 'Lysa Arryn', speakerRole: 'Vostra sorella alla Valle',
      portrait: '🦅', icon: '🦅',
      text: "Lysa vi offre rifugio alla Valle di Arryn — ma vuole qualcosa in cambio. Le sue condizioni sono strane e il suo comportamento sempre più instabile.",
      leftText: 'Rifiuta il rifugio', leftEffects: { power: -5 },
      rightText: 'Accetta e usa la Valle', rightEffects: { army: +10, power: +5, gold: -8 },
      minTurn: 3,
    },
    {
      id: 'catelyn_tyrion_prisoner', tags: ['power', 'army'], forChars: ['catelyn'],
      speaker: 'Voce interiore', speakerRole: 'Momento di decisione',
      portrait: '🔒', icon: '🔒',
      text: "Avete arrestato Tyrion Lannister credendolo responsabile del tentato omicidio di Bran. Ma le prove sono circostanziali. Liberarlo o portarlo a processo?",
      leftText: 'Liberalo — forse avete sbagliato', leftEffects: { power: -8, gold: +8 },
      rightText: 'Processo alla Valle', rightEffects: { power: -5, army: -5, faith: +5 },
      minTurn: 3,
    },
    {
      id: 'catelyn_robb_warning', tags: ['army', 'power'], forChars: ['catelyn'],
      speaker: 'Catelyn Tully Stark', speakerRole: 'Lettera a Robb',
      portrait: '📜', icon: '📜',
      text: "Robb sta per prendere una decisione militare che vi preoccupa profondamente. Potete intervenire e fermarlo — rischiando di minargli l'autorità — o fidarvi di lui.",
      leftText: 'Fidati di Robb', leftEffects: { army: -5, power: +5 },
      rightText: 'Intervieni e ferma la scelta', rightEffects: { army: +8, power: -8, people: +5 },
      minTurn: 4,
    },
    {
      id: 'catelyn_tully_loyalty', tags: ['people', 'faith'], forChars: ['catelyn'],
      speaker: 'Ser Brynden Tully', speakerRole: 'Vostro zio, il Pesce Nero',
      portrait: '🐟', icon: '🐟',
      text: "Il Pesce Nero vuole radunare i Tully per difendere Pietrarivello. «Il sangue di Tully non ha mai abbandonato le sue terre, nipote.»",
      leftText: 'Resta con Robb nel Nord', leftEffects: { people: -5, army: +3 },
      rightText: 'Torna a difendere Pietrarivello', rightEffects: { people: +12, army: +8, faith: +8 },
      minTurn: 4,
    },
    {
      id: 'catelyn_mothers_grief', tags: ['faith', 'people'], forChars: ['catelyn'],
      speaker: 'Septa Mordane', speakerRole: 'Confidente di sempre',
      portrait: '🕯️', icon: '🕯️',
      text: "Bran non si risveglia. Sansa è a Approdo del Re. Arya è dispersa. Il dolore è paralizzante. La Fede offre conforto — ma la guerra non aspetta.",
      leftText: 'Il dolore può aspettare — la guerra no', leftEffects: { army: +5, people: -8 },
      rightText: 'Cerca pace nella Fede', rightEffects: { faith: +14, people: +5, power: -5 },
      minTurn: 3,
    },
    ...
    {
      id: 'brienne_oath_catelyn', tags: ['faith', 'army'], forChars: ['brienne'],
      speaker: 'Ombra di Catelyn Stark', speakerRole: 'Il tuo giuramento',
      portrait: '🗡️', icon: '🗡️',
      text: "Avete giurato di proteggere le figlie di Lady Catelyn. Ogni scelta che vi allontana da questo scopo pesa sul vostro onore. Ma a volte l'onore richiede sacrifici pratici.",
      leftText: 'Il giuramento guida tutto', leftEffects: { faith: +14, army: -5 },
      rightText: 'Qualche compromesso è necessario', rightEffects: { army: +8, faith: -8 },
      minTurn: 2,
    },
    {
      id: 'brienne_woman_knight', tags: ['people', 'power'], forChars: ['brienne'],
      speaker: 'Cavalieri di Castel Tempesta', speakerRole: 'Derisione pubblica',
      portrait: '⚔️', icon: '⚔️',
      text: "I cavalieri ridono di voi. «Una donna in armatura è uno scherzo.» Potete ignorarli o rispondere con una dimostrazione che non dimenticheranno.",
      leftText: "L'ignoranza non vale risposta", leftEffects: { people: -5, power: +3 },
      rightText: 'Dimostraglielo in combattimento', rightEffects: { army: +8, people: +10, power: +5 },
      minTurn: 2,
    },
    {
      id: 'brienne_jaime_respect', tags: ['power', 'army'], forChars: ['brienne'],
      speaker: 'Ser Jaime Lannister', speakerRole: 'Il prigioniero',
      portrait: '🦁', icon: '🦁',
      text: "Jaime vi provoca continuamente — ma a tratti mostra qualcosa che sembra rispetto genuino. Abbassare la guardia potrebbe essere un errore. O potrebbe essere l'inizio di qualcosa.",
      leftText: 'Mantieni la distanza professionale', leftEffects: { power: +5 },
      rightText: "Fidati della tua percezione di lui", rightEffects: { power: +8, army: +5, people: +5 },
      minTurn: 3,
    },
    {
      id: 'brienne_podrick_trust', tags: ['people', 'gold'], forChars: ['brienne'],
      speaker: 'Podrick Payne', speakerRole: 'Il tuo scudiero',
      portrait: '🛡️', icon: '🛡️',
      text: "Podrick è fedele oltre ogni aspettativa — ma inesperto. Investire nel suo addestramento vi rallenta. Ma un alleato leale vale più di mille mercenari.",
      leftText: 'Non hai tempo per addestrarlo', leftEffects: { army: +3 },
      rightText: 'Addestra Podrick con dedizione', rightEffects: { gold: -6, army: +8, people: +10 },
      minTurn: 2,
    },
    {
      id: 'brienne_sansa_rescue', tags: ['army', 'faith'], forChars: ['brienne'],
      speaker: 'Informatore locale', speakerRole: 'Notizia da Inverno caduto',
      portrait: '🐺', icon: '🐺',
      text: "Avete localizzato Sansa Stark. Salvarla è pericoloso — dovrete attraversare territorio nemico. Ma è il motivo per cui siete qui.",
      leftText: 'Attendi un momento migliore', leftEffects: { power: -5, faith: -5 },
      rightText: 'Vai subito — è il tuo scopo', rightEffects: { army: -8, faith: +14, people: +8 },
      minTurn: 5,
    },
    ...
    {
      id: 'davos_smuggler_past', tags: ['gold', 'power'], forChars: ['davos'],
      speaker: 'Vecchio socio di Bassopietra', speakerRole: 'Voce dal passato',
      portrait: '⚓', icon: '⚓',
      text: "Un vecchio contatto dal vostro passato da contrabbandiere offre una rotta commerciale illegale ma estremamente redditizia. Nessuno saprebbe.",
      leftText: 'Quei giorni sono finiti', leftEffects: { faith: +8 },
      rightText: 'Usa i vecchi canali', rightEffects: { gold: +14, faith: -10, power: -5 },
      minTurn: 2,
    },
    {
      id: 'davos_melisandre_conflict', tags: ['faith', 'people'], forChars: ['davos'],
      speaker: 'Melisandre', speakerRole: 'Sacerdotessa Rossa',
      portrait: '🔥', icon: '🔥',
      text: "Melisandre vi guarda come se poteste bruciare. «Il Cavaliere della Cipolla porta fortuna, ma anche debolezza al Re.» Potete confrontarvi con lei — o evitare lo scontro.",
      leftText: 'Evita il confronto', leftEffects: { faith: -5, people: +5 },
      rightText: 'Sfida apertamente le sue influenze', rightEffects: { faith: -10, people: +12, power: +3 },
      minTurn: 3,
    },
    {
      id: 'davos_common_man', tags: ['people', 'faith'], forChars: ['davos'],
      speaker: 'Popolo di Porto Reale', speakerRole: 'Voce della gente comune',
      portrait: '🧅', icon: '🧅',
      text: "La gente comune vi rispetta perché venite da loro. Potete usare questa fiducia per raccogliere informazioni preziose — o per guadagnare consenso popolare genuino.",
      leftText: 'Usa la fiducia per raccogliere informazioni', leftEffects: { power: +8, people: -3 },
      rightText: 'Costruisci consenso genuino', rightEffects: { people: +14, faith: +6 },
      minTurn: 2,
    },
    {
      id: 'davos_stannis_loyalty', tags: ['power', 'army'], forChars: ['davos'],
      speaker: 'Re Stannis Baratheon', speakerRole: 'Il tuo Re',
      portrait: '🦌', icon: '🦌',
      text: "Stannis vi chiede di compiere qualcosa che viola il vostro codice morale per la causa. «Il Re ha bisogno di voi, Ser Davos.» Obbedite o protestate?",
      leftText: 'Protesta apertamente', leftEffects: { power: -8, faith: +10, people: +5 },
      rightText: 'Obbedisci — Stannis sa cosa fa', rightEffects: { power: +8, army: +5, faith: -8 },
      minTurn: 4,
    },
    {
      id: 'davos_nightswatch_plea', tags: ['faith', 'army'], forChars: ['davos'],
      speaker: 'Inviato del Muro', speakerRole: 'Richiesta urgente',
      portrait: '❄️', icon: '❄️',
      text: "La Guardia della Notte ha bisogno di uomini. Lo sapete da sempre. Potete intercedere presso Stannis per mandare aiuti — ma lui ha altre priorità.",
      leftText: 'Non è il momento', leftEffects: { faith: -5 },
      rightText: 'Insisti con Stannis', rightEffects: { army: -8, faith: +12, people: +8 },
      minTurn: 4,
    },

    // ══════════════════════════════════════════════════════════════════
    // ── NUOVE CARTE GENERICHE AVANZATE ──
    // ══════════════════════════════════════════════════════════════════

    {
      id: 'dragon_egg_rumor', tags: ['faith', 'power'],
      speaker: 'Mercante di Asshai', speakerRole: 'Notizia dall\'est',
      portrait: '🥚', icon: '🥚',
      text: "Voci parlano di un uovo di drago in vendita a Quarth. Il prezzo è astronomico, la veridicità incerta. Ma se fosse vero, cambierebbe ogni equilibrio.",
      leftText: 'Troppo rischioso investire', leftEffects: {},
      rightText: 'Finanzia una spedizione', rightEffects: { gold: -14 },
      minTurn: 8,
      excludeChars: ['tormund','arya','bronn'],
      onRightChoose: () => {
        const roll = Math.random();
        if (roll < 0.05 && !state.hasDragon) {
          // 5% — uovo autentico: nasce un drago!
          state.hasDragon = true;
          if (!state.troops) state.troops = {};
          state.troops['drago'] = 1;
          state.resources.army = Math.min(getResourceCap('army') - 1, getTroopForce());
          showModal('🐉 Un Drago!',
            'L\'uovo era autentico. Nell\'oscurità della notte, tra le fiamme, è nato un drago. Le voci si diffondono in tutta Westeros — nessuno oserà più sfidarvi apertamente. Il drago è ora nel vostro esercito: in battaglia potrete usare la sua abilità speciale una volta per scontro.',
            '🔥', 'Per il Fuoco e il Sangue');
        } else if (roll < 0.40) {
          // 35% — autentico ma solo simbolico
          state.resources.faith = Math.min(getResourceCap('faith') - 1, state.resources.faith + 18);
          state.resources.power = Math.min(getResourceCap('power') - 1, state.resources.power + 10);
          showToast('🥚 L\'uovo era autentico — pietrificato, non schiuso. La leggenda del drago alimenta la vostra fama. +18 Fede, +10 Potere.', 'good');
        } else {
          // 60% — truffa
          showToast('🥚 Una truffa. L\'oro è perso. Ma la storia della vostra ricerca gira per le taverne.', 'bad');
        }
        updateHUD(); saveGame();
      },
    },
    {
      id: 'grand_council_call', tags: ['power', 'people', 'faith'],
      speaker: 'Lord dei Grandi Castelli', speakerRole: 'Richiesta del Piccolo Consiglio',
      excludeChars: ['arya','tormund','bronn','theon'],
      portrait: '🏛️', icon: '🏛️',
      text: "I maggiori Lord chiedono un Grande Consiglio per discutere la successione. Partecipare rafforza la vostra legittimità; boicottarlo vi isola.",
      leftText: 'Boicotta il Consiglio', leftEffects: { power: -8, people: -5 },
      rightText: 'Partecipa e guida il dibattito', rightEffects: { power: +8, people: +8, faith: +5, gold: -8 },
      minTurn: 10,
    },
    {
      id: 'the_old_ways', tags: ['faith', 'army'],
      speaker: 'Druido del bosco', speakerRole: 'I vecchi Dei',
      portrait: '🌳', icon: '🌳',
      text: "Un druido del bosco offre la benedizione degli Dei Antichi alla vostra causa. Pochi ci credono ancora — ma nel Nord, il rito degli alberi-volto ha ancora potere.",
      leftText: 'I vecchi Dei sono folklore', leftEffects: { faith: -5 },
      rightText: 'Onora gli Dei Antichi', rightEffects: { faith: +12, army: +5, people: +8 },
      minTurn: 5,
      excludeChars: ['cersei','jaime','joffrey','tyrion','littlefinger','melisandre','margaery'],
    },
    {
      id: 'horse_lord_envoy', tags: ['army', 'power'],
      speaker: 'Ko Pono', speakerRole: 'Emissario Dothraki',
      portrait: '🐴', icon: '🐴',
      text: "Un emissario Dothraki arriva con una proposta di razzie congiunte contro una casata nemica. I Dothraki sono brutali ma efficaci. Il costo politico è alto.",
      leftText: 'Rifiuta i barbari', leftEffects: { power: +3, faith: +5 },
      rightText: 'Alleanza tattica coi Dothraki', rightEffects: { army: +14, people: -10, faith: -8 },
      minTurn: 6,
      excludeChars: ['ned','catelyn','davos','brienne','stannis','sansa','margaery'],
    },
    {
      id: 'archery_tournament', tags: ['army', 'people'],
      speaker: 'Maestro d\'armi', speakerRole: 'Proposta di addestramento',
      portrait: '🏹', icon: '🏹',
      text: "Un torneo di arceria aperto a tutti — comuni e nobili — permetterebbe di individuare nuovi talenti militari. La gente lo adorerebbe.",
      leftText: 'Non abbiamo tempo per giochi', leftEffects: {},
      rightText: 'Organizza il torneo', rightEffects: { gold: -6, army: +8, people: +10 },
      minTurn: 3,
    },
    {
      id: 'trade_embargo', tags: ['gold', 'power'],
      speaker: 'Mastro dei mercanti', speakerRole: 'Crisi commerciale',
      portrait: '🚫', icon: '🚫',
      text: "Una casata rivale ha imposto un embargo sui vostri commerci. Potete rispondere con un contro-embargo o cercare di negoziare canali alternativi.",
      leftText: 'Contro-embargo immediato', leftEffects: { gold: -8, power: +8, people: -5 },
      rightText: 'Cerca percorsi commerciali alternativi', rightEffects: { gold: -5, power: +3 },
      minTurn: 5,
      onRightChoose: () => {
        state.activeEffects = state.activeEffects || [];
        state.activeEffects.push({ type: 'gold_per_turn', value: 6, turns: 6 });
        showToast('🛤️ Nuovi canali commerciali aperti. +6 oro per 6 turni.', 'good');
      },
    },
    {
      id: 'hidden_library', tags: ['faith', 'power'],
      speaker: 'Maester archivista', speakerRole: 'Scoperta nella fortezza',
      portrait: '📚', icon: '📚',
      text: "Una biblioteca nascosta contiene testi su strategie militari antiche e segreti politici dimenticati. Studiarli richiede tempo e denaro — ma la conoscenza è potere.",
      leftText: 'Non abbiamo tempo per letture', leftEffects: {},
      rightText: 'Finanzia lo studio dei testi', rightEffects: { gold: -8, faith: +8, power: +8 },
      minTurn: 6,
    },
    {
      id: 'village_fire', tags: ['people', 'army'],
      speaker: 'Capovilla disperato', speakerRole: 'Notizia dal territorio',
      portrait: '🔥', icon: '🔥',
      text: "Un incendio doloso ha devastato un villaggio. I sospetti puntano a sabotatori nemici. Potete inviare truppe a proteggere i superstiti o ricostruire con fondi della corona.",
      leftText: 'Invia truppe di protezione', leftEffects: { army: -5, people: +8 },
      rightText: 'Ricostruisci con fondi reali', rightEffects: { gold: -10, people: +14, faith: +5 },
      minTurn: 3,
    },
    {
      id: 'mance_rayder_envoy', tags: ['army', 'power'],
      speaker: 'Emissario di Mance Rayder', speakerRole: 'Il Re Oltre il Muro',
      portrait: '🌨️', icon: '🌨️',
      text: "Mance Rayder offre una tregua temporanea con i Liberi in cambio di aiuto contro i Morti Ambulanti. Un accordo impossibile — o forse l'unico che conta davvero.",
      leftText: 'I Liberi restano nemici', leftEffects: { power: +5, army: +5 },
      rightText: 'Trattativa con Mance', rightEffects: { army: +10, power: -8, faith: +5 },
      minTurn: 7,
      excludeChars: ['cersei','jaime','tyrion','littlefinger','melisandre'],
    },
    {
      id: 'ravens_go_silent', tags: ['power', 'army'],
      speaker: 'Maester delle comunicazioni', speakerRole: 'Rapporto urgente',
      portrait: '🦅', icon: '🦅',
      text: "I corvi messaggeri smettono di arrivare da tre castelli alleati. Silenzio improvviso. Potete inviare una pattuglia di ricognizione o aspettare prima di reagire.",
      leftText: 'Aspetta — potrebbero essere problemi tecnici', leftEffects: { power: -5 },
      rightText: 'Invia pattuglie subito', rightEffects: { army: -6, power: +6 },
      minTurn: 5,
    },
    {
      id: 'stone_men_sighting', tags: ['army', 'faith'],
      speaker: 'Capitano fluviale', speakerRole: 'Notizia dai Valyrian Freeways',
      portrait: '🪨', icon: '🪨',
      text: "Uomini di pietra sono stati avvistati lungo il fiume. La Greyscale si diffonde. Quarantena immediata blocca il commercio; ignorarla rischia un'epidemia.",
      leftText: 'Ignora — le voci esagerano sempre', leftEffects: { people: -10, gold: +5 },
      rightText: 'Quarantena e controlli sanitari', rightEffects: { gold: -8, people: +8, faith: +6 },
      minTurn: 6,
    },
    {
      id: 'dornish_wine', tags: ['faith', 'people'],
      speaker: 'Commerciante dornish', speakerRole: 'Proposta commerciale',
      portrait: '🍷', icon: '🍷',
      text: "Un mercante di Dorne offre esclusiva per i suoi vini rari. Il popolo adorerà la novità. Ma i puristi nordici vedono il vino dornish come un simbolo di decadenza.",
      leftText: 'Rifiuta — non si addice', leftEffects: { faith: +5, people: -3 },
      rightText: 'Accetta l\'esclusiva', rightEffects: { gold: +10, people: +8, faith: -5 },
      minTurn: 3,
    },
    {
      id: 'plague_prayer', tags: ['faith', 'people'],
      speaker: 'Septo maggiore', speakerRole: 'Settimana sacra',
      portrait: '✝️', icon: '✝️',
      text: "Una nuova malattia colpisce i bambini. Il Gran Septo propone settimane di preghiere pubbliche. I Maestri preferiscono erbe e medicine. Chi ha ragione?",
      leftText: 'Sostieni le cure scientifiche', leftEffects: { people: +10, faith: -8 },
      rightText: 'Ordina le preghiere pubbliche', rightEffects: { faith: +14, people: +3, gold: -6 },
      minTurn: 5,
    },
    {
      id: 'castle_expansion', tags: ['power', 'army'],
      speaker: 'Mastro costruttore', speakerRole: 'Piano architettonico',
      portrait: '🏰', icon: '🏰',
      text: "Espandere le mura del castello renderebbe la fortezza quasi inespugnabile. Costo enorme, tempi lunghi — ma un castello forte è un simbolo di potere eterno.",
      leftText: 'Non ora', leftEffects: {},
      rightText: 'Avvia la costruzione', rightEffects: { gold: -14, power: +8, army: +5 },
      minTurn: 8,
    },
    {
      id: 'bread_and_circuses', tags: ['people', 'gold'],
      speaker: 'Mastro dei giochi', speakerRole: 'Proposta di intrattenimento',
      portrait: '🎪', icon: '🎪',
      text: "Il popolo è inquieto. Tre giorni di giochi, musica e cibo gratuito potrebbero placare le tensioni — almeno temporaneamente.",
      leftText: 'Il popolo deve capire i tempi difficili', leftEffects: { people: -8 },
      rightText: 'Organizza i giochi', rightEffects: { gold: -10, people: +14, faith: +4 },
      minTurn: 4,
    },
    {
      id: 'valyrian_relic', tags: ['power', 'faith'],
      speaker: 'Antiquario di Lys', speakerRole: 'Offerta straordinaria',
      portrait: '⚡', icon: '⚡',
      text: "Una reliquia di Valyria è in vendita. I collezionisti farebbero di tutto per averla. Trattenerla aumenterebbe il vostro prestigio; venderla riempirebbe le casse.",
      leftText: 'Vendi alla miglior offerta', leftEffects: { gold: +14, power: -3 },
      rightText: 'Tienila come simbolo di potere', rightEffects: { power: +8, faith: +6 },
      minTurn: 6,
      excludeChars: ['tormund','arya'],
    },
    {
      id: 'harvest_tax_revolt', tags: ['people', 'power'],
      speaker: 'Portavoce dei contadini', speakerRole: 'Assemblea popolare',
      portrait: '✊', icon: '✊',
      text: "I contadini si rifiutano di pagare le tasse del raccolto. Non è ancora una rivolta, ma potrebbe diventarlo. Cedere mostra debolezza; reprimere genera odio.",
      leftText: 'Cedi — riduci le tasse', leftEffects: { gold: -8, people: +12 },
      rightText: 'Mantieni le tasse, usa la forza se serve', rightEffects: { gold: +8, people: -14, army: -5 },
      minTurn: 5,
    },
  ...
  const COUP_PRETENDERS = [
    { id: 'daemon_coup', name: 'Daemon Targaryen', icon: '🐉', house: 'Targaryen',
      flavor: 'Daemon Targaryen ha reclamato il Trono con drago e spada. Il Rinnegato governa ora i Sette Regni.',
      allies: ['Targaryen'], enemies: ['Hightower', 'Lannister'] },
  ...
  function recordAllianceRejection(hId) {
    ...
    if (rec.count === 2 && (state.turn - rec.lastTurn) <= 12) {
      ...
      if (state.turn - rec.lastTurn <= 20) {
        ...
        showEnemyToast(hId, 'Le vostre continue richieste hanno esaurito la loro pazienza. Vi dichiarano nemici.');
  ...
  // ── showEnemyToast: toast visivo con stemma + motivo quando casata → nemica ──
  function showEnemyToast(houseId, reason) {
    const h = state.houses[houseId];
    if (!h) return;
    const hDef = HOUSES_DEF.find(d => d.id === houseId);
    const icon = hDef ? houseIcon(hDef, '1.5rem') : h.icon || '⚔';
    const prev = document.getElementById('enemy-toast-' + houseId);
    if (prev) prev.remove();
    const toast = document.createElement('div');
    toast.id = 'enemy-toast-' + houseId;
    toast.style.cssText = `
      position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);
      z-index:1200;background:rgba(30,6,6,0.97);
      border:1px solid rgba(239,68,68,0.6);border-radius:8px;
      padding:1.1rem 1.4rem;max-width:300px;width:88%;
    ...
    `;
    toast.innerHTML = `
      <div style="font-size:0.55rem;letter-spacing:0.18em;text-transform:uppercase;color:#f87171;opacity:.8">⚔ NUOVA CASATA NEMICA ⚔</div>
      <div style="font-size:2.2rem;line-height:1">${icon}</div>
      <div style="font-family:'Cinzel Decorative',serif;font-size:0.85rem;color:#f87171">Casa ${h.name}</div>
      <div style="font-family:'EB Garamond',serif;font-size:0.82rem;color:#9a8a6a;line-height:1.5;font-style:italic">${reason}</div>
      <button onclick="document.getElementById('enemy-toast-${houseId}')?.remove()" style="margin-top:0.2rem;padding:0.4rem 1.4rem;background:transparent;border:1px solid rgba(239,68,68,0.4);border-radius:3px;font-family:'Cinzel',serif;font-size:0.62rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;cursor:pointer;color:#f87171">Capito</button>
    `;
  ...
  function showCharacterSelect() {
    // In modalità multiplayer la musica è già gestita dall'AudioManager — non ripartire da capo
    if (!Game._mpMode && typeof AudioManager !== 'undefined') AudioManager.playMain();
  ...
  function _showHouseSelect() {
    ...
    const HOUSE_GROUPS = [
      ...
      { id: 'Targaryen', name: 'Casa Targaryen',   icon: '🐉', crest: 'images/houses/Targaryen.png', region: 'Esilio / Dragonstone',  chars: ['daenerys','daemon','rhaenyra','aegon_t'],     color: 'rgba(220,38,38,0.12)',   border: 'rgba(220,38,38,0.45)'  },
  ...
  function initState(char) {
    ...
    state = {
      ...
      faithHighTurns: 0,
      troops: {},          // { milizia: 2, sellaspe: 1, ... }
      hasDragon: false,    // drago nell'esercito (solo da carta evento)
      // ── Memoria diplomatica ──
      diplomaticMemory: {},
    };
  }
  ...
  function startGame() {
    ...
    initSwipe();
    saveGame();
    // In modalità multiplayer la musica è già in corso — non rifà il fade-in da zero
    if (!Game._mpMode && typeof AudioManager !== 'undefined') AudioManager.playMain();
    _maybeTutGame();
  }
  ...
  function updateHUD() {
    ...
    if (char.id === 'arya') {
      ...
      const _objEl = document.getElementById('objective-text');
      if (_objEl) {
        // Usa objective (breve) per la barra; objectiveFull disponibile nel popup
        _objEl.textContent = char.objective || '';
        _objEl.title = char.objectiveFull || char.objective || '';
      }
    }
    ...
    Object.keys(gauges).forEach(key => {
      ...
      if (valEl) {
        if (key === 'army') {
          // Mostra composizione truppe se presenti
          const hasTroops = state.troops && Object.keys(state.troops).length > 0;
          const dragonNote = state.hasDragon ? '🐉' : '';
          const troopNote = hasTroops
            ? TROOP_TYPES.filter(t => (state.troops[t.id]||0) > 0)
                .map(t => `${t.icon}${state.troops[t.id]}`).join('')
            : '';
          const dispNote = dragonNote || troopNote
            ? ` [${[dragonNote, troopNote].filter(Boolean).join('')}]`
            : '';
          valEl.textContent = loanNote
            ? `${Math.round(raw)}(${loanNote})/${cap}${dispNote}`
            : `${Math.round(raw)}/${cap}${dispNote}`;
        } else {
          valEl.textContent = loanNote
    ...
    if (garrisonCount > 0) {
      ...
      if (!capBadge) {
        ...
        capBadge.style.cssText = [
          ...
          'color:#fca5a5','padding:0.14rem 0.5rem',
          'letter-spacing:0.05em','line-height:1.5',
        ].join(';');
        const objBar = document.getElementById('objective-bar');
        if (objBar && objBar.parentNode) objBar.parentNode.insertBefore(capBadge, objBar.nextSibling);
        else document.getElementById('screen-game')?.appendChild(capBadge);
      }
      const totalCost = Object.values(state.garrisons || {}).reduce((s, g) => s + g.costPerCycle, 0);
      const garrisonNames = Object.values(state.garrisons||{}).map(g=>g.name).join(', ');
      // Mostra cap dinamici per risorsa se diversi da 100
      const capBonus = state.conquestCapBonus || {};
      const resIcons = { gold:'💰', army:'⚔', people:'👥', faith:'✝', power:'👑' };
      const capParts = Object.entries(capBonus)
        .filter(([, v]) => v > 0)
        .map(([res, v]) => `${resIcons[res]}cap ${100+v}`)
        .join(' · ');
      const capNote = capParts ? ` · ${capParts}` : '';
      // Mostra cooldown ritirata se attivo
      const retreatNote = (state.retreatWarCooldown && state.turn <= state.retreatWarCooldown)
        ? ` · 🏃 blocco guerra ${state.retreatWarCooldown - state.turn}t` : '';
      capBadge.textContent = `🏰 ${garrisonCount===1?'1 territorio':`${garrisonCount} territori`}: ${garrisonNames} · −${totalCost}💰/5t${capNote}${retreatNote}`;
    } else if (capBadgeEl) {
      capBadgeEl.remove();
    }

    // Mostra badge cooldown ritirata anche senza guarnigioni
    if (!garrisonCount && state.retreatWarCooldown && state.turn <= state.retreatWarCooldown) {
      let capBadge = capBadgeEl;
      if (!capBadge) {
        capBadge = document.createElement('div');
        capBadge.id = 'cap-badge';
      ...
      capBadge.textContent = `🏃 Truppe demoralizzate — nessuna guerra per ${state.retreatWarCooldown - state.turn} turni`;
    }
  ...
  function drawNextCard() {
    ...
    // ── Rendita e costo casate conquistate — ogni 5 turni ──
    if (!_inActiveWar && state.turn % 5 === 0 && state.garrisons && Object.keys(state.garrisons).length > 0) {
      ...
      Object.entries(state.garrisons).forEach(([id, g]) => {
        ...
        if (!h || !h.suppressed) { delete state.garrisons[id]; return; }

        // ── Costo mantenimento (gold) ──
        totalGarrisonCost += g.costPerCycle;
        costLines.push(`${g.icon} ${g.name}`);

        // ── Rendita passiva: ogni casata produce la sua risorsa caratteristica ──
        const houseDef = HOUSES_DEF.find(hd => hd.id === id);
        if (houseDef?.conquestIncome) {
          const cap = getResourceCap();
          const { res, val, label } = houseDef.conquestIncome;
          state.resources[res] = Math.min(cap - 1, state.resources[res] + val);
          incomeLines.push(`${label}`);
        }
      });
      ...
      // Toast riepilogativo
      if (costLines.length > 0 || incomeLines.length > 0) {
        const costMsg  = costLines.length  ? `🏰 Guarnigioni (${costLines.join(', ')}): −${totalGarrisonCost} oro` : '';
        const incMsg   = incomeLines.length ? `📦 Rendite territori: ${incomeLines.join(' · ')}` : '';
        const combined = [costMsg, incMsg].filter(Boolean).join('\n');
        setTimeout(() => showToast(combined, totalGarrisonCost > 0 ? 'warn' : 'good'), 300);
        updateHUD(); saveGame();
      }
    }

    // ── Upkeep truppe reclutate — ogni 5 turni ──
    if (!_inActiveWar && state.turn % 5 === 0 && state.troops && Object.keys(state.troops).length > 0) {
      const upkeep = getTroopUpkeep();
      const cap = getResourceCap();
      const lines = [];
      let canAfford = true;

      // Verifica se può permettersi il mantenimento
      Object.entries(upkeep).forEach(([res, cost]) => {
        if (cost > 0 && state.resources[res] < cost) canAfford = false;
      });

      if (canAfford) {
        Object.entries(upkeep).forEach(([res, cost]) => {
          if (cost > 0) {
            state.resources[res] = Math.max(0, state.resources[res] - cost);
            const icons = { gold:'💰', faith:'✝', people:'👥' };
            lines.push(`−${cost}${icons[res]||res}`);
          }
        });
        if (lines.length > 0) {
          const troopSummary = TROOP_TYPES
            .filter(t => (state.troops[t.id] || 0) > 0)
            .map(t => `${t.icon}×${state.troops[t.id]}`)
            .join(' ');
          setTimeout(() => showToast(`⚔ Mantenimento truppe (${troopSummary}): ${lines.join(' ')} ogni 5 turni`, 'warn'), 500);
        }
      } else {
        // Non può permettersi — diserzione: perde metà delle truppe più costose
        const costlyTypes = TROOP_TYPES
          .filter(t => (state.troops[t.id] || 0) > 0 && t.upkeep && Object.keys(t.upkeep).length > 0)
          .sort((a, b) => (b.upkeep.gold || 0) - (a.upkeep.gold || 0));

        let deserted = [];
        costlyTypes.forEach(t => {
          if ((state.troops[t.id] || 0) > 0) {
            const lost = Math.ceil((state.troops[t.id] || 0) / 2);
            state.troops[t.id] = Math.max(0, state.troops[t.id] - lost);
            if (state.troops[t.id] === 0) delete state.troops[t.id];
            deserted.push(`${t.icon}×${lost}`);
          }
        });
        if (deserted.length > 0) {
          setTimeout(() => showToast(`💸 Non puoi pagare il mantenimento! ${deserted.join(' ')} disertano — le truppe abbandonano la causa.`, 'bad'), 500);
        }
      }
      // Aggiorna army come riflesso della forza truppe
      state.resources.army = Math.min(getResourceCap('army') - 1, getTroopForce());
      updateHUD(); saveGame();
    }
    ...
    // ── Mantenimento esercito — ogni 5 turni ──
    if (!_inActiveWar && state.turn % 5 === 0) {
      _applyArmyUpkeep();
    }
    ...
    if (state.isPlayerKing && !_inActiveWar) {
      ...
      if (turnsSinceKing > 0 && turnsSinceKing % 8 === 0) {
        ...
        Object.entries(state.houses).forEach(([id, h]) => {
          ...
          if (Math.random() < 0.25) {
            h.status = 'enemy';
            showEnemyToast(id, 'La casata ha atteso troppo senza giurare fedeltà alla Corona. Si ribella apertamente.');
            ...
            showEnemyToast(id, 'Troppo tempo senza giuramento di fedeltà alla Corona. La casata si ribella.');
          }
        });
      }
    }
    ...
    const available = EVENTS.filter(e => {
      ...
      if (charId === 'custom' && state.customCardRole) {
        ...
        if (state.customCardRole === 'shadow' && e.forChars && e.forChars.every(c => ['tyrion','ned','catelyn','sansa','margaery','olenna','jaime','daenerys','cersei','stannis','robb','roose','ramsay','tywin','daemon','rhaenyra','aegon_t'].includes(c))) return false;
      }
      return true;
    });
  ...
  function _resolveCoup(pretender, playerAlerted) {
    // ── DRAGO TARGARYEN: protezione assoluta del re regnante ──
    // Se il GIOCATORE è il re regnante, è Targaryen E ha il drago → il colpo di stato fallisce sempre
    if (state.isPlayerKing && state.hasDragon) {
      const playerHouse = state.character?.house || '';
      if (playerHouse.includes('Targaryen')) {
        showCoupFailedOverlay(pretender, playerAlerted);
        showToast('🐉 Il tuo drago ruggisce — nessuno osa sfidare un Targaryen con il fuoco dalla sua parte. Il complotto è sventato!', 'good');
        return;
      }
    }

    // ── DRAGO TARGARYEN CPU: se il pretendente è Targaryen e ha un drago → riesce sempre al 100% ──
    // Il pretendente Targaryen CPU "ha il drago" se la casa Targaryen è potente (army > 80)
    // oppure se viene da un evento con drago — qui lo modelliamo tramite il flavour del pretendente
    const pretenderIsTargaryen = pretender.house === 'Targaryen';
    const targaryenHouse = state.houses['Targaryen'];
    const targaryenHasDragon = pretenderIsTargaryen && targaryenHouse && (targaryenHouse.army >= 80 || targaryenHouse.hasDragon);
    ...
    // ── Drago Targaryen CPU: colpo garantito al 100% ──
    if (targaryenHasDragon) {
      coupChance = 1.0;
    }

    // Player acting reduces coup chance (only if not already forced)
    if (coupChance < 1.0) {
  ...
  function triggerCoup(pretender) {
    ...
    pretender.enemies.forEach(hId => {
      if (state.houses[hId] && state.houses[hId].status !== 'ally') {
        ...
        showEnemyToast(hId, 'Il pretendente al trono ha riunito i suoi nemici. Questa casata si schiera contro di voi.');
      }
    });
  ...
  function renderCard(card) {
    ...
    // Emoji animate floating sul background per carte speciali
    const _mainCard = document.getElementById('main-card');
    if (_mainCard) {
      if (isKingDecree || isKingChallenge || isThroneLegit) {
        _spawnCardEmojis(_mainCard, '👑', '#c9a84c');
      } else if (isUltimatum || isBetrayConsq) {
        _spawnCardEmojis(_mainCard, '⚔', '#f87171');
      } else if (isWarPending) {
        _spawnCardEmojis(_mainCard, '🔥', '#ea580c');
      } else if (isPactResponse) {
        _spawnCardEmojis(_mainCard, '🩸', '#a855f7');
      } else if (isCoupWarning) {
        _spawnCardEmojis(_mainCard, '🟣', '#7c3aed');
      } else if (isAllyReq) {
        _spawnCardEmojis(_mainCard, '🤝', '#4ade80');
      } else {
        _spawnCardEmojis(_mainCard, null, null);
      }
    }
  ...
  // ── Emoji animate floating sul background delle carte speciali ──
  function _spawnCardEmojis(cardEl, emoji, color) {
    // Rimuovi precedenti
    cardEl.querySelectorAll('.card-emoji-float').forEach(e => e.remove());
    if (!emoji) return;
    const container = document.createElement('div');
    container.className = 'card-emoji-float-wrap';
    container.style.cssText = 'position:absolute;inset:0;overflow:hidden;pointer-events:none;border-radius:8px;z-index:1';
    cardEl.appendChild(container);
    for (let i = 0; i < 12; i++) {
      const span = document.createElement('span');
      span.className = 'card-emoji-float';
      ...
      span.style.cssText = [
        ...
        `font-size:${size}rem`,
        `opacity:0`,
        `animation:cardEmojiFloat ${dur}s ${delay}s ease-in-out infinite`,
        `filter:blur(0.3px)`,
      ].join(';');
  ...
  function makeChoice(side) {
    ...
    if (tags.includes('betray_ally')) {
      ...
      if (betrayedHouses.length > 0) {
        ...
        showEnemyToast(betrayed, 'Il vostro tradimento è stato scoperto. La casata vi considera nemici giurati.');
  ...
  function getResourceCap(res) {
    // Cap base 100 + 15 per ogni conquista sulla risorsa caratteristica della casata
    // Ogni casata conquistata espande solo il cap della sua risorsa specifica
    const bonusCaps = state.conquestCapBonus || {};
    return 100 + (bonusCaps[res] || 0);
  }

  // clamp using dynamic cap
  function clampRes(v, res) {
    return Math.max(0, Math.min(getResourceCap(res), Math.round(v)));
  }
  ...
  function checkGameOver() {
    ...
    if (char.objectiveCheck(state)) {
      // Per obiettivi "trono" — non triggerEnd ma mostra overlay con continua/menu
      if (char.throneObjective && !state._throneObjectiveDone) {
        state._throneObjectiveDone = true;
        _showThroneObjectiveWin(char);
        return;
      }
      return triggerEnd(true, char.icon, `${char.name} Trionfa!`,
        `${char.objectiveFull || char.objective} — Dopo ${state.turn} turni di intrighi, guerre e diplomazia, il vostro nome entrerà nella storia dei Sette Regni.`
      );
    }
    // Obiettivo secondario (dopo vittoria trono)
    if (char.throneObjective && state._throneObjectiveDone && state.isPlayerKing) {
      const allPledged = Object.values(state.houses).every(h => h.suppressed || h.kingAlly || h.status === 'ally');
      if (allPledged) {
        return triggerEnd(true, char.icon, `I Sette Regni Unificati!`,
          `Avete compiuto l'impresa più grande della storia di Westeros. Tutte le casate sono fedeli alla vostra Corona. ${char.name} ha scritto la storia.`
        );
      }
    }
  }
  ...
  // ── Overlay vittoria trono con opzione Continua o Torna al menu ──
  function _showThroneObjectiveWin(char) {
    const ov = document.createElement('div');
    ov.className = 'war-overlay';
    const secondary = char.secondaryObjective || 'Unifica tutte le casate sotto la tua Corona.';
    ov.innerHTML = `
      <div class="war-title" style="color:#c9a84c;font-size:1.1rem">👑 OBIETTIVO COMPIUTO!</div>
      <div class="war-log" style="text-align:center">
        <div style="font-size:2.5rem;margin:0.5rem 0">${char.icon}</div>
        <p class="war-result war-victory" style="font-size:1rem">${char.name} Trionfa!</p>
        <p style="font-family:'EB Garamond',serif;font-size:0.92rem;color:#e8dcc8;line-height:1.6;margin-top:0.5rem;font-style:italic">
          «${char.objectiveFull || char.objective}»
        </p>
        <div style="margin-top:1rem;padding:0.7rem;background:rgba(201,168,76,0.1);border:1px solid rgba(201,168,76,0.3);border-radius:6px">
          <div style="font-family:'Cinzel',serif;font-size:0.65rem;color:#c9a84c;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:0.4rem">📜 OBIETTIVO SECONDARIO</div>
          <div style="font-family:'EB Garamond',serif;font-size:0.88rem;color:#9a8a6a">${secondary}</div>
        </div>
      </div>
      <div style="display:flex;gap:0.75rem;justify-content:center;margin-top:0.5rem;flex-wrap:wrap">
        <button onclick="if(typeof AudioManager!=='undefined')AudioManager.playMainFromWar();this.closest('.war-overlay').remove();Game.restart()" style="padding:0.6rem 1.4rem;background:transparent;border:1px solid rgba(201,168,76,0.4);border-radius:3px;font-family:'Cinzel',serif;font-size:0.68rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;cursor:pointer;color:#c9a84c">
          🏠 Torna al Menu
        </button>
        <button onclick="this.closest('.war-overlay').remove();Game.checkAndContinue()" style="padding:0.6rem 1.4rem;background:linear-gradient(135deg,#78350f,#c9a84c);border:none;border-radius:3px;font-family:'Cinzel',serif;font-size:0.68rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;cursor:pointer;color:#0a0a0f">
          ⚔ Continua a Regnare
        </button>
      </div>
    `;
  ...
  function triggerEnd(won, icon, title, text) {
    ...
    const _eiEl = document.getElementById('ending-icon');
    if (_eiEl) { _eiEl.textContent = ''; _eiEl.innerHTML = icon; }
  ...
  // DIPLOMACY PANEL
  // ══════════════════════════════════════════════
  // SCHEDA DETTAGLIO TRUPPA — popup ritratto + stats
  // ══════════════════════════════════════════════
  function showTroopDetail(typeId) {
    const t = TROOP_TYPES.find(t => t.id === typeId);
    if (!t) return;
    document.getElementById('troop-detail-overlay')?.remove();

    const resIcons = { gold:'💰', faith:'✝', people:'👥', army:'⚔', power:'👑' };
    const costStr  = Object.entries(t.cost||{}).map(([r,v])=>`${resIcons[r]}${v}`).join(' ') || '—';
    const upkStr   = Object.entries(t.upkeep||{}).map(([r,v])=>`${resIcons[r]}${v}`).join(' ') || 'Gratis';

    // Abilità passive formattate
    const passivesHtml = (t.passives||[]).map(p => `
      <div style="display:flex;gap:0.4rem;margin-bottom:0.3rem;padding:0.35rem 0.5rem;background:rgba(201,168,76,0.06);border-left:2px solid ${t.battleColor};border-radius:2px">
        <span style="font-size:0.9rem;flex-shrink:0">${p.icon}</span>
        <div>
          <div style="font-family:'Cinzel',serif;font-size:0.62rem;color:#c9a84c;letter-spacing:0.06em">${p.name}</div>
          <div style="font-family:'EB Garamond',serif;font-size:0.78rem;color:#9a8a6a;line-height:1.4">${p.desc}</div>
        </div>
      </div>`).join('') || `<div style="font-family:'EB Garamond',serif;font-size:0.78rem;color:#6b5e4a;font-style:italic">Nessuna abilità speciale.</div>`;

    const ov = document.createElement('div');
    ov.id = 'troop-detail-overlay';
    ov.style.cssText = 'position:fixed;inset:0;z-index:700;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,0.88);backdrop-filter:blur(6px);animation:fadeIn 0.2s ease';
    ov.innerHTML = `
      <div style="background:#0e0e16;border:1px solid ${t.battleColor}55;border-radius:8px;width:90%;max-width:380px;overflow:hidden;max-height:90vh;overflow-y:auto">
        <!-- Ritratto -->
        <div style="position:relative;height:10rem;background:linear-gradient(180deg,#12121a,#0a0a12);display:flex;align-items:center;justify-content:center;overflow:hidden;border-bottom:1px solid ${t.battleColor}33">
          <img src="images/troops/${t.id}.png" alt="${t.name}"
            style="height:100%;object-fit:cover;opacity:0.92"
            onerror="this.outerHTML='<span style=\\'font-size:5rem\\'>${t.icon}</span>'">
          <div style="position:absolute;inset:0;background:linear-gradient(0deg,#0e0e16 0%,transparent 60%)"></div>
          <div style="position:absolute;bottom:0.6rem;left:0.8rem">
            <div style="font-family:'Cinzel Decorative',serif;font-size:1rem;color:#fff;text-shadow:0 1px 6px rgba(0,0,0,0.9)">${t.name}</div>
            <div style="font-size:0.65rem;color:${t.battleColor};letter-spacing:0.1em;text-transform:uppercase">${t.role||'Combattente'}</div>
          </div>
          <button onclick="document.getElementById('troop-detail-overlay').remove()" style="position:absolute;top:0.5rem;right:0.5rem;background:rgba(0,0,0,0.5);border:1px solid rgba(255,255,255,0.15);border-radius:50%;width:26px;height:26px;cursor:pointer;color:#9a8a6a;font-size:0.8rem">✕</button>
        </div>
        <!-- Stats -->
        <div style="padding:0.9rem 1rem">
          <div style="font-family:'EB Garamond',serif;font-size:0.88rem;color:#c8b99a;line-height:1.6;margin-bottom:0.8rem;font-style:italic">"${t.lore||t.desc}"</div>
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:0.4rem;margin-bottom:0.8rem">
            <div style="padding:0.4rem 0.6rem;background:rgba(74,222,128,0.06);border:1px solid rgba(74,222,128,0.2);border-radius:4px;text-align:center">
              <div style="font-family:'Cinzel',serif;font-size:0.55rem;color:#6b5e4a;letter-spacing:0.08em;text-transform:uppercase">Forza</div>
              <div style="font-family:'Cinzel Decorative',serif;font-size:1rem;color:#4ade80">${t.force}</div>
            </div>
            <div style="padding:0.4rem 0.6rem;background:rgba(248,113,113,0.06);border:1px solid rgba(248,113,113,0.2);border-radius:4px;text-align:center">
              <div style="font-family:'Cinzel',serif;font-size:0.55rem;color:#6b5e4a;letter-spacing:0.08em;text-transform:uppercase">Vita ×</div>
              <div style="font-family:'Cinzel Decorative',serif;font-size:1rem;color:#f87171">${t.hpMult||1}×</div>
            </div>
            <div style="padding:0.4rem 0.6rem;background:rgba(251,191,36,0.06);border:1px solid rgba(251,191,36,0.2);border-radius:4px;text-align:center">
              <div style="font-family:'Cinzel',serif;font-size:0.55rem;color:#6b5e4a;letter-spacing:0.08em;text-transform:uppercase">Costo</div>
              <div style="font-size:0.8rem;color:#fbbf24">${costStr}</div>
            </div>
            <div style="padding:0.4rem 0.6rem;background:rgba(251,146,60,0.06);border:1px solid rgba(251,146,60,0.2);border-radius:4px;text-align:center">
              <div style="font-family:'Cinzel',serif;font-size:0.55rem;color:#6b5e4a;letter-spacing:0.08em;text-transform:uppercase">Mantenim./5t</div>
              <div style="font-size:0.8rem;color:#fb923c">${upkStr}</div>
            </div>
          </div>
          <!-- Abilità passive -->
          <div style="font-family:'Cinzel',serif;font-size:0.62rem;color:#6b5e4a;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:0.4rem">⚡ Abilità Passive</div>
          ${passivesHtml}
        </div>
      </div>`;
  ...
  function showArmyPanel(tab) {
    document.getElementById('army-panel-overlay')?.remove();
    const charId = state.character?.id || '';
    const troops  = state.troops || {};
    const totalForce = getTroopForce();
    const upkeep = getTroopUpkeep();
    const resIcons = { gold:'💰', faith:'✝', people:'👥', army:'⚔', power:'👑' };
    const activeTab = tab || 'esercito';

    // ── SEZIONE ESERCITO ──
    const buildEsercitoTab = () => {
      const upkTotal = Object.entries(upkeep).filter(([,v])=>v>0)
        .map(([r,v])=>`${resIcons[r]}${v}`).join(' ') || '—';

      // Per categoria
      const activeTroops = TROOP_TYPES.filter(t => {
        if (t.onlyFromCard) return state.hasDragon;
        return (troops[t.id]||0) > 0;
      });

      if (activeTroops.length === 0) return `
        <div style="padding:1.5rem;text-align:center;font-family:'EB Garamond',serif;font-size:0.9rem;color:#6b5e4a;font-style:italic">
          Nessuna truppa reclutata.<br>
          <span style="font-size:0.8rem">Il tuo esercito si basa sulla milizia implicita (⚔ ${state.resources.army}).<br>Vai in <strong style="color:#c9a84c">Arruolamento</strong> per reclutare.</span>
        </div>`;

      const rows = activeTroops.map(t => {
        const count = t.onlyFromCard ? 1 : (troops[t.id]||0);
        const force = t.force * count;
        const upkPer = Object.entries(t.upkeep||{}).map(([r,v])=>`${resIcons[r]}${v*count}`).join(' ') || '—';
        const dismissBtn = !t.onlyFromCard
          ? `<button onclick="Game.dismissTroop('${t.id}')" style="margin-top:0.3rem;padding:0.22rem 0.55rem;background:transparent;border:1px solid rgba(239,68,68,0.35);border-radius:3px;font-family:'Cinzel',serif;font-size:0.58rem;color:#f87171;cursor:pointer">Congeda 1</button>`
          : `<div style="font-size:0.58rem;color:#f87171;font-family:'Cinzel',serif;margin-top:0.3rem">★ UNICO</div>`;
        return `
          <div style="display:flex;gap:0.55rem;align-items:flex-start;padding:0.55rem 0.65rem;background:#12121a;border:1px solid ${t.battleColor}44;border-radius:5px;margin-bottom:0.35rem">
            <button onclick="Game.showTroopDetail('${t.id}')" style="background:none;border:none;cursor:pointer;padding:0;flex-shrink:0;font-size:1.6rem;line-height:1">${t.icon}</button>
            <div style="flex:1;min-width:0">
              <button onclick="Game.showTroopDetail('${t.id}')" style="background:none;border:none;cursor:pointer;padding:0;text-align:left;width:100%">
                <div style="font-family:'Cinzel',serif;font-size:0.72rem;color:${t.battleColor};font-weight:700;text-decoration:underline dotted;text-underline-offset:2px">${t.name} ×${count}</div>
              </button>
              <div style="font-size:0.62rem;color:#9a8a6a;margin-top:0.1rem">⚔ Forza: <strong style="color:#4ade80">${force}</strong> · Mantenim.: <strong style="color:#fb923c">${upkPer}/5t</strong></div>
              ${dismissBtn}
            </div>
          </div>`;
      }).join('');
      ...
      return `
        <div style="padding:0.6rem 0.75rem;background:rgba(74,222,128,0.04);border:1px solid rgba(74,222,128,0.15);border-radius:5px;margin-bottom:0.7rem;display:flex;justify-content:space-between;align-items:center">
          <div style="font-family:'Cinzel',serif;font-size:0.65rem;color:#9a8a6a">Forza totale</div>
          <div style="font-family:'Cinzel Decorative',serif;font-size:1rem;color:#4ade80">${totalForce}</div>
          <div style="font-family:'Cinzel',serif;font-size:0.65rem;color:#9a8a6a">Mantenim./5t</div>
          <div style="font-size:0.8rem;color:#fb923c">${upkTotal}</div>
        </div>
        ${rows}`;
    };

    // ── SEZIONE ARRUOLAMENTO ──
    const buildArruolamentoTab = () => {
      return TROOP_TYPES.map(t => {
        if (t.onlyFromCard) {
          // Drago — non reclutabile, solo informativo
          return `
            <div style="padding:0.55rem 0.65rem;background:rgba(248,113,113,0.06);border:1px solid rgba(248,113,113,0.25);border-radius:5px;margin-bottom:0.35rem;opacity:0.75">
              <div style="display:flex;gap:0.5rem;align-items:center">
                <button onclick="Game.showTroopDetail('${t.id}')" style="background:none;border:none;cursor:pointer;font-size:1.5rem;padding:0">${t.icon}</button>
                <div style="flex:1">
                  <button onclick="Game.showTroopDetail('${t.id}')" style="background:none;border:none;cursor:pointer;padding:0;text-align:left">
                    <div style="font-family:'Cinzel',serif;font-size:0.7rem;color:#f87171;font-weight:700;text-decoration:underline dotted;text-underline-offset:2px">${t.name} <span style="color:#fbbf24;font-size:0.58rem">★ LEGGENDARIO</span></div>
                  </button>
                  <div style="font-family:'EB Garamond',serif;font-size:0.72rem;color:#9a8a6a">${t.desc}</div>
                  <div style="font-size:0.6rem;color:#6b5e4a;margin-top:0.1rem;font-style:italic">Non reclutabile — si ottiene solo da evento speciale 🥚</div>
                </div>
              </div>
            </div>`;
        }

        const allowed = !t.allowedChars || t.allowedChars.includes(charId);
        const count   = troops[t.id] || 0;
        const atMax   = count >= t.maxUnits;
        const costParts = Object.entries(t.cost).map(([r,v])=>`${resIcons[r]}${v}`).join(' ') || '—';
        const upkParts  = Object.entries(t.upkeep||{}).map(([r,v])=>`${resIcons[r]}${v}`).join(' ') || 'gratis';
        const canAfford = Object.entries(t.cost).every(([r,v]) => state.resources[r] >= v);

        let btn;
        if (!allowed)     btn = `<button disabled style="padding:0.28rem 0.6rem;font-size:0.58rem;font-family:'Cinzel',serif;background:transparent;border:1px solid rgba(100,100,100,0.3);border-radius:3px;color:#3a3a3a;cursor:not-allowed;white-space:nowrap">Escluso</button>`;
        else if (atMax)   btn = `<button disabled style="padding:0.28rem 0.6rem;font-size:0.58rem;font-family:'Cinzel',serif;background:transparent;border:1px solid rgba(100,100,100,0.3);border-radius:3px;color:#6b5e4a;cursor:not-allowed;white-space:nowrap">Max</button>`;
        else if (!canAfford) btn = `<button disabled style="padding:0.28rem 0.6rem;font-size:0.58rem;font-family:'Cinzel',serif;background:transparent;border:1px solid rgba(239,68,68,0.3);border-radius:3px;color:#6b5e4a;cursor:not-allowed;white-space:nowrap">Fondi</button>`;
        else btn = `<button onclick="Game.recruitTroop('${t.id}')" style="padding:0.28rem 0.65rem;font-size:0.58rem;font-family:'Cinzel',serif;font-weight:700;background:rgba(74,222,128,0.12);border:1px solid rgba(74,222,128,0.45);border-radius:3px;color:#4ade80;cursor:pointer;white-space:nowrap">+Recluta</button>`;

        const borderCol = !allowed ? 'rgba(50,50,50,0.3)' : count > 0 ? `${t.battleColor}44` : 'rgba(201,168,76,0.15)';
        const passiveIcons = (t.passives||[]).map(p=>`<span title="${p.name}">${p.icon}</span>`).join('');

        return `
          <div style="padding:0.55rem 0.65rem;background:#12121a;border:1px solid ${borderCol};border-radius:5px;margin-bottom:0.35rem;opacity:${allowed?'1':'0.42'}">
            <div style="display:flex;gap:0.5rem;align-items:flex-start">
              <button onclick="Game.showTroopDetail('${t.id}')" style="background:none;border:none;cursor:pointer;font-size:1.45rem;padding:0;flex-shrink:0;line-height:1;margin-top:0.05rem">${t.icon}</button>
              <div style="flex:1;min-width:0">
                <div style="display:flex;align-items:center;gap:0.35rem;flex-wrap:wrap">
                  <button onclick="Game.showTroopDetail('${t.id}')" style="background:none;border:none;cursor:pointer;padding:0;text-align:left">
                    <span style="font-family:'Cinzel',serif;font-size:0.7rem;color:#e8dcc8;font-weight:700;text-decoration:underline dotted;text-underline-offset:2px">${t.name}</span>
                  </button>
                  ${count > 0 ? `<span style="font-family:'Cinzel',serif;font-size:0.65rem;color:${t.battleColor}">×${count}/${t.maxUnits}</span>` : `<span style="font-size:0.6rem;color:#4a4a4a">0/${t.maxUnits}</span>`}
                  ${passiveIcons ? `<span style="font-size:0.75rem;opacity:0.8">${passiveIcons}</span>` : ''}
                </div>
                <div style="font-size:0.6rem;color:#6b5e4a;margin-top:0.1rem">⚔ ${t.force} · 💊 ${t.hpMult||1}× · Costo: ${costParts} · /5t: ${upkParts}</div>
              </div>
    ...
    const overlay = document.createElement('div');
    overlay.id = 'army-panel-overlay';
    overlay.style.cssText = 'position:fixed;inset:0;z-index:500;display:flex;align-items:flex-end;justify-content:center;background:rgba(0,0,0,0.75);backdrop-filter:blur(4px);';
    overlay.innerHTML = `
      <div style="background:#0e0e16;border:1px solid rgba(74,222,128,0.35);border-radius:10px 10px 0 0;width:100%;max-width:480px;max-height:88vh;display:flex;flex-direction:column;animation:tut-pop 0.25s ease">
        <!-- Header -->
        <div style="padding:0.9rem 1rem 0;display:flex;align-items:center;justify-content:space-between;flex-shrink:0">
          <div style="font-family:'Cinzel Decorative',serif;font-size:0.88rem;color:#4ade80">⚔ Esercito</div>
          <button onclick="document.getElementById('army-panel-overlay').remove()" style="background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.12);border-radius:50%;width:26px;height:26px;font-size:0.85rem;cursor:pointer;color:#9a8a6a">✕</button>
        </div>
        <!-- Tab switcher -->
        <div style="padding:0.5rem 1rem 0;display:flex;gap:0.4rem;flex-shrink:0">
          <button id="tab-esercito" onclick="Game.showArmyPanel('esercito')"
            style="flex:1;padding:0.45rem;font-family:'Cinzel',serif;font-size:0.65rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;border-radius:4px 4px 0 0;cursor:pointer;transition:all 0.15s;
            background:${activeTab==='esercito'?'rgba(74,222,128,0.15)':'transparent'};
            border:1px solid ${activeTab==='esercito'?'rgba(74,222,128,0.5)':'rgba(74,222,128,0.15)'};
            border-bottom:${activeTab==='esercito'?'1px solid #0e0e16':'1px solid rgba(74,222,128,0.15)'};
            color:${activeTab==='esercito'?'#4ade80':'#6b5e4a'}">
            🛡 Esercito
          </button>
          <button id="tab-arruolamento" onclick="Game.showArmyPanel('arruolamento')"
            style="flex:1;padding:0.45rem;font-family:'Cinzel',serif;font-size:0.65rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;border-radius:4px 4px 0 0;cursor:pointer;transition:all 0.15s;
            background:${activeTab==='arruolamento'?'rgba(74,222,128,0.15)':'transparent'};
            border:1px solid ${activeTab==='arruolamento'?'rgba(74,222,128,0.5)':'rgba(74,222,128,0.15)'};
            border-bottom:${activeTab==='arruolamento'?'1px solid #0e0e16':'1px solid rgba(74,222,128,0.15)'};
            color:${activeTab==='arruolamento'?'#4ade80':'#6b5e4a'}">
            ⚔ Arruolamento
          </button>
        </div>
        <!-- Separatore -->
        <div style="height:1px;background:rgba(74,222,128,0.2);flex-shrink:0"></div>
        <!-- Contenuto tab scrollabile -->
        <div style="overflow-y:auto;padding:0.75rem 0.85rem 1.2rem;flex:1">
          ${activeTab === 'esercito' ? buildEsercitoTab() : buildArruolamentoTab()}
          ${activeTab === 'arruolamento' && !state.hasDragon ? `
            <div style="margin-top:0.6rem;padding:0.5rem 0.65rem;background:rgba(201,168,76,0.05);border:1px solid rgba(201,168,76,0.12);border-radius:4px;font-family:'EB Garamond',serif;font-size:0.75rem;color:#6b5e4a;font-style:italic">
              🐉 Il Drago non si recluta. Cerca il mercante con l'uovo misterioso...
            </div>` : ''}
        </div>
      </div>`;
  ...
  function recruitTroop(typeId) {
    const t = TROOP_TYPES.find(t => t.id === typeId);
    if (!t || t.onlyFromCard) return;
    if (!state.troops) state.troops = {};

    const count = state.troops[typeId] || 0;
    if (count >= t.maxUnits) { showToast(`⚔ Hai già il massimo di ${t.name} (${t.maxUnits}).`, 'warn'); return; }

    // Controlla accesso per personaggio
    if (t.allowedChars && !t.allowedChars.includes(state.character?.id)) {
      showToast(`🚫 ${state.character?.name} non può reclutare ${t.name}.`, 'warn'); return;
    }

    // Paga il costo
    for (const [res, val] of Object.entries(t.cost)) {
      if (state.resources[res] < val) {
        showToast(`💸 Risorse insufficienti per reclutare ${t.name}.`, 'warn'); return;
      }
    }
    for (const [res, val] of Object.entries(t.cost)) {
      state.resources[res] = Math.max(0, state.resources[res] - val);
    }

    state.troops[typeId] = count + 1;

    // Aggiorna army come riflesso
    state.resources.army = Math.min(getResourceCap('army') - 1, getTroopForce());

    const resIcons = { gold:'💰', faith:'✝', people:'👥' };
    const costStr = Object.entries(t.cost).map(([r,v]) => `${resIcons[r]}${v}`).join(' ');
    showToast(`${t.icon} ${t.name} reclutati (×${state.troops[typeId]}) — ${costStr} spesi. Forza: +${t.force}`, 'good');
    updateHUD(); saveGame();
    showArmyPanel('arruolamento'); // resta sul tab arruolamento
  }

  function dismissTroop(typeId) {
    const t = TROOP_TYPES.find(t => t.id === typeId);
    if (!t || !state.troops || !(state.troops[typeId] > 0)) return;

    state.troops[typeId]--;
    if (state.troops[typeId] === 0) delete state.troops[typeId];

    // Rimborso parziale (50%)
    const refund = {};
    Object.entries(t.cost).forEach(([res, val]) => {
      const r = Math.floor(val * 0.5);
      if (r > 0) { refund[res] = r; state.resources[res] = Math.min(getResourceCap(res) - 1, state.resources[res] + r); }
    });

    state.resources.army = Math.min(getResourceCap('army') - 1, getTroopForce());

    const resIcons = { gold:'💰', faith:'✝', people:'👥' };
    const refundStr = Object.entries(refund).map(([r,v]) => `+${resIcons[r]}${v}`).join(' ');
    showToast(`${t.icon} ${t.name} congedati. Rimborso parziale: ${refundStr || 'nessuno'}.`, 'warn');
    updateHUD(); saveGame();
    showArmyPanel('esercito'); // resta sul tab esercito
  }
  ...
  function renderDiplomacy() {
    ...
    function buildHouseCard(hId, h, section) {
      ...
      // Badge protezione tributo
      const tributeProt = (state.tributeProtection || {})[hId];
      const isProtected = tributeProt && state.turn <= tributeProt;
      if (isProtected) statusLabel += ` 🤝 Protetta (${tributeProt - state.turn}t)`;
  ...
  function _openHousePopup(hId) {
    ...
    popup.innerHTML = `
      <div style="background:#0e0e16;border:1px solid rgba(201,168,76,0.4);border-radius:10px 10px 0 0;width:100%;max-width:480px;padding:1.2rem 1.1rem 1.4rem;animation:tut-pop 0.25s ease;max-height:80vh;overflow-y:auto">
        ...
        ${(() => {
          // ── Riquadro economico conquista: visibile solo per casate non-alleate e non-soppresse ──
          if (isSuppressed || isAlly) return '';
          const hd = HOUSES_DEF.find(d => d.id === hId);
          if (!hd?.conquestIncome) return '';
          const ci = hd.conquestIncome;
          const resIcons = { gold: '💰', army: '⚔', people: '👥', faith: '✝', power: '👑' };
          const garNet = ci.val - 4; // rendita - costo guarnigione (4 oro ogni 5 turni)
          const netLabel = garNet >= 0
            ? `<span style="color:#4ade80">bilancio netto: +${garNet} ${resIcons[ci.res]} +${ci.val} ${resIcons[ci.res]} −4💰 ogni 5 turni</span>`
            : `<span style="color:#fbbf24">bilancio netto: +${ci.val}${resIcons[ci.res]} −4💰 ogni 5 turni</span>`;
          return `
            <div style="margin-top:0.7rem;padding:0.6rem 0.75rem;background:rgba(239,68,68,0.05);border:1px solid rgba(239,68,68,0.2);border-radius:4px">
              <div style="font-family:'Cinzel',serif;font-size:0.6rem;color:#f87171;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:0.3rem">⚔ Se Conquistata</div>
              <div style="font-family:'EB Garamond',serif;font-size:0.82rem;color:#e8dcc8;line-height:1.5">
                📦 <strong>${ci.label}</strong> ogni 5 turni<br>
                🏰 −4 💰 Oro guarnigione ogni 5 turni<br>
                <span style="font-size:0.75rem;color:#9a8a6a">${netLabel}</span>
              </div>
            </div>`;
        })()}
      </div>`;
  ...
  function showTruceOverlay(hId, h, truceCost, truceRefusals, wasAttacked) {
    ...
    const playerForce = getTroopForce() + (state.loanedArmy || 0);
  ...
  function ravenAction(action) {
    ...
    if (action === 'alliance') {
      ...
      if (h.status === 'ally') {
        h.status = 'enemy';
        showEnemyToast(state.ravenTarget, 'Avete dichiarato guerra a un alleato. Il tradimento non sarà dimenticato.');
        ...
        // ── Cooldown post-ritirata: le truppe si rifiutano di marciare ──
        if (state.retreatWarCooldown && state.turn <= state.retreatWarCooldown) {
          const turnsLeft = state.retreatWarCooldown - state.turn;
          showToast(`🏃 Le vostre truppe si rifiutano di marciare dopo la ritirata — ancora ${turnsLeft} ${turnsLeft === 1 ? 'turno' : 'turni'} di blocco.`, 'warn');
          state.ravenTarget = null; toggleDiplomacy(); return;
        }
        if (state.retreatWarCooldown && state.turn > state.retreatWarCooldown) {
          delete state.retreatWarCooldown;
        }
        state.ravenTarget = null;
        toggleDiplomacy();
  ...
  function showWarDiplomacyChoice(houseId, h) {
    // ── Protezione tributo: casata al sicuro per N turni ──
    const protectedUntil = (state.tributeProtection || {})[houseId];
    if (protectedUntil && state.turn <= protectedUntil) {
      const turnsLeft = protectedUntil - state.turn;
      showToast(`🤝 Casa ${h.name} ha pagato tributo e gode di protezione — non potete attaccarli per ancora ${turnsLeft} ${turnsLeft === 1 ? 'turno' : 'turni'}. Un accordo è un accordo.`, 'warn');
      return;
    }
    // Se la protezione è scaduta, rimuovila
    if (protectedUntil && state.turn > protectedUntil) {
      delete state.tributeProtection[houseId];
    }
  ...
  function warDiploTribute(houseId, tributeRes, tributeAmt) {
    ...
    if (accepts) {
      ...
      // ── Protezione tributo: il giocatore non può attaccare questa casata per 8 turni ──
      if (!state.tributeProtection) state.tributeProtection = {};
      state.tributeProtection[houseId] = state.turn + 8;
      showToast(`💰 Casa ${h.name} ha accettato di pagare ${tributeAmt} ${resLabels[tributeRes]} per evitare la guerra. Rimarranno al sicuro per 8 turni — un accordo è un accordo.`, 'good');
      updateHUD(); saveGame();
    } else {
      showToast(`⚔ Casa ${h.name} rifiuta l'ultimatum! La guerra inizierà tra 2 turni.`, 'warn');
      h.status = 'enemy';
      showEnemyToast(houseId, 'La casata ha rifiutato il vostro ultimatum. La guerra è ora inevitabile.');
    ...
    setTimeout(() => {
      ...
      if (discovered) {
        ...
        if (captureCount === 0) {
          ...
          h.status = 'enemy';
          showEnemyToast(hId, 'La vostra spia è stata catturata per la seconda volta. La casata vi dichiara nemici.');
  ...
  function _loyaltyRefused(hId) {
    ...
    if (!h) return;
    h.status = 'enemy';
    showEnemyToast(hId, 'La casata ha rifiutato di giurare fedeltà alla Corona. Si schiera apertamente contro il vostro regno.');
    if (state.pendingLoyaltyPledges) {
      state.pendingLoyaltyPledges = state.pendingLoyaltyPledges.filter(id => id !== hId);
    }
  ...
  function _showRetreatSummaryPopup(h, survived, armyLost, becameDiffidente, becameAlly) {
    ...
    overlay.innerHTML = `
      <div style="background:linear-gradient(160deg,#1a1508,#12100a);border:2px solid rgba(239,68,68,0.45);border-radius:8px;width:92%;max-width:460px;padding:1.75rem 1.5rem;font-family:'Cinzel',serif;max-height:90vh;overflow-y:auto">
        ...
        <div style="margin-top:0.8rem;padding:0.65rem;background:rgba(239,68,68,0.07);border:1px solid rgba(239,68,68,0.25);border-radius:4px;font-family:'EB Garamond',serif;font-size:0.85rem;color:#fb923c;line-height:1.5">
          ⏳ <strong>Blocco Militare — 5 turni</strong><br>
          <span style="color:#9a8a6a;font-size:0.8rem">Le vostre truppe sono demoralizzate. Non potete dichiarare guerra ad alcuna casata fino al turno ${(state.retreatWarCooldown || (state.turn + 5))}.</span>
        </div>
      ...
      onLeftChoose: () => {
        ...
        if (state.kingDemandRefusals === 1) {
          ...
          if (state.houses[state.kingHouseAffiliation]) {
            ...
            showEnemyToast(state.kingHouseAffiliation, 'Il Re ha rifiutato le vostre richieste. La sua casata e i suoi alleati vi considerano nemici.');
          }
  ...
  function _openKingChallengeDiplomacy() {
    ...
    const playerForce = getTroopForce() + loanedArmy;
    const diff = state.character.difficulty;
  ...
  function _startKingBattle() {
    ...
    const loanedArmy = state.loanedArmy || 0;
    let playerForce = getTroopForce() + loanedArmy;
  ...
  function executeThroneAttack(playerForce, kingForce) {
    ...
    Game._battleRetreatFinish = function(survived) {
      ...
      if (kingHouseId && state.houses[kingHouseId]) {
        ...
        showEnemyToast(kingHouseId, `Avete sfidato il Re. La sua casata vi considera nemici giurati — non ci sarà pace finché uno dei due non sarà caduto.`);
      }
  ...
  // ══════════════════════════════════════════════════════════════════════
  // STRATEGIC BATTLE SYSTEM v1.0
  // Battaglia strategica vista dall'alto — sostituisce il sistema numerico
  // Scacchiera 7×10 (7 colonne, 10 righe), nebbia di guerra, cerchietti con HP
  // ══════════════════════════════════════════════════════════════════════
  function showStrategicBattle(playerForce, enemyForce, enemyLabel, onComplete, allowRetreat) {
    if (typeof AudioManager !== 'undefined') AudioManager.playWar();

    // ── 1 cerchietto ogni 5 truppe, cap 16 ──
    const pCount = Math.min(16, Math.max(1, Math.floor(playerForce / 5)));
    const eCount = Math.min(16, Math.max(1, Math.floor(enemyForce / 5)));

    // ── Griglia 7×10 — ottimizzata per mobile ──
    const COLS = 7, ROWS = 10;
    const CW = 40, CH = 42;         // celle touch-friendly (lievemente più strette per 7 colonne)
    const BW = COLS * CW;           // 280px
    const BH = ROWS * CH;           // 420px
    const UR = 14;                   // raggio cerchietto (più piccolo per stare in cella 42px)
    const HP_BASE = 5;
    const SPEED_PX = 32;
    const ATK_RANGE = UR * 2.6;
    const ATK_INTERVAL = 2200;

    // Stemma casata giocatore
    const playerHouseId = state.character?.house?.split(' ').pop() || '';
    const playerHouseDef = HOUSES_DEF.find(h =>
      h.id === playerHouseId || state.character?.house?.includes(h.id));
    const playerCrest = playerHouseDef?.crest || null;
    const enemyHouseId = state.pendingWarTarget || null;
    const enemyHouseDef = enemyHouseId ? HOUSES_DEF.find(h => h.id === enemyHouseId) : null;
    const enemyCrest = enemyHouseDef?.crest || null;

    let phase = 'placement';
    let countdown = 20;
    let cdTimer = null;
    let raf = null;
    let dragUnit = null, dragOX = 0, dragOY = 0;
    let selectedId = null;
    let fogLifted = false;
    let particles = [];

    function spawnParticles(x, y, type) {
      const count = type === 'blood' ? 6 : 5;
      for (let i = 0; i < count; i++) {
        ...
        particles.push({
          ...
          r: type === 'blood' ? 2 + Math.random() * 2 : 1.5 + Math.random() * 1.5,
          color: type === 'blood'
            ? `rgba(${160+Math.floor(Math.random()*60)},${Math.floor(Math.random()*20)},10,`
            : `rgba(${220+Math.floor(Math.random()*35)},${180+Math.floor(Math.random()*60)},20,`,
          gravity: type === 'blood' ? 0.12 : -0.04,
        });
      }
    }

    function snapToCell(col, row) {
      return { x: col * CW + CW / 2, y: row * CH + CH / 2 };
    }
    function nearestPlayerCell(x, y) {
      const col = Math.max(0, Math.min(COLS - 1, Math.floor(x / CW)));
      const row = Math.max(Math.floor(ROWS / 2), Math.min(ROWS - 1, Math.floor(y / CH)));
      return { col, row };
    }

    let _uid = 0;
    function makeUnit(side, col, row, angle, stacks, troopType) {
      stacks = stacks || 1;
      const pos = snapToCell(col, row);
      // Statistiche base — soldato normale (1 cerchietto ogni 5 esercito)
      // Unica eccezione: drago (solo giocatore o re Targaryen CPU rarissimo)
      const typeStats = {
        soldato: { hpMult: 1.0, dmgMult: 1.0, spd: 1.0, r: 0, color: '#a3a3a3', icon: '⚔' },
        drago:   { hpMult: 3.0, dmgMult: 2.5, spd: 1.2, r: 6, color: '#f87171', icon: '🐉' },
      };
      const ts = typeStats[troopType] || typeStats['soldato'];
      const hpVal = Math.round(HP_BASE * stacks * ts.hpMult);
      const dmgVal = Math.max(1, Math.round(stacks * ts.dmgMult));
      return {
        id: 'u' + (_uid++), side,
        x: pos.x, y: pos.y, angle,
        hp: hpVal, maxHp: hpVal,
        stacks, dmg: dmgVal,
        troopType: troopType || 'soldato',
        troopColor: ts.color,
        troopIcon: ts.icon,
        troopR: ts.r,           // bonus raggio visivo
        troopSpd: ts.spd,       // moltiplicatore velocità
        alive: true, dead: false, deadAt: 0, lastAtk: 0,
        engagedId: null,
      };
    }

    // ── Unità giocatore: 1 cerchietto ogni 5 esercito, tipo soldato normale ──
    const UNIT_CAP = 12;
    const playerUnitsList = [];
    const pUnitCount = Math.min(UNIT_CAP, Math.max(1, Math.floor(playerForce / 5)));
    for (let i = 0; i < pUnitCount; i++) playerUnitsList.push({ type: 'soldato', passive: null });
    // Drago: rarissimo, solo da carta evento
    if (state.hasDragon && !playerUnitsList.find(u => u.type === 'drago')) {
      playerUnitsList.push({ type: 'drago', passive: null });
    }

    const visibleList = playerUnitsList.slice(0, UNIT_CAP);
    const playerUnits = [];
    let placed = 0;
    for (let row = ROWS - 1; row >= ROWS - 2 && placed < visibleList.length; row--) {
      for (let col = 0; col < COLS && placed < visibleList.length; col++) {
        const entry = visibleList[placed];
        const u = makeUnit('p', col, row, -Math.PI / 2, 1, entry.type);

        // ── Passiva: Infiltrazione — resta nella zona del giocatore, si teletrasporta allo start ──
        if (entry.passive === 'infiltrato' || entry.passive === 'infiltrato_elite') {
          // Rimane nella posizione normale (zona giocatore)
          // Calcola la cella target nella zona nemica (colonna speculare)
          const targetRow = Math.min(Math.floor(ROWS / 2) - 1, 1); // riga 1 zona nemica
          u.infiltrating = true;
          u.infiltrateTargetCol = col;
          u.infiltrateTargetRow = targetRow;
          u.infiltrateBonus = entry.passive === 'infiltrato_elite' ? 2.0 : 1.5;
          u.infiltrateBonusAttacks = entry.passive === 'infiltrato_elite' ? 2 : 3;
        }
        playerUnits.push(u);
        placed++;
      }
    ...
    // ── Passiva Drago: Terrore — rallenta attacchi nemici per 10s ──
    let dragonTerrorActive = state.hasDragon;
    const DRAGON_TERROR_DURATION = 10000; // ms
    const dragonTerrorStart = Date.now();

    // ── CPU: tutte le casate usano soldati normali (1 cerchietto ogni 5 esercito) ──
    // Solo il re Targaryen CPU può avere il drago in casi rarissimi (5% di probabilità)
    const isKingBattle = !enemyHouseId || enemyLabel?.toLowerCase().includes('re') || enemyLabel?.toLowerCase().includes('king');
    const isTargaryenKing = isKingBattle && state.king &&
      ['daenerys','daemon','rhaenyra','aegon_t'].includes(state.king);
    const cpuHasDragon = isTargaryenKing && Math.random() < 0.05; // 5% rarissimo

    const CPU_CAP = 12;
    const eVisible = Math.min(CPU_CAP, eCount);

    const CPU_STRATS = [
      (n) => { const u=[]; for(let i=0;i<n;i++) u.push([i%COLS, Math.floor(i/COLS)]); return u; },
      (n) => { const pos=[[2,0],[3,0],[1,1],[4,1],[0,1],[5,1],[2,1],[3,1],[0,0],[5,0]]; return pos.slice(0,n); },
      (n) => { const u=[]; for(let i=0;i<n;i++) u.push([i%2===0?0:COLS-1, Math.floor(i/2)]); return u; },
      (n) => { const u=[]; for(let i=0;i<n;i++) u.push([i%COLS, i<COLS?0:1]); return u; },
      (n) => { const u=[]; for(let i=0;i<n;i++) u.push([1+Math.floor(i%4), Math.floor(i/4)]); return u; },
    ];

    const enemyUnits = [];
    CPU_STRATS[Math.floor(Math.random() * CPU_STRATS.length)](eVisible)
      .forEach(([col, row]) => {
        enemyUnits.push(makeUnit('e', col, row, Math.PI / 2, 1, 'soldato'));
      });
    // Drago CPU Targaryen rarissimo
    if (cpuHasDragon) {
      enemyUnits.push(makeUnit('e', Math.floor(COLS/2), 0, Math.PI / 2, 1, 'drago'));
    }
    ...
    ov.innerHTML = `
      <div style="display:flex;flex-direction:column;align-items:center;gap:4px;width:${BW+20}px;max-height:100vh;overflow:hidden">

        <!-- Header forze -->
        <div style="display:flex;justify-content:space-between;width:100%;font-size:.58rem;letter-spacing:.1em;text-transform:uppercase">
          <span style="color:#4ade80">🛡 <strong>${Math.round(playerForce)}</strong></span>
          <span id="sb-phase" style="color:#9a8a6a">POSIZIONAMENTO</span>
          <span style="color:#f87171"><strong>${Math.round(enemyForce)}</strong> ⚔</span>
        </div>

        <!-- Barre HP + contatori unità -->
        <div style="display:flex;gap:5px;width:100%;align-items:center">
          <div style="flex:1;height:5px;background:rgba(74,222,128,.15);border-radius:3px;overflow:hidden">
            <div id="sb-pbar" style="height:100%;width:100%;background:linear-gradient(90deg,#16a34a,#4ade80);border-radius:3px;transition:width .4s"></div>
          </div>
          <div style="font-size:.65rem;font-weight:700;color:#9a8a6a;min-width:36px;text-align:center">
            <span id="sb-pu" style="color:#4ade80">${pCount}</span><span style="color:#4a4040"> : </span><span id="sb-eu" style="color:#f87171">${eCount}</span>
          </div>
          <div style="flex:1;height:5px;background:rgba(248,113,113,.15);border-radius:3px;overflow:hidden">
            <div id="sb-ebar" style="height:100%;width:100%;background:linear-gradient(90deg,#f87171,#dc2626);border-radius:3px;transition:width .4s"></div>
          </div>
        </div>

        <!-- Countdown + messaggio -->
        <div style="display:flex;align-items:center;gap:10px;padding:2px 0">
          <div id="sb-cd" style="font-family:'Cinzel Decorative',serif;font-size:1.5rem;color:#c9a84c;min-width:2rem;text-align:center">20</div>
          <div id="sb-msg" style="font-size:.58rem;color:#9a8a6a;line-height:1.35;text-align:center">Posiziona le truppe. Trascina nei quadrati.<br>
          ${(() => {
            const dragon = state.hasDragon ? `<span style="color:#f87171">🐉 Drago</span>` : '';
            return dragon ? `${dragon}` : '⚔ Soldati';
          })()}</div>
        </div>

        <!-- Campo di battaglia unificato -->
        <div style="position:relative;width:${BW}px;height:${BH}px;border:1px solid rgba(201,168,76,.28);border-radius:4px;overflow:hidden;background:#08080f;flex-shrink:0">
          <canvas id="sb-grid" width="${BW}" height="${BH}" style="position:absolute;inset:0;pointer-events:none"></canvas>
          <canvas id="sb-main" width="${BW}" height="${BH}" style="position:absolute;inset:0;cursor:grab;touch-action:none"></canvas>
          <canvas id="sb-fog"  width="${BW}" height="${BH}" style="position:absolute;inset:0;pointer-events:none"></canvas>
          <!-- Linea mezzeria -->
          <div style="position:absolute;left:0;right:0;top:50%;height:1px;background:rgba(201,168,76,.28);pointer-events:none"></div>
          <div style="position:absolute;top:3px;left:4px;font-size:.44rem;color:#f87171;opacity:.7;letter-spacing:.06em">${enemyLabel.toUpperCase()}</div>
          <div style="position:absolute;bottom:3px;left:4px;font-size:.44rem;color:#4ade80;opacity:.7;letter-spacing:.06em">LE TUE TRUPPE</div>
        </div>

        <!-- Pulsanti -->
        <div id="sb-btns" style="display:flex;gap:8px;margin-top:2px">
          ${allowRetreat ? '<button id="sb-ret" style="padding:.42rem .9rem;background:transparent;border:1px solid rgba(201,168,76,.4);border-radius:3px;font-family:Cinzel,serif;font-size:.6rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;cursor:pointer;color:#c9a84c">🏃 Ritirata</button>' : ''}
          ${state.hasDragon ? '<button id="sb-dragon" style="padding:.42rem .9rem;background:rgba(239,68,68,0.15);border:1px solid rgba(239,68,68,0.6);border-radius:3px;font-family:Cinzel,serif;font-size:.6rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;cursor:pointer;color:#f87171">🐉 Drago!</button>' : ''}
        </div>
      </div>
    `;
    document.body.appendChild(ov);

    const mainCv = document.getElementById('sb-main');
    const gridCv = document.getElementById('sb-grid');
    const fogCv  = document.getElementById('sb-fog');
    const mCtx   = mainCv.getContext('2d');
    const gCtx   = gridCv.getContext('2d');
    const fCtx   = fogCv.getContext('2d');

    // Precarica stemmi
    const pImg = playerCrest ? Object.assign(new Image(), {src: playerCrest}) : null;
    const eImg = enemyCrest  ? Object.assign(new Image(), {src: enemyCrest})  : null;
    ...
    function drawGrid() {
      ...
      const half = BH / 2;
      // Zona nemica (sopra)
      gCtx.strokeStyle = 'rgba(239,68,68,.10)'; gCtx.lineWidth = 1;
      for(let c=1;c<COLS;c++){gCtx.beginPath();gCtx.moveTo(c*CW,0);gCtx.lineTo(c*CW,half);gCtx.stroke();}
      for(let r=1;r<ROWS/2;r++){gCtx.beginPath();gCtx.moveTo(0,r*CH);gCtx.lineTo(BW,r*CH);gCtx.stroke();}
      // Zona giocatore (sotto)
      gCtx.strokeStyle = 'rgba(74,222,128,.10)';
      for(let c=1;c<COLS;c++){gCtx.beginPath();gCtx.moveTo(c*CW,half);gCtx.lineTo(c*CW,BH);gCtx.stroke();}
      for(let r=ROWS/2+1;r<ROWS;r++){gCtx.beginPath();gCtx.moveTo(0,r*CH);gCtx.lineTo(BW,r*CH);gCtx.stroke();}
      // Highlight ultime 2 righe (zona placement)
      gCtx.fillStyle='rgba(74,222,128,.04)';
      gCtx.fillRect(0, (ROWS-2)*CH, BW, CH*2);
    }
    drawGrid();

    // ── Nebbia ──
    const fogPts = Array.from({length:38},()=>({
      x:Math.random()*BW, y:Math.random()*BH/2,
      r:20+Math.random()*26, vx:(Math.random()-.5)*.28, vy:(Math.random()-.5)*.2,
      a:.28+Math.random()*.24,
    }));
    function drawFog() {
      fCtx.clearRect(0,0,BW,BH);
      if(fogLifted) return;
      fCtx.fillStyle='rgba(6,3,3,.55)'; fCtx.fillRect(0,0,BW,BH/2);
      fogPts.forEach(p=>{
        p.x+=p.vx; p.y+=p.vy;
        if(p.x<-40)p.x=BW+5; if(p.x>BW+40)p.x=-5;
        if(p.y<-8)p.y=BH/2+5; if(p.y>BH/2+8)p.y=-5;
        const g=fCtx.createRadialGradient(p.x,p.y,0,p.x,p.y,p.r);
        g.addColorStop(0,`rgba(50,38,34,${p.a})`); g.addColorStop(1,'rgba(50,38,34,0)');
    ...
    // ── Aggiorna barre ──
    function updateBars() {
      const ap=playerUnits.filter(u=>u.alive).length;
      const ae=enemyUnits.filter(u=>u.alive).length;
      const pb=document.getElementById('sb-pbar'), eb=document.getElementById('sb-ebar');
      const pu=document.getElementById('sb-pu'),   eu=document.getElementById('sb-eu');
      if(pb) pb.style.width=(ap/Math.max(1,pCount)*100)+'%';
      if(eb) eb.style.width=(ae/Math.max(1,eCount)*100)+'%';
      if(pu) pu.textContent=ap;
      if(eu) eu.textContent=ae;
    }

    // ── Disegna unità ──
    function drawUnit(u) {
      if(u.dead) {
        const age=(Date.now()-u.deadAt)/1000;
        if(age>4) return;
        mCtx.save();
        mCtx.globalAlpha=Math.max(0,.6-age*.15);
        mCtx.font=`${UR*1.1}px serif`;
        mCtx.textAlign='center'; mCtx.textBaseline='middle';
        mCtx.fillText('💀',u.x,u.y);
        mCtx.restore();
        return;
      }

      const iP = u.side==='p';
      const tColor = u.troopColor || (iP ? '#4ade80' : '#f87171');
      const r = UR + (u.troopR||0) + (u.stacks-1)*1.2;
      const isSel = selectedId===u.id;

      mCtx.save();
      mCtx.translate(u.x, u.y);

      // Stemma casata in trasparenza
      const crestImg = iP ? pImg : eImg;
      if(crestImg && crestImg.complete && crestImg.naturalWidth>0) {
        mCtx.save();
        mCtx.globalAlpha=0.13;
        mCtx.drawImage(crestImg, -r*.85, -r*.85, r*1.7, r*1.7);
        mCtx.restore();
      }

      // ── Corpo: forma diversa per tipo ──
      const tt = u.troopType || '';
      mCtx.beginPath();

      if(tt === 'drago') {
        // Drago: esagono rosso grande
        for(let i=0;i<6;i++){
          const a=i*Math.PI/3-Math.PI/6;
          i===0 ? mCtx.moveTo(Math.cos(a)*r,Math.sin(a)*r) : mCtx.lineTo(Math.cos(a)*r,Math.sin(a)*r);
        }
        mCtx.closePath();
        mCtx.fillStyle='rgba(80,10,10,.95)';
      } else {
        // Soldato normale: cerchio
        mCtx.arc(0,0,r,0,Math.PI*2);
        mCtx.fillStyle=iP?'rgba(8,24,14,.92)':'rgba(24,8,8,.92)';
      }

      mCtx.fill();
      // Bordo colore tipo
      mCtx.strokeStyle = isSel ? '#fbbf24' : tColor;
      mCtx.lineWidth = isSel ? 2.8 : (tt==='drago'?3:1.8);
      mCtx.stroke();

      // ── Indicatore direzione (arco fronte) ──
      mCtx.rotate(u.angle);
      mCtx.beginPath();
      mCtx.arc(0,0,r+2.8,-Math.PI/2.3,Math.PI/2.3);
      mCtx.strokeStyle=tColor+'cc';
      mCtx.lineWidth=3.5; mCtx.stroke();

      // Punta
      mCtx.beginPath();
      mCtx.moveTo(r+4,0); mCtx.lineTo(r-2,-4); mCtx.lineTo(r-2,4);
      mCtx.closePath();
      mCtx.fillStyle=isSel?'#fbbf24':tColor; mCtx.fill();

      mCtx.restore();

      // ── HP bar ──
      const bw=r*2, bx=u.x-r, by=u.y+r+3;
      mCtx.fillStyle='rgba(0,0,0,.5)'; mCtx.fillRect(bx,by,bw,3);
      mCtx.fillStyle=u.hp>u.maxHp*.6?'#4ade80':u.hp>u.maxHp*.3?'#fbbf24':'#f87171';
      mCtx.fillRect(bx,by,bw*(u.hp/u.maxHp),3);

      // ── Icona tipo al centro ──
      mCtx.font=`${r*0.9}px serif`;
      mCtx.textAlign='center'; mCtx.textBaseline='middle';
      mCtx.globalAlpha=0.85;
      mCtx.fillText(u.troopIcon||'⚔', u.x, u.y);
      mCtx.globalAlpha=1;
    }
    ...
    function drawParticles() {
      ...
      particles.forEach(p=>{
        ...
        p.vx*=0.91; p.life-=p.decay;
        mCtx.save();
        mCtx.globalAlpha=Math.max(0,p.life*.9);
        mCtx.fillStyle=p.color+Math.max(0,p.life)+')';
        mCtx.beginPath(); mCtx.arc(p.x,p.y,p.r,0,Math.PI*2); mCtx.fill();
        mCtx.restore();
      });
    }

    // ── Particelle nebbia per teletrasporto infiltrati ──
    function spawnFogParticles(x, y) {
      for (let i = 0; i < 16; i++) {
        const angle = Math.random() * Math.PI * 2;
        ...
        particles.push({
          ...
          r: 3 + Math.random() * 5,
          color: 'rgba(160,100,255,',
          gravity: -0.025,
        });
      }
    }

    // ── Teletrasporta gli infiltrati — chiamata a countdown=0 ──
    function teleportInfiltrators() {
      playerUnits.forEach(u => {
        if (!u.infiltrating || u.dead) return;
        spawnFogParticles(u.x, u.y); // nebbia partenza
        // Trova cella target libera (colonna speculare, righe 0-1 zona nemica)
        let tc = u.infiltrateTargetCol;
        let tr = u.infiltrateTargetRow != null ? u.infiltrateTargetRow : 1;
        // Controlla se occupata da nemico
        const occupied = (c, r) => enemyUnits.some(e => {
          if (e.dead) return false;
          const p = snapToCell(c, r);
          return Math.abs(e.x - p.x) < CW * 0.55 && Math.abs(e.y - p.y) < CH * 0.55;
        });
        if (occupied(tc, tr)) {
          // Prova colonne adiacenti nella stessa riga
          const alts = [tc-1, tc+1, tc-2, tc+2, tc+3, tc-3];
          for (const altC of alts) {
            if (altC >= 0 && altC < COLS && !occupied(altC, tr)) { tc = altC; break; }
          }
          // Se riga 1 tutta occupata, prova riga 0
          if (occupied(tc, tr) && tr === 1) {
            tr = 0;
            for (let c = 0; c < COLS; c++) {
              if (!occupied(c, tr)) { tc = c; break; }
            }
          }
        }
        const dest = snapToCell(tc, tr);
        u.x = dest.x; u.y = dest.y;
        u.angle = Math.PI / 2; // punta verso il centro
        u.infiltrateActive = true; // bonus danno attivo
        spawnFogParticles(u.x, u.y); // nebbia arrivo
      });
    }

    // ── Marker target per infiltrati (visibile solo in fase posizionamento) ──
    function drawInfiltrateMarkers() {
      if (phase !== 'placement') return;
      playerUnits.forEach(u => {
        if (!u.infiltrating || u.dead) return;
        const tr = u.infiltrateTargetRow != null ? u.infiltrateTargetRow : 1;
        const target = snapToCell(u.infiltrateTargetCol, tr);
        const pulse = 0.3 + 0.22 * Math.sin(Date.now() / 380);
        mCtx.save();
        // Cerchio pulsante tratteggiato nella zona nemica
        mCtx.globalAlpha = pulse;
        mCtx.strokeStyle = u.troopColor || '#c084fc';
        mCtx.lineWidth = 1.8;
        mCtx.setLineDash([4, 4]);
        mCtx.beginPath();
        mCtx.arc(target.x, target.y, UR + 2, 0, Math.PI * 2);
        mCtx.stroke();
        mCtx.setLineDash([]);
        // Linea tratteggiata dalla truppa al target
        mCtx.globalAlpha = pulse * 0.35;
        mCtx.lineWidth = 1;
        mCtx.setLineDash([3, 5]);
        mCtx.beginPath();
        mCtx.moveTo(u.x, u.y);
        mCtx.lineTo(target.x, target.y);
        mCtx.stroke();
        mCtx.setLineDash([]);
        // Simbolo teletrasporto
        mCtx.globalAlpha = pulse * 0.85;
        mCtx.font = `${UR * 0.75}px serif`;
        mCtx.textAlign = 'center';
        mCtx.textBaseline = 'middle';
        mCtx.fillStyle = u.troopColor || '#c084fc';
        mCtx.fillText('✦', target.x, target.y);
        mCtx.restore();
      });
    }
    ...
    function render() {
      ...
      mCtx.fillStyle='rgba(5,5,12,.28)'; mCtx.fillRect(0,0,BW,BH);
      drawInfiltrateMarkers();
      enemyUnits.forEach(u=>{ if(!fogLifted&&!u.dead)return; drawUnit(u); });
      if(!fogLifted) enemyUnits.filter(u=>u.dead).forEach(u=>drawUnit(u));
    ...
    function canvasPos(e) {
      ...
      const sx=mainCv.width/rect.width, sy=mainCv.height/rect.height;
      const src=e.touches?e.touches[0]:e;
      return {x:(src.clientX-rect.left)*sx, y:(src.clientY-rect.top)*sy};
    }
    function hitPlayer(pos) {
      for(const u of playerUnits){
        if(u.dead||!u.alive) continue;
        const r=UR+(u.stacks-1)*1.5+5; // hit area leggermente più grande per touch
    ...
    mainCv.addEventListener('pointerdown',e=>{
      ...
      const h=hitPlayer(pos);
      if(h){dragUnit=h;selectedId=h.id;dragOX=pos.x-h.x;dragOY=pos.y-h.y;mainCv.style.cursor='grabbing';h._origX=h.x;h._origY=h.y;}
      e.preventDefault();
    },{passive:false});
    mainCv.addEventListener('pointermove',e=>{
      if(!dragUnit||phase!=='placement') return;
      const pos=canvasPos(e);
      // Solo metà inferiore durante placement
      dragUnit.x=Math.max(UR,Math.min(BW-UR,pos.x-dragOX));
      dragUnit.y=Math.max(BH/2+UR,Math.min(BH-UR,pos.y-dragOY));
      e.preventDefault();
    },{passive:false});
    mainCv.addEventListener('pointerup',()=>{
      if(dragUnit&&phase==='placement'){
        const {col,row}=nearestPlayerCell(dragUnit.x,dragUnit.y);
        const snapped=snapToCell(col,row);
        // Fusione SOLO se stessa cella E stesso tipo di truppa
        const other=playerUnits.find(u=>
          u!==dragUnit && u.alive && !u.dead &&
          Math.abs(u.x-snapped.x)<CW*.45 && Math.abs(u.y-snapped.y)<CH*.45 &&
          u.troopType === dragUnit.troopType   // ← solo tipo omogeneo
        );
        if(other){
          other.stacks+=dragUnit.stacks; other.hp+=dragUnit.hp;
          other.maxHp+=dragUnit.maxHp; other.dmg+=dragUnit.dmg;
          dragUnit.alive=false; dragUnit.dead=true; dragUnit.deadAt=0;
          selectedId=other.id;
        } else {
          // Se cella occupata da tipo diverso, rimetti al posto originale
          const blocker=playerUnits.find(u=>
            u!==dragUnit && u.alive && !u.dead &&
            Math.abs(u.x-snapped.x)<CW*.45 && Math.abs(u.y-snapped.y)<CH*.45
          );
          dragUnit.x = blocker ? dragUnit._origX||snapped.x : snapped.x;
          dragUnit.y = blocker ? dragUnit._origY||snapped.y : snapped.y;
          if(!blocker){ dragUnit.x=snapped.x; dragUnit.y=snapped.y; }
        }
        dragUnit=null; mainCv.style.cursor='grab';
      }
      selectedId=null;
    });
    mainCv.addEventListener('pointercancel',()=>{dragUnit=null;mainCv.style.cursor='grab';});

    // ── Ritirata ──
    if(allowRetreat){
      document.getElementById('sb-ret')?.addEventListener('click',()=>{
        cleanup();
        const surv=Math.max(1,Math.round(playerForce*(0.25+Math.random()*.15)));
        onComplete(false,surv,Math.round(enemyForce));
      });
    }

    // ── Drago — abilità speciale una volta per battaglia ──
    let dragonUsed = false;
    if(state.hasDragon){
      document.getElementById('sb-dragon')?.addEventListener('click',()=>{
        if(dragonUsed) return;
        dragonUsed = true;
        const btn = document.getElementById('sb-dragon');
        if(btn){ btn.disabled=true; btn.style.opacity='0.35'; btn.textContent='🐉 Usato'; }

        // AOE: colpisce fino a 4 nemici vivi con danno massiccio
        const alive = enemyUnits.filter(u=>u.alive);
        const targets = alive.sort(()=>Math.random()-0.5).slice(0,4);
        targets.forEach(u=>{
          u.hp = Math.max(0, u.hp - u.maxHp * 0.8); // 80% HP danni
          spawnParticles(u.x,u.y,'blood');
          spawnParticles(u.x,u.y,'blood');
          if(u.hp<=0){ u.hp=0; u.alive=false; u.dead=true; u.deadAt=Date.now(); }
        });

        // Flash rosso sullo schermo
        const flash = document.createElement('div');
        flash.style.cssText='position:absolute;inset:0;background:rgba(220,38,38,0.35);pointer-events:none;animation:fadeIn 0.1s ease,fadeOut 0.6s ease 0.1s forwards;z-index:10;border-radius:4px';
        document.querySelector('#sb-overlay .war-overlay, #sb-overlay > div')?.appendChild(flash);
        setTimeout(()=>flash.remove(),800);

        const msgEl=document.getElementById('sb-msg');
        if(msgEl) msgEl.innerHTML='<span style="color:#f87171;font-weight:700">🔥 Il drago semina terrore! '+targets.length+' nemici colpiti!</span>';
        updateBars();
      });
    }
    ...
    function startCountdown(){
      document.getElementById('sb-phase').textContent='COUNTDOWN';
      cdTimer=setInterval(()=>{
        countdown--;
        const el=document.getElementById('sb-cd');
        if(el){el.textContent=countdown;el.style.color=countdown<=5?'#f87171':'#c9a84c';}
        if(countdown<=0){clearInterval(cdTimer);teleportInfiltrators();startBattle();}
      },1000);
    }
    ...
    function startBattle(){
      phase='battle';
      fogLifted=true;
      document.getElementById('sb-phase').textContent='BATTAGLIA';
      document.getElementById('sb-cd').textContent='⚔';
      document.getElementById('sb-msg').textContent='Le armate si scontrano!';
      mainCv.style.cursor='default';

      function dist(a,b){const dx=a.x-b.x,dy=a.y-b.y;return Math.sqrt(dx*dx+dy*dy);}
      function angleToUnit(f,t){return Math.atan2(t.y-f.y,t.x-f.x);}
      function dmgMult(atkA,vicA){
        let d=atkA-(vicA+Math.PI);
        while(d>Math.PI)d-=2*Math.PI; while(d<-Math.PI)d+=2*Math.PI;
        const a=Math.abs(d);
        if(a<Math.PI/3)  return 1.0;
        if(a<2*Math.PI/3)return 1.5;
        return 2.0;
      }
      ...
      function tick(ts){
        ...
        lastTs=ts;
        const ap=playerUnits.filter(u=>u.alive);
        const ae=enemyUnits.filter(u=>u.alive);
        if(ap.length===0||ae.length===0){endBattle(ap.length>0);return;}

        const allAlive=[...ap,...ae];

        allAlive.forEach(u=>{
          const opps=u.side==='p'?ae:ap;
          if(!opps.length) return;

          // ── ENGAGEMENT: mantieni il bersaglio finché è vivo ──
          let target = null;
          if(u.engagedId) {
            // Cerca il nemico agganciato
            target = opps.find(op=>op.id===u.engagedId&&op.alive);
            if(!target) u.engagedId = null; // morto → libero
          }
          if(!target) {
            // Non agganciato: cerca il nemico più vicino in range
            let nearD=Infinity;
            opps.forEach(op=>{const d=dist(u,op);if(d<nearD){nearD=d;target=op;}});
            // Ingaggia solo se entro ATK_RANGE
            if(target && dist(u,target)<=ATK_RANGE) {
              u.engagedId = target.id;
            }
          }
          if(!target) return;

          const targetDist = dist(u,target);

          // Rotazione fluida verso bersaglio
          const ta=angleToUnit(u,target);
          let da=ta-u.angle;
          while(da>Math.PI)da-=2*Math.PI; while(da<-Math.PI)da+=2*Math.PI;
          u.angle+=da*Math.min(1,dt*4.5);

          if(targetDist>ATK_RANGE){
            // Avanza verso il bersaglio agganciato (o il più vicino)
            u.x+=Math.cos(ta)*SPEED_PX*(u.troopSpd||1)*dt;
            u.y+=Math.sin(ta)*SPEED_PX*(u.troopSpd||1)*dt;
            u.x=Math.max(UR,Math.min(BW-UR,u.x));
            u.y=Math.max(UR,Math.min(BH-UR,u.y));
          } else {
            // In range → attacca il bersaglio agganciato
            // ── Terrore Drago: ATK_INTERVAL nemici +20% per 10s ──
            const terrorMult = (dragonTerrorActive && u.side==='e' && (ts - dragonTerrorStart) < DRAGON_TERROR_DURATION) ? 1.2 : 1.0;
            if(dragonTerrorActive && (ts - dragonTerrorStart) >= DRAGON_TERROR_DURATION) dragonTerrorActive = false;

            if(ts - u.lastAtk >= ATK_INTERVAL * terrorMult){
              u.lastAtk=ts;
              const atkA=angleToUnit(u,target);
              const mult=dmgMult(atkA,target.angle);

              // ── Bonus Infiltrazione: primi N attacchi fanno danno extra ──
              let infiltMult = 1.0;
              if(u.infiltrating && u.infiltrateBonusAttacks > 0) {
                infiltMult = u.infiltrateBonus || 1.5;
                u.infiltrateBonusAttacks--;
                if(u.infiltrateBonusAttacks <= 0) u.infiltrating = false;
              }

              target.hp -= u.dmg * mult * infiltMult;
              spawnParticles(target.x, target.y, (mult*infiltMult) > 1.2 ? 'blood' : 'spark');
              if(target.hp<=0){
                target.hp=0; target.alive=false; target.dead=true; target.deadAt=Date.now();
                u.engagedId=null;
                spawnParticles(target.x,target.y,'blood');
                spawnParticles(target.x,target.y,'blood');
              }
              updateBars();
            }
    ...
    function endBattle(playerWon){
      ...
      const survived     =Math.max(1,Math.round(playerForce*(pAlive/Math.max(1,playerUnits.length))));
      const enemySurvived=Math.max(0,Math.round(enemyForce*(eAlive/Math.max(1,enemyUnits.length))));

      const phEl=document.getElementById('sb-phase');
      const cdEl=document.getElementById('sb-cd');
      const msgEl=document.getElementById('sb-msg');
      const btnsEl=document.getElementById('sb-btns');
      if(phEl) phEl.textContent=playerWon?'VITTORIA':'SCONFITTA';
      if(cdEl){cdEl.textContent=playerWon?'🏆':'💀';cdEl.style.color=playerWon?'#4ade80':'#f87171';}
      if(msgEl) msgEl.innerHTML=playerWon
        ?`<span style="color:#4ade80;font-size:.72rem">${Math.round(survived)} truppe sopravvissute.</span>`
        :`<span style="color:#f87171;font-size:.72rem">Sconfitti. ${Math.round(enemySurvived)} nemici rimasti.</span>`;
      if(btnsEl) btnsEl.innerHTML=`<button id="sb-finish" style="padding:.55rem 1.8rem;background:linear-gradient(135deg,${playerWon?'#14532d,#16a34a':'#7f1d1d,#dc2626'});border:none;border-radius:3px;font-family:Cinzel,serif;font-size:.7rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;cursor:pointer;color:#fff">${playerWon?'👑 Continua':'💀 Continua'}</button>`;
      document.getElementById('sb-finish')?.addEventListener('click',()=>{
        cleanup(); onComplete(playerWon,survived,enemySurvived);
      });
      function resultLoop(){render();if(phase==='result')requestAnimationFrame(resultLoop);}
      requestAnimationFrame(resultLoop);
    }

    function cleanup(){
      clearInterval(cdTimer); cancelAnimationFrame(raf); phase='done';
      document.getElementById('sb-overlay')?.remove();
    }

    // Avvia loop placement + countdown immediato
    function placementLoop(){
      render();
      if(phase==='placement'||phase==='countdown') requestAnimationFrame(placementLoop);
    }
  ...
  // ── Wrappers che sostituiscono le vecchie funzioni di battaglia ──
  function showThroneAttackAnimation(playerForce, kingForce, onComplete) {
    const kingName = state.kingName || 'Il Re';
    showStrategicBattle(playerForce, kingForce, kingName, onComplete, false);
  }

  function showBattleAnimation(playerForce, enemyForce, onComplete, allowRetreat, bgConfig) {
    const houseId = state.pendingWarTarget;
    const h = houseId ? state.houses[houseId] : null;
    const enemyLabel = h ? `Casa ${h.name}` : 'Nemico';
    showStrategicBattle(playerForce, enemyForce, enemyLabel, onComplete, !!allowRetreat);
  }
  ...
  function _resolveThroneAttack(won, playerForce, kingForce, survived, enemySurvived) {
    ...
    if (won) {
      ...
      // ── Apply resources — cap dinamico per risorsa (include bonus conquiste precedenti) ──
      Object.keys(state.resources).forEach(k => {
        state.resources[k] = Math.min(getResourceCap(k) - 1, Math.max(1, state.resources[k]));
      });
      ...
      returnLoanedArmies();
      state.resources.army  = Math.min(65, Math.min(getResourceCap('army') - 1, ownThroneSwrvived + 8));
      state.resources.power = Math.min(getResourceCap('power') - 1, state.resources.power + 12);
  ...
  function requestAllyArmy(hId) {
    ...
    if (effectiveBetrayal > 0 && Math.random() < effectiveBetrayal) {
      h.status = 'enemy';
      showEnemyToast(hId, 'La casata ha ceduto alle lusinghe dei vostri nemici. Un alleato si rivela traditore.');
  ...
  function triggerPactCall(hId) {
    ...
    state.eventQueue.unshift({
      ...
      onLeftChoose: () => {
        h.status = 'enemy';
        showEnemyToast(hId, 'Avete rotto un patto di sangue. Questo tradimento non sarà mai dimenticato dalla casata.');
        h.pactBroken = true;
  ...
  function buildStartingEnemyTributeCard(hId, h, threatScore) {
    ...
    // ── Escalation: chi ha già pagato paga di più la volta successiva ──
    const escLevel = (state.tributeEscalation || {})[hId] || 0;
    const escMult  = 1 + escLevel * 0.25; // +25% per ogni pagamento precedente
    const demandAmt = Math.max(8, Math.round(base * diffMult * escMult));
    ...
    return {
      ...
      onRightChoose: () => {
        ...
        // ── Escalation: ogni pagamento consecutivo gonfia le pretese future ──
        if (!state.tributeEscalation) state.tributeEscalation = {};
        state.tributeEscalation[hId] = Math.min(4, (state.tributeEscalation[hId] || 0) + 1);
        const escLevel = state.tributeEscalation[hId];
        const escNote = escLevel >= 2 ? ` Le loro pretese crescono — la prossima richiesta sarà più alta (×${(1 + escLevel * 0.25).toFixed(2)}).` : '';
        showToast(`${h.icon} Casa ${h.name} riceve il tributo. Le loro armate crescono (+${armyBonus} soldati). Staranno quieti per ora.${escNote}`, 'warn');
      },
      onLeftChoose: () => {
  ...
  function buildTributeDemandCard(hId, h) {
    ...
    return {
      ...
      onLeftChoose: () => {
        ...
        h.status = 'enemy';
        showEnemyToast(hId, 'Avete rifiutato di pagare il tributo dovuto. La casata considera questo un affronto imperdonabile.');
  ...
  function showWarConfirmation(houseId) {
    ...
    const playerForce = getTroopForce() + existingLoan;
  ...
  function _revealEnemyAlliances(houseId, h) {
    ...
    Object.entries(state.houses).forEach(([id, hh]) => {
      ...
      const supportChance = hh.status === 'enemy' ? 0.40 : 0.15;
      if (Math.random() < supportChance) {
        const contribution = Math.floor(hh.army * (0.10 + Math.random() * 0.10));
        if (contribution > 0) {
          ...
          if (!state.warAllianceSupporters[houseId].some(s => s.name === hh.name))
  ...
  function triggerHouseBattle(houseId, playerInitiated) {
    ...
    // Calculate forces — usa forza truppe reclutate se disponibile
    const loanedArmy = state.loanedArmy || 0;
    let playerForce = getTroopForce() + loanedArmy;
    ...
    Game._battleRetreatFinish = function(survived) {
      ...
      h.status = 'enemy';
      showEnemyToast(houseId, 'Vi siete ritirati dal campo di battaglia. La casata vi considera codardi e vi dichiara nemici permanenti.');
      h.attackedByPlayer = true;

      // ── Cooldown guerra: 5 turni di blocco su tutte le dichiarazioni di guerra ──
      state.retreatWarCooldown = state.turn + 5;
      showToast(`🏃 La disfatta è bruciante — le vostre truppe si rifiutano di marciare per 5 turni. Nessuna guerra può essere dichiarata fino al turno ${state.retreatWarCooldown}.`, 'warn');
      ...
      const becameAlly       = [];
      Object.entries(state.houses).forEach(([id, nh]) => {
        if (nh.suppressed || id === houseId || nh.status !== 'neutral') return; // alleati già esclusi dal check neutral
        const roll = Math.random();
        if (roll < 0.35) {
  ...
  function _resolveHouseBattle(houseId, h, won, survived, enemySurvived, playerForce, enemyForce, desertNote, playerInitiated) {
    ...
    if (won) {
      ...
      // ── Cap dinamico: +15 sulla risorsa caratteristica della casata conquistata ──
      state.conquests = conquestCount + 1;
      const conqueredHouseDef = HOUSES_DEF.find(hd => hd.id === houseId);
      if (conqueredHouseDef?.conquestIncome) {
        const capRes = conqueredHouseDef.conquestIncome.res;
        if (!state.conquestCapBonus) state.conquestCapBonus = {};
        state.conquestCapBonus[capRes] = (state.conquestCapBonus[capRes] || 0) + 15;
      }
      const cap = getResourceCap('army'); // usa il cap base (100) per army post-battaglia
      ...
      state.resources.army   = Math.min(75, Math.min(getResourceCap('army'), ownSurvived + bonusArmy));
      state.resources.gold   = Math.min(getResourceCap('gold') - 1,   state.resources.gold   + bonusGold);
      state.resources.people = Math.max(1, Math.min(getResourceCap('people') - 1, state.resources.people + bonusPeople));
      state.resources.power  = Math.min(getResourceCap('power') - 1,  state.resources.power  + bonusPower);
      state.resources.faith  = Math.min(getResourceCap('faith') - 1,  state.resources.faith  + bonusFaith);
      ...
      let fearCount = 0;
      Object.entries(state.houses).forEach(([id, nh]) => {
        if (id === houseId || id === kingHouseId || nh.suppressed || nh.status !== 'neutral' || nh.status === 'ally') return;
      ...
      state.garrisons[houseId] = { name: h.name, icon: h.icon, costPerCycle: Math.min(6, 3 + (state.conquests || 0)) };
      ...
      triggerEnd(false, houseIcon(h, '3.5rem'), `Annesso da Casa ${h.name}`,
  ...
  function showHouseBattleResult(won, h, bonusGold, bonusArmy, bonusPeople, bonusPower, cap, desertNote, survived, fearCount) {
    const overlay = document.createElement('div');
    overlay.className = 'war-overlay';
    const houseId = Object.keys(state.houses).find(id => state.houses[id] === h);
    const garrisonCost = (state.garrisons || {})[houseId]?.costPerCycle || 3;
    const houseDef = HOUSES_DEF.find(hd => hd.id === houseId);
    const income = houseDef?.conquestIncome;
    const resIcons = { gold:'💰', army:'⚔', people:'👥', faith:'✝', power:'👑' };
    const newCap = income ? getResourceCap(income.res) : null;
    const incomeHtml = income
      ? `<div style="color:#4ade80">📦 ${income.label} ogni 5 turni (rendita)</div>`
      : '';
    const capHtml = newCap && newCap > 100
      ? `<div style="color:#a78bfa">📈 Cap ${resIcons[income.res]} espanso a ${newCap} (+15)</div>`
      : '';
    overlay.innerHTML = `
      ...
      <div class="war-log">
        ...
        <p style="margin-top:0.5rem">Casa ${h.name} è stata soppressa. Le sue terre sono ora vostre.</p>
        ...
        <div style="margin-top:0.65rem;padding:0.5rem 0.65rem;background:rgba(239,68,68,0.07);border:1px solid rgba(239,68,68,0.25);border-radius:4px;font-family:'EB Garamond',serif;font-size:0.85rem;line-height:1.6">
          ...
          <div style="color:#fca5a5">🏰 Guarnigione Casa ${h.name}: <strong>-${garrisonCost} oro ogni 5 turni</strong></div>
  ...
  function loadGame() {
    try {
      ...
      // Compatibilità salvataggi precedenti senza troops
      if (!state.troops) state.troops = {};
      if (state.hasDragon === undefined) state.hasDragon = false;
      showScreen('screen-game');
      updateHUD();
      drawNextCard();
      initSwipe();
  ...
  function _buildCharGrid_UNUSED() {
  ...
  function _tutStep_game() {
    _tutGameSteps = [
      ...
      // 8 — Esercito
      () => _tutPopup(null,
        '⚔ <strong>Esercito</strong>:<br>La risorsa ⚔ rappresenta la tua forza militare. In battaglia ogni <strong>5 punti Esercito = 1 cerchietto</strong> sul campo (max 12) — vale per te <em>e</em> per i nemici CPU.<br><br>🐉 <strong>Drago</strong>: ottenibile <em>solo</em> da eventi speciali (uovo di drago) — rarissimo. Anche il re Targaryen CPU lo può avere, ma è molto raro.',
        null, _tutGameNext, 'Capito →'),
      ...
      // 10 — Drago Targaryen e Colpi di Stato
      () => _tutPopup(null,
        '🐉 <strong>Colpi di Stato &amp; Drago Targaryen</strong>:<br>Dal turno 15 pretendenti possono tentare colpi di stato.<br><br><span style="color:#fca5a5">⚠ Se sei re <strong>Targaryen con il drago</strong>, nessun colpo di stato può spodestarti.</span><br><br><span style="color:#fbbf24">⚠ Un pretendente <strong>Targaryen CPU con drago</strong> riesce sempre al <strong>100%</strong>.</span>',
        null, _tutGameNext, 'Capito →'),
  ...
  return {
    ...
    _getState: () => state,
    _getCharacters: () => CHARACTERS,
    _getHousesDef: () => HOUSES_DEF,
...
window.addEventListener('load', () => {
  ...
  if (badge) badge.textContent = 'v' + (typeof Game !== 'undefined' && Game.VERSION ? Game.VERSION : '2.9.0');
...
var LOCKED_CHARS = {
  // TARGARYEN — Aegon il Conquistatore: sblocca con qualsiasi Targaryen
  'aegon_t':      { unlockBy: ['daenerys','daemon','rhaenyra'],
                    reason: 'Completa l\'obiettivo di Daenerys, Viserys o Rhaenyra Targaryen' },
  // LANNISTER — Tywin il più potente: sblocca con qualsiasi Lannister
  'tywin':        { unlockBy: ['cersei','tyrion','jaime'],
                    reason: 'Completa l\'obiettivo di Cersei, Tyrion o Jaime Lannister' },
  // STARK — Ned l\'anima del Nord: sblocca con i figli Stark
  'ned':          { unlockBy: ['jon','robb','sansa','arya'],
                    reason: 'Completa l\'obiettivo di Jon Snow, Robb, Sansa o Arya Stark' },
  // BARATHEON — Davos è fedele a Stannis, non il contrario
  'davos':        { unlockBy: ['stannis'],
                    reason: 'Completa l\'obiettivo di Stannis Baratheon — Davos lo segue' },
  // TYRELL — Olenna la mente dietro Margaery
  'olenna':       { unlockBy: ['margaery'],
                    reason: 'Completa l\'obiettivo di Margaery Tyrell' },
  // BOLTON — Ramsay richiede Roose (il padre che lo ha creato)
  'ramsay':       { unlockBy: ['roose'],
                    reason: 'Completa l\'obiettivo di Roose Bolton' },
  // HIGHTOWER — Alicent spinta dal padre Otto
  'alicent':      { unlockBy: ['otto'],
                    reason: 'Completa l\'obiettivo di Otto Hightower' },
  // Oltre il Muro — Tormund compagno di Ygritte e Jon
  'tormund':      { unlockBy: ['ygritte','jon'],
                    reason: 'Completa l\'obiettivo di Ygritte o Jon Snow' },
  // Melisandre: lega Stannis al fuoco, sblocca con Stannis
  'melisandre':   { unlockBy: ['stannis'],
                    reason: 'Completa l\'obiettivo di Stannis Baratheon — lei serve il Re Scelto' },
  // Oberyn: principe di Dorne, sblocca con un personaggio di potere/intrighi
  'oberyn':       { unlockBy: ['tyrion','littlefinger'],
                    reason: 'Completa l\'obiettivo di Tyrion Lannister o Ditocorto' },
  // Ditocorto: il grande burattinaio, ultimo da sbloccare
  'littlefinger': { unlockBy: ['cersei','sansa','tyrion'],
                    reason: 'Completa l\'obiettivo di Cersei, Sansa o Tyrion Lannister' },
  // Sandor Clegane: il Mastino, sblocca con Arya (l\'unico con cui ha un legame)
  'sandor':       { unlockBy: ['arya','sansa'],
                    reason: 'Completa l\'obiettivo di Arya o Sansa Stark' },
  // Jorah: fedele a Daenerys sopra ogni cosa
  'jorah':        { unlockBy: ['daenerys'],
                    reason: 'Completa l\'obiettivo di Daenerys Targaryen' },
  // Brienne: sblocca con Catelyn o Sansa (le donne che giura di proteggere)
  'brienne':      { unlockBy: ['catelyn','sansa'],
                    reason: 'Completa l\'obiettivo di Catelyn Tully o Sansa Stark' },
};

// Casate e personaggi per il completamento oro
var HOUSE_CHARS = {
  'Targaryen':  ['daenerys','daemon','rhaenyra','aegon_t'],
...
// ══════════════════════════════════════════════════════════════════════════════
// IRON & ALLIANCES — MULTIPLAYER ENGINE
// PeerJS WebRTC — fino a 4 giocatori, stesso WiFi o internet
// Architettura: Host + Guest peer-to-peer (host fa da relay)

// ══════════════════════════════════════════════════════════════════════════════
// IRON & ALLIANCES — MULTIPLAYER ENGINE v2
// PeerJS WebRTC · fino a 4 giocatori · WiFi locale o Internet
// FIX: CHARACTERS accessibili, codice = Peer ID, STUN Google, avvio diretto
// ══════════════════════════════════════════════════════════════════════════════


// ══════════════════════════════════════════════════════════════════════════════
// IRON & ALLIANCES — MULTIPLAYER ENGINE v3
// PeerJS WebRTC · fino a 4 giocatori · WiFi locale o Internet
// - Codice sessione corto (5 char, es. IA3X7)
// - Avvio automatico con personaggio pre-scelto (nessuna schermata casata)
// - Guerra PvP identica al singleplayer: ultimatum, rinforzi alleati, scacchiera
// - Scambi di risorse tra giocatori
// - Chat globale + chat privata con popup non invasivo
// ══════════════════════════════════════════════════════════════════════════════

const MultiplayerEngine = (() => {

  // ── Accesso a CHARACTERS/HOUSES_DEF dal Game ──
  function _chars()  { return typeof Game !== 'undefined' && Game._getCharacters ? Game._getCharacters() : []; }

  // ── Stato interno ──
  let _peer        = null;
  let _myPeerId    = null;
  let _isHost      = false;
  let _connections = {};   // { peerId: DataConnection }
  let _players     = {};   // { peerId: { name, charId, house, ready, resources, turn, isKing, state } }
  let _takenHouses = {};   // { houseName: peerId }
  let _sessionCode = null;
  let _kickedPeers = {};   // { peerId: timestampMs } — peer espulsi dall'host, con cooldown 60s
  let _lobbyBanned = {};   // { name_lc: timestampMs } — per blocco per nome (fallback se cambiano peer)

  // Trono
  let _throneTimer        = null;
  let _throneStart        = null;
  let _throneHolderPeerId = null;
  let _throneWarBlocked   = false;
  const THRONE_WIN_MS = 5 * 60 * 1000;

  // Chat privata
  let _privateChatTarget = null;  // peerId del destinatario chat privata aperta

  // ── Host Migration ──
  // Gerarchia preventiva: ogni guest conosce l'ordine di successione
  // basato su latenza (ping) verso l'host, con ordine-join come tiebreaker.
  // Struttura: [{ peerId, ping, joinOrder }] — ordinato dal "migliore" al "peggiore"
  let _hostHierarchy   = [];   // array ordinato di peerId (primo = prossimo host)
  let _pingMap         = {};   // { peerId: latencyMs }
  let _joinOrder       = [];   // ordine di arrivo in sessione
  let _migrating       = false;// lock anti-doppio-trigger
  let _pingInterval    = null; // setInterval per ping periodico
  const PING_INTERVAL_MS = 8000;  // misura ping ogni 8s
  const MIGRATION_TIMEOUT_MS = 4000; // attesa ACK nuovi guest dopo migrazione
  ...
  const PEER_CONNECT_OPTS = { reliable: true, serialization: 'json' };
  ...
  function _css() {
    ...
    s.id = 'mp-style';
    s.textContent = `
      @keyframes mp-in   { from{opacity:0;transform:translateY(8px)} to{opacity:1;transform:translateY(0)} }
      @keyframes mp-pulse{ 0%,100%{opacity:1} 50%{opacity:.4} }
      @keyframes mp-ring { 0%{transform:scale(1)} 30%{transform:scale(1.08)} 60%{transform:scale(.97)} 100%{transform:scale(1)} }
      .mp-screen{position:fixed;inset:0;z-index:600;background:#0a0a0f;display:flex;flex-direction:column;align-items:center;overflow-y:auto;padding:1.5rem 1rem 3rem;animation:mp-in .3s ease}
      .mp-card{background:linear-gradient(160deg,#1a1508,#12100a);border:1px solid rgba(201,168,76,.4);border-radius:8px;padding:1.2rem;width:100%;max-width:420px;margin-bottom:.75rem;font-family:'Cinzel',serif;box-sizing:border-box}
      .mp-inp{width:100%;padding:.55rem .7rem;background:#0a0a0f;border:1px solid rgba(201,168,76,.3);border-radius:3px;font-family:'Cinzel',serif;font-size:.78rem;color:#e8dcc8;box-sizing:border-box;margin-bottom:.4rem}
      .mp-btn-gold{width:100%;padding:.75rem;background:linear-gradient(135deg,#78350f,#c9a84c,#78350f);border:none;border-radius:3px;font-family:'Cinzel',serif;font-size:.8rem;font-weight:700;letter-spacing:.12em;text-transform:uppercase;cursor:pointer;color:#0a0a0f;margin-top:.5rem}
      .mp-btn-green{width:100%;padding:.75rem;background:linear-gradient(135deg,#14532d,#16a34a,#14532d);border:none;border-radius:3px;font-family:'Cinzel',serif;font-size:.8rem;font-weight:700;letter-spacing:.12em;text-transform:uppercase;cursor:pointer;color:#fff;margin-top:.5rem}
      .mp-btn-blue{width:100%;padding:.75rem;background:linear-gradient(135deg,#1e3a5f,#3b82f6,#1e3a5f);border:none;border-radius:3px;font-family:'Cinzel',serif;font-size:.8rem;font-weight:700;letter-spacing:.12em;text-transform:uppercase;cursor:pointer;color:#fff;margin-top:.5rem}
      .mp-btn-ghost{width:100%;padding:.65rem;background:transparent;border:1px solid rgba(201,168,76,.35);border-radius:3px;font-family:'Cinzel',serif;font-size:.72rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;cursor:pointer;color:#c9a84c;margin-top:.4rem}
      .mp-slot{display:flex;align-items:center;gap:.6rem;padding:.5rem .65rem;background:#12121a;border:1px solid rgba(201,168,76,.18);border-radius:5px;margin-bottom:.35rem;font-family:'Cinzel',serif}
      .mp-slot.ready{border-color:rgba(74,222,128,.5)} .mp-slot.me{border-color:rgba(201,168,76,.7)}
      .mp-hud{position:fixed;bottom:0;left:0;right:0;background:rgba(10,10,15,.96);border-top:1px solid rgba(201,168,76,.2);padding:.5rem .75rem;display:flex;align-items:center;justify-content:space-between;font-family:'Cinzel',serif;font-size:.6rem;z-index:698;gap:.3rem;flex-wrap:wrap}
      .mp-throne{position:fixed;top:0;left:0;right:0;background:rgba(192,132,252,.15);border-bottom:1px solid rgba(192,132,252,.4);padding:.35rem 1rem;display:flex;align-items:center;justify-content:space-between;font-family:'Cinzel',serif;font-size:.65rem;color:#c084fc;z-index:699;letter-spacing:.04em}
      .mp-ecard{display:flex;flex-direction:column;align-items:center;gap:.1rem;padding:.3rem .4rem;background:#12121a;border-radius:4px;border:1px solid rgba(201,168,76,.15);min-width:52px;font-size:.55rem;cursor:pointer;transition:border-color .2s}
      .mp-ecard:hover{border-color:rgba(201,168,76,.5)} .mp-ecard.king{border-color:rgba(192,132,252,.6)}
      .mp-toast-priv{position:fixed;bottom:4.5rem;right:.75rem;z-index:750;background:#12121a;border:1px solid rgba(201,168,76,.5);border-radius:6px;padding:.55rem .8rem;font-family:'Cinzel',serif;font-size:.7rem;color:#e8dcc8;max-width:240px;animation:mp-ring .4s ease;cursor:pointer;box-shadow:0 4px 20px rgba(0,0,0,.6)}
      .mp-chat-win{position:fixed;bottom:4rem;right:.5rem;z-index:740;background:#0e0e16;border:1px solid rgba(201,168,76,.4);border-radius:8px;width:280px;max-height:360px;display:flex;flex-direction:column;font-family:'Cinzel',serif;animation:mp-in .2s ease;box-shadow:0 8px 30px rgba(0,0,0,.7)}
      .mp-chat-log{flex:1;overflow-y:auto;padding:.6rem .75rem;font-family:'EB Garamond',serif;font-size:.82rem;color:#9a8a6a;line-height:1.6;min-height:120px;max-height:200px}
      .mp-chat-inp-row{display:flex;gap:.4rem;padding:.5rem .65rem;border-top:1px solid rgba(201,168,76,.15)}
      .mp-char-btn{display:flex;flex-direction:column;align-items:center;padding:.4rem .55rem;background:#12121a;border:1px solid rgba(201,168,76,.2);border-radius:5px;cursor:pointer;min-width:64px;transition:border-color .15s;font-family:'Cinzel',serif}
      .mp-char-btn:hover:not(:disabled){border-color:rgba(201,168,76,.65)} .mp-char-btn:disabled{opacity:.3;cursor:not-allowed;background:rgba(30,30,30,.4)}
      .mp-war-popup{position:fixed;inset:0;z-index:860;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.85);backdrop-filter:blur(4px);animation:mp-in .25s ease}
    `;
    document.head.appendChild(s);
  }

  const _el = id => document.getElementById(id);
  function _toast(msg, type) { if (typeof Game !== 'undefined' && Game._showToast) Game._showToast(msg, type||''); }

  // ══════════════════════════════
  // PULSANTE SPLASH
  // ══════════════════════════════
  function injectBtn() {
    if (_el('btn-multiplayer')) return;
    const splash = _el('screen-splash');
    if (!splash) return;
    _css();
    const btn = document.createElement('button');
    btn.id = 'btn-multiplayer';
    btn.className = 'btn-secondary';
    btn.innerHTML = '⚔ Multiplayer — Fino a 4 Giocatori';
    btn.style.cssText = 'margin-top:.5rem;border-color:rgba(248,113,113,.5);color:#f87171';
    btn.addEventListener('click', showLobby);
    (splash.querySelector('.splash-content') || splash).appendChild(btn);
  }
  ...
  function showLobby() {
    ...
    // Controlla se il giocatore è in cooldown kick
    let kickRemainingMs = 0;
    try {
      const kickUntil = parseInt(localStorage.getItem('ia_kick_until') || '0', 10);
      if (kickUntil > Date.now()) kickRemainingMs = kickUntil - Date.now();
    } catch(e){}

    const w = document.createElement('div');
    w.id = 'mp-lobby'; w.className = 'mp-screen';
    w.innerHTML = `
      <div style="width:100%;max-width:420px">
        <div style="font-family:'Cinzel Decorative',serif;font-size:1.1rem;color:#c9a84c;text-align:center;margin-bottom:.25rem">⚔ Multiplayer</div>
        <div style="font-family:'EB Garamond',serif;font-size:.88rem;color:#6b5e4a;text-align:center;margin-bottom:1.2rem;font-style:italic">Fino a 4 giocatori · stesso WiFi o Internet</div>
        <div class="mp-card">
          <div style="font-size:.68rem;color:#fbbf24;letter-spacing:.1em;text-transform:uppercase;margin-bottom:.5rem">👑 Crea Partita (Host)</div>
          <input id="mp-hname" class="mp-inp" placeholder="Il tuo nome" maxlength="20">
          <button class="mp-btn-gold" onclick="MultiplayerEngine.createSession()">Crea Partita</button>
        </div>
        <div class="mp-card">
          <div style="font-size:.68rem;color:#60a5fa;letter-spacing:.1em;text-transform:uppercase;margin-bottom:.5rem">🗡 Unisciti</div>
          <div style="font-family:'EB Garamond',serif;font-size:.83rem;color:#9a8a6a;margin-bottom:.5rem">Inserisci il codice di 5 caratteri dell'host (es. <strong style="color:#c9a84c;letter-spacing:.1em">IA3X7</strong>).</div>
          <input id="mp-gname" class="mp-inp" placeholder="Il tuo nome" maxlength="20">
          <input id="mp-code" class="mp-inp" placeholder="Codice (es. IA3X7)" maxlength="8"
            style="letter-spacing:.25em;text-transform:uppercase;font-size:1rem;text-align:center"
            oninput="this.value=this.value.toUpperCase().replace(/[^A-Z0-9]/g,'')">
          <button id="mp-join-btn" class="mp-btn-blue" onclick="MultiplayerEngine.joinSession()">Unisciti</button>
          <div id="mp-kick-timer" style="display:none;text-align:center;font-family:'EB Garamond',serif;font-size:.8rem;color:#f87171;margin-top:.4rem;font-style:italic"></div>
        </div>
        <button class="mp-btn-ghost" onclick="MultiplayerEngine.closeLobby()">← Menu Principale</button>
      </div>`;
    document.body.appendChild(w);

    // Se c'è un cooldown kick attivo, disabilita il bottone unisciti
    if (kickRemainingMs > 0) {
      const _applyKickCooldown = () => {
        const rem = Math.max(0, Math.ceil(kickRemainingMs / 1000 - (Date.now() - (_kickCooldownStart || Date.now())) / 1000));
        const btn = _el('mp-join-btn');
        const timerEl = _el('mp-kick-timer');
        const actualRem = Math.max(0, Math.ceil((kickRemainingMs - (Date.now() - _kickCooldownStart)) / 1000));
        if (actualRem > 0) {
          if (btn) { btn.disabled = true; btn.style.opacity = '0.5'; btn.style.cursor = 'not-allowed'; btn.textContent = `Attendi ${actualRem}s`; }
          if (timerEl) { timerEl.style.display = 'block'; timerEl.textContent = `🚫 Sei stato espulso. Puoi rientrare tra ${actualRem} secondi.`; }
          setTimeout(_applyKickCooldown, 1000);
        } else {
          try { localStorage.removeItem('ia_kick_until'); } catch(e){}
          if (btn) { btn.disabled = false; btn.style.opacity = ''; btn.style.cursor = ''; btn.textContent = 'Unisciti'; }
          if (timerEl) timerEl.style.display = 'none';
        }
      };
      const _kickCooldownStart = Date.now();
      // closure trick: usa una IIFE per catturare il valore
      (function(startTs, totalMs) {
        const tick = () => {
          const actualRem = Math.max(0, Math.ceil((totalMs - (Date.now() - startTs)) / 1000));
          const btn = _el('mp-join-btn');
          const timerEl = _el('mp-kick-timer');
          if (actualRem > 0) {
            if (btn) { btn.disabled = true; btn.style.opacity = '0.5'; btn.style.cursor = 'not-allowed'; btn.textContent = `Attendi ${actualRem}s`; }
            ...
            try { localStorage.removeItem('ia_kick_until'); } catch(e2){}
            if (btn) { btn.disabled = false; btn.style.opacity = ''; btn.style.cursor = ''; btn.textContent = 'Unisciti'; }
            if (timerEl) timerEl.style.display = 'none';
          }
        };
        tick();
      })(Date.now(), kickRemainingMs);
    }
  }

  function closeLobby() { _el('mp-lobby')?.remove(); _el('mp-room')?.remove(); }
  ...
  function createSession() {
    const name = (_el('mp-hname')?.value || '').trim() || 'Anonimo';
    _isHost = true;
    _loadPeer(() => _createSessionAttempt(name, 0));
  }

  function _createSessionAttempt(name, attempt) {
    if (attempt > 8) {
      _toast('❌ Impossibile creare la stanza. Riprova tra qualche secondo.', 'warn');
      _isHost = false;
      return;
    }
    ...
    const code = _genCode();
    const peerId = 'ia-' + code.toLowerCase();
    _peer = new Peer(peerId, PEER_CFG);

    // Timeout di sicurezza: se 'open' non scatta entro 12s, riprova
    const openTimeout = setTimeout(() => {
      if (_peer && !_myPeerId) {
        try { _peer.destroy(); } catch(e){}
        _peer = null;
        _toast(`⏳ Tentativo ${attempt+2}…`, 'warn');
        setTimeout(() => _createSessionAttempt(name, attempt + 1), 300);
      }
    }, 12000);
    ...
    _peer.on('open', id => {
      ...
      _myPeerId = id;
      _sessionCode = code;
      _players[id] = _mkP(id, name, true);
      _kickedPeers = {};
      _lobbyBanned = {};
      _registerJoinOrder(id);
      _el('mp-lobby')?.remove();
      _showRoom();
    });

    _peer.on('connection', _onGuest);

    _peer.on('error', e => {
      clearTimeout(openTimeout);
      if (_peer) { try { _peer.destroy(); } catch(e2){} _peer = null; }
      _myPeerId = null;
      if (e.type === 'unavailable-id' || e.type === 'peer-unavailable' || e.type === 'network' || e.type === 'server-error') {
        const delay = 300 + attempt * 200;
        setTimeout(() => _createSessionAttempt(name, attempt + 1), delay);
      } else {
        _toast('❌ Errore: ' + e.type, 'warn');
        _isHost = false;
      }
    });

    _peer.on('disconnected', () => {
      // PeerJS si è disconnesso dal server segnalazione — tenta reconnect
      if (_peer && _isHost) {
        setTimeout(() => {
          try { if (_peer) _peer.reconnect(); } catch(e){}
        }, 1500);
      }
    });
  }
  ...
  function joinSession() {
    const name = (_el('mp-gname')?.value || '').trim() || 'Anonimo';
    let code = (_el('mp-code')?.value || '').trim().toUpperCase().replace(/[^A-Z0-9]/g,'');
    if (code.startsWith('IA-')) code = code.slice(3);
    if (!code) { _toast('Inserisci il codice host', 'warn'); return; }
    _isHost = false;
    _loadPeer(() => _joinAttempt(name, code, 0));
  }

  function _joinAttempt(name, code, attempt) {
    if (attempt > 6) {
      _toast('❌ Impossibile connettersi. Verifica il codice e riprova.', 'warn');
      return;
    }
    if (_peer && attempt === 0) {
      // prima volta: crea peer fresco
    } else if (_peer) {
      try { _peer.destroy(); } catch(e){} _peer = null;
    }

    const hostId = 'ia-' + code.toLowerCase();
    _peer = new Peer(PEER_CFG);

    const openTimeout = setTimeout(() => {
      if (_peer && !_myPeerId) {
        try { _peer.destroy(); } catch(e){}
        _peer = null;
        setTimeout(() => _joinAttempt(name, code, attempt + 1), 400);
      }
    }, 14000);
    ...
    _peer.on('open', myId => {
      clearTimeout(openTimeout);
      _myPeerId = myId;
      _players[myId] = _mkP(myId, name, true);
      _registerJoinOrder(myId);

      let connOk = false;
      const conn = _peer.connect(hostId, PEER_CONNECT_OPTS);
      ...
      const connTimeout = setTimeout(() => {
        if (!connOk) {
          ...
          setTimeout(() => _joinAttempt(name, code, attempt + 1), delay);
        }
      }, 12000);
      ...
      conn.on('open', () => {
        ...
        _setupConn(conn);
        _send(conn, { type:'JOIN_REQUEST', name, peerId: myId });
        _el('mp-lobby')?.remove();
        _showRoom();
      });
    ...
    _peer.on('disconnected', () => {
      if (_peer && _myPeerId) {
        setTimeout(() => { try { if (_peer) _peer.reconnect(); } catch(e){} }, 1500);
      }
    });
  }

  function _mkP(peerId, name, isMe) {
    return { peerId, name, charId:null, house:null, ready:false, isMe,
             resources:null, turn:0, isKing:false, state:'lobby' };
  }

  // ══════════════════════════════
  // CONNESSIONI
  // ══════════════════════════════
  function _onGuest(conn) {
    if (Object.keys(_players).length >= 4) {
      conn.on('open', () => { _send(conn, { type:'ROOM_FULL' }); conn.close(); }); return;
    }
    conn.on('open', () => { _connections[conn.peer] = conn; _setupConn(conn); });
  }

  function _setupConn(conn) {
    conn.on('data',  msg => _route(msg, conn.peer));
    conn.on('close', ()  => _onDC(conn.peer));
  }

  // ══════════════════════════════
  // ROUTER
  // ══════════════════════════════
  function _route(msg, from) {
    switch (msg.type) {
      case 'JOIN_REQUEST':   _hJoin(msg, from);      break;
      case 'PLAYER_LIST':    _hList(msg);             break;
      case 'CHAR_PICK_START': _hCharPickStart();      break;
      case 'CHAR_SEL':       _hChar(msg, from);       break;
      case 'READY':          _hReady(from);           break;
      case 'GAME_START':     _hStart();               break;
      case 'STATE_UPDATE':   _hState(msg);            break;
      case 'THRONE_ON':      _hThroneOn(msg, from);   break;
      case 'THRONE_OFF':     _hThroneOff(from);       break;
      case 'PLAYER_WIN':     _hWin(msg);              break;
      case 'PLAYER_DEAD':    _hDead(msg, from);       break;
      // Guerra PvP
      case 'WAR_ULTIMATUM':  _hWarUlt(msg, from);     break;
      case 'WAR_ULT_RESP':   _hWarUltResp(msg, from); break;
      case 'WAR_DECL':       _hWarDecl(msg, from);    break;
      case 'WAR_DECL_ACK':   _hWarDeclAck(msg, from); break;  // FIX-3
      case 'WAR_REINF_REQ':  _hReinfReq(msg, from);   break;
      case 'WAR_REINF_RESP': _hReinfResp(msg, from);  break;
      case 'WAR_START':      _hWarStart(msg, from);   break;
      case 'WAR_UPDATE':     _hWarUpd(msg);           break;
      case 'WAR_RESULT':     _hWarRes(msg, from);     break;
      // Scambi risorse
      case 'RES_OFFER':      _hResOffer(msg, from);   break;
      case 'RES_RESP':       _hResResp(msg, from);    break;
      // Chat
      case 'CHAT_GLOBAL':    _hChatGlobal(msg, from); break;
      case 'CHAT_PRIV':      _hChatPriv(msg, from);   break;
      // Relay
      case 'RELAY':          _hRelay(msg, from);      break;
      case 'ROOM_FULL':      _toast('❌ Stanza piena (max 4)', 'warn'); break;
      case 'KICKED':         _hKicked(msg); break;
      // Host migration
      case 'PING':           _hPing(msg, from);                break;
      case 'PONG':           _hPong(msg, from);                break;
      case 'HIERARCHY':      _hHierarchy(msg);                 break;
      case 'HOST_LEAVING':   _hHostLeaving(msg);               break;
      case 'MIGRATION_NEW_HOST': _hMigrationNewHost(msg, from); break;
      case 'MIGRATION_ACK':  _hMigrationAck(msg, from);        break;
      // Battaglia live PvP
      case 'PVP_BATTLE_READY':   _hPvpBattleReady(msg, from);   break;
      case 'PVP_PLACEMENT':      _hPvpPlacement(msg, from);     break;
      case 'PVP_RETREAT':        _hPvpRetreat(msg, from);       break;
    }
  }
  ...
  // HANDLERS LOBBY
  // ══════════════════════════════
  function _hJoin(msg, from) {
    if (!_isHost) return;

    // Controlla se è stato espulso di recente (cooldown 60s)
    const kickTs = _kickedPeers[from] || _kickedPeers[msg.name?.toLowerCase()];
    if (kickTs && Date.now() - kickTs < 60000) {
      const remaining = Math.ceil((60000 - (Date.now() - kickTs)) / 1000);
      const conn = _connections[from];
      if (conn) { _send(conn, { type: 'KICKED', reason: `Sei stato espulso. Riprova tra ${remaining}s.`, cooldownMs: 60000 - (Date.now() - kickTs) }); conn.close(); }
      delete _connections[from];
      return;
    }

    _players[from] = _mkP(from, msg.name, false);
    _registerJoinOrder(from);
    _bcastList();
    _refreshRoom();
  }

  // ── Kick di un giocatore dalla lobby (solo host) ──
  function kickPlayer(peerId) {
    if (!_isHost) return;
    const p = _players[peerId];
    if (!p) return;
    const conn = _connections[peerId];
    // Registra espulsione con timestamp
    _kickedPeers[peerId] = Date.now();
    if (p.name) _kickedPeers[p.name.toLowerCase()] = Date.now();
    // Notifica il guest e chiudi connessione
    if (conn) { _send(conn, { type: 'KICKED', reason: 'Sei stato espulso dall\'host.', cooldownMs: 60000 }); setTimeout(() => { try { conn.close(); } catch(e){} }, 300); }
    // Rimuovi dalla stanza
    if (p.house) delete _takenHouses[p.house];
    delete _players[peerId];
    delete _connections[peerId];
    _bcastList();
    _refreshRoom();
    _toast(`🚫 ${p.name} espulso dalla lobby.`, 'warn');
  }
  function _hKicked(msg) {
    const cooldownMs = msg.cooldownMs || 60000;
    const secs = Math.ceil(cooldownMs / 1000);
    _toast(`🚫 ${msg.reason || 'Sei stato espulso dall\'host.'}`, 'warn');
    // Salva cooldown in localStorage così persiste al refresh
    try { localStorage.setItem('ia_kick_until', String(Date.now() + cooldownMs)); } catch(e){}
    _end();
    // Mostra schermata lobby con timer
    setTimeout(() => {
      showLobby();
      const until = Date.now() + cooldownMs;
      const _showKickTimer = () => {
        const rem = Math.max(0, Math.ceil((until - Date.now()) / 1000));
        const joinBtn = _el('mp-lobby')?.querySelector('.mp-btn-blue');
        if (joinBtn) {
          if (rem > 0) {
            joinBtn.disabled = true;
            joinBtn.textContent = `Attendi ${rem}s prima di rientrare`;
            joinBtn.style.opacity = '0.5';
            joinBtn.style.cursor = 'not-allowed';
            setTimeout(_showKickTimer, 1000);
          } else {
      ...
      setTimeout(_showKickTimer, 150);
    }, 400);
  }

  function _bcastList() {
    const list = Object.values(_players).map(p => ({
      peerId:p.peerId, name:p.name, charId:p.charId, house:p.house,
      ready:p.ready, isKing:p.isKing, state:p.state,
    }));
    _bcast({ type:'PLAYER_LIST', players:list, takenHouses:_takenHouses, sessionCode:_sessionCode });
  }
  function _hList(msg) {
    _sessionCode = msg.sessionCode || _sessionCode;
    msg.players.forEach(p => {
      if (p.peerId === _myPeerId) {
        // Aggiorna solo i campi non locali (non sovrascrivere lo stato locale con quello vecchio dell'host)
        const me = _players[_myPeerId];
        if (me) {
          // Preserva la scelta locale più recente
          if (!me.charId && p.charId) me.charId = p.charId;
          if (!me.house  && p.house)  me.house  = p.house;
        }
        return;
      }
      _players[p.peerId] = { ...(_players[p.peerId]||{}), ...p };
    });
    _takenHouses = msg.takenHouses || _takenHouses;
    _refreshRoom();
    // Aggiorna blocchi casate se la schermata di selezione è aperta
    if (document.getElementById('char-grid')) _applyMpHouseBlocks();
  }
  ...
  function _showRoom() {
    ...
    _el('mp-room')?.remove();
    const w = document.createElement('div');
    w.id = 'mp-room'; w.className = 'mp-screen';

    const codeBox = _isHost ? `
      <div class="mp-card">
        <div style="font-size:.68rem;color:#fbbf24;letter-spacing:.1em;text-transform:uppercase;margin-bottom:.4rem">📋 Codice Sessione</div>
        <div id="mp-codebox" onclick="MultiplayerEngine._copyCode()"
          style="font-family:'Cinzel Decorative',serif;font-size:2.8rem;color:#c9a84c;letter-spacing:.35em;text-align:center;
          padding:.6rem .5rem;background:rgba(201,168,76,.08);border:2px solid rgba(201,168,76,.5);border-radius:8px;
          margin:.25rem 0;cursor:pointer;user-select:all;transition:all .2s">…</div>
        <div style="font-size:.62rem;color:#6b5e4a;text-align:center;font-family:'EB Garamond',serif;font-style:italic">
          👆 Tocca per copiare · Di' il codice ad alta voce agli altri
        </div>
      </div>` : `
      <div class="mp-card" style="border-color:rgba(74,222,128,.3)">
        <div style="font-size:.68rem;color:#4ade80;letter-spacing:.1em;text-transform:uppercase">✅ Connesso come ospite</div>
      </div>`;

    w.innerHTML = `
      <div style="width:100%;max-width:420px">
        <div style="font-family:'Cinzel Decorative',serif;font-size:1rem;color:#c9a84c;text-align:center;margin-bottom:.75rem">
          ⚔ Sala del Trono <span style="font-size:.6rem;color:${_isHost?'#c9a84c':'#60a5fa'}">(${_isHost?"host":"ospite"})</span>
        </div>
        ${codeBox}
        <div class="mp-card">
          <div style="font-size:.68rem;color:#9a8a6a;letter-spacing:.1em;text-transform:uppercase;margin-bottom:.5rem">Giocatori</div>
          <div id="mp-plist"></div>
        </div>
        <div id="mp-charsec-wrap" class="mp-card" style="display:none">
          <div style="font-size:.68rem;color:#fbbf24;letter-spacing:.1em;text-transform:uppercase;margin-bottom:.5rem">Il Tuo Personaggio</div>
          <div id="mp-charsec"></div>
        </div>
        <div class="mp-card">
          <div style="font-size:.68rem;color:#9a8a6a;letter-spacing:.1em;text-transform:uppercase;margin-bottom:.4rem">💬 Chat Lobby</div>
          <div id="mp-lob-chat" style="max-height:80px;overflow-y:auto;margin-bottom:.4rem;font-family:'EB Garamond',serif;font-size:.82rem;color:#9a8a6a;line-height:1.6"></div>
          <div style="display:flex;gap:.4rem">
            <input id="mp-lob-inp" class="mp-inp" style="flex:1;margin:0" placeholder="Messaggio…" maxlength="80"
              onkeydown="if(event.key==='Enter')MultiplayerEngine.sendLobbyChat()">
            <button onclick="MultiplayerEngine.sendLobbyChat()" style="padding:.45rem .75rem;background:rgba(201,168,76,.15);border:1px solid rgba(201,168,76,.4);border-radius:3px;font-family:'Cinzel',serif;font-size:.7rem;cursor:pointer;color:#c9a84c">Invia</button>
          </div>
        </div>
        <div id="mp-room-act"></div>
        <button class="mp-btn-ghost" onclick="MultiplayerEngine._leave()">← Lascia</button>
      </div>`;
    document.body.appendChild(w);
    setTimeout(() => {
      const box = _el('mp-codebox');
      if (box && _sessionCode) box.textContent = _sessionCode;
    }, 80);
    _refreshRoom();
  }

  function _refreshRoom() {
    const plist = _el('mp-plist');
    const csec  = _el('mp-charsec');
    const act   = _el('mp-room-act');
    const cbox  = _el('mp-codebox');
    if (!plist) return;
    if (cbox && _sessionCode) cbox.textContent = _sessionCode;
    const CHARS = _chars();
    const me = _players[_myPeerId];
    const allPlayers = Object.values(_players);

    // Fase corrente: 'lobby' = in attesa pronti | 'charPick' = selezione personaggio | 'ready' = tutti hanno scelto
    const anyCharPick = allPlayers.some(p => p.charId);
    const allChosen   = allPlayers.length >= 2 && allPlayers.every(p => p.charId);
    const allReady    = allPlayers.length >= 2 && allPlayers.every(p => p.ready);

    // Lista giocatori
    plist.innerHTML = allPlayers.map(p => {
      const isMe = p.peerId === _myPeerId;
      const cd = p.charId ? CHARS.find(c => c.id === p.charId) : null;
      const canKick = _isHost && !isMe;
      return `<div class="mp-slot ${p.ready?'ready':''} ${isMe?'me':''}">
        <span style="font-size:1.35rem">${cd?.icon||'❓'}</span>
        <div style="flex:1;min-width:0">
          <div style="font-size:.75rem;color:#e8dcc8;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">
            ${p.name}${isMe?' <span style="color:#c9a84c;font-size:.6rem">(tu)</span>':''}
          </div>
          <div style="font-size:.6rem;color:#9a8a6a">${cd?.name||'—'}</div>
        </div>
        <div style="font-size:.62rem">
          ${p.charId
            ? '<span style="color:#4ade80">✓ Scelto</span>'
            : (p.ready ? '<span style="color:#60a5fa">✓ Pronto</span>' : '<span style="color:#6b5e4a">attesa…</span>')}
        </div>
        ${canKick ? `<button onclick="MultiplayerEngine.kickPlayer('${p.peerId}')" title="Espelli"
          style="margin-left:.4rem;padding:.2rem .45rem;background:rgba(239,68,68,.15);border:1px solid rgba(239,68,68,.4);border-radius:3px;font-size:.6rem;cursor:pointer;color:#f87171;font-family:'Cinzel',serif">✕</button>` : ''}
      </div>`;
    }).join('');

    // Sezione personaggio — visibile solo dopo l'avvio della selezione
    const wrap = _el('mp-charsec-wrap');
    if (csec && wrap) {
      if (anyCharPick) {
        wrap.style.display = '';
        if (me?.charId) {
          const cd = CHARS.find(c => c.id === me.charId);
          csec.innerHTML = `
            <div style="display:flex;align-items:center;gap:.6rem;margin-bottom:.5rem">
              <span style="font-size:1.8rem">${cd?.icon||'❓'}</span>
              <div>
                <div style="font-size:.8rem;color:#e8dcc8">${cd?.name||me.charId}</div>
                <div style="font-size:.62rem;color:#9a8a6a">${cd?.house||''}</div>
              </div>
            </div>
            ${!allChosen ? `<button class="mp-btn-ghost" style="margin-top:0" onclick="MultiplayerEngine._openNativeCharSelect()">↺ Cambia personaggio</button>` : ''}`;
        } else {
          csec.innerHTML = `
            <div style="font-family:'EB Garamond',serif;font-size:.85rem;color:#c9a84c;margin-bottom:.5rem">⚔ Scegli il tuo personaggio!</div>
            <button class="mp-btn-gold" onclick="MultiplayerEngine._openNativeCharSelect()">⚔ Scegli Personaggio</button>`;
        }
      } else {
    ...
    if (act) {
      if (!anyCharPick) {
        // Fase 1: lobby — bottone "Pronto"
        if (!me?.ready) {
          act.innerHTML = `<button class="mp-btn-green" onclick="MultiplayerEngine.setReady()" style="max-width:420px">✓ Sono Pronto</button>`;
        } else {
          act.innerHTML = `<div style="text-align:center;color:#60a5fa;font-size:.82rem;padding:.5rem;font-family:'Cinzel',serif">
            ✓ Pronto — in attesa degli altri (${allPlayers.filter(p=>p.ready).length}/${allPlayers.length})</div>`;
        }
      } else if (anyCharPick && !allChosen) {
        // Fase 2: selezione in corso
        act.innerHTML = `<div style="font-family:'EB Garamond',serif;font-size:.82rem;color:#6b5e4a;text-align:center;padding:.5rem">
          ⚔ Selezione in corso… ${allPlayers.filter(p=>p.charId).length}/${allPlayers.length} hanno scelto</div>`;
      } else if (allChosen && _isHost) {
        // Fase 3: tutti hanno scelto — host avvia
        act.innerHTML = `<button class="mp-btn-green" onclick="MultiplayerEngine.hostStart()" style="max-width:420px">⚔ Avvia la Partita!</button>`;
      } else if (allChosen) {
        act.innerHTML = `<div style="font-family:'EB Garamond',serif;font-size:.82rem;color:#4ade80;text-align:center;padding:.5rem">✓ Tutti pronti — in attesa dell'host…</div>`;
      }
    }

    // Auto-avvio selezione: appena tutti pronti, l'host parte automaticamente
    if (_isHost && allReady && !anyCharPick) {
      setTimeout(() => {
        // Ricontrolla che siamo ancora in questa fase (evita doppio trigger)
        const stillAllReady = Object.values(_players).every(p => p.ready);
        const stillNoneChosen = !Object.values(_players).some(p => p.charId);
        if (stillAllReady && stillNoneChosen) hostStartCharPick();
      }, 800);
    }
  }

  // ══════════════════════════════════════════════════════════════════════
  // SELEZIONE PERSONAGGIO — fase 2 del flusso multiplayer
  //
  // FLUSSO NUOVO:
  //   1. Lobby → tutti premono "✓ Sono Pronto"
  //   2. Quando tutti sono pronti l'host vede "⚔ Avvia Selezione"
  //   3. L'host clicca → CHAR_PICK_START broadcast a tutti
  //   4. Ogni giocatore vede la schermata nativa casate/personaggi
  //      con le casate già prese bloccate in real-time
  //   5. Ogni giocatore sceglie e conferma → CHAR_SEL broadcast
  //   6. Quando tutti hanno scelto, l'host vede "⚔ Avvia la Partita!"
  //   7. Host clicca → GAME_START → ogni client avvia il proprio gioco
  // ══════════════════════════════════════════════════════════════════════

  // Casate "senza casa" — possono essere scelte da più giocatori
  const HOUSELESS = ['Nessuna Casa','Senza Casa','Popolo Libero',"R'hllor",'Esilio / Casa Mormont'];

  // ── Normalizza il nome casata per confronto ──
  function _normHouse(h) {
    return (h || '').replace(/^Casa\s*/i,'').trim().split('/')[0].trim().toLowerCase();
  }

  // ── L'host avvia la fase di selezione personaggio ──
  function hostStartCharPick() {
    if (!_isHost) return;
    _bcast({ type: 'CHAR_PICK_START' });
    _openNativeCharSelect();
  }

  // ── Ricevuto da guest quando l'host avvia la selezione ──
  function _hCharPickStart() {
    _openNativeCharSelect();
  }

  // ── Apre la schermata nativa con blocchi casate ──
  function _openNativeCharSelect() {
    if (typeof Game === 'undefined') return;
    Game._mpMode   = true;
    Game._mpEngine = MultiplayerEngine;

    // Nascondi room MP ma non distruggerla (ci torniamo dopo)
    const room = _el('mp-room');
    if (room) room.style.display = 'none';

    Game.showCharacterSelect();
    setTimeout(_applyMpHouseBlocks, 200);
    _installStartHook();
  }

  // ── Blocca visivamente le casate già prese da altri ──
  function _applyMpHouseBlocks() {
    if (typeof Game === 'undefined') return;

    const takenByOthers = {};
    Object.entries(_takenHouses).forEach(([houseName, pid]) => {
      if (pid !== _myPeerId) takenByOthers[_normHouse(houseName)] = _players[pid]?.name || '?';
    });

    const cards = document.querySelectorAll('#char-grid .char-card');
    cards.forEach(card => {
      // Rimuovi badge vecchi prima di ri-applicare
      card.querySelector('.mp-house-taken-badge')?.remove();
      card.querySelector('.mp-char-locked-badge')?.remove();

      const nameEl = card.querySelector('.char-card-name');
      if (!nameEl) return;
      const houseText = _normHouse(nameEl.textContent);

      let takerName = null;
      Object.entries(takenByOthers).forEach(([hn, who]) => {
        if (houseText.includes(hn) || hn.includes(houseText) && houseText.length > 2) takerName = who;
      });
      ...
      if (takerName) {
        ...
        badge.className = 'mp-house-taken-badge';
        badge.style.cssText = 'position:absolute;bottom:0;left:0;right:0;background:rgba(239,68,68,.75);color:#fff;font-family:"Cinzel",serif;font-size:.52rem;text-align:center;padding:.2rem .3rem;border-radius:0 0 5px 5px;letter-spacing:.04em';
        badge.textContent = `🔒 ${takerName}`;
      ...
      // Blocca personaggi non sbloccati
      const charIdOnCard = card.dataset.charId;
      if (charIdOnCard && typeof isCharLocked === 'function' && isCharLocked(charIdOnCard)) {
        card.style.opacity = '0.35';
        card.style.pointerEvents = 'none';
        card.style.filter = 'grayscale(0.85)';
        card.style.position = 'relative';
        const badge = document.createElement('div');
        badge.className = 'mp-char-locked-badge';
        badge.style.cssText = 'position:absolute;bottom:0;left:0;right:0;background:rgba(30,20,10,.8);color:#9a8a6a;font-family:"Cinzel",serif;font-size:.5rem;text-align:center;padding:.2rem .3rem;border-radius:0 0 5px 5px;letter-spacing:.04em';
        badge.textContent = '🔒 Bloccato';
        card.appendChild(badge);
      }
    });

    if (!window._mpHouseBlockObserver) {
      const grid = document.getElementById('char-grid');
      if (grid) {
        window._mpHouseBlockObserver = new MutationObserver(() => setTimeout(_applyMpHouseBlocks, 80));
        window._mpHouseBlockObserver.observe(grid, { childList: true, subtree: true });
      }
    }
  }

  function _stopHouseBlockObserver() {
    if (window._mpHouseBlockObserver) {
      window._mpHouseBlockObserver.disconnect();
      window._mpHouseBlockObserver = null;
    }
  }

  // ── Intercetta "⚔ Inizia la partita" nella char-detail-overlay ──
  function _installStartHook() {
    const poll = setInterval(() => {
      const btn = document.getElementById('char-detail-start');
      if (!btn || btn._mpHooked) return;
      btn._mpHooked = true;
      clearInterval(poll);
      ...
      btn.addEventListener('click', (e) => {
        ...
        const img = overlay.querySelector('img[id^="char-portrait-img-"]');
        const charId = img ? img.id.replace('char-portrait-img-', '') : null;
        if (!charId) { _toast('Errore nel leggere il personaggio.', 'warn'); return; }

        if (typeof isCharLocked === 'function' && isCharLocked(charId)) {
          _toast('🔒 Personaggio non ancora sbloccato.', 'warn');
          overlay.remove();
          return;
        }
        ...
        const isHouseless = HOUSELESS.includes(char.house);
        if (!isHouseless) {
          const myShort = _normHouse(char.house);
          const alreadyTaken = Object.entries(_takenHouses).some(([hn, pid]) => {
            if (pid === _myPeerId) return false;
            return _normHouse(hn) === myShort;
          });
          if (alreadyTaken) {
            _toast('⚠ Casata già scelta da un altro giocatore!', 'warn');
            overlay.remove();
            _applyMpHouseBlocks();
            return;
          }
        ...
        overlay.remove();
        _stopHouseBlockObserver();
        _confirmMpCharChoice(charId, char.house);
      }, true);
  ...
  // ── Registra la scelta e torna alla room MP in attesa ──
  function _confirmMpCharChoice(charId, house) {
    const prev = _players[_myPeerId];
    if (prev?.house && prev.house !== house && !HOUSELESS.includes(prev.house)) {
      delete _takenHouses[prev.house];
    }

    _players[_myPeerId].charId = charId;
    _players[_myPeerId].house  = house;
    _players[_myPeerId].ready  = false;
    _takenHouses[house] = _myPeerId;

    const msg = { type: 'CHAR_SEL', charId, house, peerId: _myPeerId };
    if (_isHost) {
      Object.values(_connections).forEach(c => _send(c, msg));
      _bcastList();
    } else {
      _toHost(msg);
    }

    // Torna alla room MP (la mostra se era nascosta)
    const room = _el('mp-room');
    if (room) {
      room.style.display = '';
      // Torna alla schermata MP (nascondi la schermata char-select nativa)
      document.querySelectorAll('.screen').forEach(s => s.classList.remove('active'));
    }
    setTimeout(() => {
      if (_el('mp-room')) _refreshRoom();
      else _showRoom();
    }, 80);
  }

  function selectChar(charId, house) { _confirmMpCharChoice(charId, house); }

  function _hChar(msg, from) {
    const p = _players[from];
    if (p) {
      if (p.house && !HOUSELESS.includes(p.house)) delete _takenHouses[p.house];
      p.charId = msg.charId;
      p.house  = msg.house;
      p.ready  = false;
      _takenHouses[msg.house] = from;
    }
    if (_isHost) {
      Object.entries(_connections).forEach(([pid, c]) => { if (pid !== from) _send(c, msg); });
      _bcastList();
    }
    _refreshRoom();
    if (document.getElementById('char-grid')) _applyMpHouseBlocks();
  ...
  // Fase 1 — pronto in lobby (senza personaggio ancora)
  function setReady() {
    const me = _players[_myPeerId];
    if (!me) return;
    me.ready = true;
    if (_isHost) _bcastList(); else _toHost({ type: 'READY', peerId: _myPeerId });
    _refreshRoom();
  }

  function _hReady(from) {
    if (_players[from]) _players[from].ready = true;
    if (_isHost) _bcastList();
    _refreshRoom();
  }

  // Fase 2 — avvia la partita (tutti hanno scelto il personaggio)
  function hostStart() {
    const list = Object.values(_players);
    if (!list.every(p => p.charId)) { _toast('Non tutti hanno scelto il personaggio!', 'warn'); return; }
    // FIX-2: l'host genera un seed condiviso per il Re CPU iniziale e lo include nel GAME_START
    // Tutti i client useranno questo seed per selezionare lo stesso Re iniziale
    const kingSeed = Math.floor(Math.random() * 0xFFFFFF);
    _bcast({ type: 'GAME_START', kingSeed });
    _startGame(kingSeed);
    if (_isHost) _startPingLoop();
  }
  function _hStart(msg) { _startGame(msg?.kingSeed); }

  // ══════════════════════════════════════════════════════════════════
  // AVVIO PARTITA — naviga automaticamente al personaggio già scelto
  // ══════════════════════════════════════════════════════════════════
  function _startGame(kingSeed) {
    _el('mp-room')?.remove();
    _el('mp-lobby')?.remove();
    _stopHouseBlockObserver();

    const charId = _players[_myPeerId]?.charId;
    if (!charId) { _toast('Personaggio non trovato!', 'warn'); return; }
    const char = _chars().find(c => c.id === charId);
    if (!char) { _toast('Personaggio non trovato!', 'warn'); return; }

    if (typeof Game === 'undefined') return;
    Game._mpMode   = true;
    Game._mpEngine = MultiplayerEngine;

    // FIX-2: salva il seed condiviso nel Game prima dell'avvio,
    // così tutti i client usano lo stesso Re iniziale CPU
    if (kingSeed !== undefined) Game._mpKingSeed = kingSeed;

    Game.showCharacterSelect();
    _autoClickNative(char, 0);
    setTimeout(() => { _injectHud(); _injectThroneBar(); _startSync(); }, 2800);
  }

  function _autoClickNative(char, attempt) {
    if (attempt > 35) { _toast('⚠ Avvio manuale: scegli ' + char.name, 'warn'); return; }
    setTimeout(() => {
      const cards = document.querySelectorAll('#char-grid .char-card');
      let found = false;
      cards.forEach(card => {
        if (found) return;
        const charIdD = card.dataset.charId;
        const nameEl  = card.querySelector('.char-card-name, .char-name');
        if (charIdD === char.id || (nameEl && nameEl.textContent.trim() === char.name)) {
          card.click(); found = true;
        }
      });
      if (found) { setTimeout(() => _clickNativeStart(char, 0), 600); return; }

      // Naviga prima alla casata
      const houseSuffix = _normHouse(char.house);
      let houseClicked = false;
      cards.forEach(card => {
        if (houseClicked) return;
        const nameEl = card.querySelector('.char-card-name, .char-name');
        if (nameEl && _normHouse(nameEl.textContent).includes(houseSuffix)) {
          card.click(); houseClicked = true;
        }
      });
      _autoClickNative(char, attempt + 1);
    }, attempt === 0 ? 400 : 300);
  }

  function _clickNativeStart(char, attempt) {
    if (attempt > 25) return;
    const overlay = document.getElementById('char-detail-overlay');
    if (!overlay) { setTimeout(() => _clickNativeStart(char, attempt + 1), 350); return; }
    const btn = overlay.querySelector('#char-detail-start') ||
                Array.from(overlay.querySelectorAll('button')).find(b => /avvia|inizia|gioca|start|scegli/i.test(b.textContent));
    if (btn) {
      btn._mpHooked = false; // avvio reale — non intercettare
      btn.click();
      return;
    }
    setTimeout(() => _clickNativeStart(char, attempt + 1), 350);
  }
  ...
  // ══════════════════════════════
  function _startSync() {
    clearInterval(window._mpSync);
    window._mpSync = setInterval(() => {
      const s = typeof Game !== 'undefined' ? Game._getState() : null;
      if (!s?.character) return;
      // Serializza le casate in forma leggera (solo id, status, army) per non appesantire il messaggio
      const housesSnap = {};
      if (s.houses) {
        Object.entries(s.houses).forEach(([id, h]) => {
          housesSnap[id] = { status: h.status, army: h.army, name: h.name, icon: h.icon };
        });
      }
      const snap = {
        peerId:     _myPeerId,
        ...
        turn:       s.turn,
        isKing:     s.king === s.character.id,
        king:       s.king,           // FIX-1a: propaga il Re corrente
        gameOver:   !!s.gameOver,
        houses:     housesSnap,       // FIX-1b: dati eserciti casate CPU
        armyUnits:  s.armyUnits ? [...s.armyUnits] : [],  // FIX-1c: truppe reclutate
      };
      const me = _players[_myPeerId];
      if (me) Object.assign(me, { resources:snap.resources, turn:snap.turn, isKing:snap.isKing,
                                   king:snap.king, houses:snap.houses, armyUnits:snap.armyUnits,
                                   state:snap.gameOver?'dead':'playing' });
      const m = { type:'STATE_UPDATE', snap };
      _isHost ? _bcast(m) : _toHost({ type:'RELAY', payload:m });
      _updateHud();
      _checkThrone(snap);
      if (snap.gameOver) {
        const dm = { type:'PLAYER_DEAD', peerId:_myPeerId };
        _isHost ? _bcast(dm) : _toHost({ type:'RELAY', payload:dm });
      }
    }, 3000);
  }

  function _hState(msg) {
    const p = _players[msg.snap.peerId];
    if (p) Object.assign(p, {
      resources:  msg.snap.resources,
      turn:       msg.snap.turn,
      isKing:     msg.snap.isKing,
      king:       msg.snap.king,       // FIX-1a ricevuto
      houses:     msg.snap.houses,     // FIX-1b ricevuto
      armyUnits:  msg.snap.armyUnits,  // FIX-1c ricevuto
      state:      msg.snap.gameOver?'dead':'playing',
    });
    _updateHud();
  }
  function _hDead(msg, from) {
    if (_players[from]) _players[from].state = 'dead';
    _toast(`💀 ${_players[from]?.name||'?'} è stato eliminato.`, 'warn');
    _updateHud();
  }
  ...
  // RELAY
  // ══════════════════════════════
  function _hRelay(msg, from) {
    if (!_isHost) return;
    const dest = msg.payload?._to;
    if (dest) {
      const c = _connections[dest];
      if (c) _send(c, msg.payload);
      // FIX-14: se il messaggio è diretto a un peer specifico, NON processarlo anche localmente
      // (evita doppia elaborazione di WAR_DECL, THRONE_ON, chat, ecc.)
    } else {
      // Broadcast: forwarda a tutti gli altri guest e processa anche in locale (host è destinatario)
      Object.entries(_connections).forEach(([pid, c]) => { if (pid !== from) _send(c, msg.payload); });
      _route(msg.payload, from);
    }
  }
  ...
  // TRONO 5 MINUTI
  // ══════════════════════════════
  function _checkThrone(snap) {
    if (snap.isKing) {
      if (_throneHolderPeerId !== _myPeerId) {
        // FIX-9: se l'host, controlla che nessun altro stia già tenendo il trono
        // Se un altro giocatore ha già il trono, il mio claim non è valido
        if (_isHost) {
          const alreadyHeld = _throneHolderPeerId && _throneHolderPeerId !== _myPeerId &&
                              _players[_throneHolderPeerId]?.state !== 'dead';
          if (alreadyHeld) return; // ignora il claim in conflitto
        }
        _throneHolderPeerId = _myPeerId; _throneStart = Date.now();
        _toast('👑 Hai il Trono! Mantienilo 5 minuti per vincere.', 'good');
        const m = { type:'THRONE_ON', peerId:_myPeerId, name:_players[_myPeerId]?.name };
        _isHost ? _bcast(m) : _toHost({ type:'RELAY', payload:m });
        _startCountdown();
      }
    } else if (_throneHolderPeerId === _myPeerId) {
      _throneHolderPeerId = null; _throneStart = null;
      clearInterval(_throneTimer); _throneTimer = null;
      const m = { type:'THRONE_OFF', peerId:_myPeerId };
      _isHost ? _bcast(m) : _toHost({ type:'RELAY', payload:m });
      _toast('👑 Hai perso il Trono!', 'warn'); _updThrone();
    }
  }
  function _startCountdown() {
    clearInterval(_throneTimer);
    _throneTimer = setInterval(() => {
      const el = Date.now() - _throneStart;
      _updThrone(el);
      if (el >= THRONE_WIN_MS) {
        clearInterval(_throneTimer); _throneTimer = null;
        const s = typeof Game !== 'undefined' ? Game._getState() : null;
        if (s?.inActiveBattle || s?.pendingWarTarget) { _throneWarBlocked = true; _toast('👑 5 min scaduti! Esito guerra deciderà il vincitore.', 'good'); }
        else _declareWin();
      }
    }, 1000);
  }
  function _declareWin() {
    _toast('🏆 HAI VINTO! 5 minuti sul Trono!', 'good');
    const m = { type:'PLAYER_WIN', peerId:_myPeerId, name:_players[_myPeerId]?.name };
    _isHost ? _bcast(m) : _toHost({ type:'RELAY', payload:m });
    _showWin(_players[_myPeerId]?.name||'Tu', true);
  }
  function _hThroneOn(msg, from) {
    if (from === _myPeerId) return;
    _throneHolderPeerId = from;
    _toast(`👑 ${_players[from]?.name||'?'} ha il Trono! Scalzalo entro 5 min.`, 'warn');
    _updThrone();
  }
  function _hThroneOff(from) {
    if (_throneHolderPeerId === from) { _throneHolderPeerId = null; _updThrone(); }
  }
  function _hWin(msg) { _showWin(msg.name||'?', msg.peerId === _myPeerId); }

  // ══════════════════════════════════════════════════════
  // GUERRA PvP — IDENTICA AL SINGLEPLAYER
  // Flusso: ultimatum opzionale → dichiarazione → turno 1-2-3
  //         → rinforzi alleati CPU → pre-battle overlay → scacchiera
  // ══════════════════════════════════════════════════════

  // ── Invia ultimatum (richiesta risorse prima di guerra) ──
  function sendWarUltimatum(targetPeerId) {
    const me = _players[_myPeerId];
    const opp = _players[targetPeerId];
    if (!opp || opp.state === 'dead') { _toast('Giocatore non disponibile.', 'warn'); return; }

    _el('mp-actions')?.remove();
    // Mostra UI per scegliere risorse da richiedere
    const ov = document.createElement('div');
    ov.id = 'mp-ult-build';
    ov.className = 'mp-war-popup';
    const resOpts = [
      { res:'gold', icon:'💰', label:'Oro' },
      { res:'army', icon:'⚔', label:'Esercito' },
      { res:'people', icon:'👥', label:'Popolo' },
      { res:'faith', icon:'✝', label:'Fede' },
      { res:'power', icon:'👑', label:'Potere' },
    ];
    ov.innerHTML = `
      <div style="background:linear-gradient(160deg,#1a1508,#12100a);border:2px solid rgba(239,68,68,.5);border-radius:8px;width:90%;max-width:380px;padding:1.5rem;font-family:'Cinzel',serif">
        <div style="font-family:'Cinzel Decorative',serif;color:#f87171;font-size:.9rem;margin-bottom:.4rem">⚔ Ultimatum a ${opp.name}</div>
        <div style="font-family:'EB Garamond',serif;font-size:.85rem;color:#9a8a6a;margin-bottom:1rem;line-height:1.5">
          Invia un ultimatum: chiedi risorse oppure dichiari guerra direttamente.
        </div>
        <div style="font-size:.68rem;color:#c9a84c;letter-spacing:.08em;text-transform:uppercase;margin-bottom:.5rem">Richiedi (opzionale):</div>
        <div style="display:flex;flex-wrap:wrap;gap:.4rem;margin-bottom:1rem">
          ${resOpts.map(r => `
            <label style="display:flex;align-items:center;gap:.3rem;background:#12121a;border:1px solid rgba(201,168,76,.2);border-radius:4px;padding:.35rem .55rem;cursor:pointer;font-family:'Cinzel',serif;font-size:.68rem;color:#e8dcc8">
              <input type="checkbox" id="ult-${r.res}" style="margin:0"> ${r.icon} ${r.label}
              <input type="number" id="ult-${r.res}-amt" min="1" max="30" value="10"
                style="width:40px;padding:.2rem;background:#0a0a0f;border:1px solid rgba(201,168,76,.25);border-radius:2px;font-family:'Cinzel',serif;font-size:.68rem;color:#c9a84c;text-align:center">
            </label>`).join('')}
        </div>
        <div style="display:flex;gap:.6rem">
          <button onclick="MultiplayerEngine._sendUltimatum('${targetPeerId}')"
            style="flex:1;padding:.65rem;background:linear-gradient(135deg,#7f1d1d,#dc2626);border:none;border-radius:3px;font-family:'Cinzel',serif;font-size:.72rem;font-weight:700;letter-spacing:.1em;cursor:pointer;color:#fff">
            📜 Invia Ultimatum
          </button>
          <button onclick="MultiplayerEngine._declareWarDirect('${targetPeerId}')"
            style="flex:1;padding:.65rem;background:rgba(239,68,68,.12);border:1px solid rgba(239,68,68,.4);border-radius:3px;font-family:'Cinzel',serif;font-size:.72rem;font-weight:700;letter-spacing:.1em;cursor:pointer;color:#f87171">
            ⚔ Guerra Diretta
          </button>
        </div>
        <button onclick="document.getElementById('mp-ult-build')?.remove()"
          style="width:100%;padding:.55rem;background:transparent;border:1px solid rgba(201,168,76,.25);border-radius:3px;font-family:'Cinzel',serif;font-size:.68rem;cursor:pointer;color:#9a8a6a;margin-top:.4rem">Annulla</button>
      </div>`;
    document.body.appendChild(ov);
  }

  function _sendUltimatum(targetPeerId) {
    const resOpts = ['gold','army','people','faith','power'];
    const demands = [];
    resOpts.forEach(res => {
      const cb  = _el('ult-' + res);
      const amt = _el('ult-' + res + '-amt');
      if (cb?.checked) demands.push({ res, amount: Math.max(1, parseInt(amt?.value||'10')) });
    });
    _el('mp-ult-build')?.remove();
    const me = _players[_myPeerId];
    const msg = { type:'WAR_ULTIMATUM', from:_myPeerId, fromName:me?.name, demands, charId:me?.charId };
    _sendToP(targetPeerId, msg);
    if (demands.length > 0)
      _toast(`📜 Ultimatum inviato a ${_players[targetPeerId]?.name||'?'}.`);
    else
      _declareWarDirect(targetPeerId);
  }

  function _hWarUlt(msg, from) {
    const CHARS = _chars();
    const fc = CHARS.find(c => c.id === msg.charId);
    const demandText = msg.demands?.length > 0
      ? msg.demands.map(d => {
          const icons = {gold:'💰',army:'⚔',people:'👥',faith:'✝',power:'👑'};
          return `${icons[d.res]||d.res} ${d.amount}`;
        }).join(' + ')
      : 'Nessuna risorsa — solo guerra';

    _el('mp-ult-recv')?.remove();
    const ov = document.createElement('div');
    ov.id = 'mp-ult-recv';
    ov.className = 'mp-war-popup';
    ov.innerHTML = `
      <div style="background:linear-gradient(160deg,#1a1508,#12100a);border:2px solid rgba(239,68,68,.5);border-radius:8px;width:90%;max-width:380px;padding:1.5rem;font-family:'Cinzel',serif;text-align:center">
        <div style="font-size:2rem;margin-bottom:.4rem">${fc?.icon||'⚔'}</div>
        <div style="font-family:'Cinzel Decorative',serif;color:#f87171;font-size:.9rem;margin-bottom:.4rem">⚔ ULTIMATUM</div>
        <div style="font-family:'EB Garamond',serif;font-size:.9rem;color:#9a8a6a;margin-bottom:1rem;line-height:1.6;font-style:italic">
          «<strong style="color:#e8dcc8">${msg.fromName}</strong> ti invia un ultimatum.<br>
          ${msg.demands?.length > 0 ? `Chiede: <strong style="color:#c9a84c">${demandText}</strong><br>o ti dichiara guerra.` : 'Si prepara alla guerra.'}»
        </div>
        ${msg.demands?.length > 0 ? `
        <div style="display:flex;gap:.6rem;margin-bottom:.5rem">
          <button onclick="MultiplayerEngine._respondUlt('${from}','accept',${JSON.stringify(msg.demands).replace(/"/g,'&quot;')})"
            style="flex:1;padding:.65rem;background:linear-gradient(135deg,#14532d,#16a34a);border:none;border-radius:3px;font-family:'Cinzel',serif;font-size:.7rem;font-weight:700;cursor:pointer;color:#fff">
            ✓ Paga (${demandText})
          </button>
          <button onclick="MultiplayerEngine._respondUlt('${from}','refuse',null)"
            style="flex:1;padding:.65rem;background:rgba(239,68,68,.12);border:1px solid rgba(239,68,68,.4);border-radius:3px;font-family:'Cinzel',serif;font-size:.7rem;font-weight:700;cursor:pointer;color:#f87171">
            ✗ Rifiuta → Guerra
          </button>
        </div>` : ''}
        <button onclick="MultiplayerEngine._respondUlt('${from}','fight',null)"
          style="width:100%;padding:.65rem;background:linear-gradient(135deg,#7f1d1d,#dc2626);border:none;border-radius:3px;font-family:'Cinzel',serif;font-size:.7rem;font-weight:700;cursor:pointer;color:#fff;margin-top:.2rem">
          ⚔ ${msg.demands?.length>0 ? 'Rifiuta tutto e combatti' : 'Preparati alla guerra'}
        </button>
      </div>`;
    document.body.appendChild(ov);
    setTimeout(() => ov.remove(), 40000);
  }

  function _respondUlt(fromPeerId, response, demands) {
    _el('mp-ult-recv')?.remove();
    const me = _players[_myPeerId];

    if (response === 'accept' && demands) {
      // Paga le risorse richieste
      const s = typeof Game !== 'undefined' ? Game._getState() : null;
      if (s) {
        demands.forEach(d => { s.resources[d.res] = Math.max(0, (s.resources[d.res]||0) - d.amount); });
        Game._updateHUD?.(); Game._saveGame?.();
      }
      _sendToP(fromPeerId, { type:'WAR_ULT_RESP', from:_myPeerId, fromName:me?.name, response:'paid', demands });
      _toast('✓ Tributo pagato. Guerra evitata.', 'good');
    } else {
      // Rifiuto → guerra
      _sendToP(fromPeerId, { type:'WAR_ULT_RESP', from:_myPeerId, fromName:me?.name, response:'refused' });
      // Prepara la guerra dal lato difensore (fase rinforzi)
      _initPvpWarDefender(fromPeerId);
    }
  }

  function _hWarUltResp(msg, from) {
    if (msg.response === 'paid') {
      const icons = {gold:'💰',army:'⚔',people:'👥',faith:'✝',power:'👑'};
      const list = (msg.demands||[]).map(d => `${icons[d.res]}${d.amount}`).join('+');
      _toast(`✓ ${msg.fromName} ha pagato il tributo (${list}). Guerra evitata.`, 'good');
      // Aggiungi risorse pagate
      const s = typeof Game !== 'undefined' ? Game._getState() : null;
      if (s && msg.demands) msg.demands.forEach(d => {
        s.resources[d.res] = Math.min(100, (s.resources[d.res]||0) + d.amount);
      });
      Game?._updateHUD?.(); Game?._saveGame?.();
    } else {
      // Ha rifiutato → avvia guerra — FIX-10: cancella eventuale timer ACK già in corso
      const s = typeof Game !== 'undefined' ? Game._getState?.() : null;
      if (s?._pvpWarDeclAckTimer) { clearTimeout(s._pvpWarDeclAckTimer); s._pvpWarDeclAckTimer = null; }
      _toast(`⚔ ${msg.fromName} ha rifiutato l'ultimatum! La guerra è dichiarata.`, 'warn');
      _initPvpWarAttacker(from);
    }
  }

  // ── Guerra diretta (senza ultimatum) ──
  function _declareWarDirect(targetPeerId) {
    _el('mp-ult-build')?.remove();
    const me = _players[_myPeerId];
    // Guerra incondizionata: anche l'attaccante non può ritirarsi
    const s = typeof Game !== 'undefined' ? Game._getState?.() : null;
    if (s) s._pvpUnconditional = true;
    _sendToP(targetPeerId, { type:'WAR_DECL', from:_myPeerId, fromName:me?.name, charId:me?.charId });
    _toast(`⚔ Dichiarazione di guerra inviata a ${_players[targetPeerId]?.name||'?'}!`, 'warn');
    // FIX-3: non avviare la fase attaccante subito — aspetta WAR_DECL_ACK dal difensore (max 42s poi parte)
    const ackTimer = setTimeout(() => {
      _toast('⚔ Nessuna risposta: la guerra inizia automaticamente.', 'warn');
      _initPvpWarAttacker(targetPeerId);
    }, 42000);
    // Salva il timer così può essere cancellato quando arriva l'ack
    if (s) { s._pvpWarDeclAckTimer = ackTimer; s._pvpWarDeclTarget = targetPeerId; }
  }

  function _hWarDeclAck(msg, from) {
    // FIX-3: il difensore ha confermato la ricezione → avvio normale
    const s = typeof Game !== 'undefined' ? Game._getState?.() : null;
    if (s?._pvpWarDeclAckTimer) { clearTimeout(s._pvpWarDeclAckTimer); s._pvpWarDeclAckTimer = null; }
    if (s?._pvpWarDeclTarget === from) _initPvpWarAttacker(from);
  }

  // ── Richiesta rinforzi alleati senza uscire dalla schermata MP ──
  function _mpRequestAllyArmy(houseId, opponentPeerId, role) {
    // Forzare un pendingWarTarget fittizio affinché requestAllyArmy non rifiuti
    const s = typeof Game !== 'undefined' ? Game._getState?.() : null;
    if (!s) return;
    const prev = s.pendingWarTarget;
    if (!s.pendingWarTarget) s.pendingWarTarget = '__pvp__';

    // Intercetta showModal e showToast per non navigare via
    const origModal = Game.showModal?.bind(Game);
    const origToast = Game.showToast?.bind(Game);
    const toasts = [];
    if (typeof Game !== 'undefined') {
      Game.showModal = (title, body, icon, btnLabel, cb) => {
        // Riapri il pannello rinforzi dopo che il modale viene chiuso
        const origCb = cb;
        Game.showModal = origModal; // ripristina subito
        if (origModal) origModal(title, body, icon, btnLabel, () => {
          origCb?.();
          _el('mp-pvp-reinf')?.remove();
          _showPvpReinforcements(opponentPeerId, role);
        });
      };
    }

    try {
      if (typeof Game !== 'undefined' && Game.requestAllyArmy) {
        Game.requestAllyArmy(houseId);
      }
    } finally {
      if (!prev) s.pendingWarTarget = null;
      // Piccolo delay per lasciare completare eventuali toast/modal, poi riapre il pannello
      setTimeout(() => {
        if (typeof Game !== 'undefined') Game.showModal = origModal;
        // Se il pannello è sparito (nessun modal aperto), riaprilo
        if (!_el('mp-pvp-reinf') && !document.getElementById('modal-overlay') && !document.querySelector('.modal-overlay')) {
          _showPvpReinforcements(opponentPeerId, role);
        }
      }, 200);
    }
  ...
  function _hWarDecl(msg, from) {
    const CHARS = _chars();
    const fc = CHARS.find(c => c.id === msg.charId);
    // Guerra incondizionata: la ritirata è vietata per il difensore
    const s = typeof Game !== 'undefined' ? Game._getState?.() : null;
    if (s) s._pvpUnconditional = true;
    // FIX-3: invia subito l'ack all'attaccante così sa che il messaggio è arrivato
    _sendToP(from, { type:'WAR_DECL_ACK', from:_myPeerId });
    _el('mp-wardecl-recv')?.remove();
    const ov = document.createElement('div');
    ov.id = 'mp-wardecl-recv';
    ov.className = 'mp-war-popup';
    ov.innerHTML = `
      <div style="background:linear-gradient(160deg,#1a1508,#12100a);border:2px solid rgba(239,68,68,.5);border-radius:8px;width:90%;max-width:360px;padding:1.5rem;font-family:'Cinzel',serif;text-align:center">
        <div style="font-size:2rem;margin-bottom:.4rem">${fc?.icon||'⚔'}</div>
        <div style="font-family:'Cinzel Decorative',serif;color:#f87171;font-size:.9rem;margin-bottom:.5rem">⚔ DICHIARAZIONE DI GUERRA</div>
        <div style="font-family:'EB Garamond',serif;font-size:.9rem;color:#9a8a6a;margin-bottom:1.2rem;font-style:italic;line-height:1.6">
          «<strong style="color:#e8dcc8">${msg.fromName}</strong> ti ha dichiarato guerra!<br>Prepara le tue truppe.»
        </div>
        <button onclick="document.getElementById('mp-wardecl-recv')?.remove();MultiplayerEngine._initPvpWarDefender('${from}')"
          style="width:100%;padding:.7rem;background:linear-gradient(135deg,#7f1d1d,#dc2626);border:none;border-radius:3px;font-family:'Cinzel',serif;font-size:.75rem;font-weight:700;cursor:pointer;color:#fff">
          ⚔ Prepara la difesa
        </button>
      </div>`;
    document.body.appendChild(ov);
  ...
  // ── FASE RINFORZI (identica al singleplayer: chiedi aiuto alle casate CPU alleate) ──
  function _initPvpWarAttacker(targetPeerId) {
    // Mostra il pannello rinforzi del singleplayer (usa le stesse funzioni di Game)
    const s = typeof Game !== 'undefined' ? Game._getState() : null;
    if (!s) return;
    // Salva il target PvP nello stato per recuperarlo dopo
    s._pvpWarTarget = targetPeerId;
    s._pvpWarRole   = 'attacker';
    // FIX-5: pre-popola _pvpBattleState con oppArmy dal sync in modo che _showPvpReinforcements abbia il valore corretto
    const opp = _players[targetPeerId];
    if (!_pvpBattleState) _pvpBattleState = {};
    _pvpBattleState.opponentPeerId = targetPeerId;
    _pvpBattleState.oppArmy = (opp?.resources?.army || 50);
    _showPvpReinforcements(targetPeerId, 'attacker');
  }
  function _initPvpWarDefender(attackerPeerId) {
    const s = typeof Game !== 'undefined' ? Game._getState() : null;
    if (!s) return;
    s._pvpWarTarget = attackerPeerId;
    s._pvpWarRole   = 'defender';
    // FIX-5: pre-popola _pvpBattleState
    const opp = _players[attackerPeerId];
    if (!_pvpBattleState) _pvpBattleState = {};
    _pvpBattleState.opponentPeerId = attackerPeerId;
    _pvpBattleState.oppArmy = (opp?.resources?.army || 50);
    _showPvpReinforcements(attackerPeerId, 'defender');
  }

  function _showPvpReinforcements(opponentPeerId, role) {
    const s = typeof Game !== 'undefined' ? Game._getState() : null;
    if (!s) return;
    const opp = _players[opponentPeerId];
    const myArmy = (s.resources?.army||0) + (s.loanedArmy||0);
    // FIX-4: preferisci il valore trasmesso via WAR_START (include loanedArmy avversario)
    // _pvpBattleState.oppArmy viene valorizzato in _hWarStart con il valore reale dell'avversario
    const oppArmy = (_pvpBattleState?.oppArmy) || (opp?.resources?.army || 50);
    const winPct  = Math.round(Math.min(95, Math.max(5, myArmy / (myArmy + oppArmy) * 100)));
    const allies  = Object.entries(s.houses||{}).filter(([, h]) => h.status === 'ally' && !h.suppressed);
    const CHARS   = _chars();
    const oppChar = CHARS.find(c => c.id === opp?.charId);

    if (typeof AudioManager !== 'undefined') AudioManager.playWar();

    const loanNote = (s.loanedArmy||0) > 0
      ? `<p style="color:#4ade80;font-size:.82rem;font-family:'EB Garamond',serif">⚔ Rinforzi ottenuti: +${s.loanedArmy}</p>` : '';

    const allyRows = allies.length > 0
      ? allies.map(([id, h]) => {
          const hasLoan    = (s.allyLoans||{})[id];
          const hasRefused = (s.allyLoanRefusals||{})[id];
          if (hasLoan)    return `<div style="padding:.45rem .65rem;margin-bottom:.3rem;background:rgba(74,222,128,.08);border:1px solid rgba(74,222,128,.25);border-radius:3px;font-family:'EB Garamond',serif;font-size:.88rem;color:#4ade80">${h.icon} ${h.name} — ⚔ +${hasLoan.amount} forniti</div>`;
          if (hasRefused) return `<div style="padding:.45rem .65rem;margin-bottom:.3rem;background:rgba(120,60,60,.08);border:1px solid rgba(239,68,68,.2);border-radius:3px;font-family:'EB Garamond',serif;font-size:.82rem;color:#9a8a6a">${h.icon} ${h.name} — ha rifiutato</div>`;
          return `<button onclick="MultiplayerEngine._mpRequestAllyArmy('${id}','${opponentPeerId}','${role}')"
            style="width:100%;text-align:left;padding:.45rem .65rem;margin-bottom:.3rem;background:rgba(74,222,128,.08);border:1px solid rgba(74,222,128,.25);border-radius:3px;font-family:'EB Garamond',serif;font-size:.88rem;color:#e8dcc8;cursor:pointer">
            ${h.icon} ${h.name} — ⚔ ${Math.round(h.army)} <span style="color:#c9a84c;float:right">Chiedi rinforzi →</span>
          </button>`;
        }).join('')
      : '<p style="color:#6b5e4a;font-size:.82rem;font-style:italic;font-family:\'EB Garamond\',serif">Nessun alleato disponibile.</p>';

    _el('mp-pvp-reinf')?.remove();
    const ov = document.createElement('div');
    ov.id = 'mp-pvp-reinf';
    ov.style.cssText = 'position:fixed;inset:0;background:rgba(0,0,0,.92);z-index:850;display:flex;align-items:center;justify-content:center;animation:mp-in .3s ease';
    ov.innerHTML = `
      <div style="background:#12121a;border:2px solid rgba(239,68,68,.5);border-radius:6px;width:92%;max-width:450px;max-height:90vh;overflow-y:auto;padding:1.75rem;font-family:'Cinzel',serif">
        <div style="font-family:'Cinzel Decorative',serif;color:#f87171;font-size:1rem;margin-bottom:.3rem">
          ⚔ ${role==='attacker'?'Guerra a':'Difesa da'} ${opp?.name||'?'}
          <span style="font-size:.65rem;color:#9a8a6a;font-family:'Cinzel',serif;display:block;margin-top:.15rem">${oppChar?.house||''}</span>
        </div>
        <div style="font-size:.7rem;color:#9a8a6a;letter-spacing:.1em;text-transform:uppercase;margin-bottom:1rem">Pianificazione</div>
        <div style="display:flex;justify-content:space-between;font-size:.82rem;color:#e8dcc8;margin-bottom:.4rem">
          <span>🗡 Tue forze: <strong style="color:#4ade80">${Math.round(myArmy)}</strong></span>
          <span>🛡 Forze nemiche: <strong style="color:#f87171">${Math.round(oppArmy)}</strong></span>
        </div>
        <div style="height:10px;border-radius:4px;overflow:hidden;background:rgba(255,255,255,.05);margin-bottom:.4rem;display:flex">
          <div style="width:${Math.round(myArmy/(myArmy+oppArmy)*100)}%;background:linear-gradient(90deg,#166534,#4ade80)"></div>
          <div style="flex:1;background:linear-gradient(90deg,#991b1b,#f87171)"></div>
        </div>
        <div style="text-align:center;font-size:.75rem;color:#c9a84c;margin-bottom:.75rem">
          Probabilità vittoria: <strong>${winPct}%</strong>
        </div>
        ${loanNote}
        <div style="background:rgba(74,222,128,.04);border:1px solid rgba(74,222,128,.2);border-radius:4px;padding:.75rem;margin-bottom:.75rem">
          <div style="font-size:.72rem;color:#4ade80;letter-spacing:.08em;text-transform:uppercase;margin-bottom:.5rem">🤝 Rinforzi dalle casate alleate</div>
          ${allyRows}
        </div>
        <div style="background:rgba(201,168,76,.06);border:1px solid rgba(201,168,76,.15);border-radius:4px;padding:.65rem;margin-bottom:1rem;font-family:'EB Garamond',serif;font-size:.88rem;color:#e8dcc8;line-height:1.5">
          <strong style="color:#4ade80">Se vinci:</strong> +Esercito +Potere, l'avversario perde risorse.<br>
          <strong style="color:#f87171">Se perdi:</strong> perdi Esercito e Potere.
        </div>
        <div style="display:flex;gap:.75rem">
          <button onclick="document.getElementById('mp-pvp-reinf')?.remove();MultiplayerEngine._launchPvpBattle('${opponentPeerId}','${role}')"
            style="flex:1;padding:.75rem;background:linear-gradient(135deg,#7f1d1d,#dc2626);border:none;border-radius:2px;font-family:'Cinzel',serif;font-size:.75rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;cursor:pointer;color:#fff">
            ⚔ ${role==='attacker'?'Attacca!':'Difendi!'}
          </button>
          ${s._pvpUnconditional
            ? `<button disabled title="Guerra incondizionata — la ritirata non è permessa"
                style="flex:1;padding:.75rem;background:transparent;border:1px solid rgba(120,120,120,.25);border-radius:2px;font-family:'Cinzel',serif;font-size:.75rem;font-weight:600;letter-spacing:.1em;text-transform:uppercase;cursor:not-allowed;color:#4a4a4a;opacity:.45">
                🚫 Ritira (bloccata)
              </button>`
            : `<button onclick="if(typeof AudioManager!=='undefined')AudioManager.playMainFromWar();document.getElementById('mp-pvp-reinf')?.remove();Game.cancelWar?.()"
                style="flex:1;padding:.75rem;background:transparent;border:1px solid rgba(201,168,76,.4);border-radius:2px;font-family:'Cinzel',serif;font-size:.75rem;font-weight:600;letter-spacing:.1em;text-transform:uppercase;cursor:pointer;color:#c9a84c">
                Ritira
              </button>`}
        </div>
      </div>`;
  ...
  // ══════════════════════════════════════════════════════════════════════
  // BATTAGLIA LIVE PvP — placement sincronizzato + countdown condiviso
  // Flusso:
  //  1. Entrambi i giocatori aprono la scacchiera e posizionano le truppe
  //  2. Countdown da 20 sincronizzato via WAR_START (attacker avvia, defender segue)
  //  3. Allo scadere: attacker invia le sue posizioni (PVP_PLACEMENT),
  //     defender fa lo stesso → entrambi ricevono le posizioni dell'avversario
  //  4. La battaglia parte con le truppe reali posizionate dall'avversario
  //  5. Ritirata bloccata in guerra incondizionata; disponibile dopo 10s in guerra normale
  // ══════════════════════════════════════════════════════════════════════

  let _pvpBattleState = null; // stato condiviso battaglia live

  function _launchPvpBattle(opponentPeerId, role) {
    const s = typeof Game !== 'undefined' ? Game._getState?.() : null;
    if (!s) return;
    const opp     = _players[opponentPeerId];
    const myArmy  = (s.resources?.army||0) + (s.loanedArmy||0);
    // FIX-7: preferisci il valore già ricevuto via WAR_START (se il difensore ha già risposto)
    // altrimenti usa il dato del sync (può essere leggermente obsoleto)
    const oppArmy = (_pvpBattleState?.oppArmy && _pvpBattleState.opponentPeerId === opponentPeerId)
                    ? _pvpBattleState.oppArmy
                    : (opp?.resources?.army || 50);
    const CHARS   = _chars();
    const oppChar = CHARS.find(c => c.id === opp?.charId);

    // Stato condiviso per questa battaglia
    _pvpBattleState = {
      opponentPeerId,
      role,
      myArmy,
      oppArmy,
      unconditional: !!s._pvpUnconditional,
      myPlacement:   null,
      oppPlacement:  null,
      battleStarted: false,
      retreatUnlocked: false,
      startTs: Date.now(), // FIX-12: timestamp di riferimento per il countdown
    };

    // Notifica l'avversario che siamo pronti
    _sendToP(opponentPeerId, {
      type: 'WAR_START', from: _myPeerId, fromName: _players[_myPeerId]?.name,
      myArmy, role,
      startTs: Date.now(), // FIX-12: timestamp assoluto per sincronizzare il countdown
    });

    // Lancia la scacchiera live
    _showLivePvpBattle(opponentPeerId, role, myArmy, oppArmy, oppChar, opp);

    // Notifica spettatori
    _bcast({ type:'WAR_UPDATE', p1:{ peerId:_myPeerId, name:_players[_myPeerId]?.name, army:myArmy },
             p2:{ peerId:opponentPeerId, name:opp?.name, army:oppArmy }, phase:'battle' });
  }

  function _hWarStart(msg, from) {
    // Il mio avversario ha avviato — apro anch'io la battaglia
    const s = typeof Game !== 'undefined' ? Game._getState?.() : null;
    if (!s) return;
    const myArmy  = (s.resources?.army||0) + (s.loanedArmy||0);
    const oppArmy = msg.myArmy || 50;
    const CHARS   = _chars();
    const opp     = _players[from];
    const oppChar = CHARS.find(c => c.id === opp?.charId);
    const myRole  = msg.role === 'attacker' ? 'defender' : 'attacker';

    _pvpBattleState = {
      opponentPeerId: from,
      role: myRole,
      myArmy,
      oppArmy,   // FIX-6: valore reale trasmesso dall'avversario (include suo loanedArmy)
      unconditional: !!s._pvpUnconditional,
      myPlacement:  null,
      oppPlacement: null,
      battleStarted: false,
      retreatUnlocked: false,
      startTs: msg.startTs || Date.now(), // FIX-12: usa il timestamp dell'attaccante per allineare il countdown
    };

    // FIX-6b: comunica al pannello rinforzi il valore corretto (se ancora aperto)
    const reinfPanel = document.getElementById('mp-pvp-reinf');
    if (reinfPanel) {
      const oppBar = reinfPanel.querySelector('[data-opp-army]');
      if (oppBar) oppBar.textContent = Math.round(oppArmy);
    }

    _toast(`⚔ La battaglia con ${msg.fromName} è iniziata! Posiziona le tue truppe.`, 'warn');
    _showLivePvpBattle(from, myRole, myArmy, oppArmy, oppChar, opp);
    _bcast({ type:'WAR_UPDATE', phase:'started', p1Name:msg.fromName, p2Name:_players[_myPeerId]?.name });
  }

  // ── Scacchiera live PvP ──
  function _showLivePvpBattle(opponentPeerId, role, myArmy, oppArmy, oppChar, opp) {
    const s = typeof Game !== 'undefined' ? Game._getState?.() : null;
    if (!s) return;

    const COLS = 7, ROWS = 10, CW = 40, CH = 42;
    const BW = COLS * CW, BH = ROWS * CH;
    const UR = 14, HP_BASE = 5;
    const COUNTDOWN_SEC = 20;
    const RETREAT_UNLOCK_SEC = 10; // secondi dall'inizio battaglia

    const unconditional = !!s._pvpUnconditional;
    const pCount = Math.min(12, Math.max(1, Math.floor(myArmy / 5)));
    const eCount = Math.min(12, Math.max(1, Math.floor(oppArmy / 5)));

    // ── Unità placement ──
    let _uid = 0;
    function makeUnit(side, col, row) {
      const x = col * CW + CW / 2, y = row * CH + CH / 2;
      const hp = HP_BASE;
      return { id: 'u'+(++_uid), side, x, y, col, row, hp, maxHp: hp, dmg: 1,
               alive: true, dead: false, deadAt: 0, lastAtk: 0, engagedId: null,
               angle: side === 'p' ? -Math.PI/2 : Math.PI/2,
               troopType:'soldato', troopColor:'#a3a3a3', troopSpd:1, troopR:0 };
    }

    // Posizionamento default nelle ultime 2 righe
    const playerUnits = [];
    let placed = 0;
    for (let row = ROWS-1; row >= ROWS-2 && placed < pCount; row--)
      for (let col = 0; col < COLS && placed < pCount; col++)
        { playerUnits.push(makeUnit('p', col, row)); placed++; }

    // Placeholder nemici (sostituiti dalle posizioni reali dopo il countdown)
    const enemyUnits = [];

    let phase = 'placement';
    let countdown = COUNTDOWN_SEC;
    let cdTimer = null, raf = null, dragUnit = null, dragOX = 0, dragOY = 0;
    let battleStartTs = 0, particles = [];
    let retreatBtn = null;
    ...
    const ov = document.createElement('div');
    ov.id = 'sb-overlay';
    ov.style.cssText = 'position:fixed;inset:0;z-index:950;background:#07070e;display:flex;flex-direction:column;align-items:center;justify-content:center;font-family:"Cinzel",serif;overflow:hidden';
    ov.innerHTML = `
      <div style="display:flex;flex-direction:column;align-items:center;gap:4px;width:${BW+20}px;max-height:100vh;overflow:hidden">
        <div style="display:flex;justify-content:space-between;width:100%;font-size:.58rem;letter-spacing:.1em;text-transform:uppercase">
          <span style="color:#4ade80">🛡 <strong>${Math.round(myArmy)}</strong></span>
          <span id="sb-phase" style="color:#9a8a6a">POSIZIONAMENTO</span>
          <span style="color:#f87171"><strong>${Math.round(oppArmy)}</strong> ⚔</span>
        </div>
        <div style="display:flex;gap:5px;width:100%;align-items:center">
          <div style="flex:1;height:5px;background:rgba(74,222,128,.15);border-radius:3px;overflow:hidden">
            <div id="sb-pbar" style="height:100%;width:100%;background:linear-gradient(90deg,#16a34a,#4ade80);border-radius:3px;transition:width .4s"></div>
        ...
        <div style="display:flex;align-items:center;gap:10px;padding:2px 0">
          <div id="sb-cd" style="font-family:'Cinzel Decorative',serif;font-size:1.5rem;color:#c9a84c;min-width:2rem;text-align:center">${COUNTDOWN_SEC}</div>
          <div id="sb-msg" style="font-size:.58rem;color:#9a8a6a;line-height:1.35;text-align:center">
            Posiziona le truppe nella tua metà.<br>
            <span style="color:#c9a84c;font-size:.55rem">⚔ vs ${opp?.name||'?'} · ${oppChar?.house||''}</span>
          </div>
        </div>
        <div style="position:relative;width:${BW}px;height:${BH}px;border:1px solid rgba(201,168,76,.28);border-radius:4px;overflow:hidden;background:#08080f;flex-shrink:0">
          <canvas id="sb-grid" width="${BW}" height="${BH}" style="position:absolute;inset:0;pointer-events:none"></canvas>
          ...
          <canvas id="sb-fog"  width="${BW}" height="${BH}" style="position:absolute;inset:0;pointer-events:none"></canvas>
          <div style="position:absolute;left:0;right:0;top:50%;height:1px;background:rgba(201,168,76,.28);pointer-events:none"></div>
          <div style="position:absolute;top:3px;left:4px;font-size:.44rem;color:#f87171;opacity:.7;letter-spacing:.06em">${(opp?.name||'NEMICO').toUpperCase()}</div>
          <div style="position:absolute;bottom:3px;left:4px;font-size:.44rem;color:#4ade80;opacity:.7;letter-spacing:.06em">LE TUE TRUPPE</div>
        </div>
        <div id="sb-btns" style="display:flex;gap:8px;margin-top:2px">
          ${unconditional
            ? `<div style="font-size:.58rem;color:#f87171;font-family:'Cinzel',serif;opacity:.7">⚠ Guerra incondizionata — ritirata vietata</div>`
            : `<button id="sb-ret" style="padding:.42rem .9rem;background:transparent;border:1px solid rgba(120,120,120,.3);border-radius:3px;font-family:Cinzel,serif;font-size:.6rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;cursor:not-allowed;color:#4a4a4a;opacity:.45" disabled>🚫 Ritirata (disponibile dopo 10s)</button>`}
        </div>
      </div>`;
    document.body.appendChild(ov);
    ...
    const gCtx   = gridCv.getContext('2d');
    const fCtx   = fogCv.getContext('2d');
    retreatBtn    = document.getElementById('sb-ret');
    ...
    function spawnParticles(x,y,type){
      for(let i=0;i<6;i++){
        ...
        particles.push({x,y,vx:Math.cos(a)*sp,vy:Math.sin(a)*sp,life:1,decay:.05,r:2+Math.random()*2,
          color:type==='blood'?`rgba(200,10,10,`:`rgba(230,180,20,`,gravity:type==='blood'?.12:-.04});
      }
    }
    function render() {
      mCtx.clearRect(0,0,BW,BH);
      // Fog (solo in placement)
      fCtx.clearRect(0,0,BW,BH);
      if(phase==='placement'){
        fCtx.fillStyle='rgba(0,0,0,.55)';
        fCtx.fillRect(0,0,BW,BH/2);
      }
      // Particelle
      particles=particles.filter(p=>p.life>0);
      particles.forEach(p=>{
        mCtx.globalAlpha=p.life;
        mCtx.fillStyle=p.color+p.life+')';
        mCtx.beginPath();mCtx.arc(p.x,p.y,p.r,0,Math.PI*2);mCtx.fill();
        p.x+=p.vx;p.y+=p.vy+p.gravity;p.life-=p.decay;
      });
      mCtx.globalAlpha=1;
      // Unità
      [...playerUnits,...enemyUnits].forEach(u=>{
        if(u.dead){
          const age=Date.now()-u.deadAt;
          if(age>600) return;
          mCtx.globalAlpha=Math.max(0,1-age/600);
        }
        const col = u.side==='p'?'#4ade80':'#f87171';
        mCtx.beginPath();mCtx.arc(u.x,u.y,UR,0,Math.PI*2);
        mCtx.fillStyle=u.side==='p'?'rgba(74,222,128,.18)':'rgba(248,113,113,.18)';mCtx.fill();
        mCtx.strokeStyle=col;mCtx.lineWidth=u===dragUnit?2.5:1.5;mCtx.stroke();
        // HP bar
        const hpPct=u.hp/u.maxHp;
        mCtx.fillStyle='rgba(0,0,0,.5)';mCtx.fillRect(u.x-UR,u.y+UR+2,UR*2,3);
        mCtx.fillStyle=hpPct>.5?'#4ade80':hpPct>.25?'#fbbf24':'#f87171';
        mCtx.fillRect(u.x-UR,u.y+UR+2,UR*2*hpPct,3);
        // Freccia direzione
        mCtx.save();mCtx.translate(u.x,u.y);mCtx.rotate(u.angle);
        mCtx.fillStyle=col+'aa';mCtx.beginPath();
        mCtx.moveTo(UR-4,0);mCtx.lineTo(UR-8,-3);mCtx.lineTo(UR-8,3);mCtx.closePath();mCtx.fill();
        mCtx.restore();
        mCtx.globalAlpha=1;
      });
    }
    ...
    function updateBars(){
      const pa=playerUnits.filter(u=>u.alive).length;
      const ea=enemyUnits.filter(u=>u.alive).length;
      const pPct=pa/Math.max(1,playerUnits.length), ePct=ea/Math.max(1,enemyUnits.length);
      const pb=document.getElementById('sb-pbar'),eb=document.getElementById('sb-ebar');
      const pu=document.getElementById('sb-pu'),eu=document.getElementById('sb-eu');
      if(pb)pb.style.width=(pPct*100)+'%';
      if(eb)eb.style.width=(ePct*100)+'%';
      if(pu)pu.textContent=pa;
      if(eu)eu.textContent=ea;
    }
    ...
    function unitAt(x,y){return playerUnits.find(u=>Math.hypot(u.x-x,u.y-y)<UR+4);}

    mainCv.addEventListener('mousedown', e=>{ if(phase!=='placement') return; const pt=ptFromEv(e); const u=unitAt(pt.x,pt.y); if(u){dragUnit=u;dragOX=pt.x-u.x;dragOY=pt.y-u.y;mainCv.style.cursor='grabbing';} });
    mainCv.addEventListener('mousemove', e=>{ if(!dragUnit||phase!=='placement') return; const pt=ptFromEv(e); dragUnit.x=pt.x-dragOX;dragUnit.y=pt.y-dragOY; });
    mainCv.addEventListener('mouseup',   e=>{ if(!dragUnit||phase!=='placement') return; const pt=ptFromEv(e); snapUnit(dragUnit,pt.x-dragOX,pt.y-dragOY); dragUnit=null; mainCv.style.cursor='grab'; });
    mainCv.addEventListener('touchstart',e=>{ e.preventDefault(); if(phase!=='placement') return; const pt=ptFromEv(e); const u=unitAt(pt.x,pt.y); if(u){dragUnit=u;dragOX=pt.x-u.x;dragOY=pt.y-u.y;} },{passive:false});
    mainCv.addEventListener('touchmove', e=>{ e.preventDefault(); if(!dragUnit||phase!=='placement') return; const pt=ptFromEv(e); dragUnit.x=pt.x-dragOX;dragUnit.y=pt.y-dragOY; },{passive:false});
    mainCv.addEventListener('touchend',  e=>{ e.preventDefault(); if(!dragUnit||phase!=='placement') return; const pt=ptFromEv(e.changedTouches?{touches:e.changedTouches}:e); snapUnit(dragUnit,dragUnit.x,dragUnit.y); dragUnit=null; },{passive:false});

    function snapUnit(u, x, y){
      // Solo metà inferiore (zona giocatore)
      const col=Math.max(0,Math.min(COLS-1,Math.floor(x/CW)));
      const row=Math.max(Math.floor(ROWS/2),Math.min(ROWS-1,Math.floor(y/CH)));
      // Evita sovrapposizioni
      const occupied=playerUnits.filter(o=>o!==u&&o.col===col&&o.row===row);
      if(occupied.length){u.x=u.col*CW+CW/2;u.y=u.row*CH+CH/2;return;}
      u.col=col;u.row=row;u.x=col*CW+CW/2;u.y=row*CH+CH/2;
    }
    ...
    function startCd(){
      phase='countdown';
      document.getElementById('sb-phase').textContent='COUNTDOWN';
      // FIX-12: calcola il countdown in base al timestamp condiviso invece di un interval locale
      // Questo allinea i due client anche se c'è lag di rete
      const sharedStartTs = (_pvpBattleState?.startTs) || Date.now();
      cdTimer=setInterval(()=>{
        const elapsed = Math.floor((Date.now() - sharedStartTs) / 1000);
        countdown = Math.max(0, COUNTDOWN_SEC - elapsed);
        const el=document.getElementById('sb-cd');
        if(el){el.textContent=countdown;el.style.color=countdown<=5?'#f87171':'#c9a84c';}
        if(countdown<=0){clearInterval(cdTimer);_onCountdownEnd();}
      },250); // tick più frequente per maggiore precisione visiva
    }

    function _onCountdownEnd(){
      phase='waiting_opp';
      document.getElementById('sb-phase').textContent='IN ATTESA…';
      document.getElementById('sb-cd').textContent='⏳';
      document.getElementById('sb-msg').textContent="In attesa delle posizioni avversarie…";

      // Serializza le mie posizioni e le invia
      const myPos = playerUnits.map(u=>({col:u.col,row:u.row}));
      if(_pvpBattleState) _pvpBattleState.myPlacement = myPos;

      _sendToP(opponentPeerId, { type:'PVP_PLACEMENT', from:_myPeerId, positions: myPos });

      // Se ho già ricevuto le posizioni avversarie, avvio la battaglia
      if(_pvpBattleState?.oppPlacement) _startLiveBattle();
    }

    function _startLiveBattle(){
      if(_pvpBattleState?.battleStarted) return;
      if(_pvpBattleState) _pvpBattleState.battleStarted = true;

      // Popola le unità nemiche con le posizioni reali dell'avversario
      // Le posizioni avversarie sono nel suo sistema di riferimento (metà inferiore per lui)
      // Dobbiamo specchiarle: la riga R del difensore → riga (ROWS-1-R) nella vista dell'attaccante
      const oppPos = _pvpBattleState?.oppPlacement || [];
      enemyUnits.length = 0;
      const oppUnitCount = Math.min(12, Math.max(1, Math.floor(oppArmy/5)));
      for(let i=0;i<Math.min(oppPos.length, oppUnitCount);i++){
        const op = oppPos[i];
        const mirrorRow = ROWS - 1 - op.row; // specchia verticalmente
        const mirrorCol = COLS - 1 - op.col; // specchia orizzontalmente
        enemyUnits.push(makeUnit('e', mirrorCol, mirrorRow));
      }
      // Se l'avversario aveva meno unità del previsto, riempi con default
      while(enemyUnits.length < oppUnitCount){
        const i = enemyUnits.length;
        enemyUnits.push(makeUnit('e', i%COLS, Math.floor(i/COLS)));
      }
      ...
      document.getElementById('sb-msg').textContent='Le armate si scontrano!';
      mainCv.style.cursor='default';
      fCtx.clearRect(0,0,BW,BH); // rimuovi nebbia

      // Sblocca ritirata dopo 10s (solo se non guerra incondizionata)
      if(!unconditional && retreatBtn){
        setTimeout(()=>{
          if(phase!=='battle') return;
          retreatBtn.disabled=false;
          retreatBtn.style.opacity='1';
          retreatBtn.style.cursor='pointer';
          retreatBtn.style.color='#c9a84c';
          retreatBtn.style.borderColor='rgba(201,168,76,.4)';
          retreatBtn.textContent='🏃 Ritirata';
          retreatBtn.onclick=()=>_doRetreat(opponentPeerId,role,myArmy);
          if(_pvpBattleState) _pvpBattleState.retreatUnlocked=true;
        }, RETREAT_UNLOCK_SEC * 1000);
      }

      // Battle loop
      const SPEED_PX=32, ATK_RANGE=UR*2.6, ATK_INTERVAL=2200;
      function dist(a,b){const dx=a.x-b.x,dy=a.y-b.y;return Math.sqrt(dx*dx+dy*dy);}
      function angleToUnit(f,t){return Math.atan2(t.y-f.y,t.x-f.x);}
      let lastTs=0;
      function tick(ts){
        ...
        [...ap,...ae].forEach(u=>{
          const opps=u.side==='p'?ae:ap;
          if(!opps.length) return;
          let target=opps.find(op=>op.id===u.engagedId&&op.alive);
          if(!target){u.engagedId=null;let nd=Infinity;opps.forEach(op=>{const d=dist(u,op);if(d<nd){nd=d;target=op;}});}
          if(!target) return;
          const td=dist(u,target);
          const ta=angleToUnit(u,target);
          let da=ta-u.angle;
          while(da>Math.PI)da-=2*Math.PI;while(da<-Math.PI)da+=2*Math.PI;
          u.angle+=da*Math.min(1,dt*4.5);
          if(td>ATK_RANGE){u.x+=Math.cos(ta)*SPEED_PX*dt;u.y+=Math.sin(ta)*SPEED_PX*dt;u.x=Math.max(UR,Math.min(BW-UR,u.x));u.y=Math.max(UR,Math.min(BH-UR,u.y));}
          else{
            if(!u.engagedId) u.engagedId=target.id;
            if(ts-u.lastAtk>=ATK_INTERVAL){u.lastAtk=ts;target.hp-=u.dmg;spawnParticles(target.x,target.y,'blood');
              if(target.hp<=0){target.hp=0;target.alive=false;target.dead=true;target.deadAt=Date.now();u.engagedId=null;}
              updateBars();
            }
          }
        });
    ...
    function endBattle(playerWon){
      ...
      const pAlive=playerUnits.filter(u=>u.alive).length;
      const eAlive=enemyUnits.filter(u=>u.alive).length;
      const survived=Math.max(1,Math.round(myArmy*(pAlive/Math.max(1,playerUnits.length))));
      const enemySurvived=Math.max(0,Math.round(oppArmy*(eAlive/Math.max(1,enemyUnits.length))));
      const phEl=document.getElementById('sb-phase'),cdEl=document.getElementById('sb-cd');
      const msgEl=document.getElementById('sb-msg'),btnsEl=document.getElementById('sb-btns');
      if(phEl) phEl.textContent=playerWon?'VITTORIA':'SCONFITTA';
      if(cdEl){cdEl.textContent=playerWon?'🏆':'💀';cdEl.style.color=playerWon?'#4ade80':'#f87171';}
      if(msgEl) msgEl.innerHTML=playerWon
        ?`<span style="color:#4ade80;font-size:.72rem">${Math.round(survived)} truppe sopravvissute.</span>`
      ...
      document.getElementById('sb-finish')?.addEventListener('click',()=>{
        cleanup();
        _pvpBattleResult(playerWon, opponentPeerId, role, myArmy, oppArmy);
      });
      function rl(){render();if(phase==='result')requestAnimationFrame(rl);}
    ...
    function cleanup(){
      clearInterval(cdTimer); cancelAnimationFrame(raf); phase='done';
      document.getElementById('sb-overlay')?.remove();
      if(s) s._pvpUnconditional = false;
      _pvpBattleState = null;
    }

    // Avvia loop placement + countdown
    function placementLoop(){render();if(phase==='placement'||phase==='countdown'||phase==='waiting_opp')requestAnimationFrame(placementLoop);}
    requestAnimationFrame(placementLoop);
    startCd();

    // Ascolta quando arrivano le posizioni avversarie
    function _onOppReady() {
      document.removeEventListener('pvp-opp-placement-ready', _onOppReady);
      _startLiveBattle();
    }
    document.addEventListener('pvp-opp-placement-ready', _onOppReady);
  }

  // ── Ricevo le posizioni dell'avversario ──
  function _hPvpPlacement(msg, from) {
    if(!_pvpBattleState || _pvpBattleState.opponentPeerId !== from) return;
    _pvpBattleState.oppPlacement = msg.positions;
    // Se il mio countdown è già scaduto, avvio la battaglia ora
    if(_pvpBattleState.myPlacement) {
      // Cerca la funzione _startLiveBattle nell'overlay attivo — la triggero via evento custom
      document.dispatchEvent(new CustomEvent('pvp-opp-placement-ready'));
    }
  }

  // ── Gestisce la ritirata ──
  function _doRetreat(opponentPeerId, role, myArmy) {
    const s = typeof Game !== 'undefined' ? Game._getState?.() : null;
    // Perdita per la ritirata: 25% esercito + 8 potere
    if(s){
      s.resources.army  = Math.max(1, Math.round(myArmy * 0.75));
      s.resources.power = Math.max(1, (s.resources.power||50) - 8);
      Game?._updateHUD?.(); Game?._saveGame?.();
    }
    document.getElementById('sb-overlay')?.remove();
    _pvpBattleState = null;
    _sendToP(opponentPeerId, { type:'PVP_RETREAT', from:_myPeerId, name:_players[_myPeerId]?.name });
    _toast('🏃 Ti sei ritirato. Perdite subite: -25% esercito, -8 potere.', 'warn');
  }

  function _hPvpRetreat(msg, from) {
    // L'avversario si è ritirato — vittoria automatica con perdite lievi
    const s = typeof Game !== 'undefined' ? Game._getState?.() : null;
    if(s){
      s.resources.army  = Math.min(100, (s.resources.army||50) + 5);
      s.resources.power = Math.min(100, (s.resources.power||50) + 6);
      Game?._updateHUD?.(); Game?._saveGame?.();
    }
    document.getElementById('sb-overlay')?.remove();
    _pvpBattleState = null;
    _toast(`🏃 ${msg.name||'L\'avversario'} si è ritirato. Vittoria per abbandono! +5⚔ +6👑`, 'good');
  }

  // ── Handler pronto battaglia ──
  function _hPvpBattleReady(msg, from) {
    // Usato per sincronizzazione futura (es. entrambi confermano ready)
  }

  function _pvpBattleResult(won, opponentPeerId, role, myArmy, oppArmy) {
    const s = typeof Game !== 'undefined' ? Game._getState() : null;
    if (s) {
      if (won) {
        s.resources.army  = Math.min(100, Math.round(myArmy * 0.85 + 5));
        s.resources.power = Math.min(100, (s.resources.power||50) + 12);
        s.loanedArmy = 0; s.allyLoans = {};
      } else {
        s.resources.army  = Math.max(1, Math.round(myArmy * 0.3));
        s.resources.power = Math.max(1, (s.resources.power||50) - 10);
        s.loanedArmy = 0; s.allyLoans = {};
      }
      Game?._updateHUD?.(); Game?._saveGame?.();
    }
    if (_throneWarBlocked && won && _players[_myPeerId]?.isKing) { _throneWarBlocked = false; _declareWin(); }

    // FIX-8: invia i valori finali del perdente così l'avversario applica esattamente gli stessi numeri
    // Il mittente è sempre chi ha appena visto la schermata di risultato — quindi ha i dati aggiornati
    const loserFinalArmy  = won ? Math.max(1, Math.round(oppArmy * 0.3))       : Math.min(100, Math.round(oppArmy * 0.85 + 5));
    const loserPowerDelta = won ? -10 : 12;
    _sendToP(opponentPeerId, {
      type:'WAR_RESULT', winnerId: won ? _myPeerId : opponentPeerId,
      winnerName: won ? (_players[_myPeerId]?.name||'?') : (_players[opponentPeerId]?.name||'?'),
      loserFinalArmy,
      loserPowerDelta,
    });
    _toast(won ? '🏆 Hai vinto la guerra!' : '💀 Hai perso la guerra.', won?'good':'warn');
  }

  function _runSimpleBattle(opponentPeerId, role, myArmy, oppArmy) {
    const won = myArmy * (0.5 + Math.random()*0.5) > oppArmy * (0.5 + Math.random()*0.5);
    _pvpBattleResult(won, opponentPeerId, role, myArmy, oppArmy);
  }

  function _hWarUpd(msg) {
    // Mostra badge spettatore se non coinvolti
    if (msg.phase === 'battle' || msg.phase === 'started') {
      const p1 = msg.p1Name || msg.p1?.name;
      const p2 = msg.p2Name || msg.p2?.name;
      if (!p1 || !p2) return;
      if ([msg.p1?.peerId, msg.p2?.peerId].includes(_myPeerId)) return;
      _showSpecPrompt(p1, p2);
    }
  }

  function _hWarRes(msg, from) {
    // FIX-8: applica il risultato autorevole calcolato dall'avversario
    // Questo evita che i due client calcolino esiti diversi con random locale
    const isMe = msg.winnerId === _myPeerId;
    const s = typeof Game !== 'undefined' ? Game._getState?.() : null;
    if (s && msg.loserFinalArmy !== undefined) {
      if (!isMe) {
        // Ho perso: usa i valori finali mandati dall'avversario
        s.resources.army  = Math.max(1, msg.loserFinalArmy);
        s.resources.power = Math.max(1, (s.resources.power||50) + (msg.loserPowerDelta || -10));
      } else {
        // Ho vinto: applica i guadagni (speculare a ciò che ha calcolato il perdente)
        s.resources.army  = Math.min(100, Math.round((s.resources?.army||50) * 0.85 + 5));
        s.resources.power = Math.min(100, (s.resources.power||50) + 12);
      }
      s.loanedArmy = 0; s.allyLoans = {};
      Game?._updateHUD?.(); Game?._saveGame?.();
    }
    if (_throneWarBlocked && isMe && _players[_myPeerId]?.isKing) { _throneWarBlocked = false; _declareWin(); }
    _toast(isMe ? '🏆 Hai vinto la guerra!' : `💀 ${msg.winnerName} ha vinto la battaglia.`, isMe?'good':'warn');
  }

  // Spettatori
  function _showSpecPrompt(p1, p2) {
    _el('mp-spec-pr')?.remove();
    const pr = document.createElement('div');
    pr.id = 'mp-spec-pr';
    pr.style.cssText = 'position:fixed;bottom:5rem;left:50%;transform:translateX(-50%);z-index:799;background:#12121a;border:1px solid rgba(239,68,68,.4);border-radius:8px;padding:.85rem 1rem;font-family:"Cinzel",serif;width:88%;max-width:340px;animation:mp-in .3s ease';
    pr.innerHTML = `
      <div style="font-size:.68rem;color:#f87171;margin-bottom:.3rem">⚔ GUERRA IN CORSO</div>
      <div style="font-family:'EB Garamond',serif;font-size:.85rem;color:#e8dcc8;margin-bottom:.6rem"><strong>${p1}</strong> vs <strong>${p2}</strong></div>
      <div style="display:flex;gap:.5rem">
        <button onclick="MultiplayerEngine._openSpec()" style="flex:1;padding:.5rem;background:rgba(239,68,68,.15);border:1px solid rgba(239,68,68,.4);border-radius:3px;font-family:'Cinzel',serif;font-size:.65rem;cursor:pointer;color:#fca5a5">👁 Guarda</button>
        <button onclick="document.getElementById('mp-spec-pr')?.remove()" style="padding:.5rem .75rem;background:transparent;border:1px solid rgba(201,168,76,.25);border-radius:3px;font-family:'Cinzel',serif;font-size:.65rem;cursor:pointer;color:#9a8a6a">No</button>
      </div>`;
    document.body.appendChild(pr);
    setTimeout(() => pr.remove(), 15000);
  }

  function _openSpec() {
    _el('mp-spec-pr')?.remove();
    _el('mp-spec-ov')?.remove();
    const ov = document.createElement('div');
    ov.id = 'mp-spec-ov';
    ov.style.cssText = 'position:fixed;inset:0;z-index:790;background:rgba(10,10,15,.97);display:flex;flex-direction:column;align-items:center;padding:1.5rem 1rem;font-family:"Cinzel",serif;';
    ov.innerHTML = `
      <div style="font-family:'Cinzel Decorative',serif;font-size:.9rem;color:#f87171;margin-bottom:.75rem">👁 Modalità Spettatore</div>
      <div id="mp-spec-log" style="width:100%;max-width:380px;flex:1;overflow-y:auto;background:#12121a;border:1px solid rgba(239,68,68,.2);border-radius:6px;padding:.75rem;font-family:'EB Garamond',serif;font-size:.85rem;color:#e8dcc8;line-height:1.7;margin-bottom:1rem;min-height:200px"></div>
      <button onclick="document.getElementById('mp-spec-ov')?.remove()" style="padding:.6rem 1.5rem;background:transparent;border:1px solid rgba(201,168,76,.35);border-radius:3px;font-family:'Cinzel',serif;font-size:.72rem;cursor:pointer;color:#c9a84c">Torna al gioco</button>`;
    document.body.appendChild(ov);
  }
  ...
  // SCAMBI DI RISORSE TRA GIOCATORI
  // ══════════════════════════════
  function openTradePanel(targetPeerId) {
    _el('mp-trade')?.remove();
    _el('mp-actions')?.remove();
    const opp = _players[targetPeerId];
    const s   = typeof Game !== 'undefined' ? Game._getState() : null;
    ...
    ov.className = 'mp-war-popup';
    ov.innerHTML = `
      <div style="background:#0e0e16;border:1px solid rgba(201,168,76,.4);border-radius:8px;width:92%;max-width:420px;padding:1.5rem;font-family:'Cinzel',serif;max-height:88vh;overflow-y:auto">
        <div style="font-family:'Cinzel Decorative',serif;color:#c9a84c;font-size:.9rem;margin-bottom:.75rem">🤝 Scambio con ${opp.name}</div>
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:.75rem;margin-bottom:1rem">
          <div>
            <div style="font-size:.65rem;color:#4ade80;letter-spacing:.08em;text-transform:uppercase;margin-bottom:.4rem">Offri (dalla tua scorta)</div>
            ${resOpts.map(r => `
              <div style="display:flex;align-items:center;gap:.4rem;margin-bottom:.3rem">
                <span style="font-size:.9rem;width:1.2rem">${r.icon}</span>
                <span style="font-size:.65rem;color:#9a8a6a;flex:1">${r.label} (${Math.round(s.resources[r.res]||0)})</span>
                <input type="number" id="tr-give-${r.res}" min="0" max="${Math.round(s.resources[r.res]||0)}" value="0"
                  style="width:48px;padding:.2rem;background:#0a0a0f;border:1px solid rgba(201,168,76,.2);border-radius:2px;font-family:'Cinzel',serif;font-size:.7rem;color:#c9a84c;text-align:center">
              </div>`).join('')}
          </div>
          <div>
            <div style="font-size:.65rem;color:#f87171;letter-spacing:.08em;text-transform:uppercase;margin-bottom:.4rem">Richiedi (da ${opp.name})</div>
            ${resOpts.map(r => {
              const oppVal = Math.round(opp.resources?.[r.res]||0);
              return `
              <div style="display:flex;align-items:center;gap:.4rem;margin-bottom:.3rem">
                <span style="font-size:.9rem;width:1.2rem">${r.icon}</span>
                <span style="font-size:.65rem;color:#9a8a6a;flex:1">${r.label} (${oppVal})</span>
                <input type="number" id="tr-req-${r.res}" min="0" max="${oppVal}" value="0"
                  style="width:48px;padding:.2rem;background:#0a0a0f;border:1px solid rgba(201,168,76,.2);border-radius:2px;font-family:'Cinzel',serif;font-size:.7rem;color:#c9a84c;text-align:center">
              </div>`;
            }).join('')}
          </div>
        ...
        <div style="display:flex;gap:.6rem">
          <button onclick="MultiplayerEngine._sendTradeOffer('${targetPeerId}')"
            class="mp-btn-gold" style="margin-top:0">📜 Invia Proposta</button>
          <button onclick="document.getElementById('mp-trade')?.remove()"
            class="mp-btn-ghost" style="margin-top:0">Annulla</button>
        </div>
      </div>`;
    ov.addEventListener('click', e => { if (e.target === ov) ov.remove(); });
    document.body.appendChild(ov);
  ...
  function _sendTradeOffer(targetPeerId) {
    const resKeys = ['gold','army','people','faith','power'];
    const give = {}, req = {};
    resKeys.forEach(res => {
      const g = parseInt(_el('tr-give-'+res)?.value||'0');
      const r = parseInt(_el('tr-req-'+res)?.value||'0');
      if (g > 0) give[res] = g;
      if (r > 0) req[res]  = r;
    });
    if (Object.keys(give).length === 0 && Object.keys(req).length === 0) {
      _toast('Inserisci almeno una risorsa nello scambio.', 'warn'); return;
    }
    _el('mp-trade')?.remove();
    const me = _players[_myPeerId];
    _sendToP(targetPeerId, { type:'RES_OFFER', from:_myPeerId, fromName:me?.name, give, req });
    _toast(`🤝 Proposta di scambio inviata a ${_players[targetPeerId]?.name||'?'}`, 'good');
  }

  function _hResOffer(msg, from) {
    const icons = {gold:'💰',army:'⚔',people:'👥',faith:'✝',power:'👑'};
    const fmtObj = (obj) => Object.entries(obj).map(([k,v]) => `${icons[k]||k}${v}`).join(' ');
    const giveText = Object.keys(msg.give||{}).length > 0 ? `Ti dà: <strong style="color:#4ade80">${fmtObj(msg.give)}</strong>` : '';
    const reqText  = Object.keys(msg.req||{}).length  > 0 ? `Vuole: <strong style="color:#f87171">${fmtObj(msg.req)}</strong>`  : '';

    _el('mp-trade-recv')?.remove();
    const ov = document.createElement('div');
    ov.id = 'mp-trade-recv';
    ov.className = 'mp-war-popup';
    ov.innerHTML = `
      <div style="background:linear-gradient(160deg,#1a1508,#12100a);border:2px solid rgba(201,168,76,.5);border-radius:8px;width:90%;max-width:360px;padding:1.5rem;font-family:'Cinzel',serif;text-align:center">
        <div style="font-family:'Cinzel Decorative',serif;color:#c9a84c;font-size:.9rem;margin-bottom:.4rem">🤝 Proposta di Scambio</div>
        <div style="font-family:'EB Garamond',serif;font-size:.9rem;color:#9a8a6a;margin-bottom:1rem;line-height:1.7;font-style:italic">
          «<strong style="color:#e8dcc8">${msg.fromName}</strong> propone uno scambio:<br>
          ${giveText}${giveText&&reqText?' · ':''}${reqText||'(solo dono)'}»
        </div>
        <div style="display:flex;gap:.75rem">
          <button onclick="MultiplayerEngine._respondTrade('${from}',true,${JSON.stringify(msg.give||{}).replace(/"/g,'&quot;')},${JSON.stringify(msg.req||{}).replace(/"/g,'&quot;')})"
            style="flex:1;padding:.7rem;background:linear-gradient(135deg,#14532d,#16a34a);border:none;border-radius:3px;font-family:'Cinzel',serif;font-size:.72rem;font-weight:700;cursor:pointer;color:#fff">✓ Accetta</button>
          <button onclick="MultiplayerEngine._respondTrade('${from}',false,{},{})"
            style="flex:1;padding:.7rem;background:transparent;border:1px solid rgba(201,168,76,.4);border-radius:3px;font-family:'Cinzel',serif;font-size:.72rem;font-weight:700;cursor:pointer;color:#c9a84c">✗ Rifiuta</button>
        </div>
      </div>`;
    document.body.appendChild(ov);
    setTimeout(() => ov.remove(), 35000);
  }

  function _respondTrade(fromPeerId, accept, give, req) {
    _el('mp-trade-recv')?.remove();
    if (!accept) {
      _sendToP(fromPeerId, { type:'RES_RESP', from:_myPeerId, accepted:false });
      _toast('✗ Proposta di scambio rifiutata.'); return;
    }
    const s = typeof Game !== 'undefined' ? Game._getState() : null;
    if (!s) return;
    // Applica scambio locale: ricevi ciò che il mittente offre, dai ciò che ha richiesto
    Object.entries(give||{}).forEach(([res, amt]) => {
      s.resources[res] = Math.min(100, (s.resources[res]||0) + amt);
    });
    Object.entries(req||{}).forEach(([res, amt]) => {
      s.resources[res] = Math.max(0, (s.resources[res]||0) - amt);
    });
    Game?._updateHUD?.(); Game?._saveGame?.();
    _sendToP(fromPeerId, { type:'RES_RESP', from:_myPeerId, fromName:_players[_myPeerId]?.name, accepted:true, give:req, req:give });
    _toast('✓ Scambio completato!', 'good');
  }

  function _hResResp(msg, from) {
    if (!msg.accepted) { _toast(`✗ ${_players[from]?.name||'?'} ha rifiutato lo scambio.`, 'warn'); return; }
    const s = typeof Game !== 'undefined' ? Game._getState() : null;
    if (!s) return;
    // Applica: ricevi ciò che l'altro ha accettato di darti
    Object.entries(msg.give||{}).forEach(([res, amt]) => {
      s.resources[res] = Math.min(100, (s.resources[res]||0) + amt);
    });
    Object.entries(msg.req||{}).forEach(([res, amt]) => {
      s.resources[res] = Math.max(0, (s.resources[res]||0) - amt);
    });
    Game?._updateHUD?.(); Game?._saveGame?.();
    _toast(`✓ Scambio completato con ${_players[from]?.name||'?'}!`, 'good');
  }

  // ══════════════════════════════
  // CHAT GLOBALE + PRIVATA
  // ══════════════════════════════

  // Lobby chat
  function sendLobbyChat() {
    const inp  = _el('mp-lob-inp');
    const text = inp?.value?.trim();
    if (!text) return;
    inp.value = '';
    const me  = _players[_myPeerId];
    const msg = { type:'CHAT_GLOBAL', from:_myPeerId, name:me?.name||'?', text, scope:'lobby' };
    _appendLobbyChat(msg);
    if (_isHost) _bcast(msg); else _toHost({ type:'RELAY', payload:msg });
  }
  function _appendLobbyChat(msg) {
    const log = _el('mp-lob-chat');
    if (!log) return;
    const d = document.createElement('div');
    d.innerHTML = `<span style="color:#c9a84c">${msg.name}:</span> <span style="color:#e8dcc8">${msg.text}</span>`;
    log.appendChild(d); log.scrollTop = log.scrollHeight;
  }

  // Chat globale in-game (finestra)
  function toggleGlobalChat() {
    if (_el('mp-gchat')) { _el('mp-gchat')?.remove(); return; }
    _css();
    const win = document.createElement('div');
    win.id = 'mp-gchat';
    win.className = 'mp-chat-win';
    win.style.cssText += 'right:.5rem;bottom:4rem;';
    win.innerHTML = `
      <div style="padding:.55rem .75rem;border-bottom:1px solid rgba(201,168,76,.15);display:flex;align-items:center;justify-content:space-between">
        <div style="font-size:.72rem;color:#c9a84c;letter-spacing:.06em">💬 Chat Globale</div>
        <div style="display:flex;gap:.35rem;align-items:center">
          <button onclick="MultiplayerEngine._openPrivList()" style="background:transparent;border:1px solid rgba(60,130,246,.3);border-radius:3px;padding:.2rem .4rem;font-family:'Cinzel',serif;font-size:.58rem;cursor:pointer;color:#60a5fa">Privata</button>
          <button onclick="document.getElementById('mp-gchat')?.remove()" style="background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);border-radius:50%;width:22px;height:22px;font-size:.78rem;cursor:pointer;color:#9a8a6a">✕</button>
        </div>
      </div>
      <div id="mp-gchat-log" class="mp-chat-log"></div>
      <div class="mp-chat-inp-row">
        <input id="mp-gchat-inp" class="mp-inp" style="flex:1;margin:0;font-size:.72rem;padding:.4rem .55rem" placeholder="Messaggio a tutti…" maxlength="120"
          onkeydown="if(event.key==='Enter')MultiplayerEngine.sendGlobalMsg()">
        <button onclick="MultiplayerEngine.sendGlobalMsg()" style="padding:.4rem .65rem;background:rgba(201,168,76,.15);border:1px solid rgba(201,168,76,.4);border-radius:3px;font-family:'Cinzel',serif;font-size:.65rem;cursor:pointer;color:#c9a84c">↵</button>
      </div>`;
    document.body.appendChild(win);
  }

  function sendGlobalMsg() {
    const inp  = _el('mp-gchat-inp');
    const text = inp?.value?.trim();
    if (!text) return;
    inp.value = '';
    const me  = _players[_myPeerId];
    const msg = { type:'CHAT_GLOBAL', from:_myPeerId, name:me?.name||'?', text };
    _appendGlobalChat(msg);
    if (_isHost) _bcast(msg); else _toHost({ type:'RELAY', payload:msg });
  }

  function _appendGlobalChat(msg) {
    const log = _el('mp-gchat-log');
    if (!log) return;
    const d = document.createElement('div');
    const isMine = msg.from === _myPeerId;
    d.style.cssText = `text-align:${isMine?'right':'left'};margin-bottom:.3rem`;
    d.innerHTML = `${!isMine?`<span style="color:#c9a84c;font-size:.72rem">${msg.name}: </span>`:''}
      <span style="background:${isMine?'rgba(201,168,76,.15)':'rgba(255,255,255,.06)'};padding:.15rem .45rem;border-radius:3px;font-size:.82rem;color:#e8dcc8">${msg.text}</span>`;
    log.appendChild(d); log.scrollTop = log.scrollHeight;
  }

  function _hChatGlobal(msg, from) {
    _appendLobbyChat(msg);   // anche in lobby se aperta
    _appendGlobalChat(msg);  // in finestra chat globale se aperta
    // Toast non invasivo se la chat non è aperta
    if (!_el('mp-gchat') && !_el('mp-room')) _showChatNotif(msg.name, msg.text, null);
  }

  // Lista destinatari per chat privata
  function _openPrivList() {
    _el('mp-priv-list')?.remove();
    const others = Object.values(_players).filter(p => p.peerId !== _myPeerId && p.state !== 'dead');
    if (!others.length) { _toast('Nessun giocatore disponibile.', 'warn'); return; }
    const ov = document.createElement('div');
    ov.id = 'mp-priv-list';
    ov.style.cssText = 'position:fixed;bottom:4rem;right:.5rem;z-index:745;background:#0e0e16;border:1px solid rgba(60,130,246,.4);border-radius:8px;padding:.75rem;font-family:"Cinzel",serif;min-width:180px;animation:mp-in .2s ease';
    ov.innerHTML = `
      <div style="font-size:.65rem;color:#60a5fa;letter-spacing:.08em;text-transform:uppercase;margin-bottom:.5rem">Messaggia in privato:</div>
      ${others.map(p => {
        const cd = _chars().find(c => c.id === p.charId);
        return `<button onclick="MultiplayerEngine._openPrivChat('${p.peerId}');document.getElementById('mp-priv-list')?.remove()"
          style="display:flex;align-items:center;gap:.4rem;width:100%;padding:.4rem .5rem;background:transparent;border:none;cursor:pointer;text-align:left;border-radius:3px;transition:background .15s"
          onmouseenter="this.style.background='rgba(60,130,246,.1)'" onmouseleave="this.style.background='transparent'">
          <span style="font-size:1rem">${cd?.icon||'⚔'}</span>
          <span style="font-size:.72rem;color:#e8dcc8">${p.name}</span>
        </button>`;
      }).join('')}
      <button onclick="document.getElementById('mp-priv-list')?.remove()" style="width:100%;padding:.35rem;background:transparent;border:1px solid rgba(201,168,76,.2);border-radius:3px;font-family:'Cinzel',serif;font-size:.62rem;cursor:pointer;color:#6b5e4a;margin-top:.4rem">Chiudi</button>`;
    document.body.appendChild(ov);
  }

  function _openPrivChat(targetPeerId) {
    _el('mp-pchat')?.remove();
    _el('mp-priv-list')?.remove();
    _privateChatTarget = targetPeerId;
    const opp = _players[targetPeerId];
    const cd  = _chars().find(c => c.id === opp?.charId);
    const win = document.createElement('div');
    win.id = 'mp-pchat';
    win.className = 'mp-chat-win';
    win.style.cssText += 'right:.5rem;bottom:4rem;border-color:rgba(60,130,246,.5)';
    win.innerHTML = `
      <div style="padding:.55rem .75rem;border-bottom:1px solid rgba(60,130,246,.2);display:flex;align-items:center;justify-content:space-between">
        <div style="font-size:.72rem;color:#60a5fa;letter-spacing:.06em">🔒 ${cd?.icon||'⚔'} ${opp?.name||'?'}</div>
        <button onclick="document.getElementById('mp-pchat')?.remove()" style="background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);border-radius:50%;width:22px;height:22px;font-size:.78rem;cursor:pointer;color:#9a8a6a">✕</button>
      </div>
      <div id="mp-pchat-log" class="mp-chat-log"></div>
      <div class="mp-chat-inp-row">
        <input id="mp-pchat-inp" class="mp-inp" style="flex:1;margin:0;font-size:.72rem;padding:.4rem .55rem" placeholder="Messaggio privato…" maxlength="120"
          onkeydown="if(event.key==='Enter')MultiplayerEngine.sendPrivMsg()">
        <button onclick="MultiplayerEngine.sendPrivMsg()" style="padding:.4rem .65rem;background:rgba(60,130,246,.15);border:1px solid rgba(60,130,246,.4);border-radius:3px;font-family:'Cinzel',serif;font-size:.65rem;cursor:pointer;color:#60a5fa">↵</button>
      </div>`;
    document.body.appendChild(win);
  }

  function sendPrivMsg() {
    const inp  = _el('mp-pchat-inp');
    const text = inp?.value?.trim();
    if (!text || !_privateChatTarget) return;
    inp.value = '';
    const me  = _players[_myPeerId];
    const msg = { type:'CHAT_PRIV', from:_myPeerId, name:me?.name||'?', text, to:_privateChatTarget };
    _appendPrivChat(msg, true);
    _sendToP(_privateChatTarget, msg);
  }

  function _appendPrivChat(msg, sent) {
    const log = _el('mp-pchat-log');
    if (!log) return;
    const d = document.createElement('div');
    d.style.cssText = `text-align:${sent?'right':'left'};margin-bottom:.3rem`;
    d.innerHTML = `<span style="background:${sent?'rgba(60,130,246,.2)':'rgba(255,255,255,.06)'};padding:.15rem .45rem;border-radius:3px;font-size:.82rem;color:#e8dcc8">${msg.text}</span>`;
    log.appendChild(d); log.scrollTop = log.scrollHeight;
  }

  function _hChatPriv(msg, from) {
    // Se la chat privata con questo utente è aperta, aggiungi messaggio
    if (_el('mp-pchat') && _privateChatTarget === from) {
      _appendPrivChat(msg, false);
    } else {
      // Notifica popup non invasiva
      _showChatNotif(msg.name, msg.text, from);
    }
  }

  // Notifica arrivo messaggio — non invasiva, in basso a destra
  function _showChatNotif(senderName, text, fromPeerId) {
    _el('mp-notif')?.remove();
    const n = document.createElement('div');
    n.id = 'mp-notif';
    n.className = 'mp-toast-priv';
    const isPriv = fromPeerId !== null;
    n.innerHTML = `
      <div style="font-size:.62rem;color:${isPriv?'#60a5fa':'#c9a84c'};letter-spacing:.06em;margin-bottom:.2rem">${isPriv?'🔒 Messaggio privato':'💬 Chat globale'}</div>
      <div style="font-size:.7rem;color:#c9a84c;margin-bottom:.1rem">${senderName}:</div>
      <div style="font-family:'EB Garamond',serif;font-size:.82rem;color:#e8dcc8;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:200px">${text}</div>
      <div style="font-size:.58rem;color:#6b5e4a;margin-top:.2rem">${isPriv?'Tocca per rispondere':'Tocca per aprire la chat'}</div>`;
    n.addEventListener('click', () => {
      n.remove();
      if (isPriv) _openPrivChat(fromPeerId);
      else toggleGlobalChat();
    });
  ...
  function _injectHud() {
    ...
    hud.id = 'mp-hud'; hud.className = 'mp-hud';
    hud.innerHTML = `
      <div style="font-size:.58rem;color:#c9a84c;letter-spacing:.06em;flex-shrink:0">⚔ AVVERSARI</div>
      <div id="mp-ecards" style="display:flex;gap:.3rem;flex-wrap:wrap;flex:1"></div>
      <div style="display:flex;gap:.3rem;flex-shrink:0">
        <button onclick="MultiplayerEngine.toggleGlobalChat()" style="padding:.3rem .5rem;background:rgba(201,168,76,.1);border:1px solid rgba(201,168,76,.3);border-radius:3px;font-family:'Cinzel',serif;font-size:.55rem;cursor:pointer;color:#c9a84c">💬</button>
        <button onclick="MultiplayerEngine._showActions()" style="padding:.3rem .6rem;background:rgba(239,68,68,.12);border:1px solid rgba(239,68,68,.3);border-radius:3px;font-family:'Cinzel',serif;font-size:.55rem;cursor:pointer;color:#fca5a5">⚔ Azioni</button>
      </div>`;
    document.body.appendChild(hud);
  }

  function _updateHud() {
    const el = _el('mp-ecards');
    if (!el) return;
    const CHARS = _chars();
    el.innerHTML = Object.values(_players).filter(p => p.peerId !== _myPeerId).map(p => {
      const ch = CHARS.find(c => c.id === p.charId);
      return `<div class="mp-ecard ${p.isKing?'king':''}" onclick="MultiplayerEngine._showActions()" title="${p.name}">
        <span style="font-size:1rem">${ch?.icon||'⚔'}</span>
        <span style="color:#e8dcc8;max-width:52px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${p.name}</span>
        <span style="color:${p.isKing?'#c084fc':p.state==='dead'?'#6b5e4a':'#9a8a6a'}">${p.isKing?'👑':''}${p.state==='dead'?'💀':''} ⚔${Math.round(p.resources?.army||0)}</span>
      </div>`;
    }).join('');
  }
  ...
  // BARRA TRONO
  // ══════════════════════════════
  function _injectThroneBar() {
    _el('mp-throne-bar')?.remove();
    const b = document.createElement('div');
    b.id = 'mp-throne-bar'; b.className = 'mp-throne';
    b.innerHTML = `<span id="mp-th-lbl" style="flex:1">👑 Nessuno sul Trono</span><span id="mp-th-tmr"></span>`;
    document.body.appendChild(b);
  }
  function _updThrone(elapsed) {
    const lbl = _el('mp-th-lbl'), tmr = _el('mp-th-tmr');
    if (!lbl) return;
    if (!_throneHolderPeerId) { lbl.textContent = '👑 Nessuno sul Trono'; if (tmr) tmr.textContent = ''; return; }
    const holder = _players[_throneHolderPeerId];
    const isMine = _throneHolderPeerId === _myPeerId;
    lbl.innerHTML = `👑 <strong style="color:${isMine?'#c9a84c':'#c084fc'}">${holder?.name||'?'}</strong> tiene il Trono`;
    if (tmr && elapsed !== undefined) {
      const rem = Math.max(0, THRONE_WIN_MS - elapsed);
      tmr.textContent = `⏱ ${Math.floor(rem/60000)}:${String(Math.floor((rem%60000)/1000)).padStart(2,'0')}`;
    }
  }
  ...
  function _showActions() {
    ...
    const CHARS  = _chars();
    const others = Object.values(_players).filter(p => p.peerId !== _myPeerId && p.state !== 'dead');
    if (!others.length) { _toast('Nessun avversario disponibile.', 'warn'); return; }

    const ov = document.createElement('div');
    ov.id = 'mp-actions';
    ov.style.cssText = 'position:fixed;inset:0;z-index:820;display:flex;align-items:flex-end;justify-content:center;background:rgba(0,0,0,.7);animation:mp-in .2s ease';
    ov.innerHTML = `
      <div style="background:#0e0e16;border:1px solid rgba(201,168,76,.35);border-radius:10px 10px 0 0;width:100%;max-width:480px;padding:1rem;font-family:'Cinzel',serif;max-height:70vh;overflow-y:auto">
        <div style="font-family:'Cinzel Decorative',serif;font-size:.88rem;color:#c9a84c;margin-bottom:.75rem;text-align:center">⚔ Azioni verso Giocatori</div>
        ${others.map(p => {
          const ch = CHARS.find(c => c.id === p.charId);
          return `<div style="background:#12121a;border:1px solid rgba(201,168,76,.15);border-radius:5px;padding:.6rem .75rem;margin-bottom:.4rem">
            <div style="display:flex;align-items:center;gap:.5rem;margin-bottom:.4rem">
              <span style="font-size:1.15rem">${ch?.icon||'⚔'}</span>
              <div><div style="font-size:.75rem;color:#e8dcc8">${p.name}</div>
              <div style="font-size:.58rem;color:#9a8a6a">⚔${p.resources?.army?Math.round(p.resources.army):'?'} · ${ch?.house||''}</div></div>
              ${p.isKing?'<span style="margin-left:auto;font-size:.7rem;color:#c084fc">👑 Re</span>':''}
            </div>
            <div style="display:flex;gap:.3rem;flex-wrap:wrap">
              <button onclick="MultiplayerEngine.sendWarUltimatum('${p.peerId}');document.getElementById('mp-actions')?.remove()"
                style="flex:1;min-width:80px;padding:.38rem;background:rgba(239,68,68,.1);border:1px solid rgba(239,68,68,.3);border-radius:3px;font-family:'Cinzel',serif;font-size:.58rem;cursor:pointer;color:#f87171">⚔ Guerra</button>
              <button onclick="MultiplayerEngine.openTradePanel('${p.peerId}');document.getElementById('mp-actions')?.remove()"
                style="flex:1;min-width:80px;padding:.38rem;background:rgba(74,222,128,.1);border:1px solid rgba(74,222,128,.3);border-radius:3px;font-family:'Cinzel',serif;font-size:.58rem;cursor:pointer;color:#4ade80">🤝 Scambia</button>
              <button onclick="MultiplayerEngine._openPrivChat('${p.peerId}');document.getElementById('mp-actions')?.remove()"
                style="flex:1;min-width:80px;padding:.38rem;background:rgba(60,130,246,.1);border:1px solid rgba(60,130,246,.3);border-radius:3px;font-family:'Cinzel',serif;font-size:.58rem;cursor:pointer;color:#60a5fa">💬 Messaggio</button>
            </div>
          </div>`;
        }).join('')}
        <button onclick="document.getElementById('mp-actions')?.remove()" style="width:100%;padding:.55rem;background:transparent;border:1px solid rgba(201,168,76,.25);border-radius:3px;font-family:'Cinzel',serif;font-size:.68rem;cursor:pointer;color:#9a8a6a;margin-top:.25rem">← Chiudi</button>
      </div>`;
    ov.addEventListener('click', e => { if (e.target === ov) ov.remove(); });
    document.body.appendChild(ov);
  }
  ...
  // VITTORIA
  // ══════════════════════════════
  function _showWin(name, isMe) {
    _el('mp-win')?.remove();
    const ov = document.createElement('div');
    ov.id = 'mp-win';
    ov.style.cssText = 'position:fixed;inset:0;z-index:900;background:rgba(10,10,15,.97);display:flex;flex-direction:column;align-items:center;justify-content:center;animation:mp-in .5s ease';
    ov.innerHTML = `
      <div style="text-align:center;padding:2rem;font-family:'Cinzel',serif">
        <div style="font-size:4rem;margin-bottom:.5rem">${isMe?'🏆':'👑'}</div>
        <div style="font-family:'Cinzel Decorative',serif;font-size:1.3rem;color:#c9a84c;margin-bottom:.5rem">${isMe?'HAI VINTO!':name+' ha vinto'}</div>
        <div style="font-family:'EB Garamond',serif;font-size:1rem;color:#9a8a6a;margin-bottom:1.5rem;font-style:italic;max-width:300px;line-height:1.6">
          ${isMe?'«Avete mantenuto il Trono per 5 minuti.»':` «${name} ha tenuto il Trono per 5 minuti.»`}
        </div>
        <button onclick="MultiplayerEngine._end()" style="padding:.75rem 2rem;background:linear-gradient(135deg,#78350f,#c9a84c,#78350f);border:none;border-radius:3px;font-family:'Cinzel',serif;font-size:.8rem;font-weight:700;letter-spacing:.15em;text-transform:uppercase;cursor:pointer;color:#0a0a0f">Torna al Menu</button>
      </div>`;
    document.body.appendChild(ov);
  }
  ...
  function _copyCode() {
    ...
    if (navigator.clipboard?.writeText) {
      navigator.clipboard.writeText(_sessionCode)
        .then(() => _toast('📋 Codice copiato!', 'good'))
        .catch(() => prompt('Codice sessione:', _sessionCode));
    } else prompt('Codice sessione:', _sessionCode);
    const box = _el('mp-codebox');
    if (box) { box.style.background='rgba(201,168,76,.3)'; setTimeout(() => box.style.background='rgba(201,168,76,.08)',500); }
  }

  // ══════════════════════════════
  // SEND HELPERS
  // ══════════════════════════════
  function _send(conn, msg)   { try { if (conn?.open) conn.send(msg); } catch(e){} }
  function _bcast(msg)        { Object.values(_connections).forEach(c => _send(c, msg)); }
  function _toHost(msg)       {
    // FIX-13: usa la gerarchia per identificare il vero host invece di prendere la prima connessione
    // (la prima connessione potrebbe non essere l'host dopo una migration)
    const hostId = _hostHierarchy?.[0];
    const c = hostId ? _connections[hostId] : Object.values(_connections)[0];
    if (c) _send(c, msg);
  }
  function _sendToP(pid, msg) {
    if (_isHost) { const c = _connections[pid]; if (c) _send(c, msg); }
    else _toHost({ type:'RELAY', payload:{ ...msg, _to:pid } });
  }

  // ══════════════════════════════════════════════════════
  // HOST MIGRATION — sistema gerarchia preventiva
  // Flusso:
  //  1. Ogni PING_INTERVAL_MS l'host manda PING a tutti i guest
  //  2. I guest rispondono con PONG (timestamp round-trip)
  //  3. L'host calcola la gerarchia (latenza ASC, join-order come tiebreaker)
  //     e la diffonde come HIERARCHY a tutti
  //  4. Se l'host si disconnette, ogni guest vede _onDC(hostPeerId)
  //  5. Il guest in cima alla gerarchia diventa nuovo host:
  //     - si riconnette agli altri guest direttamente
  //     - invia MIGRATION_NEW_HOST a tutti
  //  6. Gli altri guest rispondono con MIGRATION_ACK e si riconnettono
  // ══════════════════════════════════════════════════════

  // ── Avvia il ping loop (solo sull'host) ──
  function _startPingLoop() {
    clearInterval(_pingInterval);
    _pingInterval = setInterval(() => {
      if (!_isHost) { clearInterval(_pingInterval); return; }
      const now = Date.now();
      Object.keys(_connections).forEach(pid => {
        _send(_connections[pid], { type: 'PING', ts: now, from: _myPeerId });
      });
    }, PING_INTERVAL_MS);
  }

  function _hPing(msg, from) {
    // Guest risponde immediatamente con PONG
    _send(_connections[from] || Object.values(_connections)[0],
      { type: 'PONG', ts: msg.ts, from: _myPeerId });
  }

  function _hPong(msg, from) {
    if (!_isHost) return;
    const latency = Math.round((Date.now() - msg.ts) / 2);
    _pingMap[from] = latency;
    // Aggiorna e diffonde la gerarchia ogni volta che arriva un PONG
    _rebuildHierarchy();
  }

  // ── Costruisce e diffonde la gerarchia ──
  function _rebuildHierarchy() {
    if (!_isHost) return;
    // Solo i guest vivi partecipano alla gerarchia
    const candidates = _joinOrder
      .filter(pid => pid !== _myPeerId && _players[pid] && _players[pid].state !== 'dead')
      .map(pid => ({ peerId: pid, ping: _pingMap[pid] ?? 9999 }))
      .sort((a, b) => a.ping - b.ping);  // latenza crescente; joinOrder come tiebreaker implicito

    _hostHierarchy = candidates.map(c => c.peerId);
    _bcast({ type: 'HIERARCHY', order: _hostHierarchy, pings: _pingMap });
  }

  function _hHierarchy(msg) {
    _hostHierarchy = msg.order || [];
    _pingMap       = msg.pings || {};
  }

  // ── Registra l'ordine di join ──
  function _registerJoinOrder(pid) {
    if (!_joinOrder.includes(pid)) _joinOrder.push(pid);
  }

  // ══════════════════════════════
  // MIGRAZIONE: host in uscita
  // ══════════════════════════════

  // Chiamata dall'host quando chiude volontariamente (o all'unload)
  function _notifyHostLeaving() {
    if (!_isHost) return;
    _rebuildHierarchy();
    _bcast({ type: 'HOST_LEAVING', hierarchy: _hostHierarchy, pings: _pingMap,
             players: _buildFullPlayerSnapshot() });
    // Piccolo delay per garantire la consegna prima di distruggere il peer
    // (il caller poi chiama _end())
  }

  function _buildFullPlayerSnapshot() {
  ...
  function _hHostLeaving(msg) {
    // Riceviamo la gerarchia definitiva dall'host prima che sparisca
    if (msg) {
      _hostHierarchy = msg.hierarchy || _hostHierarchy;
      _pingMap       = msg.pings    || _pingMap;
      // Aggiorna snapshot giocatori se incluso
      if (msg.players) {
        msg.players.forEach(snap => {
          if (snap.peerId === _myPeerId) return;
          _players[snap.peerId] = { ...(_players[snap.peerId]||{}), ...snap };
        });
      }
    }
    // Ora _onDC scatterà subito dopo — la migrazione avviene là
  }

  // ══════════════════════════════
  // MIGRAZIONE: trigger su disconnessione host
  // ══════════════════════════════
  function _attemptHostMigration(hostPid) {
    if (_migrating) return;
    _migrating = true;

    // Sono io il prossimo in gerarchia?
    const nextHost = _hostHierarchy[0];
    if (!nextHost || nextHost !== _myPeerId) {
      // Non sono io — aspetto che il nuovo host mi contatti
      // Se non arriva nulla entro MIGRATION_TIMEOUT_MS + buffer, riprovo
      setTimeout(() => {
        if (_migrating && !_isHost) {
          // Fallback: prendo io il controllo se ero il secondo in lista
          const myIdx = _hostHierarchy.indexOf(_myPeerId);
          if (myIdx > 0 && !Object.values(_connections).some(c => c.open)) {
            _becomNewHost();
          } else {
            _migrating = false;
          }
        }
      }, MIGRATION_TIMEOUT_MS + 1500);
      return;
    }

    // Sono il primo in gerarchia → divento host
    _becomNewHost();
  }

  function _becomNewHost() {
    _isHost  = true;
    _migrating = false;
    clearInterval(_pingInterval);

    // Pausa guerra PvP in corso
    const s = typeof Game !== 'undefined' ? Game._getState?.() : null;
    const pvpWasPaused = s && (s.inActiveBattle || s._pvpWarTarget);
    if (pvpWasPaused && s) s._migrationPause = true;

    const oldConnections = { ..._connections };
    _connections = {};
    _joinOrder   = [_myPeerId];

    // Mostra schermata di attesa
    _showMigrationOverlay();

    // Ricostruisce le connessioni peer-to-peer verso gli altri guest superstiti
    const otherPeers = _hostHierarchy.filter(pid => pid !== _myPeerId && _players[pid]?.state !== 'dead');
    let connected = 0;
    ...
    if (total === 0) {
      ...
      _toast('👑 Sei l\'unico sopravvissuto. La partita continua.', 'good');
      _finalizeMigration();
      return;
    }
    ...
    otherPeers.forEach(pid => {
      try {
        const conn = _peer.connect(pid, PEER_CONNECT_OPTS);
        let done = false;
        conn.on('open', () => {
          if (done) return; done = true;
          _connections[pid] = conn;
          _setupConn(conn);
          _registerJoinOrder(pid);
          connected++;
          // Notifica il guest che sono il nuovo host
          _send(conn, {
            type:      'MIGRATION_NEW_HOST',
            newHostId: _myPeerId,
            newHostName: _players[_myPeerId]?.name,
            hierarchy: _hostHierarchy.filter(p => p !== _myPeerId),
            players:   _buildFullPlayerSnapshot(),
          });
          if (connected >= total) {
            setTimeout(() => { _hideMigrationOverlay(); _finalizeMigration(); }, 600);
          }
        });
        conn.on('error', () => {
          if (done) return; done = true;
          // Guest non raggiungibile — lo marco come dead
          if (_players[pid]) _players[pid].state = 'dead';
          connected++;
          if (connected >= total) {
            setTimeout(() => { _hideMigrationOverlay(); _finalizeMigration(); }, 600);
          }
  ...
  function _finalizeMigration() {
    // Ricostruisce gerarchia con i peer ora connessi
    _pingMap = {};
    Object.keys(_connections).forEach(pid => { _pingMap[pid] = 0; });
    _rebuildHierarchy();
    _startPingLoop();
    _bcastList();
    _updateHud();
    const myName = _players[_myPeerId]?.name || 'Tu';
    _toast(`👑 ${myName} è il nuovo host. La partita continua!`, 'good');

    // Riprendi guerra PvP se era in corso
    const s = typeof Game !== 'undefined' ? Game._getState?.() : null;
    if (s?._migrationPause) {
      s._migrationPause = false;
      _toast('⚔ La guerra PvP riprende ora.', 'warn');
    }
  }

  // ── Lato guest: riceve il MIGRATION_NEW_HOST ──
  function _hMigrationNewHost(msg, from) {
    _migrating = false;
    // Aggiorna la lista giocatori ricevuta dal nuovo host
    if (msg.players) {
      msg.players.forEach(snap => {
        if (snap.peerId === _myPeerId) return;
        _players[snap.peerId] = { ...(_players[snap.peerId]||{}), ...snap };
    ...
    _hostHierarchy = msg.hierarchy || [];

    // Rimuove la vecchia connessione all'host (ora morta) e aggiunge quella al nuovo host
    const oldHostConns = Object.entries(_connections).filter(([pid]) => !_players[pid] || !_players[pid].state || pid === from);
    oldHostConns.forEach(([pid, c]) => { try { c.close(); } catch(e){} delete _connections[pid]; });

    // La connessione al nuovo host è già aperta (from = newHostId) — la registriamo
    // Nota: PeerJS invia 'connection' all'host; qui il guest riceve da una conn già open
    if (!_connections[from]) {
      // Dobbiamo fare connect esplicito verso il nuovo host se non abbiamo ancora la conn
      try {
        const conn = _peer.connect(from, PEER_CONNECT_OPTS);
        conn.on('open', () => {
          _connections[from] = conn;
          _setupConn(conn);
          _send(conn, { type: 'MIGRATION_ACK', from: _myPeerId });
        });
      } catch(e) {}
    } else {
      _send(_connections[from], { type: 'MIGRATION_ACK', from: _myPeerId });
    }

    _updateHud();
    _toast(`👑 ${msg.newHostName || '?'} è il nuovo host. La partita continua!`, 'good');
  }

  function _hMigrationAck(msg, from) {
    // Il nuovo host riceve conferma dai guest — nessuna azione extra necessaria,
    // la connessione è già gestita da _becomNewHost
  }

  // ── Overlay di migrazione ──
  function _showMigrationOverlay() {
    _el('mp-migrating')?.remove();
    const ov = document.createElement('div');
    ov.id = 'mp-migrating';
    ov.style.cssText = 'position:fixed;inset:0;z-index:950;background:rgba(10,10,15,.88);display:flex;flex-direction:column;align-items:center;justify-content:center;font-family:"Cinzel",serif;animation:mp-in .3s ease;backdrop-filter:blur(6px)';
    ov.innerHTML = `
      <div style="text-align:center;padding:2rem">
        <div style="font-size:2.5rem;margin-bottom:.75rem;animation:mp-pulse 1.2s infinite">👑</div>
        <div style="font-family:'Cinzel Decorative',serif;font-size:1rem;color:#c9a84c;margin-bottom:.5rem">Cambio di Host</div>
        <div style="font-family:'EB Garamond',serif;font-size:.9rem;color:#9a8a6a;font-style:italic;max-width:280px;line-height:1.6">
          L'host ha abbandonato la partita.<br>
          La sessione viene trasferita al giocatore con la connessione migliore.<br>
          <span style="color:#c9a84c;font-size:.8rem">Le guerre in corso sono in pausa.</span>
        </div>
        <div style="margin-top:1rem;display:flex;justify-content:center;gap:6px">
          ${[0,1,2].map(i=>`<div style="width:7px;height:7px;border-radius:50%;background:#c9a84c;animation:mp-pulse 1.2s infinite;animation-delay:${i*0.3}s"></div>`).join('')}
        </div>
      </div>`;
    document.body.appendChild(ov);
  }

  function _hideMigrationOverlay() {
    _el('mp-migrating')?.remove();
  }
  ...
  function _onDC(pid) {
    ...
    if (p) { _toast(`⚠ ${p.name} si è disconnesso.`, 'warn'); p.state = 'dead'; }
    delete _connections[pid];

    // Se era l'host che si è disconnesso, avvia la migrazione
    const wasHost = !_isHost && Object.keys(_connections).filter(id => _players[id]?.state !== 'dead').length === 0
                    || (!_isHost && pid === Object.keys(_connections).find(id => true) && Object.keys(_connections).length === 0);

    // Criterio semplice e robusto: se non sono host e non ho più connessioni aperte verso l'host precedente
    // (l'host è sempre il primo connesso — i guest si connettono solo all'host, non tra loro)
    const isHostDC = !_isHost && Object.values(_connections).filter(c => c.open).length === 0;

    if (isHostDC && !_migrating) {
      // Piccolo delay: aspetta HOST_LEAVING se stava arrivando
      setTimeout(() => _attemptHostMigration(pid), 300);
    } else {
      if (_isHost) _bcastList();
    }
    _updateHud();
  ...
  function _leave()  {
    if (_isHost) { _notifyHostLeaving(); setTimeout(() => { _end(); showLobby(); }, 80); }
    else { _end(); showLobby(); }
  }
  function _end() {
    clearInterval(_throneTimer); clearInterval(window._mpSync); clearInterval(_pingInterval);
    _throneTimer = null; window._mpSync = null; _pingInterval = null;
    _stopHouseBlockObserver();
    if (typeof Game !== 'undefined') { Game._mpMode = false; Game._mpEngine = null; }
    Object.values(_connections).forEach(c => { try { c.close(); } catch(e){} });
    if (_peer) { _peer.destroy(); _peer = null; }
    _connections={}; _players={}; _takenHouses={};
    _myPeerId=null; _isHost=false; _sessionCode=null;
    _throneHolderPeerId=null; _throneStart=null; _throneWarBlocked=false;
    _privateChatTarget=null;
    _hostHierarchy=[]; _pingMap={}; _joinOrder=[]; _migrating=false;
    // FIX-15: rimuovi la scacchiera live se è rimasta aperta (es. disconnessione durante battaglia)
    document.getElementById('sb-overlay')?.remove();
    _pvpBattleState = null;
    // Non resettare _kickedPeers e _lobbyBanned qui — devono persistere tra sessioni
    ['mp-lobby','mp-room','mp-hud','mp-throne-bar','mp-win','mp-actions',
     'mp-trade','mp-trade-recv','mp-ult-build','mp-ult-recv','mp-wardecl-recv',
     'mp-pvp-reinf','mp-gchat','mp-pchat','mp-spec-ov','mp-spec-pr','mp-notif',
     'mp-migrating'].forEach(id => _el(id)?.remove());
  }

  // ══════════════════════════════
  // LOAD PEERJS
  // ══════════════════════════════
  function _loadPeer(cb) {
    if (window.Peer) { cb(); return; }
    const s = document.createElement('script');
    s.src = 'https://cdnjs.cloudflare.com/ajax/libs/peerjs/1.5.4/peerjs.min.js';
    s.onload  = cb;
    s.onerror = () => _toast('❌ Impossibile caricare PeerJS. Verifica connessione.', 'warn');
    document.head.appendChild(s);
  }
  ...
  // INIT
  // ══════════════════════════════
  if (document.readyState === 'complete') setTimeout(injectBtn, 400);
  else window.addEventListener('load', () => setTimeout(injectBtn, 400));

  // Notifica i guest quando l'host chiude la tab/browser
  window.addEventListener('beforeunload', () => {
    if (_isHost && _peer && Object.keys(_connections).length > 0) {
      _notifyHostLeaving();
    }
  });
  ...
  return {
    // Lobby
    createSession, joinSession, closeLobby,
    openCharPicker: _openNativeCharSelect,
    _openNativeCharSelect,
    selectChar, setReady, hostStart, hostStartCharPick,
    sendLobbyChat,
    kickPlayer,
    // In-game
    toggleGlobalChat, sendGlobalMsg, sendPrivMsg,
    sendWarUltimatum, openTradePanel,
    _showActions, _openSpec, _openPrivList: _openPrivList,
    _copyCode, _leave, _end,
    // Internals per onclick HTML
    _respondUlt, _respondTrade, _declareWarDirect,
    _initPvpWarDefender, _initPvpWarAttacker,
    _launchPvpBattle, _sendUltimatum, _sendTradeOffer,
    _openPrivChat,
  };
